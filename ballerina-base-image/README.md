...
cp ~/Downloads/ballerina-0.95.8.zip .
bash build.sh -d ballerina-0.95.8.zip

# Or build without copying the distribution.
bash build.sh -d ~/Downloads/ballerina-0.95.8.zip
...
```bash
$ bash build.sh -d ~/dev/ballerina/ballerina-0.95.8.zip -v 0.95.8 -o ballerinalang
```

3. This will build a Docker image with name `ballerinalang/ballerina:0.95.8` in the local Docker repository. The `latest` tag for `ballerinalang/ballerina` should now also point to this image now.
```bash
$ docker tag ballerinalang/ballerina:0.95.8 ballerinalang/ballerina:latest
```
...
```bash
$ docker tag ballerinalang/ballerina:0.95.8 ballerina/ballerina:0.95.8
$ docker tag ballerinalang/ballerina:0.95.8 ballerina/ballerina:latest
```
...
ballerinalang/ballerina                           0.95.8                              4daa1c1f2089        1 minute ago        142MB
ballerinalang/ballerina                           latest                              4daa1c1f2089        1 minute ago        142MB
ballerina/ballerina                               0.95.8                              4daa1c1f2089        1 minute ago        142MB
...
```bash
$ docker push ballerinalang/ballerina:0.95.8
$ docker push ballerinalang/ballerina:latest
$ docker push ballerina/ballerina:0.95.8
