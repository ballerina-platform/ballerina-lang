...
public final class NumberToJSON {
    ...
    public static String serializeNumber(double value) throws IOException {
        ...
        boolean sign = bits < 0;
        if (DEBUG) {
            console.println("IN=" + Long.toBinaryString(bits));
            console.println("   S=" + (sign ? "-" : "+") + " E=" + e2 + " M=" + m2);
        }
        ...
        if (DEBUG) {
            ...
            console.println("E =" + e10);
            console.println("d+=" + sp);
            console.println("d =" + sv);
            console.println("d-=" + sm);
            console.println("e2=" + e2);
        }
        ...
        if (e2 >= 0) {
            ...
            e10 = q;
            if (DEBUG) {
                console.println(mv + " * 2^" + e2);
                console.println("V+=" + dp);
                console.println("V =" + dv);
                console.println("V-=" + dm);
            }
            if (DEBUG) {
                long exact = POW5_INV[q].multiply(BigInteger.valueOf(mv))
                        .shiftRight(-e2 + q + k).longValueExact();
                console.println(exact + " " + POW5_INV[q].bitCount());
                if (dv != exact) {
        ...
        if (DEBUG) {
            console.println("d+=" + dp);
            console.println("d =" + dv);
            console.println("d-=" + dm);
            console.println("e10=" + e10);
            console.println("d-10=" + dmIsTrailingZeros);
            console.println("d   =" + dvIsTrailingZeros);
            console.println("Accept upper=" + even);
            console.println("Accept lower=" + even);
        }
        ...
        if (DEBUG) {
            console.println("LAST_REMOVED_DIGIT=" + lastRemovedDigit);
            console.println("VP=" + dp);
            console.println("VR=" + dv);
            console.println("VM=" + dm);
            console.println("O=" + output);
            console.println("OLEN=" + olength);
            console.println("EXP=" + exp);
        }
