...
service helloWorld on new http:Listener(9090) {
    ...
    resource function hello(http:Caller caller, http:Request request) {
        // [Check if the client expects a 100-continue response](https://ballerina.io/swan-lake/learn/api-docs/ballerina/http/classes/Request.html#expects100Continue).
