...
public class BindgenCommand implements BLauncherCmd {
    ...
    public void printUsage(StringBuilder out) {
        ...
        out.append("  $ bal " + COMPONENT_IDENTIFIER + " -cp ./libs/snakeyaml-1.31.jar,./libs/pdfbox-1.8.10.jar " +
                "-o ./modules/sample\n");
        out.append("  org.yaml.snakeyaml.Yaml org.apache.pdfbox.pdmodel.PDDocument java.io.File\n");
        out.append("  $ bal " + COMPONENT_IDENTIFIER + " -mvn org.yaml:snakeyaml:1.31 org.yaml.snakeyaml.Yaml\n");
    }
