...
public class BindgenCommand implements BLauncherCmd {
    ...
    public void printLongDesc(StringBuilder out) {
        ...
        out.append("or for standard Java classes. Here, the Java classes will be mapped onto Ballerina\n");
        out.append("classes, making the developer experience of Ballerina's Java interoperability seamless.\n");
        out.append("\n");
        out.append("In addition to the user-specified Java classes, partial implementations of directly\n");
        out.append("dependent Java classes will also be generated by the tool. By default, bindings for\n");
        out.append("each Java package will be mapped onto a separate Ballerina module.\n");
    }
