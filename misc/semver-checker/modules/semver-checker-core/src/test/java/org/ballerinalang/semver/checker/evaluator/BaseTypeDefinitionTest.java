...
/**
 * Base class for testing all type definition related test cases.
 */
public class BaseTypeDefinitionTest {

    /**
     * Compare the expected output and actual output for the given test cases.
     * @param fileName
     * @throws Exception
     */
