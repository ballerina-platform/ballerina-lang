...
public class ComponentModelingServerCapabilitySetter extends
        BallerinaServerCapabilitySetter<ComponentModelingServerCapabilities> {

    @Override
    public Optional<ComponentModelingServerCapabilities> build() {

        ComponentModelingServerCapabilities capabilities = new ComponentModelingServerCapabilities();
