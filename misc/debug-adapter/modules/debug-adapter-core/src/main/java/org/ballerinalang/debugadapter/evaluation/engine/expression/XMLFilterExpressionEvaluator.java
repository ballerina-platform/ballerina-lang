...
public class XMLFilterExpressionEvaluator extends Evaluator {
    ...
    public BExpressionValue evaluate() throws EvaluationException {
        try {
            ...
            RuntimeStaticMethod getFilteredChildrenFlat = getRuntimeMethod(context, B_DEBUGGER_RUNTIME_CLASS,
            ...
            getFilteredChildrenFlat.setArgValues(argValues);
            return new BExpressionValue(context, getFilteredChildrenFlat.invokeSafely());
