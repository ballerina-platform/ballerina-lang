...
Usage:
jballerina doc <sourcepath>... [-t templatesdir] [-o outputdir] [-n] [-e excludedmodules] [-v]
  sourcepath:
...
```sh
$ jballerina doc ../../../connectors/twitter/src/ ../../../connectors/soap/src/ test.bal
```
...
```sh
$ jballerina doc ../../../connectors/twitter/src/ ../../../connectors/soap/src/ test.bal  -o docs
```
...
```sh
$ jballerina doc ../../../connectors/twitter/src/ ../../../connectors/soap/src/ test.bal  -o docs -e org.wso2.ballerina.connectors.twitter
```
...
```sh
$ jballerina doc ../../../connectors/twitter/src/ ../../../connectors/soap/src/ test.bal  -o docs -v
```
**Example 5:** Generate API documentation for the given native Ballerina source directories:
```sh
$ jballerina doc ../../../connectors/twitter/src/ ../../../connectors/soap/src/ -n
```
**Example 6:** Generate API documentation using a custom templates folder:
```sh
$ jballerina doc ../../../connectors/twitter/src/ ../../../connectors/soap/src/ -t custom-templates
```
...
- Build Ballerina and extract the distribution:
  ...
  unzip jballerina-<version>.zip
  cd jballerina-<version> # Refer this as [ballerina-home]
  ```
...
- Navigate to Ballerina bin directory and execute the bellow command to generate API documentation:
  ...
  ./jballerina doc [ballerina-module-path] # absolute file path of the ballerina source module
  ```
