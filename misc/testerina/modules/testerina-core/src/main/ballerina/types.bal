...
public type DataProviderReturnType error|map<AnyOrErrorOrReadOnlyType[]>|AnyOrErrorOrReadOnlyType[][];

public type AnyOrErrorOrReadOnlyType any|error|ReadOnlyType;

public type ReadOnlyType readonly;
