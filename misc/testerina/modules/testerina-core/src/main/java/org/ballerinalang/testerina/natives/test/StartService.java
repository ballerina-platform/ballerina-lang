...
//        ctx.setReturnValues(str);
    ...
    private void startService(ProgramFile programFile, ServiceInfo matchingService) {
        ...
        BLangFunctions.invokePackageInitFunction(matchingService.getPackageInfo().getInitFunctionInfo());

        BLangFunctions.invokeVMUtilFunction(matchingService.getPackageInfo().getStartFunctionInfo());
...
//        AnnAttributeValue sslProtocolAttrVal = configInfo.getAttributeValue(HttpConstants
// .ANN_CONFIG_ATTR_SSL_PROTOCOL);
//        AnnAttributeValue hostAttrVal = configInfo.getAttributeValue(HttpConstants.ANN_CONFIG_ATTR_HOST);
//
//        ListenerConfiguration listenerConfiguration = new ListenerConfiguration();
...
//                //TODO get from language pack, and add location
//                throw new BallerinaConnectorException("Keystore password value must be provided for secure
// connection");
//            }
