 ...
 * @since 0.94
 */
public class TomlDiagnostic implements Diagnostic {
    ...
    public TomlDiagnostic(Kind kind,
                       DiagnosticPos pos,
                       DiagnosticCode code,
                       String msg) {
        this.kind = kind;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof TomlDiagnostic)) {
            return false;
        }
        TomlDiagnostic diagnostic = (TomlDiagnostic) obj;
