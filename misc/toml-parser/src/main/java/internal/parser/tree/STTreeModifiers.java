...
/**
 * Contains a set of utility methods to modify {@code STNode}.
 *
 * @since 2.0.0
 */
public class STTreeModifiers {
     ...
     */
    public static <T extends STNode> T replace(T root, STNode target, STNode replacement) {
        STNodeReplacer nodeReplacer = new STNodeReplacer(target, replacement);
