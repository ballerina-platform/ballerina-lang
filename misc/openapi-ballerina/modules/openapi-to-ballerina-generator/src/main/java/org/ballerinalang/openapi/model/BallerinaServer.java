...
/**
 * Wrapper for {@link Server} from OpenApi parser. This model is used to extract and keep Ballerina endpoint details
 * from a openapi {@link Server} instance.
 */
public class BallerinaServer implements BallerinaOpenApiObject<BallerinaServer, Server> {
