 ...
 * @since 0.992.0
 */
@CommandLine.Command(name = COMPILE_COMMAND, description = "ballerina compile - compile a Ballerina module(s) and " +
                                                           "generate a .balo file(s).")
public class CompileCommand implements BLauncherCmd {
    ...
    @CommandLine.Option(names = {"--off-line"}, description = "compile offline without downloading the dependencies.")
