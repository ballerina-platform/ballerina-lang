 ...
 * @since 0.992.0
 */
@CommandLine.Command(name = TEST_COMMAND, description = "test the Ballerina modules.")
public class TestCommand implements BLauncherCmd {
    ...
    @CommandLine.Option(names = "--siddhi-runtime", description = "enable the Siddhi runtime for stream processing.")
    ...
    public void execute() {
        ...
        if (argList == null || argList.size() == 0) {
                ...
                if (null == findRoot) {
                    CommandUtil.printError(errStream,
                            "provide a Ballerina file as the " +
                                    "input or run the build command from inside a Ballerina project.",
            ...
            if (Files.notExists(sourceFullPath)) {
                throw LauncherUtils.createLauncherException("module or source file does not exist.");
            }
            ...
            if (Files.isRegularFile(sourceFullPath) &&
                ...
                throw LauncherUtils.createLauncherException("an invalid Ballerina source path. It should either be a " +
    ...
    public void printLongDesc(StringBuilder out) {
        out.append("compile Ballerina modules and create .balo files. \n");
    }
