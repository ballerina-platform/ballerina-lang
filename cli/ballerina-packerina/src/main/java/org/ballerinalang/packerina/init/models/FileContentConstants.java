...
public class FileContentConstants {
    public static final String SERVICE = "// A system package containing protocol access constructs\n" +
                                        ...
                                        "    }\n" +
                                        "}";
    public static final String MAIN = "import ballerina/io;\n" +
                                        "\n" +
                                        "# Prints `Hello World`.\n" +
                                        "function main(string... args) {\n" +
                                        "    io:println(\"Hello World!\");\n" +
                                        "}\n";
    public static final String MAIN_TEST = "import ballerina/test;\n" +
                                            "import ballerina/io;\n" +
                                            "\n" +
                                            ...
                                            "}";
    public static final String SERVICE_TEST = "import ballerina/test;\n" +
                                            "import ballerina/io;\n" +
                                            "\n" +
                                            "# Before Suite Function\n" +
                                            "@test:BeforeSuite\n" +
