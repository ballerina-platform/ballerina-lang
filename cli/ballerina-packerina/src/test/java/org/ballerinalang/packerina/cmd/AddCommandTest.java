        ...
        try {
            ...
            Path baloFile = templateProject.resolve("target")
                    .resolve("balo").resolve("mytemplate-"
                            + ProjectConstants.IMPLEMENTATION_VERSION + "-any-0.1.0.balo");
