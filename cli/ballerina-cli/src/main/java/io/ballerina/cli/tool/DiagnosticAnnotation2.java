...
public class DiagnosticAnnotation2 {
    ...
    public DiagnosticAnnotation2(String line, int start, int length, int startLineNumber) {
    ...
    public DiagnosticAnnotation2(String line, int start, int length, int endOffset, int startLineNumber) {
        this.start = start + 3 * countTabChars(line, start);
        this.line = replaceTabs(line, start);
        this.length = length;
