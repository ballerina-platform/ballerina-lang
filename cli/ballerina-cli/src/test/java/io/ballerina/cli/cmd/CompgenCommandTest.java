...
public class CompgenCommandTest extends BaseCommandTest {
    ...
    @Test(description = "Suggest sub commands in accordance with the args")
    public void testCompgenSuggestion() throws IOException {
        CompgenCommand compgenCommand = new CompgenCommand(printStream);
    ...
    @Test(description = "Suggest flags in accordance with the args")
