...
public interface TomlListener extends ParseTreeListener {
    ...
    /**
     * Enter a parse tree produced by {@link TomlParser#tableKeySep}.
     *
     * @param ctx the parse tree
     */
    void enterTableKeySep(TomlParser.TableKeySepContext ctx);

    /**
     * Exit a parse tree produced by {@link TomlParser#tableKeySep}.
     *
     * @param ctx the parse tree
     */
    void exitTableKeySep(TomlParser.TableKeySepContext ctx);
