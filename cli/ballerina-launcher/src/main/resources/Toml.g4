...
val : string | bool | array | inlineTable | dateTime | floatingPoint | integer;
...
stdTable : stdTableOpen key ( tableKeySep key )* stdTableClose;
...
arrayTable : arrayTableOpen key ( tableKeySep key )* arrayTableClose;
