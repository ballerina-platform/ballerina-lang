...
public class TestUtils {
    ...
    private static final String TEMP_BALO_CACHE = "temp-test-utils-bala-cache";
    ...
    public void testWriteBalaFile() throws IOException, CentralClientException {
        ...
        writeBalaFile(connection, UTILS_TEST_RESOURCES.resolve(TEMP_BALO_CACHE).resolve(balaName), "wso2/sf:1.1.0",
                10000, System.out, new LogFormatter());

        Assert.assertTrue(UTILS_TEST_RESOURCES.resolve(TEMP_BALO_CACHE).resolve(balaName).toFile().exists());
        cleanBalaCache();
    }
    ...
    public void testCreateBalaInHomeRepo() throws IOException, CentralClientException {
        ...
        createBalaInHomeRepo(connection, UTILS_TEST_RESOURCES.resolve(TEMP_BALO_CACHE).resolve("wso2").resolve("sf"),
