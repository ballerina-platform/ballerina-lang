...
public connector helloBlockingStub(string host, int port){
 endpoint<grpc:GRPCConnector> ep {
    ...
    action hello (string req) (string, error) {
        var res, err1 = ep.blockingExecute("hello/hello", req);
...
public connector helloNonBlockingStub(string host, int port){
 endpoint<grpc:GRPCConnector> ep {
    ...
    action hello (string req, string serviceName) (error) {
        var err1 = ep.nonBlockingExecute("hello/hello", req, serviceName);
        if (err1 != null && err1.message != null) {
            error e = {message:err1.message};
            return e;
        }
...
const string descriptorKey = ".hello.proto";
map descriptorMap ={
".hello.proto":"",
