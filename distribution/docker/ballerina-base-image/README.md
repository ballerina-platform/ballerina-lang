...
cp ~/Downloads/ballerina-0.961.1-SNAPSHOT.zip .
bash build.sh -d ballerina-0.961.1-SNAPSHOT.zip

# Or build without copying the distribution.
bash build.sh -d ~/Downloads/ballerina-0.961.1-SNAPSHOT.zip
...
```bash
$ bash build.sh -d ~/dev/ballerina/ballerina-0.961.1-SNAPSHOT.zip -v 0.961.1-SNAPSHOT -o ballerinalang
```

3. This will build a Docker image with name `ballerinalang/ballerina:0.961.1-SNAPSHOT` in the local Docker repository. The `latest` tag for `ballerinalang/ballerina` should now also point to this image now.
```bash
$ docker tag ballerinalang/ballerina:0.961.1-SNAPSHOT ballerinalang/ballerina:latest
```
...
```bash
$ docker tag ballerinalang/ballerina:0.961.1-SNAPSHOT ballerina/ballerina:0.961.1-SNAPSHOT
$ docker tag ballerinalang/ballerina:0.961.1-SNAPSHOT ballerina/ballerina:latest
```
...
ballerinalang/ballerina                           0.961.1-SNAPSHOT                              4daa1c1f2089        1 minute ago        142MB
ballerinalang/ballerina                           latest                              4daa1c1f2089        1 minute ago        142MB
ballerina/ballerina                               0.961.1-SNAPSHOT                              4daa1c1f2089        1 minute ago        142MB
...
```bash
$ docker push ballerinalang/ballerina:0.961.1-SNAPSHOT
$ docker push ballerinalang/ballerina:latest
$ docker push ballerina/ballerina:0.961.1-SNAPSHOT
