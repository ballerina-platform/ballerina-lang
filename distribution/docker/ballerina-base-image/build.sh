...
function showUsageAndExit() {
    ...
    echo
    echo "Ex: Create a Ballerina Docker image tagged \"ballerina:latest\" with Ballerina 0.970.0-alpha1-SNAPSHOT-alpha1-SNAPSHOT-alpha1-SNAPSHOT distribution."
    echo "    ./build.sh -d ballerina-0.970.0-alpha1-SNAPSHOT-alpha1-SNAPSHOT-alpha1-SNAPSHOT.zip"
    echo
