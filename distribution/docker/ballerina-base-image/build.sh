...
function showUsageAndExit() {
    ...
    echo
    echo "Ex: Create a Ballerina Docker image tagged \"ballerina:latest\" with Ballerina 0.961.1-SNAPSHOT distribution."
    echo "    ./build.sh -d ballerina-0.961.1-SNAPSHOT.zip"
    echo
