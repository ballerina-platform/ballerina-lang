 ...
 *  under the License.
 */
package io.samjs.plugins.onedependency;
 ...
 * @since 2.0.0
 */
public class CompilerPluginWithOneDependency extends CompilerPlugin {
        ...
        public void init(CodeAnalysisContext analysisContext) {
            ...
            analysisContext.addCompilationAnalysisTask(compAnalysisCtx -> {
                ...
                if (StringUtils.isEmpty(pkgName)) {
                    ...
                    out.println("Package name is empty");
                }
                // 1)
                out.println("CompilerPluginWithOneDependency:LogCodeAnalyzer:CompilationAnalysisTask 1 called");
            ...
            analysisContext.addCompilationAnalysisTask(compAnalysisCtx -> {
                // 1)
                out.println("CompilerPluginWithOneDependency:LogCodeAnalyzer:CompilationAnalysisTask 2 called");
            });
        }
    }
}
