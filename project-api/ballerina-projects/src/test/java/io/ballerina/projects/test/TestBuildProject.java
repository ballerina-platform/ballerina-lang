...
public class TestBuildProject {
    ...
    public void testAddDocument() {
        ...
        for (ModuleId moduleId1 : buildProject.currentPackage().moduleIds()) {
            if (moduleId1.moduleDirPath().equals(filePath.getParent().toString())) {
                moduleId = moduleId1;
            }
        }
        ...
        DocumentConfig documentConfig = DocumentConfig.from(newDocumentId, newFileContent);
    ...
    public void testAddTestDocument() {
        ...
        ModuleId moduleId = null;
        for (ModuleId moduleId1 : buildProject.currentPackage().moduleIds()) {
            if (moduleId1.moduleDirPath().equals(filePath.getParent().getParent().toString())) {
                moduleId = moduleId1;
            }
        }
        Assert.assertNotNull(moduleId);
        ...
        DocumentConfig documentConfig = DocumentConfig.from(newTestDocumentId, newFileContent);
    ...
    public void testAddEmptyModule() {
        ...
        ModuleConfig newModuleConfig = ModuleConfig.from(newModuleId,
        ...
        DocumentConfig documentConfig = DocumentConfig.from(documentId, mainContent);
    ...
    public void testAddModuleWithFiles() {
        ...
        DocumentConfig testDocumentConfig = DocumentConfig.from(testDocumentId, testContent);
    ...
    public void testRemoveModule() {
        ...
        for (ModuleId moduleId : oldPackage.moduleIds()) {
            if (moduleId.moduleDirPath().equals(filePath.toString())) {
                removeId = moduleId;
            }
        }
