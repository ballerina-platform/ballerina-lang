...
public class BallerinaBlockFunctionBodyImpl extends ASTWrapperPsiElement implements BallerinaBlockFunctionBody {

  public BallerinaBlockFunctionBodyImpl(@NotNull ASTNode node) {
    super(node);
  }
