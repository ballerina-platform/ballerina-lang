...
public class BallerinaJoinTypeImpl extends ASTWrapperPsiElement implements BallerinaJoinType {
  ...
  @Override
  @Nullable
  public PsiElement getFull() {
    return findChildByType(FULL);
  }
  ...
  public PsiElement getJoin() {
    return findNotNullChildByType(JOIN);
  }
