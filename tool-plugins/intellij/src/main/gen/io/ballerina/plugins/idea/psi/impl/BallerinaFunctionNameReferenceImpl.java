...
public class BallerinaFunctionNameReferenceImpl extends ASTWrapperPsiElement implements BallerinaFunctionNameReference {

  public BallerinaFunctionNameReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }
