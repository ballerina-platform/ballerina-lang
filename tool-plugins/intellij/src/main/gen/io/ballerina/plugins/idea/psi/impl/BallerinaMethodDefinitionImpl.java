...
public class BallerinaMethodDefinitionImpl extends ASTWrapperPsiElement implements BallerinaMethodDefinition {

  public BallerinaMethodDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public BallerinaNestedRecoverableBody getNestedRecoverableBody() {
    return findNotNullChildByClass(BallerinaNestedRecoverableBody.class);
  }
