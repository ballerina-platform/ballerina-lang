...
public class BallerinaMethodDeclarationImpl extends ASTWrapperPsiElement implements BallerinaMethodDeclaration {

  public BallerinaMethodDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
