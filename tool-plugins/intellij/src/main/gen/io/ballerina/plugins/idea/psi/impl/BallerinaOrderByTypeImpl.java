...
public class BallerinaOrderByTypeImpl extends ASTWrapperPsiElement implements BallerinaOrderByType {

  public BallerinaOrderByTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
