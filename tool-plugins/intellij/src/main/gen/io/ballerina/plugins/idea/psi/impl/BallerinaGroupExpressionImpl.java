...
public class BallerinaGroupExpressionImpl extends BallerinaExpressionImpl implements BallerinaGroupExpression {

  public BallerinaGroupExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
