...
public class BallerinaParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // !(DOCUMENTATION_TEMPLATE_START|DEPRECATED_TEMPLATE_START|'@'|native|public|type|typedesc|service|function|enum|annotation|endpoint|record|int|float|boolean|string|byte|map|xml|xmlns|json|table|any|stream|object|future|identifier
  // |'{')
