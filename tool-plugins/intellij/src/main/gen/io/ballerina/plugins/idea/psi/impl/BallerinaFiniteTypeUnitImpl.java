...
public class BallerinaFiniteTypeUnitImpl extends ASTWrapperPsiElement implements BallerinaFiniteTypeUnit {

  public BallerinaFiniteTypeUnitImpl(@NotNull ASTNode node) {
    super(node);
  }
