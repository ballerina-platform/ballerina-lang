...
public class BallerinaArrayLiteralImpl extends BallerinaCompositeElementImpl implements BallerinaArrayLiteral {

  public BallerinaArrayLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
