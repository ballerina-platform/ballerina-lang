...
public final class MarkdownPreviewSettings {
    ...
    @NotNull
    private MarkdownHtmlPanelProvider.ProviderInfo myHtmlPanelProviderInfo = new JavaFxHtmlPanelProvider()
            .getProviderInfo();
    ...
    public MarkdownPreviewSettings(@NotNull SplitFileEditor.SplitEditorLayout splitEditorLayout,
            @NotNull MarkdownHtmlPanelProvider.ProviderInfo htmlPanelProviderInfo, boolean useGrayscaleRendering,
    ...
    public boolean equals(Object o) {
        ...
        if (mySplitEditorLayout != settings.mySplitEditorLayout)
            return false;
        if (!myHtmlPanelProviderInfo.equals(settings.myHtmlPanelProviderInfo))
            return false;
