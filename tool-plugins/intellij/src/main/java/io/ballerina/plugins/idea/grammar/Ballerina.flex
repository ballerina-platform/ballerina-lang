...
// MARKDOWN_RETURN_PARAMETER_DOCUMENTATION
RETURN_PARAMETER_DOCUMENTATION_END = [\n]
...
%state MARKDOWN_RETURN_PARAMETER_DOCUMENTATION_MODE
...
<MARKDOWN_DOCUMENTATION_MODE>{
    {MARKDOWN_DOCUMENTATION_LINE_END}           { inMarkdownMode = false; yybegin(YYINITIAL); return  MARKDOWN_DOCUMENTATION_LINE_END; }
...
<SINGLE_BACKTICKED_MARKDOWN_MODE>{
    {SINGLE_BACKTICK_MARKDOWN_END}              { yybegin(MARKDOWN_DOCUMENTATION_MODE); return
...
<TRIPLE_BACKTICKED_MARKDOWN_MODE>{
    {TRIPLE_BACKTICK_MARKDOWN_END}              { yybegin(MARKDOWN_DOCUMENTATION_MODE); return
...
<MARKDOWN_RETURN_PARAMETER_DOCUMENTATION_MODE> {
    {RETURN_PARAMETER_DOCUMENTATION_END}        { yybegin(MARKDOWN_DOCUMENTATION_MODE); return  RETURN_PARAMETER_DOCUMENTATION_END; }
}
