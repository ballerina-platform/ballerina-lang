...
%state SINGLE_BACKTICKED_DOCUMENTATION_MODE
%state DOUBLE_BACKTICKED_DOCUMENTATION_MODE
%state TRIPLE_BACKTICKED_DOCUMENTATION_MODE
...
<MARKDOWN_DOCUMENTATION_MODE>{
    ...
    {SINGLE_BACKTICK_DOCUMENTATION_START}  { yybegin(SINGLE_BACKTICK_DOCUMENTATION_MODE); return  SINGLE_BACKTICK_DOCUMENTATION_START; }
    {DOUBLE_BACKTICK__DOCUMENTATION_START} { yybegin(DOUBLE_BACKTICK_DOCUMENTATION_MODE); return DOUBLE_BACKTICK_DOCUMENTATION_START; }
    {TRIPLE_BACKTICK__DOCUMENTATION_START} { yybegin(TRIPLE_BACKTICK_DOCUMENTATION_MODE); return TRIPLE_BACKTICK_DOCUMENTATION_START; }
}

<SINGLE_BACKTICK_DOCUMENTATION_MODE>{
    {SINGLE_BACKTICK_DOCUMENTATION_END}   { yybegin(MARKDOWN_DOCUMENTATION_MODE); return SINGLE_BACKTICK_DOCUMENTATION_END; }
    .                                      { return BAD_CHARACTER;}
}

<DOUBLE_BACKTICK_DOCUMENTATION_MODE>{
    {DOUBLE_BACKTICK_DOCUMENTATION_END}   { yybegin(MARKDOWN_DOCUMENTATION_MODE); return DOUBLE_BACKTICK_DOCUMENTATION_END; }
    .                                      { return BAD_CHARACTER; }
}

<TRIPLE_BACKTICK_DOCUMENTATION_MODE>{
    {TRIPLE_BACKTICK_DOCUMENTATION_END}   { yybegin(MARKDOWN_DOCUMENTATION_MODE); return TRIPLE_BACKTICK_DOCUMENTATION_END; }
    .                                      { return BAD_CHARACTER;}
}
