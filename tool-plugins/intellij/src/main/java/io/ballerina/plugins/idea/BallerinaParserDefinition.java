...
import static io.ballerina.plugins.idea.psi.BallerinaTypes.COMMIT;
import static io.ballerina.plugins.idea.psi.BallerinaTypes.COMMITTED;
import static io.ballerina.plugins.idea.psi.BallerinaTypes.CONFLICT;
...
import static io.ballerina.plugins.idea.psi.BallerinaTypes.DISTINCT;
...
import static io.ballerina.plugins.idea.psi.BallerinaTypes.JOIN_EQUALS;
import static io.ballerina.plugins.idea.psi.BallerinaTypes.JSON;
import static io.ballerina.plugins.idea.psi.BallerinaTypes.KEY;
...
import static io.ballerina.plugins.idea.psi.BallerinaTypes.NEVER;
...
import static io.ballerina.plugins.idea.psi.BallerinaTypes.READONLY;
...
import static io.ballerina.plugins.idea.psi.BallerinaTypes.ROLLBACK;
...
import static io.ballerina.plugins.idea.psi.BallerinaTypes.TRANSACTIONAL;
...
public class BallerinaParserDefinition implements ParserDefinition {
    ...
    public static final TokenSet KEYWORDS = TokenSet.create(ABORT, ABORTED, ABSTRACT, ANNOTATION, ANY, ANYDATA, BOOLEAN,
            BREAK, BYTE, CATCH, CHANNEL, CHECK, CHECKPANIC, CLIENT, COMMITTED, CONST, CONTINUE, DECIMAL, DISTINCT, ELSE,
            ENUM, ERROR, EXTERNAL, FAIL, FINAL, FINALLY, FLOAT, FLUSH, FORK, FUNCTION, FUTURE, HANDLE, IF, IMPORT, IN,
            INT, IS, JSON, LET, LISTENER, LOCK, MATCH, NEVER, NEW, OBJECT, OBJECT_INIT, ONRETRY, PARAMETER, PANIC,
            PRIVATE, PUBLIC, READONLY, RECORD, REMOTE, RESOURCE, RETRIES, RETRY, RETURN, RETURNS, SERVICE, SOURCE,
            START, STREAM, STRING, TABLE, TRANSACTION, TRY, TYPE, TYPE_FIELD, TYPE_PARAMETER, TYPEDESC, TYPEOF, TRAP,
            THROW, WAIT, WHILE, WITH, WORKER, VAR, VERSION, XML, XMLNS, BOOLEAN_LITERAL, NULL_LITERAL, FROM, ON, SELECT,
            WHERE, DO, FOREVER, TRANSACTION, TRANSACTIONAL, COMMIT, ROLLBACK, CONFLICT, JOIN_EQUALS, LIMIT, KEY);
