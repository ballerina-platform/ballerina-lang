...
public enum ConfigurableTypes {
    ARTIFACT(ArtifactLanguageServerDefinition$.MODULE$.getPresentableTyp()),
    EXE(ExeLanguageServerDefinition$.MODULE$.getPresentableTyp()),
    RAWCOMMAND(RawCommandServerDefinition$.MODULE$.getPresentableTyp());
