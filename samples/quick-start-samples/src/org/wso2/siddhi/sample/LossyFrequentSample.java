...
public class LossyFrequentSample {
    ...
    public static void main(String[] args)
        ...
        String queryReference = siddhiManager.addQuery("from  cseEventStream#window.lossyFrequent(0.1,0.01) " +
                                                       "select symbol, price " +
        ...
        inputHandler.send(new Object[]{"GOOG", 40.0f});
        inputHandler.send(new Object[]{"WSO2", 64.0f});     // this event will not be triggered but will be stored
