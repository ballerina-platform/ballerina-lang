...
function main (string[] args) {
    ...
    if (argumentLength < 4) {
        ...
        string repoPRpath = string `/repos/wso2/{{repo}}/pulls`;
        message request = {};
        ...
        string textMsg = string `Number of pending pull requests in {{repo}} is {{noOfPRstr}}`;
        ...
        string tweetPath = string `/1.1/statuses/update.json?status={{uri:encode(textMsg)}}`;
