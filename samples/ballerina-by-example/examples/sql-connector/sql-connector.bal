...
function main (string[] args) {
    ...
    int ret = sql:ClientConnector.update (testDB,
       "create table Students(id int auto_increment,age int,
        name varchar(255), primary key (id))", params);
    ...
    //Column values generated during the update can be retrived via
    ...
    sql:Parameter pId = {sqlType:"integer", value:1,
                                            direction:2};
