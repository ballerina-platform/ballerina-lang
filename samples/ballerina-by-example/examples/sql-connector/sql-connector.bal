...
function main (string[] args) {
    ...
    sql:Parameter para1 = {sqlType:sql:data.INTEGER, value:8};
    sql:Parameter para2 = {sqlType:sql:data.VARCHAR, value:"Sam"};
    params = [para1, para2];
    ...
    sql:Parameter p1 = {sqlType:sql:data.INTEGER, value:10};
    sql:Parameter p2 = {sqlType:sql:data.VARCHAR, value:"Smith"};
    sql:Parameter[] item1 = [p1, p2];
    sql:Parameter p3 = {sqlType:sql:data.INTEGER, value:20};
    sql:Parameter p4 = {sqlType:sql:data.VARCHAR, value:"John"};
    ...
    sql:Parameter pAge = {sqlType:sql:data.INTEGER, value:10};
    sql:Parameter pCount = {sqlType:sql:data.INTEGER, direction:sql:dir.IN};
    sql:Parameter pId = {sqlType:sql:data.INTEGER, value:1, direction:sql:dir.OUT};
