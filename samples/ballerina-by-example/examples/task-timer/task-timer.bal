...
function main (string[] args) {
    ...
    var taskId, schedulerError = task:scheduleTimer(onTriggerFunction, onErrorFunction, {delay:500, interval:1000});
...
function cleanup() returns (error e) {
    ...
    // We randomly return an error to demonstrate how the error is propagated to the onError function
    // when an error occurs in the onTrigger function
