...
# and use `$BALLERINA_HOME/bin/ballerina run service websocket-connection-groups.bal`.

$ $BALLERINA_HOME/bin/ballerina run service websocket-connection-groups.bal
