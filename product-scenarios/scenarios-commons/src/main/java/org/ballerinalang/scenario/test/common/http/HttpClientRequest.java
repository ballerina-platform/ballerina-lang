...
*  under the License.
*/
package org.ballerinalang.scenario.test.common.http;
...
public class HttpClientRequest {
     ...
     * @param headers  http request headers map
     * @return - HttpResponse from end point
     * @throws IOException If an error occurs while sending the PUT request
     */
    public static HttpResponse doPut(String endpoint, String postBody, Map<String, String> headers)
            throws IOException {
        return executeRequestWithRequestBody(endpoint, postBody, headers, TestConstant.HTTP_METHOD_PUT);
    }

    /**
     * Send an HTTP DELETE request to a service.
     *
     * @param endpoint - service endpoint
     * @param postBody - message payload
     * @param headers  http request headers map
     ...
     */
    public static HttpResponse doDelete(String endpoint, String postBody, Map<String, String> headers)
            throws IOException {
        return executeRequestWithRequestBody(endpoint, postBody, headers, TestConstant.HTTP_METHOD_DELETE);
    }
    ...
    public static HttpResponse doDelete(String endpoint)
            throws IOException {
        return executeRequestWithoutRequestBody(TestConstant.HTTP_METHOD_DELETE, endpoint, new HashMap<>());
    }
