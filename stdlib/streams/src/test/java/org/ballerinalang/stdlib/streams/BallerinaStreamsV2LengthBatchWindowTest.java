...
/**
 * This contains methods to test lengthBatchWindow behaviour in Ballerina Streaming V2.
 *
 * @since 0.981.2
 */
public class BallerinaStreamsV2LengthBatchWindowTest {
    ...
    @BeforeClass
    public void setup() {
        result1 = BCompileUtil.compile("test-src/streamingv2-length-batch-window-test.bal");
        result2 = BCompileUtil.compile("test-src/streamingv2-length-batch-window-test2.bal");
    }
