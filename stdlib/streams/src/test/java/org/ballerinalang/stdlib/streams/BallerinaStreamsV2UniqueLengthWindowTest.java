...
public class BallerinaStreamsV2UniqueLengthWindowTest {
    ...
    @BeforeClass
    public void setup() {
        result1 = BCompileUtil.compile("test-src/streamingv2-unique-length-window-test.bal");
        result2 = BCompileUtil.compile("test-src/streamingv2-unique-length-window-test2.bal");
        resultWithAlias = BCompileUtil.
                compile("test-src/alias/streamingv2-unique-length-window-test.bal");
    }
