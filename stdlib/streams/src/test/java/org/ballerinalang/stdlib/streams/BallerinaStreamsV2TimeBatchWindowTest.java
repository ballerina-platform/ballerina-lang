...
public class BallerinaStreamsV2TimeBatchWindowTest {
    ...
    @BeforeClass
    public void setup() {
        result1 = BCompileUtil.compile("test-src/streamingv2-time-batch-window-test.bal");
        result2 = BCompileUtil.compile("test-src/streamingv2-time-batch-window-test2.bal");
    }
