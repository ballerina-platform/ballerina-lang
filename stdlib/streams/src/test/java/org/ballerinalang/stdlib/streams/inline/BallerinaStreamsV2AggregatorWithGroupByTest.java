...
public class BallerinaStreamsV2AggregatorWithGroupByTest {
    ...
    public void setup() {
        result = BCompileUtil.
                compile("test-src/inline.streams/streamingv2-aggregate-with-groupby-test.bal");
        resultWithAlias = BCompileUtil.
                compile("test-src/inline.streams/alias/streamingv2-aggregate-with-groupby-test.bal");
    }
