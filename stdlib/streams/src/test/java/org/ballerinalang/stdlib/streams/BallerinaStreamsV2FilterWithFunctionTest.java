...
public class BallerinaStreamsV2FilterWithFunctionTest {
    ...
    @BeforeClass
    public void setup() {
        result = BCompileUtil.compile("test-src/streamingv2-filter-with-function-test.bal");
        result2 = BCompileUtil.compile("test-src/streamingv2-filter-with-function-test2.bal");
        resultWithAlias = BCompileUtil.
                compile("test-src/alias/streamingv2-filter-with-function-test.bal");
        result2WithAlias = BCompileUtil.
                compile("test-src/streamingv2-filter-with-function-test2.bal");
    }
