...
public class IncompatibleRecordTypeTest {
    ...
    public void setup() {
        resultNegative = BCompileUtil.
                compile("test-src/negative/streaming-invalid-record-type-negative-test.bal", true);
        resultNegativeForInvalidOrder = BCompileUtil.
                compile("test-src/negative/streaming-output-attribute-order-negative-test.bal", true);
    }
