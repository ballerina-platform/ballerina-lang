...
public class BallerinaStreamsV2OrderByTest {
    ...
    @BeforeClass
    public void setup() {
        result = BCompileUtil.compile("test-src/streamingv2-orderby-test.bal");
        result2 = BCompileUtil.compile("test-src/streamingv2-orderby-with-functions-test.bal");
        resultWithAlias = BCompileUtil.compile("test-src/alias/streamingv2-orderby-test.bal");
        resultWithAlias2 =
                BCompileUtil.compile("test-src/alias/streamingv2-orderby-with-functions-test.bal");
    }
