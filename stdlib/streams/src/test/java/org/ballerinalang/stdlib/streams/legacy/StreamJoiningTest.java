...
public class StreamJoiningTest {
    ...
    @BeforeClass
    public void setup() {
        result = BCompileUtil.compile("test-src/legacy/join-streaming-test.bal", true);
        resultNegative = BCompileUtil.compile("test-src/negative/join-streaming-negative-test.bal", true);
    }
