...
package org.ballerinalang.stdlib.streams.inline;
...
public class BallerinaStreamsV2FilterWithFunctionTest {
    ...
    public void setup() {
        result = BCompileUtil.
                compile("test-src/inline.streams/streamingv2-filter-with-function-test.bal");
        result2 = BCompileUtil.
                compile("test-src/inline.streams/streamingv2-filter-with-function-test2.bal");
        resultWithAlias = BCompileUtil.
                compile("test-src/inline.streams/alias/streamingv2-filter-with-function-test.bal");
