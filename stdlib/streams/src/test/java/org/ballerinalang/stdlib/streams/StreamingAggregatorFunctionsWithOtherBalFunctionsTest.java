...
public class StreamingAggregatorFunctionsWithOtherBalFunctionsTest {
    ...
    @BeforeClass
    public void setup() {
        result = BCompileUtil.compile("test-src/streamingv2-aggregator-funcs-with-other-bal-funcs-test.bal");
        resultWithAlias = BCompileUtil.
                compile("test-src/alias/streamingv2-aggregator-funcs-with-other-bal-funcs-test.bal");
    }
