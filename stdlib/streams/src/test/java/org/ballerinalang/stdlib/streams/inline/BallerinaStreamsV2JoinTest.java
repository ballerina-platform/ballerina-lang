...
public class BallerinaStreamsV2JoinTest {
    ...
    @BeforeClass
    public void setup() {
        result = BCompileUtil.compile("test-src/inline.streams/streamingv2-join-test.bal");
        resultWithAlias = BCompileUtil.
                compile("test-src/inline.streams/alias/streamingv2-join-test.bal");
        resultWithoutOnCondition = BCompileUtil.
                compile("test-src/inline.streams/streamingv2-join-without-on-condition-test.bal");
    }
