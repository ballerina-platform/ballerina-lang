...
public class CallStatement extends AbstractSQLStatement {
        ...
        try {
            ...
            switch (sqlDataType) {
                case Constants.SQLDataTypes.INTEGER: {
                    ...
                    paramValue.put(Constants.PARAMETER_VALUE_FIELD, (long) value);
                }
                break;
                ...
                case Constants.SQLDataTypes.NCHAR: {
                    ...
                    paramValue.put(Constants.PARAMETER_VALUE_FIELD, value);
                }
                break;
                ...
                case Constants.SQLDataTypes.DECIMAL: {
                    ...
                    if (value == null) {
                        paramValue.put(Constants.PARAMETER_VALUE_FIELD, 0);
                    } else {
                        paramValue.put(Constants.PARAMETER_VALUE_FIELD, new DecimalValue(value));
                    }
                }
                break;
                ...
                case Constants.SQLDataTypes.FLOAT: {
                    ...
                    paramValue.put(Constants.PARAMETER_VALUE_FIELD, (double) value);
                }
                break;
                ...
                case Constants.SQLDataTypes.CLOB: {
                    ...
                    paramValue.put(Constants.PARAMETER_VALUE_FIELD, SQLDatasourceUtils.getString(value));
                }
                break;
                ...
                case Constants.SQLDataTypes.STRUCT: {
                    ...
                    paramValue.put(Constants.PARAMETER_VALUE_FIELD, stringValue);
                }
                break;
                case Constants.SQLDataTypes.REFCURSOR: {
                    ...
                    if (structType != null) {
                        ...
                        paramValue.put(Constants.PARAMETER_VALUE_FIELD,
    ...
    private BStructureType getStructType(MapValue<String, Object> parameter) {
        TypedescValue typedescValue = (TypedescValue) parameter.get(Constants.PARAMETER_RECORD_TYPE_FIELD);
