...
public class UpdateTest {
    ...
    public void testBasicInsertDataWithDatabaseError() {
        ...
        Assert.assertEquals(returns[7].stringValue(), "{ballerina/java.jdbc}DatabaseError");
    ...
    public void testBasicInsertDataWithApplicationError() {
        ...
        Assert.assertEquals(returns[5].stringValue(), "{ballerina/java.jdbc}ApplicationError");
    }
    ...
    public void testInsertBoolDataAsIntsInvalidParams() {
        ...
        Assert.assertTrue(returns[0].stringValue().contains("{ballerina/java.jdbc}ApplicationError"));
