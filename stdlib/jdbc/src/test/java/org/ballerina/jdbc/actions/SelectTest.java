...
public class SelectTest {
    ...
    public void testSelectNumericDataWithDBError() {
        ...
        Assert.assertEquals(returns[6].stringValue(), "{ballerina/java.jdbc}DatabaseError");
    ...
    public void testSelectNumericDataWithApplicationError() {
        ...
        Assert.assertEquals(returns[4].stringValue(), "{ballerina/java.jdbc}ApplicationError");
        Assert.assertTrue(
