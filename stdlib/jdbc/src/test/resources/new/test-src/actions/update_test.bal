...
function testInsertBoolDataAsIntsAndReturnBool() returns [int, boolean, boolean] {
    jdbc:Client testDB = new ({
        url: jdbcURL,
        username: jdbcUserName,
        password: jdbcPassword,
...
function testInsertBoolDataAsIntsAndReturnBoolAsDirectParams() returns [int, boolean, boolean] {
    jdbc:Client testDB = new ({
        url: jdbcURL,
        username: jdbcUserName,
        password: jdbcPassword,
