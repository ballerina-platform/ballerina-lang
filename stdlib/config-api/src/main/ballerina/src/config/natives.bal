...
function get(@untainted string key, ValueType vType) returns string|int|float|boolean|map<any>|any[] {
...
function externGet(handle key, handle vType) returns handle|int|float|boolean|map<any>|any[] = @java:Method {
    name: "get",
