...
public class VisitMethod extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        String signature = context.getStringArgument(2);
        BValueArray exceptionsArray = (BValueArray) context.getNullableRefArgument(1);
        String[] exceptions = exceptionsArray.getStringArray();
