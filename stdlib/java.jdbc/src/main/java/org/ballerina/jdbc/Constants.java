...
public final class Constants {
    ...
    public static final String JDBC_PACKAGE_PATH = "ballerina" + ORG_NAME_SEPARATOR + "java_jdbc";
    public static final BPackage JDBC_PACKAGE_ID = new BPackage("ballerina", "java.jdbc", "0.0.0");
    ...
    public static final String APPLICATION_ERROR_CODE = "{ballerina/java.jdbc}ApplicationError";
    public static final String DATABASE_ERROR_CODE = "{ballerina/java.jdbc}DatabaseError";
