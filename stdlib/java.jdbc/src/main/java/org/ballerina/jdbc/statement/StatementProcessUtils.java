...
public class StatementProcessUtils {
    ...
    static int getParameterDirection(MapValue<String, Object> parameter) {
        int direction = 0;
        String directionInput = parameter.getStringValue(Constants.PARAMETER_DIRECTION_FIELD);
    ...
    static String getSQLType(MapValue<String, Object> parameter) {
        String sqlType = "";
        Object sqlTypeValue = parameter.get(Constants.PARAMETER_SQL_TYPE_FIELD);
