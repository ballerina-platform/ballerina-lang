...
public class ServerSocketUtils {
    ...
    public static BMap<String, BValue> getSocketStruct(SocketChannel socketChannel, PackageInfo ioPackageInfo) {
        ...
        socketStruct.put(SocketConstants.FIELD_REMOTE_ADDRESS, new BString(socket.getInetAddress().getHostAddress()));
        socketStruct.put(SocketConstants.FIELD_LOCAL_ADDRESS, new BString(socket.getLocalAddress().getHostAddress()));
