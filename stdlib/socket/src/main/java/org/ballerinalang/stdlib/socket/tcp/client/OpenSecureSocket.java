...
import org.ballerinalang.stdlib.socket.tcp.SocketByteChannel;
...
public class OpenSecureSocket extends BlockingNativeCallableUnit {
    ...
    private BMap<String, BValue> createReturnStruct(Context context, SSLSocket sslSocket, ByteChannel channel)
        ...
        socketStruct.put(SocketConstants.FIELD_REMOTE_PORT, new BInteger(sslSocket.getPort()));
        socketStruct.put(SocketConstants.FIELD_LOCAL_PORT, new BInteger(sslSocket.getLocalPort()));
        socketStruct.put(SocketConstants.FIELD_REMOTE_ADDRESS,
                new BString(sslSocket.getInetAddress().getHostAddress()));
        socketStruct.put(SocketConstants.FIELD_LOCAL_ADDRESS,
