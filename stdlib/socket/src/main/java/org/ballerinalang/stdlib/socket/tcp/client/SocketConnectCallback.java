...
import org.ballerinalang.stdlib.socket.channels.SocketIOChannel;
...
public class SocketConnectCallback {
    ...
    public void notifyConnect() {
        ...
        try {
            ...
            socketStruct.put(SocketConstants.FIELD_REMOTE_PORT, new BInteger(socket.getPort()));
            socketStruct.put(SocketConstants.FIELD_LOCAL_PORT, new BInteger(socket.getLocalPort()));
            socketStruct
                    .put(SocketConstants.FIELD_REMOTE_ADDRESS, new BString(socket.getInetAddress().getHostAddress()));
            socketStruct
                    .put(SocketConstants.FIELD_LOCAL_ADDRESS, new BString(socket.getLocalAddress().getHostAddress()));
