...
//    action respond(Response res) returns (HttpConnectorError) {
...
//    action forward(Response res) returns (HttpConnectorError) {
...
//    @Return { value:"Error occured during HTTP server connector forward" }
//    action promise (PushPromise promise) returns (HttpConnectorError) {
...
//    @Param { value:"res: The outbound response message" }
//    @Return { value:"Error occured during HTTP server connector forward" }
//    action pushPromisedResponse (PushPromise promise, Response res) returns (HttpConnectorError) {
...
//    action createSessionIfAbsent() returns (Session) {
...
//    action getSession() returns (Session) {
...
//    action respondContinue() returns (HttpConnectorError) {
...
//    @Return { value:"Returns an HttpConnectorError if there was any issue in sending the response." }
//    action redirect(Response response, RedirectCode code, string[] locations) returns (HttpConnectorError) {
