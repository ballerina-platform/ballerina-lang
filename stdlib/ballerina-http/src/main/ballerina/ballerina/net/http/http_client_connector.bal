...
public native function <HttpClient client> post(@sensitive string path, Request req) (@tainted Response, HttpConnectorError);
...
@Return {value:"The inbound response message"}
@Return {value:"Error occured during HTTP client invocation"}
public native function <HttpClient client> head(@sensitive string path, Request req) (@tainted Response, HttpConnectorError);
...
@Return {value:"The inbound response message"}
@Return {value:"Error occured during HTTP client invocation"}
public native function <HttpClient client> put(@sensitive string path, Request req) (@tainted Response, HttpConnectorError);
...
@Return {value:"The inbound response message"}
@Return {value:"Error occured during HTTP client invocation"}
public native function <HttpClient client> execute(@sensitive string httpVerb, @sensitive string path, Request req) (@tainted Response, HttpConnectorError);
...
@Return {value:"The inbound response message"}
@Return {value:"Error occured during HTTP client invocation"}
public native function <HttpClient client> patch(@sensitive string path, Request req) (@tainted Response, HttpConnectorError);
...
@Return {value:"The inbound response message"}
@Return {value:"Error occured during HTTP client invocation"}
public native function <HttpClient client> delete(@sensitive string path, Request req) (@tainted Response, HttpConnectorError);
...
@Return {value:"The inbound response message"}
@Return {value:"Error occured during HTTP client invocation"}
public native function <HttpClient client> get(@sensitive string path, Request req) (@tainted Response, HttpConnectorError);
...
@Return {value:"The inbound response message"}
@Return {value:"Error occured during HTTP client invocation"}
public native function <HttpClient client> options(@sensitive string path, Request req) (@tainted Response, HttpConnectorError);
...
@Return {value:"The inbound response message"}
@Return {value:"Error occured during HTTP client invocation"}
public native function <HttpClient client> forward(@sensitive string path, Request req) (@tainted Response, HttpConnectorError);
...
public native function <HttpClient client> submit(@sensitive string httpVerb, @sensitive string path, Request req) (HttpHandle, HttpConnectorError);
...
@Return { value:"The Error occured during HTTP client invocation" }
public native function <HttpClient client> getResponse(HttpHandle handle) (@tainted Response, HttpConnectorError);
...
@Return { value:"The Error occured during HTTP client invocation" }
public native function <HttpClient client> getPromisedResponse(@sensitive PushPromise promise) (@tainted Response, HttpConnectorError);
...
public native function <HttpClient client> rejectPromise(@sensitive PushPromise promise) (boolean);
