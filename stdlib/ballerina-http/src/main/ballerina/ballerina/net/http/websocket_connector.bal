...
//native function <WebSocketConnector wsConnector> getUpgradeHeaders() (map);
//
...
//native function <WebSocketConnector wsConnector> getUpgradeHeader(string key) (string);
//
//@Description {value:"Push text to the connection"}
//@Param {value:"text: Text to be sent"}
//native function <WebSocketConnector wsConnector> pushText(string text);
//
//@Description {value:"Push binary data to the connection"}
//@Param {value:"data: Binary data to be sent"}
//native function <WebSocketConnector wsConnector> pushBinary(blob data);
//
//@Description {value:"Ping the connection"}
//@Param {value:"data: Binary data to be sent"}
//native function <WebSocketConnector wsConnector> ping(blob data);
//
//@Description {value:"Send pong message to the connection"}
//@Param {value:"data: Binary data to be sent"}
//native function <WebSocketConnector wsConnector> pong(blob data);
//
...
//native function <WebSocketConnector wsConnector> closeConnection(int statusCode, string reason);
//
//@Description {value:"Gets the query parameters from the Connection as a map"}
//@Return {value:"The map of query params" }
//native function <WebSocketConnector ep> getQueryParams () (map);
