...
@SupportEndpointTypes(
        value = {@SupportEndpointTypes.EndpointType(packageName = "ballerina.http", name = "Listener"),
                @SupportEndpointTypes.EndpointType(packageName = "ballerina.http", name = "WebSocketListener")}
)
