...
/**
 * {@code Get} is the GET action implementation of the HTTP2 Connector.
 */
@BallerinaAction(
...
public class Http2Get extends Get {

    private static final Logger logger = LoggerFactory.getLogger(Http2Get.class);
    ...
    public ConnectorFuture execute(Context context) {
        ...
        try {
            ...
            throw new BallerinaException("Failed to invoke 'get' action in " + HttpConstants.HTTP2_CONNECTOR_NAME
