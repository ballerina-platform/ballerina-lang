...
/**
 * {@code Delete} is the DELETE action implementation of the HTTP2 Connector.
 */
@BallerinaAction(
...
public class Http2Delete extends Delete {

    private static final Logger logger = LoggerFactory.getLogger(Http2Delete.class);
    ...
    public ConnectorFuture execute(Context context) {
        ...
        try {
            ...
            throw new BallerinaException("Failed to invoke 'delete' action in " + HttpConstants.HTTP2_CONNECTOR_NAME
