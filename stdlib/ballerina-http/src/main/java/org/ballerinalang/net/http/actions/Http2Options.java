...
/**
 * {@code Options} is the OPTIONS action implementation of the HTTP2 Connector.
 */
@BallerinaAction(
...
public class Http2Options extends Options {

    private static final Logger logger = LoggerFactory.getLogger(Http2Options.class);
    ...
    public ConnectorFuture execute(Context context) {
        ...
        try {
            ...
            throw new BallerinaException("Failed to invoke 'options' action in " + HttpConstants.HTTP2_CONNECTOR_NAME
