...
function testDecryptAesEcb(byte[] input, byte[] key, crypto:AesPadding padding = "PKCS5")
returns byte[]|error {
...
function testDecryptAesCbc(byte[] input, byte[] key, byte[] iv, crypto:AesPadding padding = "PKCS5")
returns byte[]|error {
