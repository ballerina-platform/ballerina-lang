...
/**
 * Extern function ballerina.crypto:hmacSha512.
 *
 * @since 0.990.3
 */
@BallerinaFunction(
        orgName = "ballerina", packageName = "crypto",
        functionName = "hmacSha512",
        args = {
...
public class HmacSha512 extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        byte[] output = CryptoUtils.hmac(context, "HmacSHA512", key, input);
    ...
    public static ArrayValue hmacSha512(Strand strand, ArrayValue inputValue, ArrayValue keyValue) {
        byte[] output = CryptoUtils.hmac("HmacSHA512", keyValue.getBytes(), inputValue.getBytes());
