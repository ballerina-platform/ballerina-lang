...
/**
 * Extern function ballerina.crypto:verifyRsaMd5Signature.
 *
 * @since 0.990.4
 */
@BallerinaFunction(orgName = "ballerina", packageName = "crypto", functionName = "verifyRsaMd5Signature")
public class VerifyRsaMd5Signature extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        try {
            context.setReturnValues(new BBoolean(CryptoUtils.verify(context, "MD5withRSA",
