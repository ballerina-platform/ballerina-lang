...
/**
 * Extern function ballerina.crypto:decryptAesCbc.
 *
 * @since 0.990.4
 */
...
public class DecryptAesCbc extends BlockingNativeCallableUnit {
    ...
    public static Object decryptAesCbc(Strand strand, Object padding, ArrayValue inputValue, ArrayValue keyValue,
                                       ArrayValue ivValue) {
