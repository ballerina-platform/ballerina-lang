...
final string coordinatorHost = config:getAsString("b7a.transactions.coordinator.host", defaultVal = getHostAddress());
final int coordinatorPort = config:getAsInt("b7a.transactions.coordinator.port", defaultVal = getAvailablePort());
