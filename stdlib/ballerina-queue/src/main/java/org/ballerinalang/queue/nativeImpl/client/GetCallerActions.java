...
public class GetCallerActions extends AbstractBlockinAction {

    private static final Logger log = LoggerFactory.getLogger(GetCallerActions.class);

    @Override
    public void execute(Context context, CallableUnitCallback callableUnitCallback) {
        Struct clientEndpoint = BLangConnectorSPIUtil.getConnectorEndpointStruct(context);
        BStruct clientConnector = (BStruct) clientEndpoint.getNativeData(QueueConstants.B_CLIENT_CONNECTOR);
