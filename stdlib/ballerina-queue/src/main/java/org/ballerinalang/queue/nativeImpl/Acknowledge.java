    ...
    public void execute(Context context, CallableUnitCallback callableUnitCallback) {
        ...
        if (null == callableUnitCallback) {
            throw new BallerinaException("JMS Acknowledge function can only be used with JMS Messages. "
                    + QueueConstants.JMS_SESSION_ACKNOWLEDGEMENT_MODE + " property is not found in the message.");
        }
        ...
        Object jmsSessionAcknowledgementMode = context.getProperties().get(QueueConstants.JMS_SESSION_ACKNOWLEDGEMENT_MODE);
        ...
        if (Session.CLIENT_ACKNOWLEDGE == (Integer) jmsSessionAcknowledgementMode) {
            if (QueueConstants.JMS_MESSAGE_DELIVERY_ERROR.equalsIgnoreCase(deliveryStatus)) {
                ...
                throw new BallerinaException(
                        "Second parameter for the jms:acknowledge function should be within the " + "set ["
                                + QueueConstants.JMS_MESSAGE_DELIVERY_SUCCESS + ", " + QueueConstants.JMS_MESSAGE_DELIVERY_ERROR
