...
//        }
        ...
        BStruct bStruct = BLangConnectorSPIUtil
                .createBStruct(context, QueueConstants.PROTOCOL_PACKAGE_QUEUE, Constants.JMS_MESSAGE_STRUCT_NAME);

        bStruct.addNativeData(QueueConstants.JMS_API_MESSAGE, jmsMessage);
        bStruct.addNativeData(QueueConstants.INBOUND_REQUEST, Boolean.FALSE);
