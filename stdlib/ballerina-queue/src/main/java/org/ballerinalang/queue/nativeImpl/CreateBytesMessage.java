...
//        }
        ...
        BStruct bStruct = BLangConnectorSPIUtil
                .createBStruct(context, QueueConstants.PROTOCOL_PACKAGE_JMS, Constants.JMS_MESSAGE_STRUCT_NAME);

        bStruct.addNativeData(QueueConstants.JMS_API_MESSAGE, JMSUtils.getBrokerMessage(bStruct));
