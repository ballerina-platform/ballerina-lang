...
public class TaskExecutor {
    ...
    public static void executeFunction(ServiceInformation serviceInformation) {
        MethodTypes onTriggerFunction = serviceInformation.getOnTriggerFunction();
    ...
    private static Object[] getParameterList(MethodTypes function, ServiceInformation serviceInformation) {
