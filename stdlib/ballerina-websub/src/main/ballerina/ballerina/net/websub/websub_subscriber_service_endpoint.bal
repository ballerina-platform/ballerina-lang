...
public function <WebSubSubscriberServiceEndpoint ep> init (http:ServiceEndpointConfiguration config) {
    ep.serviceEndpoint.init(config);
    ep.initWebSubSubscriberServiceEndpoint();
}

public native function <WebSubSubscriberServiceEndpoint ep> initWebSubSubscriberServiceEndpoint();
...
public native function <WebSubSubscriberServiceEndpoint ep> registerWebSubSubscriberServiceEndpoint(type serviceType);
...
public function <WebSubSubscriberServiceEndpoint ep> getClient () returns (http:Connection) {
