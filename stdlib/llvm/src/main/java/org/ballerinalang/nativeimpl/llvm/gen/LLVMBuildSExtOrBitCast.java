...
@BallerinaFunction(
        ...
        functionName = "LLVMBuildSExtOrBitCast",
        args = {
...
public class LLVMBuildSExtOrBitCast extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildSExtOrBitCast(arg0, val, destTy, name);
