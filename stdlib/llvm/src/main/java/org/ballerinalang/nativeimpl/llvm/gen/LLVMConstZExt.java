...
import static org.bytedeco.javacpp.LLVM.LLVMConstZExt;
...
public class LLVMConstZExt extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMConstZExt(constantVal, toType);
