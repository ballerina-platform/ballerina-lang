...
import static org.bytedeco.javacpp.LLVM.LLVMIsADbgInfoIntrinsic;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsADbgInfoIntrinsic",
        args = {
...
public class LLVMIsADbgInfoIntrinsic extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsADbgInfoIntrinsic(val);
