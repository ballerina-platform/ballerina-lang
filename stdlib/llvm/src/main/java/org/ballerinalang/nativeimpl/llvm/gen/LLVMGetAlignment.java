...
public class LLVMGetAlignment extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef v = FFIUtil.getRecodeArgumentNative(context, 0);
        int returnValue = LLVMGetAlignment(v);
