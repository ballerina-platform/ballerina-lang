...
import static org.bytedeco.javacpp.LLVM.LLVMIsConstantString;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsConstantString",
        args = {
...
public class LLVMIsConstantString extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef c = FFIUtil.getRecodeArgumentNative(context, 0);
        int returnValue = LLVMIsConstantString(c);
