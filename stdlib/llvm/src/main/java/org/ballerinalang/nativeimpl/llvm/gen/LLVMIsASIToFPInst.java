...
import static org.bytedeco.javacpp.LLVM.LLVMIsASIToFPInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsASIToFPInst",
        args = {
...
public class LLVMIsASIToFPInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsASIToFPInst(val);
