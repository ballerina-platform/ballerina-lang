...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAGetElementPtrInst",
        args = {
...
public class LLVMIsAGetElementPtrInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAGetElementPtrInst(val);
