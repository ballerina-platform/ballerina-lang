...
import static org.bytedeco.javacpp.LLVM.LLVMIsACallInst;
...
public class LLVMIsACallInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsACallInst(val);
