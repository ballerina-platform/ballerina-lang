...
import static org.bytedeco.javacpp.LLVM.LLVMIsAGlobalAlias;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAGlobalAlias",
        args = {
...
public class LLVMIsAGlobalAlias extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAGlobalAlias(val);
