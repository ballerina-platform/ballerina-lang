...
@BallerinaFunction(
        ...
        functionName = "LLVMMetadataTypeInContext",
        args = {
...
public class LLVMMetadataTypeInContext extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMContextRef c = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMTypeRef returnValue = LLVMMetadataTypeInContext(c);
