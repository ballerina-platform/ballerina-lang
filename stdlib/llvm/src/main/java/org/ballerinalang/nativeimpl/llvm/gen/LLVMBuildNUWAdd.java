...
import static org.bytedeco.javacpp.LLVM.LLVMBuildNUWAdd;
...
public class LLVMBuildNUWAdd extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildNUWAdd(arg0, lhs, rhs, name);
