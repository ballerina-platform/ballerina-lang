...
import static org.bytedeco.javacpp.LLVM.LLVMBuildPtrDiff;
...
public class LLVMBuildPtrDiff extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildPtrDiff(arg0, lhs, rhs, name);
