...
import static org.bytedeco.javacpp.LLVM.LLVMValueIsBasicBlock;
...
@BallerinaFunction(
        ...
        functionName = "LLVMValueIsBasicBlock",
        args = {
...
public class LLVMValueIsBasicBlock extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        int returnValue = LLVMValueIsBasicBlock(val);
