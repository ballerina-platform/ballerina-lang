...
import static org.bytedeco.javacpp.LLVM.LLVMGetDataLayout;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetDataLayout",
        args = {
...
public class LLVMGetDataLayout extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMModuleRef m = FFIUtil.getRecodeArgumentNative(context, 0);
        BytePointer returnValue = LLVMGetDataLayout(m);
