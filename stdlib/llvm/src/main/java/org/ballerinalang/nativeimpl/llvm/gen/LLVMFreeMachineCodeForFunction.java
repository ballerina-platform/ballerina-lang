...
import static org.bytedeco.javacpp.LLVM.LLVMFreeMachineCodeForFunction;
...
@BallerinaFunction(
        ...
        functionName = "LLVMFreeMachineCodeForFunction",
        args = {
                @Argument(name = "ee", type = RECORD, structType = "LLVMExecutionEngineRef"),
                @Argument(name = "f", type = RECORD, structType = "LLVMValueRef"),
        })
public class LLVMFreeMachineCodeForFunction extends BlockingNativeCallableUnit {
