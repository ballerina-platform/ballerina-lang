...
import static org.bytedeco.javacpp.LLVM.LLVMGetTargetDescription;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetTargetDescription",
        args = {
...
public class LLVMGetTargetDescription extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMTargetRef t = FFIUtil.getRecodeArgumentNative(context, 0);
        BytePointer returnValue = LLVMGetTargetDescription(t);
