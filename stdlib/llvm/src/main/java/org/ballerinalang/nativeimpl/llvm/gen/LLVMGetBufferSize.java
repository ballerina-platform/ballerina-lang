...
import static org.bytedeco.javacpp.LLVM.LLVMGetBufferSize;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetBufferSize",
        args = {
...
public class LLVMGetBufferSize extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMMemoryBufferRef memBuf = FFIUtil.getRecodeArgumentNative(context, 0);
        long returnValue = LLVMGetBufferSize(memBuf);
