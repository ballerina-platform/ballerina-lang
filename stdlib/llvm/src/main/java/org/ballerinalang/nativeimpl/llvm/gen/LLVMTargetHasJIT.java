...
import static org.bytedeco.javacpp.LLVM.LLVMTargetHasJIT;
...
public class LLVMTargetHasJIT extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMTargetRef t = FFIUtil.getRecodeArgumentNative(context, 0);
        int returnValue = LLVMTargetHasJIT(t);
