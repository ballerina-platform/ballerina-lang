...
@BallerinaFunction(
        ...
        functionName = "LLVMGetNextBasicBlock",
        args = {
...
public class LLVMGetNextBasicBlock extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMBasicBlockRef bb = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMBasicBlockRef returnValue = LLVMGetNextBasicBlock(bb);
