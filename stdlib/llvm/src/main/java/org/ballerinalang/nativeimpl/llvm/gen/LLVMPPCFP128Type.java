...
import static org.bytedeco.javacpp.LLVM.LLVMPPCFP128Type;
...
@BallerinaFunction(
        ...
        functionName = "LLVMPPCFP128Type",
        returnType = {
                @ReturnType(type = RECORD, structType = "LLVMTypeRef", structPackage = "ballerina/llvm"),
        }
)
public class LLVMPPCFP128Type extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVMTypeRef returnValue = LLVMPPCFP128Type();
