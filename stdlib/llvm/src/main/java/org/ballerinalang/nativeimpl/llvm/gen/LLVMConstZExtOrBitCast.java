...
import static org.bytedeco.javacpp.LLVM.LLVMConstZExtOrBitCast;
...
@BallerinaFunction(
        ...
        functionName = "LLVMConstZExtOrBitCast",
        args = {
...
public class LLVMConstZExtOrBitCast extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMConstZExtOrBitCast(constantVal, toType);
