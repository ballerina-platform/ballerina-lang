...
import static org.bytedeco.javacpp.LLVM.LLVMStoreSizeOfType;
...
@BallerinaFunction(
        ...
        functionName = "LLVMStoreSizeOfType",
        args = {
...
public class LLVMStoreSizeOfType extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        long returnValue = LLVMStoreSizeOfType(td, ty);
