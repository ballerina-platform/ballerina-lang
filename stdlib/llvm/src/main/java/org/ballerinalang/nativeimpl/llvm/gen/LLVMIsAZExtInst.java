...
import static org.bytedeco.javacpp.LLVM.LLVMIsAZExtInst;
...
public class LLVMIsAZExtInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAZExtInst(val);
