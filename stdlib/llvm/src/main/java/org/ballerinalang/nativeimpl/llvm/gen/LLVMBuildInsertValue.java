...
@BallerinaFunction(
        ...
        functionName = "LLVMBuildInsertValue",
        args = {
...
public class LLVMBuildInsertValue extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildInsertValue(arg0, aggVal, eltVal, index, name);
