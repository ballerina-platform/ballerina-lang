...
@BallerinaFunction(
        ...
        functionName = "LLVMBuildGlobalString",
        args = {
...
public class LLVMBuildGlobalString extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildGlobalString(b, str, name);
