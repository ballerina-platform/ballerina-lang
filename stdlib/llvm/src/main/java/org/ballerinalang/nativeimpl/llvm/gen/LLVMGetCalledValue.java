...
import static org.bytedeco.javacpp.LLVM.LLVMGetCalledValue;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetCalledValue",
        args = {
...
public class LLVMGetCalledValue extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef instr = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMGetCalledValue(instr);
