...
@BallerinaFunction(
        ...
        functionName = "LLVMBuildIntToPtr",
        args = {
...
public class LLVMBuildIntToPtr extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildIntToPtr(arg0, val, destTy, name);
