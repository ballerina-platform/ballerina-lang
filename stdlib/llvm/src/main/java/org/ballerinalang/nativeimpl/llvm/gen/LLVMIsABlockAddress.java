...
import static org.bytedeco.javacpp.LLVM.LLVMIsABlockAddress;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsABlockAddress",
        args = {
...
public class LLVMIsABlockAddress extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsABlockAddress(val);
