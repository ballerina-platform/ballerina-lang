...
@BallerinaFunction(
        ...
        functionName = "LLVMBuildPtrToInt",
        args = {
...
public class LLVMBuildPtrToInt extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildPtrToInt(arg0, val, destTy, name);
