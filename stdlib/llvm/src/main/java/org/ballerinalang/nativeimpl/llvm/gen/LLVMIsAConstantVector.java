...
import static org.bytedeco.javacpp.LLVM.LLVMIsAConstantVector;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAConstantVector",
        args = {
...
public class LLVMIsAConstantVector extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAConstantVector(val);
