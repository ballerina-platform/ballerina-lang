...
import static org.bytedeco.javacpp.LLVM.LLVMIsAConstantFP;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAConstantFP",
        args = {
...
public class LLVMIsAConstantFP extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAConstantFP(val);
