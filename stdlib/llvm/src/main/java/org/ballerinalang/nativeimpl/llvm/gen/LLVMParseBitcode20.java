...
import static org.bytedeco.javacpp.LLVM.LLVMParseBitcode2;
...
@BallerinaFunction(
        ...
        functionName = "LLVMParseBitcode20",
        args = {
...
public class LLVMParseBitcode20 extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        int returnValue = LLVMParseBitcode2(memBuf, outModule);
