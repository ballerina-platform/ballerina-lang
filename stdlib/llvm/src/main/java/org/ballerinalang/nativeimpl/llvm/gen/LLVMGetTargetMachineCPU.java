...
import static org.bytedeco.javacpp.LLVM.LLVMGetTargetMachineCPU;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetTargetMachineCPU",
        args = {
...
public class LLVMGetTargetMachineCPU extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMTargetMachineRef t = FFIUtil.getRecodeArgumentNative(context, 0);
        BytePointer returnValue = LLVMGetTargetMachineCPU(t);
