...
import static org.bytedeco.javacpp.LLVM.LLVMGetPreviousFunction;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetPreviousFunction",
        args = {
...
public class LLVMGetPreviousFunction extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef fn = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMGetPreviousFunction(fn);
