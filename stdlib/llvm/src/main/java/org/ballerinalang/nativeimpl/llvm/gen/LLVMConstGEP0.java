...
@BallerinaFunction(
        ...
        functionName = "LLVMConstGEP0",
        args = {
                @Argument(name = "constantVal", type = RECORD, structType = "LLVMValueRef"),
                @Argument(name = "constantIndices", type = RECORD, structType = "LLVMValueRef"),
...
public class LLVMConstGEP0 extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef constantVal = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVM.LLVMValueRef constantIndices = FFIUtil.getRecodeArgumentNative(context, 1);
