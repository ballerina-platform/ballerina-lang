...
@BallerinaFunction(
        ...
        functionName = "LLVMMDStringInContext",
        args = {
...
public class LLVMMDStringInContext extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMMDStringInContext(c, str, sLen);
