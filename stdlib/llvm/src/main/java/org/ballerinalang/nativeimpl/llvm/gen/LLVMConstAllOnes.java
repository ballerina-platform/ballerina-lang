...
import static org.bytedeco.javacpp.LLVM.LLVMConstAllOnes;
...
public class LLVMConstAllOnes extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMTypeRef ty = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMConstAllOnes(ty);
