...
@BallerinaFunction(
        ...
        functionName = "LLVMConstNamedStruct0",
        args = {
                @Argument(name = "structTy", type = RECORD, structType = "LLVMTypeRef"),
                @Argument(name = "constantVals", type = RECORD, structType = "PointerPointer"),
...
public class LLVMConstNamedStruct0 extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMTypeRef structTy = FFIUtil.getRecodeArgumentNative(context, 0);
        PointerPointer constantVals = FFIUtil.getRecodeArgumentNative(context, 1);
