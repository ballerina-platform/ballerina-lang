...
@BallerinaFunction(
        ...
        functionName = "LLVMStructTypeInContext1",
        args = {
...
public class LLVMStructTypeInContext1 extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMTypeRef returnValue = LLVMStructTypeInContext(c, elementTypes, elementCount, packed);
