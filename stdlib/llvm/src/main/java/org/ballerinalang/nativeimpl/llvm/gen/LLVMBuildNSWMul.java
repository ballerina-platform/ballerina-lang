...
import static org.bytedeco.javacpp.LLVM.LLVMBuildNSWMul;
...
public class LLVMBuildNSWMul extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildNSWMul(arg0, lhs, rhs, name);
