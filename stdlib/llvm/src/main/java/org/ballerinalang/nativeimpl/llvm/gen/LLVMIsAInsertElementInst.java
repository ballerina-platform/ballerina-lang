...
import static org.bytedeco.javacpp.LLVM.LLVMIsAInsertElementInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAInsertElementInst",
        args = {
...
public class LLVMIsAInsertElementInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAInsertElementInst(val);
