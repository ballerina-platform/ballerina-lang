...
import static org.bytedeco.javacpp.LLVM.LLVMGetBasicBlockName;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetBasicBlockName",
        args = {
...
public class LLVMGetBasicBlockName extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMBasicBlockRef bb = FFIUtil.getRecodeArgumentNative(context, 0);
        BytePointer returnValue = LLVMGetBasicBlockName(bb);
