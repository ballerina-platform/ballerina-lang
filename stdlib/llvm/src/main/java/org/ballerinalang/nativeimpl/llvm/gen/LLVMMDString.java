...
public class LLVMMDString extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        String str = context.getStringArgument(0);
        int sLen = (int) context.getIntArgument(0);
        LLVMValueRef returnValue = LLVMMDString(str, sLen);
