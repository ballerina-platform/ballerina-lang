...
import static org.bytedeco.javacpp.LLVM.LLVMPassManagerBuilderSetDisableUnitAtATime;
...
@BallerinaFunction(
        ...
        functionName = "LLVMPassManagerBuilderSetDisableUnitAtATime",
        args = {
                @Argument(name = "pmb", type = RECORD, structType = "LLVMPassManagerBuilderRef"),
                @Argument(name = "value", type = INT),
        })
public class LLVMPassManagerBuilderSetDisableUnitAtATime extends BlockingNativeCallableUnit {
