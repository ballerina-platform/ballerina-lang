...
public class LLVMBuildFPCast extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildFPCast(arg0, val, destTy, name);
