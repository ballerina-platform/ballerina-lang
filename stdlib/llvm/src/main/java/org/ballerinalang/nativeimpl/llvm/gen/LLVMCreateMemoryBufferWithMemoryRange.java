...
public class LLVMCreateMemoryBufferWithMemoryRange extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        int requiresNullTerminator = (int) context.getIntArgument(1);
        LLVMMemoryBufferRef returnValue = LLVMCreateMemoryBufferWithMemoryRange(inputData, inputDataLength,
