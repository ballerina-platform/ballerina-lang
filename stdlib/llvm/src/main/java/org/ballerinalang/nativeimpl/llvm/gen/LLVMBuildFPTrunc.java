...
import static org.bytedeco.javacpp.LLVM.LLVMBuildFPTrunc;
...
public class LLVMBuildFPTrunc extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildFPTrunc(arg0, val, destTy, name);
