...
import static org.bytedeco.javacpp.LLVM.LLVMGetTargetMachineFeatureString;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetTargetMachineFeatureString",
        args = {
...
public class LLVMGetTargetMachineFeatureString extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMTargetMachineRef t = FFIUtil.getRecodeArgumentNative(context, 0);
        BytePointer returnValue = LLVMGetTargetMachineFeatureString(t);
