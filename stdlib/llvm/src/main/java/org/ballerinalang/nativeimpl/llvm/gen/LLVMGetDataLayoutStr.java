...
import static org.bytedeco.javacpp.LLVM.LLVMGetDataLayoutStr;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetDataLayoutStr",
        args = {
...
public class LLVMGetDataLayoutStr extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMModuleRef m = FFIUtil.getRecodeArgumentNative(context, 0);
        BytePointer returnValue = LLVMGetDataLayoutStr(m);
