...
import static org.bytedeco.javacpp.LLVM.LLVMGetRelocationType;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetRelocationType",
        args = {
...
public class LLVMGetRelocationType extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMRelocationIteratorRef ri = FFIUtil.getRecodeArgumentNative(context, 0);
        long returnValue = LLVMGetRelocationType(ri);
