...
import static org.bytedeco.javacpp.LLVM.LLVMIsAConstantArray;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAConstantArray",
        args = {
...
public class LLVMIsAConstantArray extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAConstantArray(val);
