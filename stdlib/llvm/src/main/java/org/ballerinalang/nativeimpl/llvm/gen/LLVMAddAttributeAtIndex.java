...
@BallerinaFunction(
        ...
        functionName = "LLVMAddAttributeAtIndex",
        args = {
...
public class LLVMAddAttributeAtIndex extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef f = FFIUtil.getRecodeArgumentNative(context, 0);
        int idx = (int) context.getIntArgument(0);
        LLVM.LLVMAttributeRef a = FFIUtil.getRecodeArgumentNative(context, 1);
