...
import static org.bytedeco.javacpp.LLVM.LLVMBuildNUWNeg;
...
public class LLVMBuildNUWNeg extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildNUWNeg(b, v, name);
