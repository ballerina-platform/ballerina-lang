...
import static org.bytedeco.javacpp.LLVM.LLVMIsAGlobalValue;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAGlobalValue",
        args = {
...
public class LLVMIsAGlobalValue extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAGlobalValue(val);
