...
import static org.bytedeco.javacpp.LLVM.LLVMBuildNSWNeg;
...
public class LLVMBuildNSWNeg extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildNSWNeg(b, v, name);
