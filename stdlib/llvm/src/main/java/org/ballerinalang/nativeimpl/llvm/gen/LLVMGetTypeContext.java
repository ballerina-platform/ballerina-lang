...
import static org.bytedeco.javacpp.LLVM.LLVMGetTypeContext;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetTypeContext",
        args = {
...
public class LLVMGetTypeContext extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMTypeRef ty = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMContextRef returnValue = LLVMGetTypeContext(ty);
