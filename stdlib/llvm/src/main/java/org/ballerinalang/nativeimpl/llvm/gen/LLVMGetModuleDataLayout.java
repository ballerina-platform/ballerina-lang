...
@BallerinaFunction(
        ...
        functionName = "LLVMGetModuleDataLayout",
        args = {
...
public class LLVMGetModuleDataLayout extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMModuleRef m = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMTargetDataRef returnValue = LLVMGetModuleDataLayout(m);
