...
import static org.bytedeco.javacpp.LLVM.LLVMGetPersonalityFn;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetPersonalityFn",
        args = {
...
public class LLVMGetPersonalityFn extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef fn = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMGetPersonalityFn(fn);
