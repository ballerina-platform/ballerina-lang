...
import static org.bytedeco.javacpp.LLVM.LLVMX86MMXTypeInContext;
...
@BallerinaFunction(
        ...
        functionName = "LLVMX86MMXTypeInContext",
        args = {
...
public class LLVMX86MMXTypeInContext extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMContextRef c = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMTypeRef returnValue = LLVMX86MMXTypeInContext(c);
