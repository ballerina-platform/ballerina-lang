...
public class LLVMAddAlias extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVM.LLVMValueRef aliasee = FFIUtil.getRecodeArgumentNative(context, 2);
        String name = context.getStringArgument(0);
        LLVMValueRef returnValue = LLVMAddAlias(m, ty, aliasee, name);
