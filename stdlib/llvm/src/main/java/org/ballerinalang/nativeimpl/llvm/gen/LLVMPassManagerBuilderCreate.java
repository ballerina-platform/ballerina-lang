...
import org.bytedeco.javacpp.LLVM.LLVMPassManagerBuilderRef;
...
public class LLVMPassManagerBuilderCreate extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVMPassManagerBuilderRef returnValue = LLVMPassManagerBuilderCreate();
        BMap<String, BValue> rerunWrapperRecode = FFIUtil.newRecord(context, "LLVMPassManagerBuilderRef");
