...
import static org.bytedeco.javacpp.LLVM.LLVMGetGlobalValueAddress;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetGlobalValueAddress",
        args = {
...
public class LLVMGetGlobalValueAddress extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMExecutionEngineRef ee = FFIUtil.getRecodeArgumentNative(context, 0);
        String name = context.getStringArgument(0);
        long returnValue = LLVMGetGlobalValueAddress(ee, name);
