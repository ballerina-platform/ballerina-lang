...
import static org.bytedeco.javacpp.LLVM.LLVMIsAInlineAsm;
...
public class LLVMIsAInlineAsm extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAInlineAsm(val);
