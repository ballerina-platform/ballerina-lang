...
import static org.bytedeco.javacpp.LLVM.LLVMMDNode;
...
@BallerinaFunction(
        ...
        functionName = "LLVMMDNode0",
        args = {
                @Argument(name = "vals", type = RECORD, structType = "LLVMValueRef"),
...
public class LLVMMDNode0 extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef vals = FFIUtil.getRecodeArgumentNative(context, 0);
        int count = (int) context.getIntArgument(0);
        LLVMValueRef returnValue = LLVMMDNode(vals, count);
