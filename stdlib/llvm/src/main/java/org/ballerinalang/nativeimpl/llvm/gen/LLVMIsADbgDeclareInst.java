...
import static org.bytedeco.javacpp.LLVM.LLVMIsADbgDeclareInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsADbgDeclareInst",
        args = {
...
public class LLVMIsADbgDeclareInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsADbgDeclareInst(val);
