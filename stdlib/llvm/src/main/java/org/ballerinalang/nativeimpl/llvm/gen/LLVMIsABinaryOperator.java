...
import static org.bytedeco.javacpp.LLVM.LLVMIsABinaryOperator;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsABinaryOperator",
        args = {
...
public class LLVMIsABinaryOperator extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsABinaryOperator(val);
