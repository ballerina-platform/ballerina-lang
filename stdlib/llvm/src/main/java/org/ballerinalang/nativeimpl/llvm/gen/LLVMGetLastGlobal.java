...
import static org.bytedeco.javacpp.LLVM.LLVMGetLastGlobal;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetLastGlobal",
        args = {
...
public class LLVMGetLastGlobal extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMModuleRef m = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMGetLastGlobal(m);
