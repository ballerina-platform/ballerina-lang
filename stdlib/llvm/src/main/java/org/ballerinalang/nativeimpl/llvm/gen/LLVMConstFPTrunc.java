...
import static org.bytedeco.javacpp.LLVM.LLVMConstFPTrunc;
...
public class LLVMConstFPTrunc extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMConstFPTrunc(constantVal, toType);
