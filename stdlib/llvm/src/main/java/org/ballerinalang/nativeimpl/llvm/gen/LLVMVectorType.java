...
import static org.bytedeco.javacpp.LLVM.LLVMVectorType;
...
public class LLVMVectorType extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMTypeRef returnValue = LLVMVectorType(elementType, elementCount);
