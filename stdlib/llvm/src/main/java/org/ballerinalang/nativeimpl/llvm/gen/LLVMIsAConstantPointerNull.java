...
import static org.bytedeco.javacpp.LLVM.LLVMIsAConstantPointerNull;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAConstantPointerNull",
        args = {
...
public class LLVMIsAConstantPointerNull extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAConstantPointerNull(val);
