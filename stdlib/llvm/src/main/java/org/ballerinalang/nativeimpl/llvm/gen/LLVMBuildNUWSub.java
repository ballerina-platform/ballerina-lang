...
import static org.bytedeco.javacpp.LLVM.LLVMBuildNUWSub;
...
public class LLVMBuildNUWSub extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildNUWSub(arg0, lhs, rhs, name);
