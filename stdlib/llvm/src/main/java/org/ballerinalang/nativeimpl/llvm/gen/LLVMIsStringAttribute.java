...
import static org.bytedeco.javacpp.LLVM.LLVMIsStringAttribute;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsStringAttribute",
        args = {
...
public class LLVMIsStringAttribute extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMAttributeRef a = FFIUtil.getRecodeArgumentNative(context, 0);
        int returnValue = LLVMIsStringAttribute(a);
