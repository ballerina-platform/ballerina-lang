...
import static org.bytedeco.javacpp.LLVM.LLVMInt128TypeInContext;
...
@BallerinaFunction(
        ...
        functionName = "LLVMInt128TypeInContext",
        args = {
...
public class LLVMInt128TypeInContext extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMContextRef c = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMTypeRef returnValue = LLVMInt128TypeInContext(c);
