...
import static org.bytedeco.javacpp.LLVM.LLVMIsAFPToUIInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAFPToUIInst",
        args = {
...
public class LLVMIsAFPToUIInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAFPToUIInst(val);
