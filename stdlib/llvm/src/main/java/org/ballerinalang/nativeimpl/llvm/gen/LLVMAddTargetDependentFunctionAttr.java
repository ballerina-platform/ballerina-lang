...
import static org.bytedeco.javacpp.LLVM.LLVMAddTargetDependentFunctionAttr;
...
@BallerinaFunction(
        ...
        functionName = "LLVMAddTargetDependentFunctionAttr",
        args = {
                @Argument(name = "fn", type = RECORD, structType = "LLVMValueRef"),
                @Argument(name = "a", type = STRING),
                @Argument(name = "v", type = STRING),
        })
public class LLVMAddTargetDependentFunctionAttr extends BlockingNativeCallableUnit {
