...
import static org.bytedeco.javacpp.LLVM.LLVMCountBasicBlocks;
...
@BallerinaFunction(
        ...
        functionName = "LLVMCountBasicBlocks",
        args = {
...
public class LLVMCountBasicBlocks extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef fn = FFIUtil.getRecodeArgumentNative(context, 0);
        int returnValue = LLVMCountBasicBlocks(fn);
