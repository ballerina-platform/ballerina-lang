...
import static org.bytedeco.javacpp.LLVM.LLVMFP128TypeInContext;
...
@BallerinaFunction(
        ...
        functionName = "LLVMFP128TypeInContext",
        args = {
...
public class LLVMFP128TypeInContext extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMContextRef c = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMTypeRef returnValue = LLVMFP128TypeInContext(c);
