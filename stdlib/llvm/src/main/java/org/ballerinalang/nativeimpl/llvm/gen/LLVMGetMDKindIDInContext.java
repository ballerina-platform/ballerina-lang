...
@BallerinaFunction(
        ...
        functionName = "LLVMGetMDKindIDInContext",
        args = {
...
public class LLVMGetMDKindIDInContext extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        int returnValue = LLVMGetMDKindIDInContext(c, name, sLen);
