...
import static org.bytedeco.javacpp.LLVM.LLVMIsAConstantStruct;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAConstantStruct",
        args = {
...
public class LLVMIsAConstantStruct extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAConstantStruct(val);
