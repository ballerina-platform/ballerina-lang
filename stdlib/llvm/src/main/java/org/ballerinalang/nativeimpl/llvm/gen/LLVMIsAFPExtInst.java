...
import static org.bytedeco.javacpp.LLVM.LLVMIsAFPExtInst;
...
public class LLVMIsAFPExtInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAFPExtInst(val);
