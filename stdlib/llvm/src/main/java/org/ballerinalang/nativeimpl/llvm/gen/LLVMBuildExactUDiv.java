...
import static org.bytedeco.javacpp.LLVM.LLVMBuildExactUDiv;
...
@BallerinaFunction(
        ...
        functionName = "LLVMBuildExactUDiv",
        args = {
...
public class LLVMBuildExactUDiv extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildExactUDiv(arg0, lhs, rhs, name);
