...
import static org.bytedeco.javacpp.LLVM.LLVMIsALoadInst;
...
public class LLVMIsALoadInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsALoadInst(val);
