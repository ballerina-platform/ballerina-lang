...
import static org.bytedeco.javacpp.LLVM.LLVMIsACleanupReturnInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsACleanupReturnInst",
        args = {
...
public class LLVMIsACleanupReturnInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsACleanupReturnInst(val);
