...
@BallerinaFunction(
        ...
        functionName = "LLVMVoidTypeInContext",
        args = {
...
public class LLVMVoidTypeInContext extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMContextRef c = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMTypeRef returnValue = LLVMVoidTypeInContext(c);
