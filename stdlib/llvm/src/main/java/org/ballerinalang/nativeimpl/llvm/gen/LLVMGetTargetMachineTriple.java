...
import static org.bytedeco.javacpp.LLVM.LLVMGetTargetMachineTriple;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetTargetMachineTriple",
        args = {
...
public class LLVMGetTargetMachineTriple extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMTargetMachineRef t = FFIUtil.getRecodeArgumentNative(context, 0);
        BytePointer returnValue = LLVMGetTargetMachineTriple(t);
