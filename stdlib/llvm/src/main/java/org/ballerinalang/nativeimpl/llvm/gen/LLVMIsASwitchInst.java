...
import static org.bytedeco.javacpp.LLVM.LLVMIsASwitchInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsASwitchInst",
        args = {
...
public class LLVMIsASwitchInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsASwitchInst(val);
