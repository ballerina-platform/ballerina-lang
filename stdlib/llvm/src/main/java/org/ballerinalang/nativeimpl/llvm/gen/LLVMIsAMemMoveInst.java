...
import static org.bytedeco.javacpp.LLVM.LLVMIsAMemMoveInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAMemMoveInst",
        args = {
...
public class LLVMIsAMemMoveInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAMemMoveInst(val);
