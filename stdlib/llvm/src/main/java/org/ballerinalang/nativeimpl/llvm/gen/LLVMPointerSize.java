...
import static org.bytedeco.javacpp.LLVM.LLVMPointerSize;
...
public class LLVMPointerSize extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMTargetDataRef td = FFIUtil.getRecodeArgumentNative(context, 0);
        int returnValue = LLVMPointerSize(td);
