...
public class LLVMConstString extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMConstString(str, length, dontNullTerminate);
