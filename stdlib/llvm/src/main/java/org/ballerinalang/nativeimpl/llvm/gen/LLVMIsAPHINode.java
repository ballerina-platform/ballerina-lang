...
import static org.bytedeco.javacpp.LLVM.LLVMIsAPHINode;
...
public class LLVMIsAPHINode extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAPHINode(val);
