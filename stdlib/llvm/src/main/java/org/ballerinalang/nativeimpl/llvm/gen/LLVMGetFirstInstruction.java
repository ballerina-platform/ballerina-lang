...
@BallerinaFunction(
        ...
        functionName = "LLVMGetFirstInstruction",
        args = {
...
public class LLVMGetFirstInstruction extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMBasicBlockRef bb = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMGetFirstInstruction(bb);
