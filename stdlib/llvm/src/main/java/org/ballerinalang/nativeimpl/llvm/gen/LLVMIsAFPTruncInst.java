...
import static org.bytedeco.javacpp.LLVM.LLVMIsAFPTruncInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAFPTruncInst",
        args = {
...
public class LLVMIsAFPTruncInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAFPTruncInst(val);
