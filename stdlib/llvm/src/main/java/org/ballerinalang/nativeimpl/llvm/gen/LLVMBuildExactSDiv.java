...
import static org.bytedeco.javacpp.LLVM.LLVMBuildExactSDiv;
...
@BallerinaFunction(
        ...
        functionName = "LLVMBuildExactSDiv",
        args = {
...
public class LLVMBuildExactSDiv extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildExactSDiv(arg0, lhs, rhs, name);
