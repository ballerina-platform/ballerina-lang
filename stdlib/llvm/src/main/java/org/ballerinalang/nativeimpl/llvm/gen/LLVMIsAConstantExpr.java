...
import static org.bytedeco.javacpp.LLVM.LLVMIsAConstantExpr;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAConstantExpr",
        args = {
...
public class LLVMIsAConstantExpr extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAConstantExpr(val);
