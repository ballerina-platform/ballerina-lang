...
import static org.bytedeco.javacpp.LLVM.LLVMLabelType;
...
@BallerinaFunction(
        ...
        functionName = "LLVMLabelType",
        returnType = {
                @ReturnType(type = RECORD, structType = "LLVMTypeRef", structPackage = "ballerina/llvm"),
        }
)
public class LLVMLabelType extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVMTypeRef returnValue = LLVMLabelType();
