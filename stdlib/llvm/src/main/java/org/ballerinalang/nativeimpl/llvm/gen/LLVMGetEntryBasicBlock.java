...
import static org.bytedeco.javacpp.LLVM.LLVMGetEntryBasicBlock;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetEntryBasicBlock",
        args = {
...
public class LLVMGetEntryBasicBlock extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef fn = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMBasicBlockRef returnValue = LLVMGetEntryBasicBlock(fn);
