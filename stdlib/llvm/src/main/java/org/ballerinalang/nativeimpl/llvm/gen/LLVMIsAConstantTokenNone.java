...
import static org.bytedeco.javacpp.LLVM.LLVMIsAConstantTokenNone;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAConstantTokenNone",
        args = {
...
public class LLVMIsAConstantTokenNone extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAConstantTokenNone(val);
