...
import static org.bytedeco.javacpp.LLVM.LLVMBuildFRem;
...
public class LLVMBuildFRem extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildFRem(arg0, lhs, rhs, name);
