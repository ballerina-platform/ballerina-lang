...
@BallerinaFunction(
        ...
        functionName = "LLVMInitializeNativeTarget",
        returnType = {
                @ReturnType(type = INT, structPackage = "ballerina/llvm"),
        }
)
public class LLVMInitializeNativeTarget extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        int returnValue = LLVMInitializeNativeTarget();
