...
import static org.bytedeco.javacpp.LLVM.LLVMIsAConstantAggregateZero;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAConstantAggregateZero",
        args = {
...
public class LLVMIsAConstantAggregateZero extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAConstantAggregateZero(val);
