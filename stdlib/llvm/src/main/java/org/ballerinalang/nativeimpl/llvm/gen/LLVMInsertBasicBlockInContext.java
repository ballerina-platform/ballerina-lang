...
import static org.bytedeco.javacpp.LLVM.LLVMInsertBasicBlockInContext;
...
@BallerinaFunction(
        ...
        functionName = "LLVMInsertBasicBlockInContext",
        args = {
...
public class LLVMInsertBasicBlockInContext extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMContextRef c = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVM.LLVMBasicBlockRef bb = FFIUtil.getRecodeArgumentNative(context, 1);
        String name = context.getStringArgument(0);
        LLVMBasicBlockRef returnValue = LLVMInsertBasicBlockInContext(c, bb, name);
