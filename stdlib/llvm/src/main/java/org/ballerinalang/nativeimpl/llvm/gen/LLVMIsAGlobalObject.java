...
import static org.bytedeco.javacpp.LLVM.LLVMIsAGlobalObject;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAGlobalObject",
        args = {
...
public class LLVMIsAGlobalObject extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAGlobalObject(val);
