...
import static org.bytedeco.javacpp.LLVM.LLVMHasPersonalityFn;
...
@BallerinaFunction(
        ...
        functionName = "LLVMHasPersonalityFn",
        args = {
...
public class LLVMHasPersonalityFn extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef fn = FFIUtil.getRecodeArgumentNative(context, 0);
        int returnValue = LLVMHasPersonalityFn(fn);
