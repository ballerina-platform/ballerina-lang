...
import static org.bytedeco.javacpp.LLVM.LLVMGetTarget;
...
public class LLVMGetTarget extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMModuleRef m = FFIUtil.getRecodeArgumentNative(context, 0);
        BytePointer returnValue = LLVMGetTarget(m);
