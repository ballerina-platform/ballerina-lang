...
public class LLVMGetMetadata extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        int kindID = (int) context.getIntArgument(0);
        LLVMValueRef returnValue = LLVMGetMetadata(val, kindID);
