...
import static org.bytedeco.javacpp.LLVM.LLVMIsAIndirectBrInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAIndirectBrInst",
        args = {
...
public class LLVMIsAIndirectBrInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAIndirectBrInst(val);
