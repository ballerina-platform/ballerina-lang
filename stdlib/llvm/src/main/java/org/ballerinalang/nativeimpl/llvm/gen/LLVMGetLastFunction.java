...
import static org.bytedeco.javacpp.LLVM.LLVMGetLastFunction;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetLastFunction",
        args = {
...
public class LLVMGetLastFunction extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMModuleRef m = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMGetLastFunction(m);
