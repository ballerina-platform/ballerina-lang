...
import static org.bytedeco.javacpp.LLVM.LLVMBuildFMul;
...
public class LLVMBuildFMul extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildFMul(arg0, lhs, rhs, name);
