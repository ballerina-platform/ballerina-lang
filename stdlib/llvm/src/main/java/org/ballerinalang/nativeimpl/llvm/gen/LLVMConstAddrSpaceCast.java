...
import static org.bytedeco.javacpp.LLVM.LLVMConstAddrSpaceCast;
...
@BallerinaFunction(
        ...
        functionName = "LLVMConstAddrSpaceCast",
        args = {
...
public class LLVMConstAddrSpaceCast extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMConstAddrSpaceCast(constantVal, toType);
