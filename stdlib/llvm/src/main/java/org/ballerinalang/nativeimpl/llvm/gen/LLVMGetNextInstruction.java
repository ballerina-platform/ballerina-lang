...
@BallerinaFunction(
        ...
        functionName = "LLVMGetNextInstruction",
        args = {
...
public class LLVMGetNextInstruction extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef inst = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMGetNextInstruction(inst);
