...
import static org.bytedeco.javacpp.LLVM.LLVMConstStructInContext;
...
@BallerinaFunction(
        ...
        functionName = "LLVMConstStructInContext0",
        args = {
...
public class LLVMConstStructInContext0 extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMConstStructInContext(c, constantVals, count, packed);
