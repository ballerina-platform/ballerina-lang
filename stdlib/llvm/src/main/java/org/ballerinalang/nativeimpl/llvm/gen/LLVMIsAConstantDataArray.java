...
import static org.bytedeco.javacpp.LLVM.LLVMIsAConstantDataArray;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAConstantDataArray",
        args = {
...
public class LLVMIsAConstantDataArray extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAConstantDataArray(val);
