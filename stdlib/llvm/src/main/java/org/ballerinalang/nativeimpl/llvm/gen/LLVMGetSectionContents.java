...
@BallerinaFunction(
        ...
        functionName = "LLVMGetSectionContents",
        args = {
...
public class LLVMGetSectionContents extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMSectionIteratorRef si = FFIUtil.getRecodeArgumentNative(context, 0);
        BytePointer returnValue = LLVMGetSectionContents(si);
