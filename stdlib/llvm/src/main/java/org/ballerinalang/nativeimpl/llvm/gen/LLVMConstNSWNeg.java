...
import static org.bytedeco.javacpp.LLVM.LLVMConstNSWNeg;
...
public class LLVMConstNSWNeg extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef constantVal = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMConstNSWNeg(constantVal);
