...
import static org.bytedeco.javacpp.LLVM.LLVMTypeIsSized;
...
public class LLVMTypeIsSized extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMTypeRef ty = FFIUtil.getRecodeArgumentNative(context, 0);
        int returnValue = LLVMTypeIsSized(ty);
