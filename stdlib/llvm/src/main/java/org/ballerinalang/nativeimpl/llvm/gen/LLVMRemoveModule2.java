...
import static org.bytedeco.javacpp.LLVM.LLVMRemoveModule;
...
public class LLVMRemoveModule2 extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVM.LLVMModuleRef outMod = FFIUtil.getRecodeArgumentNative(context, 2);
        PointerPointer outError = FFIUtil.getRecodeArgumentNative(context, 3);
        int returnValue = LLVMRemoveModule(ee, m, outMod, outError);
