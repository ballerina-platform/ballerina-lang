...
import static org.bytedeco.javacpp.LLVM.LLVMInt16TypeInContext;
...
@BallerinaFunction(
        ...
        functionName = "LLVMInt16TypeInContext",
        args = {
...
public class LLVMInt16TypeInContext extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMContextRef c = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMTypeRef returnValue = LLVMInt16TypeInContext(c);
