...
@BallerinaFunction(
        ...
        args = {
                ...
                @Argument(name = "args", type = RECORD, structType = "LLVMGenericValueRef"),
        },
        returnType = {
...
public class LLVMRunFunction1 extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVM.LLVMGenericValueRef args = FFIUtil.getRecodeArgumentNative(context, 2);
