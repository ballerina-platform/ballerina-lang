...
import static org.bytedeco.javacpp.LLVM.LLVMCopyStringRepOfTargetData;
...
@BallerinaFunction(
        ...
        functionName = "LLVMCopyStringRepOfTargetData",
        args = {
...
public class LLVMCopyStringRepOfTargetData extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        BytePointer returnValue = LLVMCopyStringRepOfTargetData(td);
