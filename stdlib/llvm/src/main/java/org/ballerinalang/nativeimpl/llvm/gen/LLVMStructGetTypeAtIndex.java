...
@BallerinaFunction(
        ...
        functionName = "LLVMStructGetTypeAtIndex",
        args = {
...
public class LLVMStructGetTypeAtIndex extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMTypeRef structTy = FFIUtil.getRecodeArgumentNative(context, 0);
        int i = (int) context.getIntArgument(0);
        LLVMTypeRef returnValue = LLVMStructGetTypeAtIndex(structTy, i);
