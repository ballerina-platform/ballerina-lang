...
import static org.bytedeco.javacpp.LLVM.LLVMIsAIntToPtrInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAIntToPtrInst",
        args = {
...
public class LLVMIsAIntToPtrInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAIntToPtrInst(val);
