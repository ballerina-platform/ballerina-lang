...
@BallerinaFunction(
        ...
        functionName = "LLVMConstIntGetZExtValue",
        args = {
...
public class LLVMConstIntGetZExtValue extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef constantVal = FFIUtil.getRecodeArgumentNative(context, 0);
        long returnValue = LLVMConstIntGetZExtValue(constantVal);
