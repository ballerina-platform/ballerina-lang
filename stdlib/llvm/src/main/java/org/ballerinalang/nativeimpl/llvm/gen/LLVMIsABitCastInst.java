...
import static org.bytedeco.javacpp.LLVM.LLVMIsABitCastInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsABitCastInst",
        args = {
...
public class LLVMIsABitCastInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsABitCastInst(val);
