...
import static org.bytedeco.javacpp.LLVM.LLVMIsAExtractElementInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAExtractElementInst",
        args = {
...
public class LLVMIsAExtractElementInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAExtractElementInst(val);
