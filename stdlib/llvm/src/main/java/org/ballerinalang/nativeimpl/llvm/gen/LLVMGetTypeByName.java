...
import static org.bytedeco.javacpp.LLVM.LLVMGetTypeByName;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetTypeByName",
        args = {
...
public class LLVMGetTypeByName extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMModuleRef m = FFIUtil.getRecodeArgumentNative(context, 0);
        String name = context.getStringArgument(0);
        LLVMTypeRef returnValue = LLVMGetTypeByName(m, name);
