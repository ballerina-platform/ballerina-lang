...
import static org.bytedeco.javacpp.LLVM.LLVMHalfType;
...
@BallerinaFunction(
        ...
        functionName = "LLVMHalfType",
        returnType = {
                @ReturnType(type = RECORD, structType = "LLVMTypeRef", structPackage = "ballerina/llvm"),
        }
)
public class LLVMHalfType extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVMTypeRef returnValue = LLVMHalfType();
