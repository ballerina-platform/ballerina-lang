...
import static org.bytedeco.javacpp.LLVM.LLVMGetEnumAttributeAtIndex;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetEnumAttributeAtIndex",
        args = {
...
public class LLVMGetEnumAttributeAtIndex extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMAttributeRef returnValue = LLVMGetEnumAttributeAtIndex(f, idx, kindID);
