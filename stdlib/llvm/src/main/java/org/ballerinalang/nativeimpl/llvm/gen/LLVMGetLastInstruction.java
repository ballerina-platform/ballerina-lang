...
import static org.bytedeco.javacpp.LLVM.LLVMGetLastInstruction;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetLastInstruction",
        args = {
...
public class LLVMGetLastInstruction extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMBasicBlockRef bb = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMGetLastInstruction(bb);
