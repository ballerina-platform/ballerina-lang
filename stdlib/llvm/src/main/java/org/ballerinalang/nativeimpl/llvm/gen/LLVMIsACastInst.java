...
import static org.bytedeco.javacpp.LLVM.LLVMIsACastInst;
...
public class LLVMIsACastInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsACastInst(val);
