...
import static org.bytedeco.javacpp.LLVM.LLVMIsAGlobalVariable;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAGlobalVariable",
        args = {
...
public class LLVMIsAGlobalVariable extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAGlobalVariable(val);
