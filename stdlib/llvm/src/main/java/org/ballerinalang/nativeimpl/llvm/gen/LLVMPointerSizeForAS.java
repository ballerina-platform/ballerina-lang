...
import static org.bytedeco.javacpp.LLVM.LLVMPointerSizeForAS;
...
@BallerinaFunction(
        ...
        functionName = "LLVMPointerSizeForAS",
        args = {
...
public class LLVMPointerSizeForAS extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMTargetDataRef td = FFIUtil.getRecodeArgumentNative(context, 0);
        int asValue = (int) context.getIntArgument(0);
        int returnValue = LLVMPointerSizeForAS(td, asValue);
