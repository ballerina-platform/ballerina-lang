...
import static org.bytedeco.javacpp.LLVM.LLVMIsAFunction;
...
public class LLVMIsAFunction extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAFunction(val);
