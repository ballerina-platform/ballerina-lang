...
import static org.bytedeco.javacpp.LLVM.LLVMIsAResumeInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAResumeInst",
        args = {
...
public class LLVMIsAResumeInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAResumeInst(val);
