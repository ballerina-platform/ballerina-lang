...
import static org.bytedeco.javacpp.LLVM.LLVMFloatType;
...
@BallerinaFunction(
        ...
        functionName = "LLVMFloatType",
        returnType = {
                @ReturnType(type = RECORD, structType = "LLVMTypeRef", structPackage = "ballerina/llvm"),
        }
)
public class LLVMFloatType extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVMTypeRef returnValue = LLVMFloatType();
