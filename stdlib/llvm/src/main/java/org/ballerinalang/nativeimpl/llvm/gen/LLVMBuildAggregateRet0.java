...
@BallerinaFunction(
        ...
        functionName = "LLVMBuildAggregateRet0",
        args = {
                @Argument(name = "arg0", type = RECORD, structType = "LLVMBuilderRef"),
                @Argument(name = "retVals", type = RECORD, structType = "PointerPointer"),
...
public class LLVMBuildAggregateRet0 extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMBuilderRef arg0 = FFIUtil.getRecodeArgumentNative(context, 0);
        PointerPointer retVals = FFIUtil.getRecodeArgumentNative(context, 1);
