...
import static org.bytedeco.javacpp.LLVM.LLVMIsAMemCpyInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAMemCpyInst",
        args = {
...
public class LLVMIsAMemCpyInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAMemCpyInst(val);
