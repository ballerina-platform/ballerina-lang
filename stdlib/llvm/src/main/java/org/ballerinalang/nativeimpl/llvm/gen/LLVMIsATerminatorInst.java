...
import static org.bytedeco.javacpp.LLVM.LLVMIsATerminatorInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsATerminatorInst",
        args = {
...
public class LLVMIsATerminatorInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsATerminatorInst(val);
