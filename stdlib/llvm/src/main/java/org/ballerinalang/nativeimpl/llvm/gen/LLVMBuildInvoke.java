...
import static org.bytedeco.javacpp.LLVM.LLVMBuildInvoke;
...
@BallerinaFunction(
        ...
        args = {
                ...
                @Argument(name = "catchValue", type = RECORD, structType = "LLVMBasicBlockRef"),
...
public class LLVMBuildInvoke extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVM.LLVMBasicBlockRef then = FFIUtil.getRecodeArgumentNative(context, 3);
        LLVM.LLVMBasicBlockRef catchValue = FFIUtil.getRecodeArgumentNative(context, 4);
        String name = context.getStringArgument(0);
        LLVMValueRef returnValue = LLVMBuildInvoke(arg0, fn, args, numArgs, then, catchValue, name);
