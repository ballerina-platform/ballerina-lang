...
@BallerinaFunction(
        ...
        functionName = "LLVMInt8TypeInContext",
        args = {
...
public class LLVMInt8TypeInContext extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMContextRef c = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMTypeRef returnValue = LLVMInt8TypeInContext(c);
