...
import static org.bytedeco.javacpp.LLVM.LLVMIsAMemSetInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAMemSetInst",
        args = {
...
public class LLVMIsAMemSetInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAMemSetInst(val);
