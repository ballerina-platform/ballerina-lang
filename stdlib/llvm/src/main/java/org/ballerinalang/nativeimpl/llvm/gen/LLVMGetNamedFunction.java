...
@BallerinaFunction(
        ...
        functionName = "LLVMGetNamedFunction",
        args = {
...
public class LLVMGetNamedFunction extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMModuleRef m = FFIUtil.getRecodeArgumentNative(context, 0);
        String name = context.getStringArgument(0);
        LLVMValueRef returnValue = LLVMGetNamedFunction(m, name);
