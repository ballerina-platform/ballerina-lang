...
import static org.bytedeco.javacpp.LLVM.LLVMBuildTruncOrBitCast;
...
@BallerinaFunction(
        ...
        functionName = "LLVMBuildTruncOrBitCast",
        args = {
...
public class LLVMBuildTruncOrBitCast extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildTruncOrBitCast(arg0, val, destTy, name);
