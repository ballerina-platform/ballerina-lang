...
import static org.bytedeco.javacpp.LLVM.LLVMHalfTypeInContext;
...
@BallerinaFunction(
        ...
        functionName = "LLVMHalfTypeInContext",
        args = {
...
public class LLVMHalfTypeInContext extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMContextRef c = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMTypeRef returnValue = LLVMHalfTypeInContext(c);
