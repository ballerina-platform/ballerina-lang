...
import static org.bytedeco.javacpp.LLVM.LLVMConstIntGetSExtValue;
...
@BallerinaFunction(
        ...
        functionName = "LLVMConstIntGetSExtValue",
        args = {
...
public class LLVMConstIntGetSExtValue extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef constantVal = FFIUtil.getRecodeArgumentNative(context, 0);
        long returnValue = LLVMConstIntGetSExtValue(constantVal);
