...
@BallerinaFunction(
        ...
        functionName = "LLVMAddGlobalInAddressSpace",
        args = {
...
public class LLVMAddGlobalInAddressSpace extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMAddGlobalInAddressSpace(m, ty, name, addressSpace);
