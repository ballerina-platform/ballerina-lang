...
import static org.bytedeco.javacpp.LLVM.LLVMGetRelocationOffset;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetRelocationOffset",
        args = {
...
public class LLVMGetRelocationOffset extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMRelocationIteratorRef ri = FFIUtil.getRecodeArgumentNative(context, 0);
        long returnValue = LLVMGetRelocationOffset(ri);
