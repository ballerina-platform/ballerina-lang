...
import static org.bytedeco.javacpp.LLVM.LLVMBuildLShr;
...
public class LLVMBuildLShr extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildLShr(arg0, lhs, rhs, name);
