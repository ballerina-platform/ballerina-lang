...
public class LLVMRunFunction0 extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMGenericValueRef returnValue = LLVMRunFunction(ee, f, numArgs, args);
