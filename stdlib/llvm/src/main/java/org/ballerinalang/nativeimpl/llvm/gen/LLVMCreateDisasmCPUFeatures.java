...
import static org.bytedeco.javacpp.LLVM.LLVMCreateDisasmCPUFeatures;
...
@BallerinaFunction(
        ...
        functionName = "LLVMCreateDisasmCPUFeatures",
        args = {
...
public class LLVMCreateDisasmCPUFeatures extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMDisasmContextRef returnValue = LLVMCreateDisasmCPUFeatures(triple, cpu, features, disInfo, tagType,
