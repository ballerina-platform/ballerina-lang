...
import static org.bytedeco.javacpp.LLVM.LLVMGetStringAttributeAtIndex;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetStringAttributeAtIndex",
        args = {
...
public class LLVMGetStringAttributeAtIndex extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMAttributeRef returnValue = LLVMGetStringAttributeAtIndex(f, idx, k, kLen);
