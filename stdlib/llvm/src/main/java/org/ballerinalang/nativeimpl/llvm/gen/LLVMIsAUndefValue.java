...
import static org.bytedeco.javacpp.LLVM.LLVMIsAUndefValue;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAUndefValue",
        args = {
...
public class LLVMIsAUndefValue extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAUndefValue(val);
