...
import static org.bytedeco.javacpp.LLVM.LLVMInt128Type;
...
@BallerinaFunction(
        ...
        functionName = "LLVMInt128Type",
        returnType = {
                @ReturnType(type = RECORD, structType = "LLVMTypeRef", structPackage = "ballerina/llvm"),
        }
)
public class LLVMInt128Type extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVMTypeRef returnValue = LLVMInt128Type();
