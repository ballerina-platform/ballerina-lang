...
import static org.bytedeco.javacpp.LLVM.LLVMBuildZExtOrBitCast;
...
@BallerinaFunction(
        ...
        functionName = "LLVMBuildZExtOrBitCast",
        args = {
...
public class LLVMBuildZExtOrBitCast extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildZExtOrBitCast(arg0, val, destTy, name);
