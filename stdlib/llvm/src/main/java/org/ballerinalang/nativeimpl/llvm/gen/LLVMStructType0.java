...
import static org.bytedeco.javacpp.LLVM.LLVMStructType;
...
public class LLVMStructType0 extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        PointerPointer elementTypes = FFIUtil.getRecodeArgumentNative(context, 0);
        int elementCount = (int) context.getIntArgument(0);
        int packed = (int) context.getIntArgument(1);
        LLVMTypeRef returnValue = LLVMStructType(elementTypes, elementCount, packed);
