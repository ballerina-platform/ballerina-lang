...
@BallerinaFunction(
        ...
        functionName = "LLVMDoubleTypeInContext",
        args = {
...
public class LLVMDoubleTypeInContext extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMContextRef c = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMTypeRef returnValue = LLVMDoubleTypeInContext(c);
