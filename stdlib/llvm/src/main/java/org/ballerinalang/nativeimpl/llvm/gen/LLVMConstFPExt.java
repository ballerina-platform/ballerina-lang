...
import static org.bytedeco.javacpp.LLVM.LLVMConstFPExt;
...
public class LLVMConstFPExt extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMConstFPExt(constantVal, toType);
