...
import static org.bytedeco.javacpp.LLVM.LLVMConstNeg;
...
public class LLVMConstNeg extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef constantVal = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMConstNeg(constantVal);
