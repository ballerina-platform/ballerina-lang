...
import static org.bytedeco.javacpp.LLVM.LLVMIsAReturnInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAReturnInst",
        args = {
...
public class LLVMIsAReturnInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAReturnInst(val);
