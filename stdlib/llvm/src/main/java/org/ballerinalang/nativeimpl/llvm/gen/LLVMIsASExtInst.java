...
import static org.bytedeco.javacpp.LLVM.LLVMIsASExtInst;
...
public class LLVMIsASExtInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsASExtInst(val);
