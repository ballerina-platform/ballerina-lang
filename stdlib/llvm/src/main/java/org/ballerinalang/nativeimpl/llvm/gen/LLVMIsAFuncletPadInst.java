...
import static org.bytedeco.javacpp.LLVM.LLVMIsAFuncletPadInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAFuncletPadInst",
        args = {
...
public class LLVMIsAFuncletPadInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAFuncletPadInst(val);
