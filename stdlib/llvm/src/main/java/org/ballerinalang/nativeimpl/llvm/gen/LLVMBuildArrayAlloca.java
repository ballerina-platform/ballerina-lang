...
@BallerinaFunction(
        ...
        functionName = "LLVMBuildArrayAlloca",
        args = {
...
public class LLVMBuildArrayAlloca extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildArrayAlloca(arg0, ty, val, name);
