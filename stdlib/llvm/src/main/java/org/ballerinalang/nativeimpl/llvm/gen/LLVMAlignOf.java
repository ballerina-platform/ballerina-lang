...
import static org.bytedeco.javacpp.LLVM.LLVMAlignOf;
...
public class LLVMAlignOf extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMTypeRef ty = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMAlignOf(ty);
