...
import static org.bytedeco.javacpp.LLVM.LLVMCountParams;
...
public class LLVMCountParams extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef fn = FFIUtil.getRecodeArgumentNative(context, 0);
        int returnValue = LLVMCountParams(fn);
