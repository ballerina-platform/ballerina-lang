...
import static org.bytedeco.javacpp.LLVM.LLVMIsABasicBlock;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsABasicBlock",
        args = {
...
public class LLVMIsABasicBlock extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsABasicBlock(val);
