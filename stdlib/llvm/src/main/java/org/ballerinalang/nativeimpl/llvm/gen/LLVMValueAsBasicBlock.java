...
@BallerinaFunction(
        ...
        functionName = "LLVMValueAsBasicBlock",
        args = {
...
public class LLVMValueAsBasicBlock extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMBasicBlockRef returnValue = LLVMValueAsBasicBlock(val);
