...
import static org.bytedeco.javacpp.LLVM.LLVMBuildCast;
...
public class LLVMBuildCast extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildCast(b, op, val, destTy, name);
