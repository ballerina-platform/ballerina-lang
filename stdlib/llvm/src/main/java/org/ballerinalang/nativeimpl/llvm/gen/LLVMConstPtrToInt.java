...
import static org.bytedeco.javacpp.LLVM.LLVMConstPtrToInt;
...
@BallerinaFunction(
        ...
        functionName = "LLVMConstPtrToInt",
        args = {
...
public class LLVMConstPtrToInt extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMConstPtrToInt(constantVal, toType);
