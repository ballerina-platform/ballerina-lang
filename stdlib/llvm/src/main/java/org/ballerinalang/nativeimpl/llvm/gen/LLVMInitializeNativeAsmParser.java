...
@BallerinaFunction(
        ...
        functionName = "LLVMInitializeNativeAsmParser",
        returnType = {
                @ReturnType(type = INT, structPackage = "ballerina/llvm"),
        }
)
public class LLVMInitializeNativeAsmParser extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        int returnValue = LLVMInitializeNativeAsmParser();
