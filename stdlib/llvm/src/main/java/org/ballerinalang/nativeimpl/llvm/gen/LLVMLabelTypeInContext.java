...
import static org.bytedeco.javacpp.LLVM.LLVMLabelTypeInContext;
...
@BallerinaFunction(
        ...
        functionName = "LLVMLabelTypeInContext",
        args = {
...
public class LLVMLabelTypeInContext extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMContextRef c = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMTypeRef returnValue = LLVMLabelTypeInContext(c);
