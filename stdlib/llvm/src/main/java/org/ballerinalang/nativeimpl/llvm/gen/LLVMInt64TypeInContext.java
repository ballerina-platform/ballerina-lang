...
@BallerinaFunction(
        ...
        functionName = "LLVMInt64TypeInContext",
        args = {
...
public class LLVMInt64TypeInContext extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMContextRef c = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMTypeRef returnValue = LLVMInt64TypeInContext(c);
