...
import static org.bytedeco.javacpp.LLVM.LLVMGetCurrentDebugLocation;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetCurrentDebugLocation",
        args = {
...
public class LLVMGetCurrentDebugLocation extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMBuilderRef builder = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMGetCurrentDebugLocation(builder);
