...
import static org.bytedeco.javacpp.LLVM.LLVMIsABranchInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsABranchInst",
        args = {
...
public class LLVMIsABranchInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsABranchInst(val);
