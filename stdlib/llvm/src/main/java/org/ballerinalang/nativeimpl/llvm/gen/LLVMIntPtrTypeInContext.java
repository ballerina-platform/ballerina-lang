...
import static org.bytedeco.javacpp.LLVM.LLVMIntPtrTypeInContext;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIntPtrTypeInContext",
        args = {
...
public class LLVMIntPtrTypeInContext extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMContextRef c = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVM.LLVMTargetDataRef td = FFIUtil.getRecodeArgumentNative(context, 1);
        LLVMTypeRef returnValue = LLVMIntPtrTypeInContext(c, td);
