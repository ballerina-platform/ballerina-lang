...
import static org.bytedeco.javacpp.LLVM.LLVMIsASelectInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsASelectInst",
        args = {
...
public class LLVMIsASelectInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsASelectInst(val);
