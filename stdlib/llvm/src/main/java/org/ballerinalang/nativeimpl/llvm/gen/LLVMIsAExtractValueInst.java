...
import static org.bytedeco.javacpp.LLVM.LLVMIsAExtractValueInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAExtractValueInst",
        args = {
...
public class LLVMIsAExtractValueInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAExtractValueInst(val);
