...
import static org.bytedeco.javacpp.LLVM.LLVMConstFNeg;
...
public class LLVMConstFNeg extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef constantVal = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMConstFNeg(constantVal);
