...
import static org.bytedeco.javacpp.LLVM.LLVMBuildNUWMul;
...
public class LLVMBuildNUWMul extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildNUWMul(arg0, lhs, rhs, name);
