...
import static org.bytedeco.javacpp.LLVM.LLVMConstTrunc;
...
public class LLVMConstTrunc extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMConstTrunc(constantVal, toType);
