...
import static org.bytedeco.javacpp.LLVM.LLVMIsAPtrToIntInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAPtrToIntInst",
        args = {
...
public class LLVMIsAPtrToIntInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAPtrToIntInst(val);
