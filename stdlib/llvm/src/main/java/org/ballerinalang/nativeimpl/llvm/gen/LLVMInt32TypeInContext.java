...
import static org.bytedeco.javacpp.LLVM.LLVMInt32TypeInContext;
...
@BallerinaFunction(
        ...
        functionName = "LLVMInt32TypeInContext",
        args = {
...
public class LLVMInt32TypeInContext extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMContextRef c = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMTypeRef returnValue = LLVMInt32TypeInContext(c);
