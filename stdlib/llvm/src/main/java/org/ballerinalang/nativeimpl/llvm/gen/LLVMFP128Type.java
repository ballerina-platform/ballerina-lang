...
import static org.bytedeco.javacpp.LLVM.LLVMFP128Type;
...
@BallerinaFunction(
        ...
        functionName = "LLVMFP128Type",
        returnType = {
                @ReturnType(type = RECORD, structType = "LLVMTypeRef", structPackage = "ballerina/llvm"),
        }
)
public class LLVMFP128Type extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVMTypeRef returnValue = LLVMFP128Type();
