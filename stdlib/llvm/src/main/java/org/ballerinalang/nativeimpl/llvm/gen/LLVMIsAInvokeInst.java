...
import static org.bytedeco.javacpp.LLVM.LLVMIsAInvokeInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAInvokeInst",
        args = {
...
public class LLVMIsAInvokeInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAInvokeInst(val);
