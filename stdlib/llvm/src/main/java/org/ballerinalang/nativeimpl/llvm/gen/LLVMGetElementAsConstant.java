...
import static org.bytedeco.javacpp.LLVM.LLVMGetElementAsConstant;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetElementAsConstant",
        args = {
...
public class LLVMGetElementAsConstant extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef c = FFIUtil.getRecodeArgumentNative(context, 0);
        int idx = (int) context.getIntArgument(0);
        LLVMValueRef returnValue = LLVMGetElementAsConstant(c, idx);
