...
@BallerinaFunction(
        ...
        functionName = "LLVMAppendBasicBlockInContext",
        args = {
...
public class LLVMAppendBasicBlockInContext extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMBasicBlockRef returnValue = LLVMAppendBasicBlockInContext(c, fn, name);
