...
@BallerinaFunction(
        ...
        functionName = "LLVMGetFirstBasicBlock",
        args = {
...
public class LLVMGetFirstBasicBlock extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef fn = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMBasicBlockRef returnValue = LLVMGetFirstBasicBlock(fn);
