...
import static org.bytedeco.javacpp.LLVM.LLVMTokenTypeInContext;
...
@BallerinaFunction(
        ...
        functionName = "LLVMTokenTypeInContext",
        args = {
...
public class LLVMTokenTypeInContext extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMContextRef c = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMTypeRef returnValue = LLVMTokenTypeInContext(c);
