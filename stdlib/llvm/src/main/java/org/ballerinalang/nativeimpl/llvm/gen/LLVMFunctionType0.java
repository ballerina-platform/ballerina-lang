...
@BallerinaFunction(
        ...
        functionName = "LLVMFunctionType0",
        args = {
                @Argument(name = "returnType", type = RECORD, structType = "LLVMTypeRef"),
                @Argument(name = "paramTypes", type = RECORD, structType = "LLVMTypeRef"),
...
public class LLVMFunctionType0 extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMTypeRef returnType = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVM.LLVMTypeRef paramTypes = FFIUtil.getRecodeArgumentNative(context, 1);
