...
import static org.bytedeco.javacpp.LLVM.LLVMIsAUnreachableInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAUnreachableInst",
        args = {
...
public class LLVMIsAUnreachableInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAUnreachableInst(val);
