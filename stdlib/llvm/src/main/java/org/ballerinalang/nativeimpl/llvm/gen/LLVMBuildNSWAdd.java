...
import static org.bytedeco.javacpp.LLVM.LLVMBuildNSWAdd;
...
public class LLVMBuildNSWAdd extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildNSWAdd(arg0, lhs, rhs, name);
