...
import static org.bytedeco.javacpp.LLVM.LLVMConstTruncOrBitCast;
...
@BallerinaFunction(
        ...
        functionName = "LLVMConstTruncOrBitCast",
        args = {
...
public class LLVMConstTruncOrBitCast extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMConstTruncOrBitCast(constantVal, toType);
