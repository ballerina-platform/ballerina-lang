...
import static org.bytedeco.javacpp.LLVM.LLVMGetFirstParam;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetFirstParam",
        args = {
...
public class LLVMGetFirstParam extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef fn = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMGetFirstParam(fn);
