...
import static org.bytedeco.javacpp.LLVM.LLVMGetTargetName;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetTargetName",
        args = {
...
public class LLVMGetTargetName extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMTargetRef t = FFIUtil.getRecodeArgumentNative(context, 0);
        BytePointer returnValue = LLVMGetTargetName(t);
