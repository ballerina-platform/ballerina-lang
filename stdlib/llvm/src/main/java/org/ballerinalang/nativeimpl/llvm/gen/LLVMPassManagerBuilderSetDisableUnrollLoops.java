...
import static org.bytedeco.javacpp.LLVM.LLVMPassManagerBuilderSetDisableUnrollLoops;
...
@BallerinaFunction(
        ...
        functionName = "LLVMPassManagerBuilderSetDisableUnrollLoops",
        args = {
                @Argument(name = "pmb", type = RECORD, structType = "LLVMPassManagerBuilderRef"),
                @Argument(name = "value", type = INT),
        })
public class LLVMPassManagerBuilderSetDisableUnrollLoops extends BlockingNativeCallableUnit {
