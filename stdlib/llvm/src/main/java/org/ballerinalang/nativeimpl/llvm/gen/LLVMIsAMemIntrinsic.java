...
import static org.bytedeco.javacpp.LLVM.LLVMIsAMemIntrinsic;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAMemIntrinsic",
        args = {
...
public class LLVMIsAMemIntrinsic extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAMemIntrinsic(val);
