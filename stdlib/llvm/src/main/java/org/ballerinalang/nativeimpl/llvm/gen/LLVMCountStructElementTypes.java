...
@BallerinaFunction(
        ...
        functionName = "LLVMCountStructElementTypes",
        args = {
...
public class LLVMCountStructElementTypes extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMTypeRef structTy = FFIUtil.getRecodeArgumentNative(context, 0);
        int returnValue = LLVMCountStructElementTypes(structTy);
