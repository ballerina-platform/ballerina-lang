...
@BallerinaFunction(
        ...
        functionName = "LLVMPrintModuleToString",
        args = {
...
public class LLVMPrintModuleToString extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMModuleRef m = FFIUtil.getRecodeArgumentNative(context, 0);
        BytePointer returnValue = LLVMPrintModuleToString(m);
