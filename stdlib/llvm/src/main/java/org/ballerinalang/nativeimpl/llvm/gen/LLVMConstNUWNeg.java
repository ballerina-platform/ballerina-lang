...
import static org.bytedeco.javacpp.LLVM.LLVMConstNUWNeg;
...
public class LLVMConstNUWNeg extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef constantVal = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMConstNUWNeg(constantVal);
