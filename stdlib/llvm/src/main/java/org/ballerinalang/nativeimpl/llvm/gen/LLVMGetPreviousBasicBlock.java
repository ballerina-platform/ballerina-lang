...
import static org.bytedeco.javacpp.LLVM.LLVMGetPreviousBasicBlock;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetPreviousBasicBlock",
        args = {
...
public class LLVMGetPreviousBasicBlock extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMBasicBlockRef bb = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMBasicBlockRef returnValue = LLVMGetPreviousBasicBlock(bb);
