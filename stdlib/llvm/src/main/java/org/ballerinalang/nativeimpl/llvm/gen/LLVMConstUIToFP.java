...
import static org.bytedeco.javacpp.LLVM.LLVMConstUIToFP;
...
public class LLVMConstUIToFP extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMConstUIToFP(constantVal, toType);
