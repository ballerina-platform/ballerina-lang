...
import static org.bytedeco.javacpp.LLVM.LLVMIsAFPToSIInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAFPToSIInst",
        args = {
...
public class LLVMIsAFPToSIInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAFPToSIInst(val);
