...
import static org.bytedeco.javacpp.LLVM.LLVMIsAInstruction;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAInstruction",
        args = {
...
public class LLVMIsAInstruction extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAInstruction(val);
