...
import static org.bytedeco.javacpp.LLVM.LLVMIsEnumAttribute;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsEnumAttribute",
        args = {
...
public class LLVMIsEnumAttribute extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMAttributeRef a = FFIUtil.getRecodeArgumentNative(context, 0);
        int returnValue = LLVMIsEnumAttribute(a);
