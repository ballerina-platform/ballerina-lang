...
import static org.bytedeco.javacpp.LLVM.LLVMBuildAggregateRet;
...
@BallerinaFunction(
        ...
        functionName = "LLVMBuildAggregateRet1",
        args = {
                @Argument(name = "arg0", type = RECORD, structType = "LLVMBuilderRef"),
                @Argument(name = "retVals", type = RECORD, structType = "LLVMValueRef"),
...
public class LLVMBuildAggregateRet1 extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMBuilderRef arg0 = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVM.LLVMValueRef retVals = FFIUtil.getRecodeArgumentNative(context, 1);
        int n = (int) context.getIntArgument(0);
        LLVMValueRef returnValue = LLVMBuildAggregateRet(arg0, retVals, n);
