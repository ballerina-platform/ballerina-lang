...
public class LLVMConstStruct1 extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        PointerPointer constantVals = FFIUtil.getRecodeArgumentNative(context, 0);
