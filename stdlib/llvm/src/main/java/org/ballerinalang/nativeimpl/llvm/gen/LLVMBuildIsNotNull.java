...
import static org.bytedeco.javacpp.LLVM.LLVMBuildIsNotNull;
...
@BallerinaFunction(
        ...
        functionName = "LLVMBuildIsNotNull",
        args = {
...
public class LLVMBuildIsNotNull extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildIsNotNull(arg0, val, name);
