...
import static org.bytedeco.javacpp.LLVM.LLVMIsACleanupPadInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsACleanupPadInst",
        args = {
...
public class LLVMIsACleanupPadInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsACleanupPadInst(val);
