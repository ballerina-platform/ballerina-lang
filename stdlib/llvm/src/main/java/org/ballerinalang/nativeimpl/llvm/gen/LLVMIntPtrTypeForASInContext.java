...
import static org.bytedeco.javacpp.LLVM.LLVMIntPtrTypeForASInContext;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIntPtrTypeForASInContext",
        args = {
...
public class LLVMIntPtrTypeForASInContext extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMTypeRef returnValue = LLVMIntPtrTypeForASInContext(c, td, asValue);
