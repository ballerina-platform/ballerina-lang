...
import static org.bytedeco.javacpp.LLVM.LLVMGetRelocationValueString;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetRelocationValueString",
        args = {
...
public class LLVMGetRelocationValueString extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMRelocationIteratorRef ri = FFIUtil.getRecodeArgumentNative(context, 0);
        BytePointer returnValue = LLVMGetRelocationValueString(ri);
