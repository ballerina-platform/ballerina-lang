...
import static org.bytedeco.javacpp.LLVM.LLVMABISizeOfType;
...
@BallerinaFunction(
        ...
        functionName = "LLVMABISizeOfType",
        args = {
...
public class LLVMABISizeOfType extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        long returnValue = LLVMABISizeOfType(td, ty);
