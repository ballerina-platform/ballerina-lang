...
import static org.bytedeco.javacpp.LLVM.LLVMConstFPToSI;
...
public class LLVMConstFPToSI extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMConstFPToSI(constantVal, toType);
