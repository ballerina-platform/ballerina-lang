...
import static org.bytedeco.javacpp.LLVM.LLVMGetEnumAttributeKind;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetEnumAttributeKind",
        args = {
...
public class LLVMGetEnumAttributeKind extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMAttributeRef a = FFIUtil.getRecodeArgumentNative(context, 0);
        int returnValue = LLVMGetEnumAttributeKind(a);
