...
import static org.bytedeco.javacpp.LLVM.LLVMIsAAllocaInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAAllocaInst",
        args = {
...
public class LLVMIsAAllocaInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAAllocaInst(val);
