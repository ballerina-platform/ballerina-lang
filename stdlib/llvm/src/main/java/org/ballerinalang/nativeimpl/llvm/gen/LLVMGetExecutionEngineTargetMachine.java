...
import static org.bytedeco.javacpp.LLVM.LLVMGetExecutionEngineTargetMachine;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetExecutionEngineTargetMachine",
        args = {
...
public class LLVMGetExecutionEngineTargetMachine extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMExecutionEngineRef ee = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMTargetMachineRef returnValue = LLVMGetExecutionEngineTargetMachine(ee);
