...
import static org.bytedeco.javacpp.LLVM.LLVMIsATruncInst;
...
public class LLVMIsATruncInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsATruncInst(val);
