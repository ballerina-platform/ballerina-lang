...
import static org.bytedeco.javacpp.LLVM.LLVMIsACatchPadInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsACatchPadInst",
        args = {
...
public class LLVMIsACatchPadInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsACatchPadInst(val);
