...
import static org.bytedeco.javacpp.LLVM.LLVMX86MMXType;
...
@BallerinaFunction(
        ...
        functionName = "LLVMX86MMXType",
        returnType = {
                @ReturnType(type = RECORD, structType = "LLVMTypeRef", structPackage = "ballerina/llvm"),
        }
)
public class LLVMX86MMXType extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVMTypeRef returnValue = LLVMX86MMXType();
