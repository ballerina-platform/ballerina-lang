...
import static org.bytedeco.javacpp.LLVM.LLVMGetBufferStart;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetBufferStart",
        args = {
...
public class LLVMGetBufferStart extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMMemoryBufferRef memBuf = FFIUtil.getRecodeArgumentNative(context, 0);
        BytePointer returnValue = LLVMGetBufferStart(memBuf);
