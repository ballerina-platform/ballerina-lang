...
import static org.bytedeco.javacpp.LLVM.LLVMGetLastBasicBlock;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetLastBasicBlock",
        args = {
...
public class LLVMGetLastBasicBlock extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef fn = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMBasicBlockRef returnValue = LLVMGetLastBasicBlock(fn);
