...
import static org.bytedeco.javacpp.LLVM.LLVMIsAVAArgInst;
...
public class LLVMIsAVAArgInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAVAArgInst(val);
