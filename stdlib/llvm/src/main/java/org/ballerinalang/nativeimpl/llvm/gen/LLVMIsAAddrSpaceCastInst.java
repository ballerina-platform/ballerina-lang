...
import static org.bytedeco.javacpp.LLVM.LLVMIsAAddrSpaceCastInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAAddrSpaceCastInst",
        args = {
...
public class LLVMIsAAddrSpaceCastInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAAddrSpaceCastInst(val);
