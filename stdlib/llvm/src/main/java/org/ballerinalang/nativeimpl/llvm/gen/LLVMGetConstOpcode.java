...
import static org.bytedeco.javacpp.LLVM.LLVMGetConstOpcode;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetConstOpcode",
        args = {
...
public class LLVMGetConstOpcode extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef constantVal = FFIUtil.getRecodeArgumentNative(context, 0);
        int returnValue = LLVMGetConstOpcode(constantVal);
