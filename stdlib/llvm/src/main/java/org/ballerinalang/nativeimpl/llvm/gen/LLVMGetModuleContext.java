...
@BallerinaFunction(
        ...
        functionName = "LLVMGetModuleContext",
        args = {
...
public class LLVMGetModuleContext extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMModuleRef m = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMContextRef returnValue = LLVMGetModuleContext(m);
