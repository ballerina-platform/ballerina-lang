...
import static org.bytedeco.javacpp.LLVM.LLVMIsAConstantDataSequential;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAConstantDataSequential",
        args = {
...
public class LLVMIsAConstantDataSequential extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAConstantDataSequential(val);
