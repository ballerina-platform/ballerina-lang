...
import static org.bytedeco.javacpp.LLVM.LLVMIsAInsertValueInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAInsertValueInst",
        args = {
...
public class LLVMIsAInsertValueInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAInsertValueInst(val);
