...
import static org.bytedeco.javacpp.LLVM.LLVMGetExecutionEngineTargetData;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetExecutionEngineTargetData",
        args = {
...
public class LLVMGetExecutionEngineTargetData extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMExecutionEngineRef ee = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMTargetDataRef returnValue = LLVMGetExecutionEngineTargetData(ee);
