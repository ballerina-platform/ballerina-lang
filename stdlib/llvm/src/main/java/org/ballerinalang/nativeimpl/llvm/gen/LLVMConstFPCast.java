...
import static org.bytedeco.javacpp.LLVM.LLVMConstFPCast;
...
public class LLVMConstFPCast extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMConstFPCast(constantVal, toType);
