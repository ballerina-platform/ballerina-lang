...
import static org.bytedeco.javacpp.LLVM.LLVMIsAIntrinsicInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAIntrinsicInst",
        args = {
...
public class LLVMIsAIntrinsicInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAIntrinsicInst(val);
