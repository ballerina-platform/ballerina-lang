...
import static org.bytedeco.javacpp.LLVM.LLVMIsACatchReturnInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsACatchReturnInst",
        args = {
...
public class LLVMIsACatchReturnInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsACatchReturnInst(val);
