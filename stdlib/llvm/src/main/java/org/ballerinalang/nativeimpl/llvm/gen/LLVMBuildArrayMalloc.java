...
import static org.bytedeco.javacpp.LLVM.LLVMBuildArrayMalloc;
...
@BallerinaFunction(
        ...
        functionName = "LLVMBuildArrayMalloc",
        args = {
...
public class LLVMBuildArrayMalloc extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildArrayMalloc(arg0, ty, val, name);
