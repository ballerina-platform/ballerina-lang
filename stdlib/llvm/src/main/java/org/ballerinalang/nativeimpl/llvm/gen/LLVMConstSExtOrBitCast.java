...
import static org.bytedeco.javacpp.LLVM.LLVMConstSExtOrBitCast;
...
@BallerinaFunction(
        ...
        functionName = "LLVMConstSExtOrBitCast",
        args = {
...
public class LLVMConstSExtOrBitCast extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMConstSExtOrBitCast(constantVal, toType);
