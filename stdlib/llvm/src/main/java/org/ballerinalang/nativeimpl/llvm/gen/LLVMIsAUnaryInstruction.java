...
import static org.bytedeco.javacpp.LLVM.LLVMIsAUnaryInstruction;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAUnaryInstruction",
        args = {
...
public class LLVMIsAUnaryInstruction extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAUnaryInstruction(val);
