...
import static org.bytedeco.javacpp.LLVM.LLVMContextCreate;
...
@BallerinaFunction(
        ...
        functionName = "LLVMContextCreate",
        returnType = {
                @ReturnType(type = RECORD, structType = "LLVMContextRef", structPackage = "ballerina/llvm"),
        }
)
public class LLVMContextCreate extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVMContextRef returnValue = LLVMContextCreate();
