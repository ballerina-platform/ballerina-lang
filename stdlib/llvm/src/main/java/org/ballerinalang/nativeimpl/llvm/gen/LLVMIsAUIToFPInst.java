...
import static org.bytedeco.javacpp.LLVM.LLVMIsAUIToFPInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAUIToFPInst",
        args = {
...
public class LLVMIsAUIToFPInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAUIToFPInst(val);
