...
import static org.bytedeco.javacpp.LLVM.LLVMCreateTargetData;
...
@BallerinaFunction(
        ...
        functionName = "LLVMCreateTargetData",
        args = {
                @Argument(name = "stringRep", type = STRING),
        },
        returnType = {
                @ReturnType(type = RECORD, structType = "LLVMTargetDataRef", structPackage = "ballerina/llvm"),
        }
)
public class LLVMCreateTargetData extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        String stringRep = context.getStringArgument(0);
        LLVMTargetDataRef returnValue = LLVMCreateTargetData(stringRep);
