...
@BallerinaFunction(
        ...
        functionName = "LLVMGetInsertBlock",
        args = {
...
public class LLVMGetInsertBlock extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMBuilderRef builder = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMBasicBlockRef returnValue = LLVMGetInsertBlock(builder);
