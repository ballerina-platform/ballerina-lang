...
@BallerinaFunction(
        ...
        functionName = "LLVMMDNodeInContext1",
        args = {
...
public class LLVMMDNodeInContext1 extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMContextRef c = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVM.LLVMValueRef vals = FFIUtil.getRecodeArgumentNative(context, 1);
