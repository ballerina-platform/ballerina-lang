...
@BallerinaFunction(
        ...
        functionName = "LLVMPrintValueToString",
        args = {
...
public class LLVMPrintValueToString extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        BytePointer returnValue = LLVMPrintValueToString(val);
