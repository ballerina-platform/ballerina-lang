...
@BallerinaFunction(
        ...
        functionName = "LLVMBasicBlockAsValue",
        args = {
...
public class LLVMBasicBlockAsValue extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMBasicBlockRef bb = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMBasicBlockAsValue(bb);
