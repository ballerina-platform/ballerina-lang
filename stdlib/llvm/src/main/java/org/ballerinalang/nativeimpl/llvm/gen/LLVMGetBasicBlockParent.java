...
@BallerinaFunction(
        ...
        functionName = "LLVMGetBasicBlockParent",
        args = {
...
public class LLVMGetBasicBlockParent extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMBasicBlockRef bb = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMGetBasicBlockParent(bb);
