...
@BallerinaFunction(
        ...
        functionName = "LLVMWriteBitcodeToMemoryBuffer",
        args = {
...
public class LLVMWriteBitcodeToMemoryBuffer extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMModuleRef m = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMMemoryBufferRef returnValue = LLVMWriteBitcodeToMemoryBuffer(m);
