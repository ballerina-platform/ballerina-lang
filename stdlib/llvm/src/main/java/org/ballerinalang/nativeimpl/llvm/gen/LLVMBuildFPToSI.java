...
public class LLVMBuildFPToSI extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildFPToSI(arg0, val, destTy, name);
