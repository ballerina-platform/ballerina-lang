...
public class LLVMConstStruct0 extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef constantVals = FFIUtil.getRecodeArgumentNative(context, 0);
        int count = (int) context.getIntArgument(0);
        int packed = (int) context.getIntArgument(1);
        LLVMValueRef returnValue = LLVMConstStruct(constantVals, count, packed);
