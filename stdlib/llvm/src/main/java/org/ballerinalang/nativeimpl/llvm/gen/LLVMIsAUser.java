...
import static org.bytedeco.javacpp.LLVM.LLVMIsAUser;
...
public class LLVMIsAUser extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAUser(val);
