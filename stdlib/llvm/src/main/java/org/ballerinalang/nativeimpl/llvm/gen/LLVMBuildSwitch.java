...
@BallerinaFunction(
        ...
        args = {
                ...
                @Argument(name = "numCases", type = INT),
        },
        returnType = {
                @ReturnType(type = RECORD, structType = "LLVMValueRef", structPackage = "ballerina/llvm"),
        }
)
public class LLVMBuildSwitch extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVM.LLVMBasicBlockRef elseValue = FFIUtil.getRecodeArgumentNative(context, 2);
        int numCases = (int) context.getIntArgument(0);
        LLVMValueRef returnValue = LLVMBuildSwitch(arg0, v, elseValue, numCases);
