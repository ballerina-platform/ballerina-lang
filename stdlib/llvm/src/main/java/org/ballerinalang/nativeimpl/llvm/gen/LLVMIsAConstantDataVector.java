...
import static org.bytedeco.javacpp.LLVM.LLVMIsAConstantDataVector;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAConstantDataVector",
        args = {
...
public class LLVMIsAConstantDataVector extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAConstantDataVector(val);
