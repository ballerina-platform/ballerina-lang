...
import static org.bytedeco.javacpp.LLVM.LLVMGetIntrinsicID;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetIntrinsicID",
        args = {
...
public class LLVMGetIntrinsicID extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef fn = FFIUtil.getRecodeArgumentNative(context, 0);
        int returnValue = LLVMGetIntrinsicID(fn);
