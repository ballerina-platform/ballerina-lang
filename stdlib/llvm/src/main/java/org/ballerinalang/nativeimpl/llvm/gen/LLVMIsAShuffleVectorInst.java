...
import static org.bytedeco.javacpp.LLVM.LLVMIsAShuffleVectorInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsAShuffleVectorInst",
        args = {
...
public class LLVMIsAShuffleVectorInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAShuffleVectorInst(val);
