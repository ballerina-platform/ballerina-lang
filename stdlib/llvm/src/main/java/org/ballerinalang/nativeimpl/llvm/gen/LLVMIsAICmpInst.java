...
import static org.bytedeco.javacpp.LLVM.LLVMIsAICmpInst;
...
public class LLVMIsAICmpInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsAICmpInst(val);
