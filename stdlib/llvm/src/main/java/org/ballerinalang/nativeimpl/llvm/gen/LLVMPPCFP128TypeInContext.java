...
import static org.bytedeco.javacpp.LLVM.LLVMPPCFP128TypeInContext;
...
@BallerinaFunction(
        ...
        functionName = "LLVMPPCFP128TypeInContext",
        args = {
...
public class LLVMPPCFP128TypeInContext extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMContextRef c = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMTypeRef returnValue = LLVMPPCFP128TypeInContext(c);
