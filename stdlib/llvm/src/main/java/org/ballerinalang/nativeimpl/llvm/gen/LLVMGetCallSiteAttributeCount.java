...
import static org.bytedeco.javacpp.LLVM.LLVMGetCallSiteAttributeCount;
...
@BallerinaFunction(
        ...
        functionName = "LLVMGetCallSiteAttributeCount",
        args = {
...
public class LLVMGetCallSiteAttributeCount extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef c = FFIUtil.getRecodeArgumentNative(context, 0);
        int idx = (int) context.getIntArgument(0);
        int returnValue = LLVMGetCallSiteAttributeCount(c, idx);
