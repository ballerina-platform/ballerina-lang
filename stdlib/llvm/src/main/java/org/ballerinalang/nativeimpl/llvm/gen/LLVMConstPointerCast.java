...
@BallerinaFunction(
        ...
        functionName = "LLVMConstPointerCast",
        args = {
...
public class LLVMConstPointerCast extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMConstPointerCast(constantVal, toType);
