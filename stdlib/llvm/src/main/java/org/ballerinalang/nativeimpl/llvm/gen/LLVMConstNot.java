...
import static org.bytedeco.javacpp.LLVM.LLVMConstNot;
...
public class LLVMConstNot extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef constantVal = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMConstNot(constantVal);
