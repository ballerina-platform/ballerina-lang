...
import static org.bytedeco.javacpp.LLVM.LLVMBuildFPToUI;
...
public class LLVMBuildFPToUI extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        LLVMValueRef returnValue = LLVMBuildFPToUI(arg0, val, destTy, name);
