...
import static org.bytedeco.javacpp.LLVM.LLVMIsALandingPadInst;
...
@BallerinaFunction(
        ...
        functionName = "LLVMIsALandingPadInst",
        args = {
...
public class LLVMIsALandingPadInst extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        LLVM.LLVMValueRef val = FFIUtil.getRecodeArgumentNative(context, 0);
        LLVMValueRef returnValue = LLVMIsALandingPadInst(val);
