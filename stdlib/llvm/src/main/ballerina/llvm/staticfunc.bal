...
public extern function LLVMConstStringInContext(LLVMContextRef c, string str, int lengthVal, int dontNullTerminate) returns LLVMValueRef;
//public extern function LLVMConstString(BytePointer str, int length, int dontNullTerminate) returns LLVMValueRef;
public extern function LLVMConstString(string str, int lengthVal, int dontNullTerminate) returns LLVMValueRef;
public extern function LLVMIsConstantString(LLVMValueRef c) returns int;
public extern function LLVMGetAsString(LLVMValueRef c, SizeTPointer lengthVal) returns BytePointer;
...
public extern function LLVMConstArray0(LLVMTypeRef elementTy, LLVMValueRef constantVals, int lengthVal) returns LLVMValueRef;
public extern function LLVMConstArray1(LLVMTypeRef elementTy, PointerPointer constantVals, int lengthVal) returns LLVMValueRef;
