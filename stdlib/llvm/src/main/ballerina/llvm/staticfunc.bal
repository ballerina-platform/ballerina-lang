...
public extern function LLVMFunctionType1(LLVMTypeRef returnType, PointerPointer paramTypes, int paramCount, int isVarArg) returns LLVMTypeRef;
...
//public extern function LLVMBuildCall(LLVMBuilderRef arg0, LLVMValueRef fn, LLVMValueRef args, int numArgs, BytePointer name) returns LLVMValueRef;
