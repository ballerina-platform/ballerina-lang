...
# Represents the type of the invalid argument error.
public const INVALID_ARGUMENT_ERROR = "InvalidArgumentError";
# Represents client specified an invalid argument error.
public type InvalidArgumentError distinct error;

# Represents the type of the deadline exceeded error.
public const DEADLINE_EXCEEDED_ERROR = "DeadlineExceededError";
# Represents operation expired before completion error.
public type DeadlineExceededError distinct error;

# Represents the type of the not found error.
public const NOT_FOUND_ERROR = "NotFoundError";
# Represents requested entity (e.g., file or directory) not found error.
public type NotFoundError distinct error;

# Represents the type of the already exists error.
public const ALREADY_EXISTS_ERROR = "AlreadyExistsError";
...
# Represents the type of the permission denied error.
public const PERMISSION_DENIED_ERROR = "PermissionDeniedError";
...
# Represents the type of the unauthenticated error.
public const UNAUTHENTICATED_ERROR = "UnauthenticatedError";
...
# Represents the type of the resource exhausted error.
public const RESOURCE_EXHAUSTED_ERROR = "ResourceExhaustedError";
# Represents error occur when the resource is exhausted.
public type ResourceExhaustedError distinct error;

# Represents the type of the failed precondition error.
public const FAILED_PRECONDITION_ERROR = "FailedPreconditionError";
...
# Represents the type of the aborted error.
public const ABORTED_ERROR = "AbortedError";
# Represents error occur when operation is aborted.
public type AbortedError distinct error;

# Represents the type of the out of range error.
public const OUT_OF_RANGE_ERROR = "OutOfRangeError";
# Represents error occur when specified value is out of range.
public type OutOfRangeError distinct error;

# Represents the type of the unimplemented error.
public const UNIMPLEMENTED_ERROR = "UnimplementedError";
...
# Represents the type of the internal error.
public const INTERNAL_ERROR = "InternalError";
# Represents internal error.
public type InternalError distinct error;

# Represents the type of the unavailable error.
public const UNAVAILABLE_ERROR = "UnavailableError";
# Represents error occur when the service is currently unavailable.
public type UnavailableError distinct error;

# Represents the type of the data loss error.
public const DATA_LOSS_ERROR = "DataLossError";
# Represents unrecoverable data loss or corruption erros.
public type DataLossError distinct error;

# Represents the type of all the retry attempts failed scenario.
public const ALL_RETRY_ATTEMPTS_FAILED = "AllRetryAttemptsFailed";
...
# Represents the type of all the resiliency-related error.
