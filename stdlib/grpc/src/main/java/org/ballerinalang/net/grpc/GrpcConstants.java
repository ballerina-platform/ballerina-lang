...
public class GrpcConstants {
    ...
    public static final String HTTP_ENDPOINT_STARTED = "[ballerina/grpc] started HTTPS/WSS endpoint ";
    public static final String HTTPS_ENDPOINT_STARTED = "[ballerina/grpc] started HTTP/WS endpoint ";
    public static final String HTTP_ENDPOINT_STOPPED = "[ballerina/grpc] stopped HTTPS/WSS endpoint ";
    public static final String HTTPS_ENDPOINT_STOPPED = "[ballerina/grpc] stopped HTTP/WS endpoint ";
