...
public class StructMessage extends Message {
    ...
    public static StructMessage.Builder newBuilder(String messageName) throws GrpcServerException {
        return new StructMessage.Builder(messageName);
    }
    ...
    public static class Builder {
        ...
        public Descriptors.Descriptor getDescriptor() throws GrpcServerException {
            List<Descriptors.Descriptor> descriptors = com.google.protobuf.StructProto.getDescriptor()
                    .getMessageTypes();
