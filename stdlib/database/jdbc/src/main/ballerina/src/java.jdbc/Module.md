...
[jdbc:Client](https://ballerina.io/swan-lake/swan-lake/learn/api-docs/ballerina/java.jdbc/clients/Client.html) object. 
...
[jdbc:Options](https://ballerina.io/swan-lake/swan-lake/learn/api-docs/ballerina/java.jdbc/records/Options.html) 
and also uses the unshared connection pool in the type of 
[sql:ConnectionPool](https://ballerina.io/swan-lake/swan-lake/learn/api-docs/ballerina/sql/records/ConnectionPool.html). 
For more information about connection pooling, see [SQL Module](https://ballerina.io/swan-lake/swan-lake/learn/api-docs/ballerina/sql/index.html).
...
[jdbc:Client](https://ballerina.io/swan-lake/swan-lake/learn/api-docs/ballerina/java.jdbc/clients/Client.html) constructor. 

The [jdbc:Client](https://ballerina.io/swan-lake/swan-lake/learn/api-docs/ballerina/java.jdbc/clients/Client.html) references 
[sql:Client](https://ballerina.io/swan-lake/swan-lake/learn/api-docs/ballerina/sql/clients/Client.html) and 
...
[SQL Module](https://ballerina.io/swan-lake/swan-lake/learn/api-docs/ballerina/sql/index.html).
