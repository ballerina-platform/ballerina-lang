...
function testQuery(string url, string user, string password) returns @tainted record {}|error? {
...
function testQueryNumericTypeRecord(string url, string user, string password) returns @tainted NumericType|error? {
    mockclient:Client dbClient = check new (url = url, user = user, password = password);
...
function testQueryNumericInvalidColumnRecord(string url, string user, string password) returns @tainted error? {
    mockclient:Client dbClient = check new (url = url, user = user, password = password);
...
function testQueryNumericOptionalTypeRecord(string url, string user, string password)
...
function testQueryNumericUnionTypeRecord(string url, string user, string password)
...
function testQueryNumericStringTypeRecord(string url, string user, string password)
...
function testQueryNumericCustomTypeRecord(string url, string user, string password)
...
function testQueryFromNullTable(string url, string user, string password) returns @tainted record {}[]|error? {
    mockclient:Client dbClient = check new (url = url, user = user, password = password);
