...
public class SQLDatasourceUtils {
    ...
    private static Object[] getArrayData(BValue value) {
        ...
        case TypeTags.ARRAY_TAG:
            ...
            if (elementType.getTag() == TypeTags.BYTE_TAG) {
                ...
                throw new BallerinaException("unsupported  type for array parameter");
            }
        default:
            throw new BallerinaException("unsupported  type for array parameter");
        }
        ...
        for (int i = 0; i < fieldCount; ++i) {
            ...
            case TypeTags.ARRAY_TAG:
                ...
                if (elementType.getTag() == TypeTags.BYTE_TAG) {
                    ...
                    throw new BallerinaException("unsupported  type for struct parameter: " + structuredSQLType);
                }
    ...
    /**
     * This method will return equal ballerina  type for SQL type.
     *
    ...
    public static String getSQLType(BType value) {
        ...
        default:
            throw new BallerinaException(
                    "unsupported  type as direct value for sql operation, use sql:Parameter: " + value.getName());
        }
    }
    ...
    /**
     * This will retrieve the string value for the given binary .
     *
     * @param data binary
     */
    ...
    /**
     * This will retrieve the string value for the given array .
     */
    ...
    /**
     * This will retrieve the string value for the given struct .
     */
    ...
    private static String getString(Calendar calendar, String type) {
        ...
        case "datetime": //'-'? yyyy '-' mm '-' dd 'T' hh ':' mm ':' ss ('.' s+)? (zzzzzz)?
            ...
            break;
        default:
            throw new BallerinaException("invalid type for datetime : " + type);
        }
