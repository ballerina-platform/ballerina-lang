 ...
 * related to ballerina..actions.sql connector.
 *
 * @since 0.8.0
 */
            ...
            if (dataArray != null) {
                ...
                for (BField internalField : internalStructFields) {
                    ...
                    case TypeTags.RECORD_TYPE_TAG:
                        ...
                        break;
                    default:
                        throw new BallerinaException("error in retrieving UDT  for unsupported type:" + type);
                    }
                    ++index;
                }
            }
        } catch (SQLException e) {
            throw new BallerinaException("error in retrieving UDT :" + e.getMessage());
        }
        return struct;
    }
