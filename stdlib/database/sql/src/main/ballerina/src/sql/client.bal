...
TYPE_DATETIME|TYPE_TIMESTAMP|TYPE_YEAR|TYPE_ARRAY|TYPE_STRUCT|TYPE_TEXT|TYPE_TINYTEXT|TYPE_MEDIUMTEXT|TYPE_LONGTEXT|
TYPE_TINYBLOB|TYPE_LONGBLOB|TYPE_MEDIUMBLOB|TYPE_BLOB|TYPE_SET|TYPE_ENUM|TYPE_REFCURSOR;
