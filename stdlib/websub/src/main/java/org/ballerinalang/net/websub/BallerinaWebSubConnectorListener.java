...
import static org.ballerinalang.net.websub.WebSubSubscriberConstants.ON_MESSAGE_METADATA;
...
public class BallerinaWebSubConnectorListener extends BallerinaHTTPConnectorListener {
    ...
    protected void extractPropertiesAndStartResourceExecution(HttpCarbonMessage httpCarbonMessage,
        ...
        Executor.submit(scheduler, service, balResource.getName(), null, ON_MESSAGE_METADATA, callback, null,
                        signatureParams);
    }
    ...
    private void validateSignature(HttpCarbonMessage httpCarbonMessage, HttpResource httpResource,
        ...
        try {
            ...
            returnValue = Executor.executeFunction(scheduler, null, HttpConstants.ON_MESSAGE_METADATA,
