...
public class HubNativeOperationHandler {
     ...
     * @para  asyncContentDelivery         deliver updates in the same order they arrived
    ...
    public static Object startUpHubService(String basePath, String subscriptionResourcePath,
                                           ...
                                           String publicUrl, ObjectValue hubListener, boolean asyncContentDelivery) {
        ...
        return hubInstance
                .startUpHubService(Scheduler.getStrand(), basePath, subscriptionResourcePath, publishResourcePath,
                        topicRegistrationRequired, publicUrl, hubListener, asyncContentDelivery);
    }
