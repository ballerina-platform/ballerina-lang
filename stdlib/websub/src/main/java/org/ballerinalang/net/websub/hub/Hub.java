...
import static org.ballerinalang.net.websub.WebSubSubscriberConstants.ON_START_UP_HUB_METADATA;
    ...
    public Object startUpHubService(Strand strand, String basePath, String subscriptionResourcePath,
        ...
        synchronized (this) {
            if (!isStarted()) {
                ...
                started = true;
                Object setupResult = executeFunction(strand.scheduler, null, ON_START_UP_HUB_METADATA, classLoader,
