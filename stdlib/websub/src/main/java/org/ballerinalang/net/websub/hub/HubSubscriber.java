...
import static org.ballerinalang.net.websub.WebSubSubscriberConstants.ON_SEND_METADATA;
...
public class HubSubscriber extends Consumer {
    ...
    protected void send(Message message) throws BrokerException {
        ...
        try {
            Executor.executeFunction(scheduler, null, ON_SEND_METADATA, this.getClass().getClassLoader(),
