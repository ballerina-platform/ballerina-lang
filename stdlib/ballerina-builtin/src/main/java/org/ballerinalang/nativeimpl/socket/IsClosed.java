...
/**
 * Native function to check whether client socket is open or not.
 *
 * @since 0.963.0
 */
@BallerinaFunction(
...
public class IsClosed extends AbstractNativeFunction {
    @Override
    public BValue[] execute(Context context) {
        ...
        return getBValues(new BBoolean(socketChannel.socket().isClosed()));
    }
}
