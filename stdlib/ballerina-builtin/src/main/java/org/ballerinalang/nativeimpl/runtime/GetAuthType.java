...
public class GetAuthType extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        if (authType == null) {
            authType = BTypes.typeString.getZeroValue().stringValue();
        }
        context.setReturnValues(new BString(authType));
    }
}
