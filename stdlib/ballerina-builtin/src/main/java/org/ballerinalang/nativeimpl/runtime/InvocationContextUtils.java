...
public class InvocationContextUtils {
    ...
    private static TypeInfo getStructInfo(Context context, String packageName, String structName) {
    ...
    private static BStruct createInvocationContext(Context context, BStruct userPrincipal, BStruct authContext) {
        TypeInfo invocationContextInfo = getStructInfo(context, PACKAGE_RUNTIME, STRUCT_TYPE_INVOCATION_CONTEXT);
    ...
    private static BStruct createAuthContext(Context context) {
        TypeInfo authContextInfo = getStructInfo(context, PACKAGE_RUNTIME, STRUCT_TYPE_AUTH_CONTEXT);
        String scheme = "";
        String authToken = "";
    ...
    private static BStruct createUserPrincipal(Context context) {
        TypeInfo authContextInfo = getStructInfo(context, PACKAGE_RUNTIME, STRUCT_TYPE_USER_PRINCIPAL);
        String userId = "";
        String username = "";
