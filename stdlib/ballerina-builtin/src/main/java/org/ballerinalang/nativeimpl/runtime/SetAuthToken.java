...
@BallerinaFunction(
        ...
        receiver = @Receiver(type = TypeKind.STRUCT, structType = "AuthenticationContext", structPackage = "ballerina" +
                ".io"),
        args = {@Argument(name = "authToken", type = TypeKind.STRING)},
        isPublic = true
)
public class SetAuthToken extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        String authToken = context.getStringArgument(0);
