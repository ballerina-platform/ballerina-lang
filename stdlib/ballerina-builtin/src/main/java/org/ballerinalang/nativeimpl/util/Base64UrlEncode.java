...
/**
 * Native function ballerina.util:base64UrlEncode.
 *
 * @since 0.963.0
 */
@BallerinaFunction(
...
public class Base64UrlEncode extends AbstractNativeFunction {

    @Override
    public BValue[] execute(Context context) {
        String value = getStringArgument(context, 0);
        byte[] encodedValue = Base64.getUrlEncoder().encode(value.getBytes(Charset.defaultCharset()));
