...
@BallerinaFunction(
        ...
        functionName = "setAuthType",
        receiver = @Receiver(type = TypeKind.STRUCT, structType = "AuthenticationContext", structPackage = "ballerina" +
                ".io"),
        args = {@Argument(name = "authType", type = TypeKind.STRING)},
        isPublic = true
)
public class SetAuthType extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        String authType = context.getStringArgument(0);
