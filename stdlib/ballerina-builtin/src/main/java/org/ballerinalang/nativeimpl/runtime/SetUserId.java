...
@BallerinaFunction(
        ...
        functionName = "setUserId",
        receiver = @Receiver(type = TypeKind.STRUCT, structType = "AuthenticationContext", structPackage = "ballerina" +
                ".io"),
        args = {@Argument(name = "userId", type = TypeKind.STRING)},
        isPublic = true
)
public class SetUserId extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
        String userId = context.getStringArgument(0);
