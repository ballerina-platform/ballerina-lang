...
@Param {value:"s: The original string argument"}
@Param {value:"startIndex: The starting index"}
...
result"}
@Param {value:"s: The original string argument"}
@Param {value:"regex: The pattern to search for "}
...
given replacement"}
@Param {value:"s: The original string argument"}
@Param {value:"regex: The regular expression to search for"}
@Param {value:"replaceWith: The replacement string"}
@Return {value:"The derived string"}
...
@Param {value:"s: The original string argument"}
@Param {value:"regex: Regular expression"}
