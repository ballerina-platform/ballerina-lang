...
@Description {value:"Returns the size of the file in bytes. If the file is a directory, does not exist or has restricted access rights, -1 is returned."}
@Param {value:"file: The file of which the size needs to be determined"}
@Return {value:"Returns the size of the file in bytes."}
public native function <File file> size () (int);
