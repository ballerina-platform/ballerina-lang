...
public native function getAsString(@sensitive string configKey) returns string?;
...
public native function getTable (@sensitive string tableHeader) returns map;
...
public native function contains (@sensitive string configKey) returns boolean;
...
public native function setConfig(@sensitive string configKey, string configValue);
