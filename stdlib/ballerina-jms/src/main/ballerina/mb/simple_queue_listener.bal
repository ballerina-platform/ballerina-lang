...
public type SimpleQueueListener object {
    ...
    public function init(SimpleQueueListenerEndpointConfiguration config) {
        ...
        jms:Connection conn = new({
                ...
                providerUrl:getProviderUrl(config),
    ...
    function getProviderUrl(SimpleQueueListenerEndpointConfiguration config) returns string {

        string brokerUrl = "amqp://admin:admin@ballerina/default?brokerlist='tcp://localhost:5672'";
        return brokerUrl;
    }
