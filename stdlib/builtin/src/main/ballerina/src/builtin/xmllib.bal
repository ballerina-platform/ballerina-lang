...
public function xml.isSingleton() returns boolean = external;

# Check whether the XML sequence is empty.
#
# + return - Boolean flag indicating whether the XML sequence is empty
public function xml.isEmpty() returns boolean = external;
...
public function xml.elements() returns xml = external;
...
public function xml.select(string qname) returns xml = external;
...
public function xml.getItemType() returns string = external;
...
public function xml.getElementName() returns string = external;
...
public function xml.slice(int startIndex, int endIndex) returns xml = external;

# Sets the attributes to the provided attributes map.
#
# + attributes - Attributes map
public function xml.setAttributes(map<any> attributes) = external;
...
public function xml.toJSON(record {
...
public function xml.selectDescendants(string qname) returns xml = external;

# Remove an attribute from an XML.
#
# + qname - Qualified name of the attribute
public function xml.removeAttribute(string qname) = external;
...
#
# + children - children
public function xml.appendChildren(xml children) = external;
...
public function xml.removeChildren(string qname) = external;
