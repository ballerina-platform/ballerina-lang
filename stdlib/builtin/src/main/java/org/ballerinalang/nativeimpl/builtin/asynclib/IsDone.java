...
/**
 * Extern function future.isDone().
 */
@BallerinaFunction(
        orgName = "ballerina", packageName = "builtin",
        functionName = "future.isDone",
        args = {@Argument(name = "f", type = TypeKind.FUTURE)},
        returnType = {@ReturnType(type = TypeKind.BOOLEAN)},
        isPublic = true
)
public class IsDone extends BlockingNativeCallableUnit {
    ...
    public static boolean isDone(Strand strand, FutureValue futureValue) {
//        return futureValue.isDone();
        return true;
    }
