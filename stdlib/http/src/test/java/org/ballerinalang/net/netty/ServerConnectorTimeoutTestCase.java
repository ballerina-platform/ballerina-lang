...
import org.ballerinalang.net.netty.contentaware.listeners.DumbMessageListener;
...
import static org.ballerinalang.net.netty.contract.Constants.IDLE_TIMEOUT_TRIGGERED_BEFORE_INITIATING_OUTBOUND_RESPONSE;
...
public class ServerConnectorTimeoutTestCase {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ServerConnectorTimeoutTestCase.class);

    protected ServerConnector serverConnector;
    protected ListenerConfiguration listenerConfiguration;
    protected HttpWsConnectorFactory httpWsConnectorFactory;

    ServerConnectorTimeoutTestCase() {
