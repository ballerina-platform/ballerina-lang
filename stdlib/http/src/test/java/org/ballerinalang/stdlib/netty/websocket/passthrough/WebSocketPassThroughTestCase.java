...
package org.ballerinalang.stdlib.netty.websocket.passthrough;

import org.ballerinalang.stdlib.netty.util.TestUtil;
import org.ballerinalang.stdlib.netty.util.client.websocket.WebSocketTestClient;
...
public class WebSocketPassThroughTestCase {
    ...
    public void testTextPassThrough() throws InterruptedException, URISyntaxException {
        ...
        latch.await(TestUtil.WEBSOCKET_TEST_IDLE_TIMEOUT, SECONDS);
