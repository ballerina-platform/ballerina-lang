...
import org.ballerinalang.stdlib.netty.contentaware.listeners.EchoMessageListener;
...
class Utils {
    ...
    KeyPair generateRSAKeyPair() throws Exception {
        ...
        KeyPairGenerator kpGen = KeyPairGenerator.getInstance("RSA", BOUNCY_CASTLE_PROVIDER);
    ...
    private X509Certificate createCertificateFromResourceFile(String resourcePath) throws Exception {
        ...
        CertificateFactory certFactory = CertificateFactory
                .getInstance(Constants.X_509, BOUNCY_CASTLE_PROVIDER);
