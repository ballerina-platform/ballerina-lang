...
public class UriTemplateBestMatchTest {
    ...
    public void testMostSpecificMatchWithQueryParam() {
        ...
        Assert.assertEquals(((MapValueImpl<BString, Object>) bJson).get(BStringValues.fromString("echo1")).toString(),
    ...
    public void testMostSpecificMatchWithWildCard() {
        ...
        Assert.assertEquals(((MapValueImpl<BString, Object>) bJson).get(BStringValues.fromString("echo2")).toString(),
    ...
    public void testMostSpecificMatch() {
        ...
        Assert.assertEquals(((MapValueImpl<BString, Object>) bJson).get(BStringValues.fromString("echo3")).toString(),
    ...
    public void testMostSpecificServiceDispatch() {
        ...
        Assert.assertEquals(((MapValueImpl<BString, Object>) bJson).get(BStringValues.fromString("echo5")).toString(),
                            "echo5"
    ...
    public void testSubPathEndsWithBar() {
        ...
        Assert.assertEquals(((MapValueImpl<BString, Object>) bJson).get(BStringValues.fromString("first")).toString(),
                            "shafreen anfar", "Resource dispatched to wrong template");

        Assert.assertEquals(((MapValueImpl<BString, Object>) bJson).get(BStringValues.fromString("echo4")).toString(),
