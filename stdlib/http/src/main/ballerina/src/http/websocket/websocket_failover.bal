...
public type WebSocketFailoverClientEndpointConfig client object {
    ...
    private string url = "";
    private WebSocketFailoverClientEndpointConfigEndpointConfig config = {};

    # Initializes the client when called.
    #
    # + c - The `WebSocketFailoverClientEndpointConfigEndpointConfig` of the endpoint
    public function __init(public WebSocketFailoverClientEndpointConfigEndpointConfig? config = ()) {
        self.url = url;
        self.config = config ?: {};
        self.initEndpoint();
    }
...
#                    `WebSocketFailoverClientEndpointConfig`needs to be called once to start receiving messages.
...
public type WebSocketFailoverClientEndpointConfigEndpointConfig record {|
