...
public type HttpClient client object {
    ...
    public remote function post(string path, ClientMessage message) returns Response|error;
    ...
    # + message - A Request or any payload of type `string`, `xml`, `json`, `byte[]`, `io:ReadableByteChannel` or `mime:Entity[]`
    # + return - The response for the request or an `error` if failed to establish communication with the upstream server
    public remote function head(string path, ClientMessage message = ()) returns Response|error;
    ...
    # + message - A Request or any payload of type `string`, `xml`, `json`, `byte[]`, `io:ReadableByteChannel` or `mime:Entity[]`
    # + return - The response for the request or an `error` if failed to establish communication with the upstream server
    public remote function put(string path, ClientMessage message) returns Response|error;
    ...
    # + message - A Request or any payload of type `string`, `xml`, `json`, `byte[]`, `io:ReadableByteChannel` or `mime:Entity[]`
    # + return - The response for the request or an `error` if failed to establish communication with the upstream server
    public remote function execute(string httpVerb, string path, ClientMessage message) returns Response|error;
    ...
    # + message - A Request or any payload of type `string`, `xml`, `json`, `byte[]`, `io:ReadableByteChannel` or `mime:Entity[]`
    # + return - The response for the request or an `error` if failed to establish communication with the upstream server
    public remote function patch(string path, ClientMessage message) returns Response|error;
    ...
    # + message - A Request or any payload of type `string`, `xml`, `json`, `byte[]`, `io:ReadableByteChannel` or `mime:Entity[]`
    # + return - The response for the request or an `error` if failed to establish communication with the upstream server
    public remote function delete(string path, ClientMessage message) returns Response|error;
    ...
    #             or `mime:Entity[]`
    # + return - The response for the request or an `error` if failed to establish communication with the upstream server
    public remote function get(string path, ClientMessage message = ()) returns Response|error;
    ...
    #             or `mime:Entity[]`
    # + return - The response for the request or an `error` if failed to establish communication with the upstream server
    public remote function options(string path, ClientMessage message = ()) returns Response|error;
    ...
    public remote function submit(string httpVerb, string path, ClientMessage message) returns HttpFuture|error;
...
remote function HttpClient.post(string path, ClientMessage message) returns Response|error {
    return self.httpCaller->post(path, message);
}

remote function HttpClient.head(string path, ClientMessage message = ()) returns Response|error {
    return self.httpCaller->head(path, message = message);
}

remote function HttpClient.put(string path, ClientMessage message) returns Response|error {
    return self.httpCaller->put(path, message);
}

remote function HttpClient.execute(string httpVerb, string path, ClientMessage message) returns Response|error {
    return self.httpCaller->execute(httpVerb, path, message);
}

remote function HttpClient.patch(string path, ClientMessage message) returns Response|error {
    return self.httpCaller->patch(path, message);
}

remote function HttpClient.delete(string path, ClientMessage message) returns Response|error {
    return self.httpCaller->delete(path, message);
}

remote function HttpClient.get(string path, ClientMessage message = ()) returns Response|error {
    return self.httpCaller->get(path, message = message);
}

remote function HttpClient.options(string path, ClientMessage message = ()) returns Response|error {
...
remote function HttpClient.submit(string httpVerb, string path, ClientMessage message) returns HttpFuture|error {
