...
remote function HttpClient.post(string path, OutboundRequestEntity message) returns Response|error {
    return self.httpCaller->post(path, message);
}

remote function HttpClient.head(string path, OutboundRequestEntity message = ()) returns Response|error {
    return self.httpCaller->head(path, message = message);
}

remote function HttpClient.put(string path, OutboundRequestEntity message) returns Response|error {
    return self.httpCaller->put(path, message);
}

remote function HttpClient.execute(string httpVerb, string path, OutboundRequestEntity message) returns Response|error {
    return self.httpCaller->execute(httpVerb, path, message);
}

remote function HttpClient.patch(string path, OutboundRequestEntity message) returns Response|error {
    return self.httpCaller->patch(path, message);
}

remote function HttpClient.delete(string path, OutboundRequestEntity message) returns Response|error {
    return self.httpCaller->delete(path, message);
}

remote function HttpClient.get(string path, OutboundRequestEntity message = ()) returns Response|error {
    return self.httpCaller->get(path, message = message);
}

remote function HttpClient.options(string path, OutboundRequestEntity message = ()) returns Response|error {
...
remote function HttpClient.submit(string httpVerb, string path, OutboundRequestEntity message) returns HttpFuture|error {
