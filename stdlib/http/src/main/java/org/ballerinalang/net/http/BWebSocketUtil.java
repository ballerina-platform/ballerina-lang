...
public class BWebSocketUtil {
    ...
    public static void handleHandshake(BWebSocketService wsService, BWebSocketConnectionManager connectionManager,
        ...
        future.setHandshakeListener(new ServerHandshakeListener() {
            ...
            public void onSuccess(WebSocketConnection webSocketConnection) {
                ...
                BWebSocketOpenConnectionInfo connectionInfo =
                        new BWebSocketOpenConnectionInfo(wsService, webSocketConnection, webSocketEndpoint, context);
            ...
            public void onError(Throwable throwable) {
                if (context != null && callback != null) {
                    callback.notifyFailure(BHttpUtil.getError(
    ...
    public static void setListenerOpenField(BWebSocketOpenConnectionInfo connectionInfo) throws IllegalAccessException {
