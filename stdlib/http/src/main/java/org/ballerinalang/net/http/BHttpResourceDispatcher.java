 ...
 */
public class BHttpResourceDispatcher {

    public static BHttpResource findResource(BHttpService service, HttpCarbonMessage inboundRequest) {
        ...
        try {
            BHttpResource resource = service.getUriTemplate().matches(subPath, resourceArgumentValues, inboundRequest);
            if (resource != null) {
    ...
    private static void handleOptionsRequest(HttpCarbonMessage cMsg, BHttpService service) {
    ...
    private BHttpResourceDispatcher() {
    }
}
