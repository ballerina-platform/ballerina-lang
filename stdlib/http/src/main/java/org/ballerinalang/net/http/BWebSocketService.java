...
public class BWebSocketService {
    ...
    private BHttpResource upgradeResource;
    ...
    public BWebSocketService(Service service) {
        ...
        if (param != null && WebSocketConstants.FULL_WEBSOCKET_CALLER_NAME.equals(param.getVarType().toString())) {
            ...
            if (configAnnotation != null && (configAnnotationStruct = configAnnotation.getValue()) != null) {
                ...
                idleTimeoutInSeconds = BWebSocketUtil.findIdleTimeoutInSeconds(configAnnotationStruct);
                maxFrameSize = BWebSocketUtil.findMaxFrameSize(configAnnotationStruct);
            }
    ...
    public BWebSocketService(String httpBasePath, BHttpResource upgradeResource, Service service) {
        this(service);
        Annotation resourceConfigAnnotation = BHttpResource.getResourceConfigAnnotation(
    ...
    public BHttpResource getUpgradeResource() {
