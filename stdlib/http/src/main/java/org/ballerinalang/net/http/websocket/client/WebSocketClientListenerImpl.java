 ...
 * @since 1.1.0
 */
public class WebSocketClientListenerImpl extends WebSocketClientListener {

    private WebSocketOpenConnectionInfo connectionInfo;
    private static final Logger logger = LoggerFactory.getLogger(WebSocketClientListenerImpl.class);
