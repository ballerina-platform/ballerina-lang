...
/**
 * {@code AddHeader} is the ballerina extern function to add a header to a Push Promise.
 */
@BallerinaFunction(
...
public class AddHeader {
    public static void addHeader(Strand strand, ObjectValue pushPromiseObj, String headerName, String headerValue) {
