...
import org.ballerinalang.net.netty.contract.exceptions.ClientClosedConnectionException;
...
import org.ballerinalang.net.netty.contractimpl.listener.states.ReceivingHeaders;
...
import static org.ballerinalang.net.netty.contractimpl.common.Util.createInboundReqCarbonMsg;
...
public class SourceHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        if (msg instanceof HttpRequest) {
            ...
            org.ballerinalang.net.netty.contractimpl.listener.states.ListenerReqRespStateManager
                    listenerReqRespStateManager = new ListenerReqRespStateManager();
