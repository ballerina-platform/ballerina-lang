...
public class HttpConstants {
    ...
    public static final String HTTP_ENDPOINT_STARTED = "[ballerina/http] started HTTPS/WSS endpoint ";
    public static final String HTTPS_ENDPOINT_STARTED = "[ballerina/http] started HTTP/WS endpoint ";
    public static final String HTTP_ENDPOINT_STOPPED = "[ballerina/http] stopped HTTPS/WSS endpoint ";
    public static final String HTTPS_ENDPOINT_STOPPED = "[ballerina/http] stopped HTTP/WS endpoint ";
