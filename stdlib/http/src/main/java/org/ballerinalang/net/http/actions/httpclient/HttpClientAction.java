...
public class HttpClientAction extends AbstractHTTPAction {
    ...
    public static Object executeClientAction(ObjectValue httpClient, String path,
        ...
        HttpCarbonMessage outboundRequestMsg = createOutboundRequestMsg(strand, url, config, path.replaceAll(
                HttpConstants.DOWBLE_SLASH, HttpConstants.SINGLE_SLASH), requestObj);
