...
/**
 * Utility class providing utility methods using bvm values.
 */
public class BHttpUtil {
    ...
    private static final Logger log = LoggerFactory.getLogger(BHttpUtil.class);
    ...
    public static BValue[] getProperty(Context context, boolean isRequest) {
        ...
        HttpCarbonMessage httpCarbonMessage = HttpUtil
                .getCarbonMsg(httpMessageStruct, createHttpCarbonMessage(isRequest));
    ...
    public static BMap<String, BValue> createNewEntity(Context context, BMap<String, BValue> httpMessageStruct) {
        ...
        HttpCarbonMessage httpCarbonMessage = getCarbonMsg(httpMessageStruct,
                                                       createHttpCarbonMessage(isRequestStruct(httpMessageStruct)));
    ...
    public static void setEntity(Context context, boolean isRequest) {
        ...
        HttpCarbonMessage httpCarbonMessage = getCarbonMsg(httpMessageStruct,
                                                                    createHttpCarbonMessage(isRequest));
...
//        try {
//            BMap<String, BValue> httpMessageStruct = (BMap<String, BValue>)
    //            context.getRefArgument(HTTP_MESSAGE_INDEX);
...
//    }
    ...
    public static void populateEntityBody(Context context, BMap<String, BValue> httpMessageStruct,
        ...
        HttpCarbonMessage httpCarbonMessage = HttpUtil
                    .getCarbonMsg(httpMessageStruct, createHttpCarbonMessage(request));
    ...
    public static void prepareOutboundResponse(Context context, HttpCarbonMessage inboundRequestMsg,
        ...
        checkEntityAvailability(context, outboundResponseStruct);

        addHTTPSessionAndCorsHeaders(context, inboundRequestMsg, outboundResponseMsg);
        enrichOutboundMessage(outboundResponseMsg, outboundResponseStruct);
        setCompressionHeaders(context, inboundRequestMsg, outboundResponseMsg);
        setChunkingHeader(context, outboundResponseMsg);
    }
...
//        }
    ...
    public static void populateInboundRequest(BMap<String, BValue> inboundRequestStruct, BMap<String, BValue> entity,
        ...
        if (cacheControlHeader != null) {
            ...
            BRequestCacheControlStruct requestCacheControl = new BRequestCacheControlStruct(cacheControlStruct);
    ...
    public static void enrichHttpCallerWithConnectionInfo(BMap<String, BValue> httpCaller, HttpCarbonMessage inboundMsg,
                                                          BHttpResource httpResource, Struct config) {
    ...
    public static void populateInboundResponse(BMap<String, BValue> inboundResponse, BMap<String, BValue> entity,
        ...
        if (cacheControlHeader != null) {
            BResponseCacheControlStruct responseCacheControl
                    = new BResponseCacheControlStruct(
...
//    }
    ...
    public static String addBoundaryIfNotExist(HttpCarbonMessage transportMessage, String contentType) {
        ...
        boundaryString = boundaryValue != null ? boundaryValue.toString() :
                addBoundaryParameter(transportMessage, contentType);
    ...
    public static BMap<String, BValue> createResponseStruct(Context context, HttpCarbonMessage httpCarbonMessage) {
        ...
        populateInboundResponse(responseStruct, entity, mediaType, context.getProgramFile(), httpCarbonMessage);
    ...
    public static void populateSenderConfigurations(SenderConfiguration senderConfiguration, Struct
        ...
        if (secureSocket != null) {
            ...
            setDefaultTrustStore(senderConfiguration);
        }
        ...
        senderConfiguration.setChunkingConfig(getChunkConfig(chunking));
        ...
        String keepAliveConfig = clientEndpointConfig.getRefField(HttpConstants.CLIENT_EP_IS_KEEP_ALIVE)
                .getStringValue();
        senderConfiguration.setKeepAliveConfig(getKeepAliveConfig(keepAliveConfig));
        ...
        senderConfiguration.setForwardedExtensionConfig(getForwardedExtensionConfig(forwardedExtension));
    }
