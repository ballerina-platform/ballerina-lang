...
import org.ballerinalang.net.netty.contractimpl.listener.states.http2.ListenerState;
import org.ballerinalang.net.netty.contractimpl.sender.states.http2.SenderState;
...
public class Http2MessageStateContext {
    ...
    private org.ballerinalang.net.netty.contractimpl.listener.states.http2.ListenerState listenerState;
    private org.ballerinalang.net.netty.contractimpl.sender.states.http2.SenderState senderState;
     ...
     */
    public void setListenerState(org.ballerinalang.net.netty.contractimpl.listener.states.http2.ListenerState state) {
     ...
     */
    public org.ballerinalang.net.netty.contractimpl.sender.states.http2.SenderState getSenderState() {
        return senderState;
    }
