...
/**
 * Test class for email receive using POP3 with least number of parameters.
 *
 * @since 1.1.3
 */
public class PopSimpleEmailReceiveTest {
    ...
    public void setup() throws MessagingException {
        ...
        Path sourceFilePath = Paths.get("src", "test", "resources", "test-src", "PopSimpleEmailReceive.bal");
    ...
    public void testReceiveSimpleEmail() throws MessagingException, IOException {
        ...
        assertNotNull("No messages received with simple POP configuration.", returns);
