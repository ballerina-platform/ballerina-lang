...
public type Session object {
    ...
    # + return - Returns a text message or error incase of errors
    ...
    # + return - Returns a map message or error incase of errors
    ...
    # + return - Returns error unbsubscription fails
    ...
    #
    # + return - Returns JMS destination for a temporary queue or error if fails
    ...
    #
    # + return - Returns JMS destination for a temporary topic or error if fails
    ...
    # + return - Returns JMS destination for a queue or error if fails
    ...
    # + return - Returns JMS destination for a topic or error if fails
