...
@BallerinaFunction(
        ...
        functionName = "setFloatProperty",
        receiver = @Receiver(type = TypeKind.OBJECT,
                             structType = JmsConstants.MESSAGE_OBJ_NAME,
                             structPackage = JmsConstants.PROTOCOL_PACKAGE_JMS)
)
public class SetFloatProperty extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
    }

    public static Object setFloatProperty(Strand strand, ObjectValue msgObj, String key, double value) {
