...
public class GetExpiration extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
    }

    public static Object getExpiration(Strand strand, ObjectValue msgObj) {

        Message message = JmsUtils.getJMSMessage(msgObj);
        try {
            return message.getJMSExpiration();
        } catch (JMSException e) {
            return BallerinaAdapter.getError("Error when retrieving expiration time", e);
        }
    }
