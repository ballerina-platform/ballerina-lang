...
# Public Ballerina API - Ballerina RabbitMQ Message.
    ...
    @java:Method {
        class: "org.ballerinalang.messaging.rabbitmq.BasicAck"
    } external;
    ...
    # + return - An error if an I/O error is encountered or nil if successful.
    public remote function basicNack(boolean? multiple = false, boolean? requeue = true) returns Error? =
    @java:Method {
        class: "org.ballerinalang.messaging.rabbitmq.BasicNack"
    } external;
    ...
    @java:Method {
        class: "org.ballerinalang.messaging.rabbitmq.GetDeliveryTag"
    } external;
    ...
    @java:Method {
        class: "org.ballerinalang.messaging.rabbitmq.GetProperties"
    } external;
    ...
    @java:Method {
        class: "org.ballerinalang.messaging.rabbitmq.GetTextContent"
    } external;
    ...
    @java:Method {
        class: "org.ballerinalang.messaging.rabbitmq.GetIntContent"
    } external;
    ...
    @java:Method {
        class: "org.ballerinalang.messaging.rabbitmq.GetFloatContent"
    } external;
    ...
    @java:Method {
        class: "org.ballerinalang.messaging.rabbitmq.GetJSONContent"
    } external;
    ...
    @java:Method {
        class: "org.ballerinalang.messaging.rabbitmq.GetXMLContent"
    } external;
    ...
    @java:Method {
        class: "org.ballerinalang.messaging.rabbitmq.GetByteArrayContent"
    } external;
};
