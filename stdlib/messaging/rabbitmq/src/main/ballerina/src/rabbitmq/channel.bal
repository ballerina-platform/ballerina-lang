...
public type Channel client object {
    ...
    @java:Method {
        class: "org.ballerinalang.messaging.rabbitmq.QueueDeclare"
    } external;
    ...
    @java:Method {
        class: "org.ballerinalang.messaging.rabbitmq.ExchangeDeclare"
    } external;
    ...
    @java:Method {
        class: "org.ballerinalang.messaging.rabbitmq.QueueBind"
    } external;
    ...
    @java:Method {
        class: "org.ballerinalang.messaging.rabbitmq.BasicPublish"
    } external;
    ...
    # + return - An error if an I/O error is encountered or nil if successful.
    public remote function queueDelete(string queueName, boolean? ifUnused = (), boolean? ifEmpty = ()) returns Error? =
    @java:Method {
        class: "org.ballerinalang.messaging.rabbitmq.QueueDelete"
    } external;
    ...
    @java:Method {
        class: "org.ballerinalang.messaging.rabbitmq.ExchangeDelete"
    } external;
    ...
    @java:Method {
        class: "org.ballerinalang.messaging.rabbitmq.QueuePurge"
    } external;
    ...
    @java:Method {
        class: "org.ballerinalang.messaging.rabbitmq.AbortChannel"
    } external;
    ...
    @java:Method {
        class: "org.ballerinalang.messaging.rabbitmq.GetConnection"
    } external;

    private function createChannel(Connection? connection) =
    @java:Method {
        class: "org.ballerinalang.messaging.rabbitmq.CreateChannel"
    } external;
};
