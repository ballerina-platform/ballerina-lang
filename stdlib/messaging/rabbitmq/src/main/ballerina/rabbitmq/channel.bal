...
public type Channel client object {
    ...
    public remote function queueDeclare(QueueConfiguration? queueConfig = ())
                                        returns string | RabbitMQError? = external;
    ...
    public remote function exchangeDeclare(ExchangeConfiguration exchangeConfig) returns RabbitMQError? = external;
    ...
    public remote function basicPublish(@untainted MessageContent messageContent, string routingKey,
                        string exchangeName = "", BasicProperties? properties = ()) returns RabbitMQError? = external;
    ...
    public remote function exchangeDelete(string exchangeName) returns RabbitMQError? = external;

    # Purges the contents of the given queue.
    #
    # + queueName - The name of the queue.
    # + return - An error if an I/O error is encountered or nil if successful.
    public remote function queuePurge(string queueName) returns RabbitMQError? = external;
    ...
    public function close(int? closeCode = (), string? closeMessage = ()) returns RabbitMQError? = external;
    ...
    # + closeMessage - A message indicating the reason for closing the channel.
    # + return - An error if an I/O problem is encountered.
    public function abortChannel(int? closeCode = (), string? closeMessage = ()) returns RabbitMQError? = external;
    ...
    public function getConnection() returns Connection | RabbitMQError = external;
