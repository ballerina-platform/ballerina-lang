...
public type Channel client object {
    ...
    # + return - Returns an error if an I/O error is encountered or nil if successful.
    public remote extern function basicPublish(string message, string routingKey, string exchange = "") returns error?;
    ...
    public remote extern function queueDelete(string queueName) returns error?;

    # Deletes an exchange.
    #
    # + exchange - The name of the exchange.
    # + return - An I/O error if an error is encountered or nil otherwise.
    public remote extern function exchangeDelete(string exchange) returns error?;

    # Purges the contents of the given queue.
    #
    # + queueName - The name of the queue.
    # + return - An error if an I/O error is encountered or nil if successful.
    public remote extern function queuePurge(string queueName) returns error?;
};
