...
function testUnsubscribe() returns kafka:ConsumerError? {
    return kafkaConsumer->unsubscribe();
}

function testGetSubscribedTopicCount() returns int|error {
...
function testGetAvailableTopicsCount() returns int|error {
