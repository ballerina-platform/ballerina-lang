...
public class KafkaServiceCompilerTest {
    ...
    public void testKafkaServiceInvalidReturnType() {
        ...
        compileResult = BCompileUtil.compile(getFilePath("test-src/services/kafka_service_invalid_return_type.bal"));
    ...
    public void testKafkaServiceInvalidResourceName() {
        ...
        compileResult = BCompileUtil.compile(getFilePath("test-src/services/kafka_service_invalid_resource_name.bal"));
        validateCompilerErrors(compileResult, msg);
    }
    ...
    public void testKafkaServiceInvalidParameterType() {
        ...
        compileResult = BCompileUtil.compile(getFilePath("test-src/services/kafka_service_invalid_parameter_type.bal"));
        validateCompilerErrors(compileResult, msg);
    }
    ...
    public void testKafkaServiceValidateCustomErrorType() {
        compileResult = BCompileUtil.compile(
                getFilePath("test-src/services/kafka_service_custom_error_return_type_validation.bal"));
    ...
    public void testKafkaServiceMoreThanOneResource() {
        ...
        compileResult = BCompileUtil.compile(getFilePath("test-src/services/kafka_service_more_than_one_resource.bal"));
        validateCompilerErrors(compileResult, msg);
    }
