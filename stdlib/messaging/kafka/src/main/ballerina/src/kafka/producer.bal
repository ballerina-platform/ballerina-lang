...
public type Producer client object {
    ...
    public remote function commitConsumer(Consumer consumer) returns ProducerError? {
        return externCommitConsumer(self, consumer);
    }
    ...
    public remote function commitConsumerOffsets(PartitionOffset[] offsets, string groupID) returns ProducerError? {
        return externCommitConsumerOffsets(self, offsets, java:fromString(groupID));
    }
    ...
    public remote function flushRecords() returns ProducerError? {
        return externFlushRecords(self);
    }
    ...
    public remote function getTopicPartitions(string topic) returns TopicPartition[]|ProducerError {
        return externGetTopicPartitions(self, java:fromString(topic));
    }
    ...
    public remote function send(byte[] value, string topic, public byte[]? key = (), public int? partition = (),
        ...
        return externSend(self, value, java:fromString(topic), key, partition, timestamp);
    }

};

function externInit(Producer producer, ProducerConfig config) returns error? =
@java:Method {
    class: "org.ballerinalang.messaging.kafka.nativeimpl.producer.Init"
} external;

function externClose(Producer producer) returns ProducerError? =
@java:Method {
    class: "org.ballerinalang.messaging.kafka.nativeimpl.producer.Close"
} external;

function externCommitConsumer(Producer producer, Consumer consumer) returns ProducerError? =
@java:Method {
    class: "org.ballerinalang.messaging.kafka.nativeimpl.producer.CommitConsumer"
} external;

function externCommitConsumerOffsets(Producer producer, PartitionOffset[] offsets, handle groupID)
returns ProducerError? =
@java:Method {
    class: "org.ballerinalang.messaging.kafka.nativeimpl.producer.CommitConsumerOffsets"
} external;

function externFlushRecords(Producer producer) returns ProducerError? =
@java:Method {
    class: "org.ballerinalang.messaging.kafka.nativeimpl.producer.FlushRecords"
} external;

function externGetTopicPartitions(Producer producer, handle topic) returns TopicPartition[]|ProducerError =
@java:Method {
    class: "org.ballerinalang.messaging.kafka.nativeimpl.producer.GetTopicPartitions"
} external;

function externSend(Producer producer, byte[] value, handle topic, public byte[]? key = (), public int? partition = (),
public int? timestamp = ()) returns ProducerError? =
@java:Method {
