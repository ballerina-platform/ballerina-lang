...
public class ReadInt16 {

    public static Object readInt16(Strand strand, ObjectValue dataChannelObj) {
        ...
        Register register = EventRegister.getFactory().register(event, ReadInt16::readChannelResponse);
