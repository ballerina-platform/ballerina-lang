...
@BallerinaFunction(
        ...
        receiver = @Receiver(type = TypeKind.OBJECT,
                structType = "ReadableDataChannel",
                structPackage = "ballerina/io"),
        args = {@Argument(name = "channel", type = TypeKind.OBJECT, structType = "ReadableByteChannel",
                structPackage = "ballerina/io"),
                @Argument(name = "order", type = TypeKind.STRING)
        },
        isPublic = true
)
public class CreateReadableDataChannel extends BlockingNativeCallableUnit {
