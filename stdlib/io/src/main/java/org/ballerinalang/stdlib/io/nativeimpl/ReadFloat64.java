...
public class ReadFloat64 implements NativeCallableUnit {
    ...
    public void execute(Context context, CallableUnitCallback callback) {
        ...
        Register register = EventRegister.getFactory().register(event, ReadFloat64::readResponse);
    ...
    public static void readFloat64(Strand strand, ObjectValue dataChannelObj) {
