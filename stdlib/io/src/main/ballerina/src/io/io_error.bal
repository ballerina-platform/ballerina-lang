...
public type ConnectionTimedOutError distinct error<Detail>;
...
public type AccessDeniedError distinct error<Detail>;
...
public type FileNotFoundError distinct error<Detail>;

# This will be used to construct an EofError.
public const END_OF_FILE_ERROR = "{ballerina/io}EofError";
# This will get returned if read operations are performed on a channel after it closed.
public type EofError distinct error<Detail>;
