...
public class BMirrorTable extends BTable {
    ...
    public BMirrorTable(SQLDatasource datasource, String tableName, BStructureType constraintType, StructureTypeInfo
            timeStructInfo, StructureTypeInfo timeZoneStructInfo, Calendar utcCalendar) {
