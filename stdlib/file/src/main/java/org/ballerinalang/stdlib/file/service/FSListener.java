...
public class FSListener implements LocalFileSystemListener {
    ...
    private Map<String, MethodTypes> attachedFunctionRegistry;
    ...
    public FSListener(Runtime runtime, BObject service, Map<String, MethodTypes> resourceRegistry) {
    ...
    public void onMessage(LocalFileSystemEvent fileEvent) {
        ...
        MethodTypes resource = getAttachedFunctionType(fileEvent.getEvent());
        if (resource != null) {
    ...
    private MethodTypes getAttachedFunctionType(String event) {
