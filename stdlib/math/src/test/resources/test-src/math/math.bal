...
function randomInRangeTest (int a, int b) returns (int|error) {
...
function floorDivTest (int a, int b) returns (int|Error) {
    return math:floorDiv(a, b);
}

function floorModTest (int a, int b) returns (int|Error) {
...
function negateExactTest (int value) returns (int|Error) {
