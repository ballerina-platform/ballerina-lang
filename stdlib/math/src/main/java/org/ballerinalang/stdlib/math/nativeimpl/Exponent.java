...
public class Exponent extends BlockingNativeCallableUnit {

    public void execute(Context ctx) {
        double value = ctx.getFloatArgument(0);
        ctx.setReturnValues(new BInteger(Math.getExponent(value)));
    }

    public static long getExponent(Strand strand, double value) {
