...
/**
 * Extern function ballerina.math:toDegrees.
 *
 * @since 0.94
 */
@BallerinaFunction(
...
public class ToDegrees extends BlockingNativeCallableUnit {
    ...
    public static double toDegrees(Strand strand, double value) {
