...
/**
 * Extern function ballerina.math:nextDown.
 *
 * @since 0.94
 */
@BallerinaFunction(
...
public class NextDown extends BlockingNativeCallableUnit {
    ...
    public static double nextDown(Strand strand, double value) {
