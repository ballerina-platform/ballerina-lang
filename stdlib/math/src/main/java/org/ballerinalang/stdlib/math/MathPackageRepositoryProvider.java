 ...
 * under the License.
 */
package org.ballerinalang.stdlib.math;
...
/**
 * A package repository provider for ballerina/math package.
 *
 * @since 0.972.0
 */
@JavaSPIService("org.ballerinalang.spi.SystemPackageRepositoryProvider")
public class MathPackageRepositoryProvider implements SystemPackageRepositoryProvider {
