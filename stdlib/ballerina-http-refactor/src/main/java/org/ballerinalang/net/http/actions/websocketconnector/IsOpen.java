...
public class IsOpen extends AbstractNativeAction {

    private static final Logger logger = LoggerFactory.getLogger(IsOpen.class);
    ...
    public ConnectorFuture execute(Context context) {
        ...
        connectorFuture.notifyReply(new BBoolean(isOpen));
