...
public final class ServerCalls {
    ...
    public static void asyncUnimplementedUnaryCall(MethodDescriptor<?, ?> methodDescriptor,
        ...
        if (methodDescriptor == null) {
            throw new RuntimeException("methodDescriptor cannot be null");
        }
        if (responseObserver == null) {
            throw new RuntimeException("responseObserver cannot be null");
        }
        responseObserver.onError(Status.Code.UNIMPLEMENTED.toStatus()
