...
function testLocalTransacton () returns (int, int) {
    ...
    table dt = check testDB -> select("Select COUNT(*) as countval from Customers where registrationID = 200", null,
                                 typeof ResultCount);
    while (dt.hasNext()) {
...
function testTransactonRollback () returns (int, int) {
    ...
    //check whether update action is performed
    table dt = check testDB -> select("Select COUNT(*) as countval from Customers where registrationID = 210", null,
                                 typeof ResultCount);
    while (dt.hasNext()) {
        var rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
...
function testTransactonAbort () returns (int, int) {
    ...
    //check whether update action is performed
    table dt = check testDB -> select("Select COUNT(*) as countval from Customers where registrationID = 220", null,
                                 typeof ResultCount);
    while (dt.hasNext()) {
        var rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
...
function testTransactonErrorThrow () returns (int, int, int) {
    ...
    //check whether update action is performed
    table dt = check testDB -> select("Select COUNT(*) as countval from Customers where registrationID = 260", null,
                                 typeof ResultCount);
    while (dt.hasNext()) {
        var rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
...
function testTransactionErrorThrowAndCatch () returns (int, int, int) {
    ...
    //check whether update action is performed
    table dt = check testDB -> select("Select COUNT(*) as countval from Customers where registrationID = 250", null,
                                 typeof ResultCount);
    while (dt.hasNext()) {
        var rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
...
function testTransactonCommitted () returns (int, int) {
    ...
    //check whether update action is performed
    table dt = check testDB -> select("Select COUNT(*) as countval from Customers where registrationID = 300", null,
                                 typeof ResultCount);
    while (dt.hasNext()) {
        var rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
...
function testTwoTransactons () returns (int, int, int) {
    ...
    //check whether update action is performed
    table dt = check testDB -> select("Select COUNT(*) as countval from Customers where registrationID = 400", null,
                                 typeof ResultCount);
    while (dt.hasNext()) {
        var rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
...
function testTransactonWithoutHandlers () returns (int) {
    ...
    int count;
    //check whether update action is performed
    table dt = check testDB -> select("Select COUNT(*) as countval from Customers where
...
function testLocalTransactionFailed () returns (string, int) {
    ...
    a = a + " afterTrx";
    table dt = check testDB -> select("Select COUNT(*) as countval from Customers where registrationID = 111", null,
                                 typeof ResultCount);
    while (dt.hasNext()) {
        var rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
...
function testLocalTransactonSuccessWithFailed () returns (string, int) {
    ...
    a = a + " afterTrx";
    table dt = check testDB -> select("Select COUNT(*) as countval from Customers where registrationID = 222", null,
                                 typeof ResultCount);
    while (dt.hasNext()) {
        var rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
...
function testLocalTransactonFailedWithNextupdate () returns (int) {
    ...
    table dt = check testDB2 -> select("Select COUNT(*) as countval from Customers where registrationID = 12343", null,
                                  typeof ResultCount);
    while (dt.hasNext()) {
        var rs = check <ResultCount>dt.getNext();
        i = rs.COUNTVAL;
...
function testNestedTwoLevelTransactonSuccess () returns (int, int) {
    ...
    //check whether update action is performed
    table dt = check testDB -> select("Select COUNT(*) as countval from Customers where registrationID = 333", null,
                             typeof ResultCount);
    while (dt.hasNext()) {
        var rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
...
function testNestedThreeLevelTransactonSuccess () returns (int, int) {
    ...
    //check whether update action is performed
    table dt = check testDB -> select("Select COUNT(*) as countval from Customers where registrationID = 444", null,
                             typeof ResultCount);
    while (dt.hasNext()) {
        var rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
...
function testNestedThreeLevelTransactonFailed () returns (int, int) {
    ...
    //check whether update action is performed
    table dt = check testDB -> select("Select COUNT(*) as countval from Customers where registrationID = 555", null,
                             typeof ResultCount);
    while (dt.hasNext()) {
        var rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
...
function testNestedThreeLevelTransactonFailedWithRetrySuccess () returns (int, int, string) {
    ...
    //check whether update action is performed
    table dt = check testDB -> select("Select COUNT(*) as countval from Customers where registrationID = 666", null,
                             typeof ResultCount);
    while (dt.hasNext()) {
        var rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
...
function testTransactionWithWorkers () returns (int) {
    ...
    //check whether update action is performed
    int count;
    table dt = check testDB -> select("Select COUNT(*) as countval from Customers where registrationID = 834", null,
                                 typeof ResultCount);
    while (dt.hasNext()) {
        var rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
