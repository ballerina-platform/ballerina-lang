...
function testLocalTransacton() returns (int, int) {
    ...
    var temp = testDB->select("Select COUNT(*) as countval from Customers where registrationID = 200", ResultCount, false);
    table dt = check temp;
    while (dt.hasNext()) {
...
function testTransactonRollback() returns (int, int) {
    ...
    //check whether update action is performed
    var temp = testDB->select("Select COUNT(*) as countval from Customers where registrationID = 210", ResultCount, false);
    table dt = check temp;
...
function testTransactonAbort() returns (int, int) {
    ...
    //check whether update action is performed
    var temp = testDB->select("Select COUNT(*) as countval from Customers where registrationID = 220", ResultCount, false);
    var dt = check temp;
    while (dt.hasNext()) {
        var rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
...
function testTransactonErrorThrow() returns (int, int, int) {
    ...
    //check whether update action is performed
    var temp = testDB->select("Select COUNT(*) as countval from Customers where registrationID = 260", ResultCount, false);
    table dt = check temp;
    while (dt.hasNext()) {
        var rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
...
function testTransactionErrorThrowAndCatch() returns (int, int, int) {
    ...
    //check whether update action is performed
    var temp = testDB->select("Select COUNT(*) as countval from Customers where registrationID = 250", ResultCount, false);
    table dt = check temp;
    while (dt.hasNext()) {
...
function testTransactonCommitted() returns (int, int) {
    ...
    //check whether update action is performed
    var temp = testDB->select("Select COUNT(*) as countval from Customers where registrationID = 300", ResultCount, false);
    table dt = check temp;
    while (dt.hasNext()) {
        ResultCount rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
...
function testTwoTransactons() returns (int, int, int) {
    ...
    //check whether update action is performed
    var temp = testDB->select("Select COUNT(*) as countval from Customers where registrationID = 400", ResultCount, false);
    table dt = check temp;
    while (dt.hasNext()) {
        ResultCount rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
...
function testLocalTransactionFailed() returns (string, int) {
    ...
    a = a + " afterTrx";
    var temp = testDB->select("Select COUNT(*) as countval from Customers where registrationID = 111", ResultCount, false);
    table dt = check temp;
    while (dt.hasNext()) {
        ResultCount rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
...
function testLocalTransactonSuccessWithFailed() returns (string, int) {
    ...
    a = a + " afterTrx";
    var temp = testDB->select("Select COUNT(*) as countval from Customers where registrationID = 222", ResultCount, false);
    table dt = check temp;
    while (dt.hasNext()) {
        ResultCount rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
...
function testLocalTransactonFailedWithNextupdate() returns (int) {
    ...
    var temp = testDB2->select("Select COUNT(*) as countval from Customers where registrationID = 12343", ResultCount, false);
    table dt = check temp;
    while (dt.hasNext()) {
        ResultCount rs = check <ResultCount>dt.getNext();
        i = rs.COUNTVAL;
...
function testNestedTwoLevelTransactonSuccess() returns (int, int) {
    ...
    //check whether update action is performed
    var temp = testDB->select("Select COUNT(*) as countval from Customers where registrationID = 333", ResultCount, false);
    table dt = check temp;
    while (dt.hasNext()) {
        ResultCount rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
...
function testNestedThreeLevelTransactonSuccess() returns (int, int) {
    ...
    //check whether update action is performed
    var temp = testDB->select("Select COUNT(*) as countval from Customers where registrationID = 444", ResultCount, false);
    table dt = check temp;
    while (dt.hasNext()) {
        ResultCount rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
...
function testNestedThreeLevelTransactonFailed() returns (int, int) {
    ...
    //check whether update action is performed
    var temp = testDB->select("Select COUNT(*) as countval from Customers where registrationID = 555", ResultCount, false);
    table dt = check temp;
    while (dt.hasNext()) {
        ResultCount rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
...
function testNestedThreeLevelTransactonFailedWithRetrySuccess() returns (int, int, string) {
    ...
    //check whether update action is performed
    var temp = testDB->select("Select COUNT(*) as countval from Customers where registrationID = 666", ResultCount, false);
    table dt = check temp;
    while (dt.hasNext()) {
        ResultCount rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
...
function testTransactionWithWorkers() returns (int) {
    ...
    //check whether update action is performed
    int count;
    var temp = testDB->select("Select COUNT(*) as countval from Customers where registrationID = 834", ResultCount, false);
    table dt = check temp;
    while (dt.hasNext()) {
        ResultCount rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
...
function testCloseConnectionPool() returns (int) {
    ...
    int count;
    var temp = testDB->select("SELECT COUNT(*) as countVal FROM INFORMATION_SCHEMA.SYSTEM_SESSIONS", ResultCount, false);
    table dt = check temp;
    while (dt.hasNext()) {
        ResultCount rs = check <ResultCount>dt.getNext();
        count = rs.COUNTVAL;
