...
function testOutParameters () (any, any, any, any, any, any, any, any, any, any, any, any, any, any) {
    ...
    _ = testDB.callQuery("{call TestOutParams(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}", parameters, null);
    testDB.close();
...
function testINOutParameters () (any, any, any, any, any, any, any, any, any, any, any, any, any, any) {
    ...
    sql:Parameter[] parameters = [paraID, paraInt, paraLong, paraFloat, paraDouble, paraBool, paraString, paraNumeric,
                                  paraDecimal, paraReal, paraTinyInt, paraSmallInt, paraClob, paraBlob, paraBinary];
    _ = testDB.callQuery("{call TestINOUTParams(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}", parameters, null);
    testDB.close();
    return paraInt.value, paraLong.value, paraFloat.value, paraDouble.value, paraBool.value, paraString.value,
           paraNumeric.value, paraDecimal.value, paraReal.value, paraTinyInt.value, paraSmallInt.value, paraClob.value,
           paraBlob.value, paraBinary.value;
...
function testArrayOutParameters () (any, any, any, any, any, any) {
    ...
    _ = testDB.callQuery("{call TestArrayOutParams(?,?,?,?,?,?)}", parameters, null);
    testDB.close();
...
function testArrayInOutParameters () (any, any, any, any, any, any, any) {
    ...
    _ = testDB.callQuery("{call TestArrayInOutParams(?,?,?,?,?,?,?,?)}", parameters, null);
    testDB.close();
...
function testBatchUpdateWithFailure () (int[] updateCount, int count) {
    ...
    table dt = testDB.selectQuery("SELECT count(*) as countval from Customers where customerId in (111,222,333)", null, typeof ResultCount);
    while (dt.hasNext()) {
...
function testDateTimeNullOutValues () (int count) {
    ...
    _ = testDB.callQuery("{call TestDateTimeOutParams(?,?,?,?,?,?,?,?,?)}", parameters, null);

    table dt = testDB.selectQuery("SELECT count(*) as countval from DateTimeTypes where row_id = 123", null,
                                 typeof ResultCount);
    while (dt.hasNext()) {
        var rs, _ = (ResultCount)dt.getNext();
        count = rs.COUNTVAL;
...
function testDateTimeNullInOutValues () (any, any, any, any) {
    ...
    _ = testDB.callQuery("{call TestDateINOUTParams(?,?,?,?,?)}", parameters, null);
    testDB.close();
...
function testSelectIntFloatData () (int int_type, int long_type, float float_type, float double_type) {
    ...
    table dt = testDB.selectQuery("SELECT  int_type, long_type, float_type, double_type from DataTypeTable
...
function testSelectData () (string firstName) {
    ...
    table dt = testDB.selectQuery("SELECT  FirstName from Customers where registrationID = 1", null,
...
function testCallProcedure () (string firstName) {
    ...
    _ = testDB.callQuery("{call InsertPersonData(100,'James')}", null, null);
    table dt = testDB.selectQuery("SELECT  FirstName from Customers where registrationID = 100", null,
                                 typeof ResultCustomers);
    while (dt.hasNext()) {
        var rs, err = (ResultCustomers)dt.getNext();
        firstName = rs.FIRSTNAME;
...
function testCallProcedureWithResultSet () (string firstName) {
    ...
    table dt = testDB.callQuery("{call SelectPersonData()}", null, typeof ResultCustomers);
    while (dt.hasNext()) {
        var rs, err = (ResultCustomers)dt.getNext();
        firstName = rs.FIRSTNAME;
    }
...
function testQueryParameters () (string firstName) {
    ...
    sql:Parameter[] parameters = [para1];
    table dt = testDB.selectQuery("SELECT  FirstName from Customers where registrationID = ?", parameters,
                                 typeof ResultCustomers);
    while (dt.hasNext()) {
        var rs, err = (ResultCustomers)dt.getNext();
        firstName = rs.FIRSTNAME;
...
function testArrayofQueryParameters () (string firstName) {
    ...
    table dt = testDB.selectQuery("SELECT  FirstName from Customers where FirstName = ? or lastName = 'A' or
...
function testBoolArrayofQueryParameters () (int value) {
    ...
    table dt1 = testDB.selectQuery("SELECT blob_type from DataTypeTable where row_id = 1", null, typeof ResultBlob);
    blob blobData;
    while (dt1.hasNext()) {
    ...
    table dt = testDB.selectQuery("SELECT  int_type from DataTypeTable where row_id = ? and boolean_type in(?) and
...
function testArrayInParameters () (int insertCount, map int_arr, map long_arr, map double_arr, map string_arr,
    ...
    table dt = testDB.selectQuery("SELECT int_array, long_array, double_array, boolean_array,
...
function testDateTimeOutParams (int time, int date, int timestamp) (int count) {
    ...
    table dt = testDB.selectQuery("SELECT count(*) as countval from DateTimeTypes where row_id = 10", null,
                                 typeof ResultCount);
    while (dt.hasNext()) {
        var rs, _ = (ResultCount)dt.getNext();
        count = rs.COUNTVAL;
...
function testStructOutParameters () (any) {
    ...
    sql:Parameter[] parameters = [para1];
    _ = testDB.callQuery("{call TestStructOut(?)}", parameters, null);
    testDB.close();
    return para1.value;
}
...
function testComplexTypeRetrieval () (string s1, string s2, string s3, string s4) {
    ...
    table dt = testDB.selectQuery("SELECT * from DataTypeTable where row_id = 1", null, null);
    var x, _ = <xml>dt;
    s1 = <string>x;

    dt = testDB.selectQuery("SELECT * from DateTimeTypes where row_id = 1", null, null);
    x, _ = <xml>dt;
    s2 = <string>x;

    dt = testDB.selectQuery("SELECT * from DataTypeTable where row_id = 1", null, null);
    var j, _ = <json>dt;
    s3 = j.toString();
