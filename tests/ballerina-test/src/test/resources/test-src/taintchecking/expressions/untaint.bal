...
function untaintWithAddOperatorInReturn (string[] args) (string) {
    string data1 = "input1";
    string data2 = "input2";
    return untaint (data1 + data2 + args[0] + "input3" + globalvariable);
}

function untaintWithAddOperatorWithVariable (string[] args) (string) {
    string data1 = "input1";
    string data2 = "input2";
...
function untaintWithFunctionParam (string[] args) (string) {
    string data1 = "input1";
    string data2 = "input2";
    return returnInput(untaint (data1 + data2 + args[0] + "input3" + globalvariable));
}

function untaintWithFunctionReturn (string[] args) (string) {
    string data1 = "input1";
    string data2 = "input2";
    return untaint returnInput(data1 + data2 + args[0] + "input3" + globalvariable);
}

function untaintWithReceiver (string[] args) (string) {
    string data1 = "input1";
    string data2 = "input2";
