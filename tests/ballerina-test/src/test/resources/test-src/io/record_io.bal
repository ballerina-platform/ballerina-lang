...
function initDelimitedRecordChannel(string filePath, io:Mode permission, string encoding, string rs, string fs) {
    ...
    txtChannel = new io:DelimitedTextRecordChannel(charChannel, fs, rs);
}
