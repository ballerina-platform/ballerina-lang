...
public class BuiltinLoadingTest {
    ...
    public void testRedeclaredSymbols() {
        ...
        BAssertUtil.validateError(result, 0, "redeclared builtin symbol 'Time'", 29, 1);
        BAssertUtil.validateError(result, 1, "redeclared builtin symbol 'error'", 5, 1);
        BAssertUtil.validateError(result, 2, "redeclared builtin symbol 'println'", 9, 1);
        BAssertUtil.validateError(result, 3, "function 'getMessage' defined on non-local type 'error'", 20, 11);
        BAssertUtil.validateError(result, 4, "redeclared builtin symbol 'Time'", 17, 5);
        BAssertUtil.validateError(result, 5, "break cannot be used outside of a loop", 2, 5);
    }
}
