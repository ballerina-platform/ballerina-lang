...
public class StructWithPrivateFieldsNegativeTest {
    ...
    public void testPrivateStructAccess1() {
        CompileResult compileResult = BCompileUtil.compile(
                "test-src/structs/struct-private-fields-03-negative.bal");
        ...
        BAssertUtil.validateError(compileResult, 2, expectedErrMsg + "'ChildFoo'", 4, 33);
        BAssertUtil.validateError(compileResult, 3, expectedErrMsg + "'ChildFoo'", 4, 33);
        BAssertUtil.validateError(compileResult, 4, expectedErrMsg + "'privatePerson'", 8, 13);
        BAssertUtil.validateError(compileResult, 5, expectedErrMsg + "'privatePerson'", 12, 43);
    ...
    public void testPrivateStructAccess2() {
        CompileResult compileResult = BCompileUtil.compile(
                "test-src/structs/struct-private-fields-04-negative.bal");
