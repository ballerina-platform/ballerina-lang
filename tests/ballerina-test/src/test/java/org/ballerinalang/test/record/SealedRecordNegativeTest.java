...
/**
 * Negative test cases for sealed records.
 */
public class SealedRecordNegativeTest {
    ...
    public void testInvalidRestField() {
        ...
        BAssertUtil.validateError(result, 0, "rest field not allowed in sealed records", 4, 5);
    }
