...
public class SimpleConstantNegativeTest {
    ...
    public void testNegative() {
        ...
        BAssertUtil.validateError(compileResult, index++, "incompatible types: expected 'int', found '()'",
                offset += 6, 24);
        BAssertUtil.validateError(compileResult, index++, "not a constant expression", offset += 4, 33);
        BAssertUtil.validateError(compileResult, index++, "not a constant expression", offset += 1, 33);
