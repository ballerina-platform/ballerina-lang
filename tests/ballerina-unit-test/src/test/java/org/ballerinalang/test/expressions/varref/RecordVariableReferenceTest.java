...
public class RecordVariableReferenceTest {
    ...
    @BeforeClass
    public void setup() {
        result = BCompileUtil.compile("test-src/expressions/varref/record_variable_reference.bal");
        resultNegative = BCompileUtil.compile("test-src/expressions/varref/record_variable_reference_negative.bal");
    }
