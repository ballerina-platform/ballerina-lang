...
public class ReturnStmtNegativeTest {
    ...
    public void testNotEnoughArgsToReturn1() {
        ...
        BAssertUtil.validateError(result, 0, "incompatible return types: expected '(int,int)', found '()'", 2, 5);
    }
    ...
    public void testNotEnoughArgsToReturn2() {
        ...
        Assert.assertEquals(result.getErrorCount(), 1);
        BAssertUtil.validateError(result, 0, "incompatible return types: expected '(string,string)', found 'string'", 2, 12);
    }
    ...
    public void testTooManyArgsToReturn2() {
        ...
        Assert.assertEquals(result.getErrorCount(), 1);
        BAssertUtil.validateError(result, 0, "incompatible return types: expected 'string', found '(string,string)'", 2, 12);
    }
    ...
    public void testInputTypeMismatch1() {
        ...
        BAssertUtil.validateError(result,
                0, "incompatible return types: expected '(string,int,string)', found '(string,string,string)'",
                2, 12);
    }
    ...
    public void testInputTypeMismatch2() {
        ...
        Assert.assertEquals(result.getErrorCount(), 1);
        BAssertUtil.validateError(result, 0, "incompatible return types: expected 'boolean', found 'int'", 2, 26);
    }
    ...
    public void testMultiValueInSingleContext() {
        ...
        Assert.assertEquals(result.getErrorCount(), 1);
        BAssertUtil.validateError(result, 0, "incompatible return types: expected 'string', found '(string,int)'", 2, 13);
    }
    ...
    public void testReturnInResourceWithMismatchingTypes() {
        ...
        Assert.assertEquals(result.getErrorCount(), 3);
        BAssertUtil.validateError(result, 0, "incompatible return types: expected 'string', found 'int'", 22, 16);
        BAssertUtil.validateError(result, 1, "incompatible return types: expected 'int', found 'string'", 26, 16);
        BAssertUtil.validateError(result, 2, "incompatible return types: expected '()', found 'string'", 30, 16);
    }
}
