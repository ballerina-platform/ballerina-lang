...
public class TaintedStatusPropagationTest {
    ...
    public void testIterableNegative() {
        ...
        Assert.assertTrue(result.getDiagnostics().length == 2);
        BAssertUtil.validateError(result, 0, "tainted value passed to sensitive parameter 'secureIn'", 3, 20);
        BAssertUtil.validateError(result, 1, "tainted value passed to sensitive parameter 'secureIn'", 5, 67);
    }
    ...
    public void testIterableWitinIterableNegative() {
        ...
        BAssertUtil.validateError(result, 1, "tainted value passed to global variable 'globalVar'", 10, 42);
    }
