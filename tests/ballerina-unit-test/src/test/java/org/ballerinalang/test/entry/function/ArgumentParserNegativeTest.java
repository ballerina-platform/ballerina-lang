...
public class ArgumentParserNegativeTest {
    ...
    public void testInsufficientArgs() {
        ...
        try {
            ...
            Assert.assertTrue(e.getMessages().contains("usage error: insufficient arguments to call entry function '"
                                                               + functionName + "'"),
    ...
    public void testInvalidIntArg(String arg) {
        ...
        try {
            ...
            Assert.assertTrue(e.getMessages().contains("usage error: invalid argument '" + arg + "', expected integer "
                                                               + "value"),
    ...
    public void testNonPublicFunctionAsEntryFunction() {
        ...
        try {
            ...
            Assert.assertTrue(e.getMessages().contains("non public function '" + functionName
    ...
    public void testInvalidFloatArg() {
        ...
        try {
            ...
            Assert.assertTrue(e.getMessages().contains("usage error: invalid argument '" + argument
    ...
    public void testInvalidByteArg(String arg) {
        ...
        try {
            ...
            Assert.assertTrue(e.getMessages().contains("usage error: invalid argument '" + arg
                                                               + "', expected byte value"),
    ...
    public void testSensitiveParamedFunction(String functionName) {
        try {
            ...
            Assert.assertTrue(e.getMessages().contains("usage error: function with sensitive parameters cannot be"
