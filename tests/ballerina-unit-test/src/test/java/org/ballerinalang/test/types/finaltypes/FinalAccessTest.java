...
public class FinalAccessTest {
    ...
    public void testFinalFailCase() {
        ...
        BAssertUtil.validateError(compileResultNegative, 2, "cannot assign a value to final 'bar:globalBarString'",
                12, 5);
        BAssertUtil.validateError(compileResultNegative, 3, "cannot assign a value to function argument 'a'", 24, 5);
        ...
        BAssertUtil.validateError(compileResultNegative, 9, "cannot assign a value to function argument 'a'", 43, 5);
    }
