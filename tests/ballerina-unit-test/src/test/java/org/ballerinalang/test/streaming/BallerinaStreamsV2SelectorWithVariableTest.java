...
/**
 * This contains methods to test external variable in select clause in Ballerina Streaming V2.
 *
 * @since 0.980.0
 */
public class BallerinaStreamsV2SelectorWithVariableTest {
    ...
    public void setup() {
        ...
        result = BCompileUtil.compile("test-src/streaming/streamingv2-select-with-variable-test.bal");
    }
    ...
    public void testSelectQuery() {
        ...
        Assert.assertEquals(((BInteger) employee0.get("age")).intValue(), 40);
        Assert.assertEquals(employee1.get("teacherName").stringValue(), "Mohan");
        Assert.assertEquals(((BInteger) employee1.get("age")).intValue(), 40);
        Assert.assertEquals(employee2.get("teacherName").stringValue(), "Shareek");
        Assert.assertEquals(((BInteger) employee2.get("age")).intValue(), 40);
    }
}
