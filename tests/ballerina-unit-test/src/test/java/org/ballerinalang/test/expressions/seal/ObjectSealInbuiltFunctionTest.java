...
/**
 * Test cases for sealing Object type variables.
 *
 * @since 0.983.0
 */
public class ObjectSealInbuiltFunctionTest {

    private CompileResult compileResult;

    @BeforeClass
    public void setup() {
        compileResult = BCompileUtil.compile("test-src/expressions/seal/object-seal-expr-test.bal");
    }
