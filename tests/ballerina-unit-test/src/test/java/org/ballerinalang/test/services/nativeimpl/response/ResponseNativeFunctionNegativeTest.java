...
public class ResponseNativeFunctionNegativeTest {
    ...
    public void testGetTextPayloadNegative() {
        ...
        Assert.assertTrue(returnVals[0].stringValue()
                .contains("Error occurred while retrieving text" + "  from entity : String payload is null"));
    }
    ...
    public void testGetXmlPayloadNegative() {
        ...
        Assert.assertTrue(errMsg.contains("Error occurred while retrieving xml  from entity : Empty xml payload"));
    }
