 ...
 */
public class RecordConstantInBaloTest {
    ...
    public void setup() {
        ...
        compileResult = BCompileUtil.compile("test-src/balo/test_balo/constant/record-constant.bal");
    }
    ...
    public void testBooleanConstKeyReference() {
        ...
        Assert.assertNotNull(returns[0]);
        Assert.assertEquals(returns[0].stringValue(), "{\"br5kn\":true}");
    }
    ...
    public void testIntConstKeyReference() {
        ...
        Assert.assertNotNull(returns[0]);
        Assert.assertEquals(returns[0].stringValue(), "{\"ir5kn\":123}");
    }
    ...
    public void testByteConstKeyReference() {
        ...
        Assert.assertNotNull(returns[0]);
        Assert.assertEquals(returns[0].stringValue(), "{\"byter5kn\":64}");
    }
    ...
    public void testFloatConstKeyReference() {
        ...
        Assert.assertNotNull(returns[0]);
        Assert.assertEquals(returns[0].stringValue(), "{\"fr5kn\":12.5}");
    }
    ...
    public void testDecimalConstKeyReference() {
        ...
        Assert.assertNotNull(returns[0]);
        Assert.assertEquals(returns[0].stringValue(), "{\"dr5kn\":5.56}");
    }
    ...
    public void testStringConstKeyReference() {
        ...
        Assert.assertNotNull(returns[0]);
        Assert.assertEquals(returns[0].stringValue(), "{\"sr5kn\":\"sr4v\"}");
    }
    ...
    public void testNullConstKeyReference() {
        ...
        Assert.assertNotNull(returns[0]);
        Assert.assertEquals(returns[0].stringValue(), "{\"nr5kn\":()}");
    }
    ...
    public void testStringConstKeyReferenceInLocalVar() {
        ...
        Assert.assertNotNull(returns[0]);
        Assert.assertEquals(returns[0].stringValue(), "sr4v");
    }
    ...
    public void testConstInAnnotations() {
        ...
        Assert.assertNotNull(returns[0]);
        Assert.assertEquals(returns[0].stringValue(), "{name:\"recordTestAnnotation\", moduleName:\"testorg/foo\", " +
