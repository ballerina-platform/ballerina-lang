...
public class BNullValueTest {
    ...
    void testNullValueNegative() {
        ...
        BAssertUtil.validateError(result, 2, "null literal can only be used in JSON related contexts", 20, 20);
        BAssertUtil.validateError(result, 3, "null literal can only be used in JSON related contexts", 20, 13);
        BAssertUtil.validateError(result, 4, "operator '+' not defined for '()' and '()'", 20, 13);
