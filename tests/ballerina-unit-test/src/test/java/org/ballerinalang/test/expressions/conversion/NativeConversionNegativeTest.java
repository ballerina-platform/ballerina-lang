...
public class NativeConversionNegativeTest {
    ...
    public void testStructToJsonConstrained1() {
        BAssertUtil.validateError(negativeCompileResult, 3, "incompatible types: 'Person' cannot be converted to "
                + "'json<Person2>'", 72, 23);
    }

    @Test
    public void testStructToJsonConstrainedNegative() {
        BAssertUtil.validateError(negativeCompileResult, 4, "incompatible types: 'Person2' cannot be converted to "
                + "'json<Person3>'", 81, 18);
    }
