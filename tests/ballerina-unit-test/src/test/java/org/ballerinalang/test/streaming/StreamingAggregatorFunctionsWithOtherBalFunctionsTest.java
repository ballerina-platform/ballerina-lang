 ...
 * @since 0.980.0
 */
public class StreamingAggregatorFunctionsWithOtherBalFunctionsTest {
    ...
    public void testQuery() {
        ...
        Assert.assertEquals(((BInteger) teacher0.get("age")).intValue(), 900);
        ...
        Assert.assertEquals(((BInteger) teacher1.get("age")).intValue(), 2025);
        ...
        Assert.assertEquals(((BInteger) teacher2.get("age")).intValue(), 2025);
        ...
        Assert.assertEquals(((BInteger) teacher3.get("age")).intValue(), 900);
