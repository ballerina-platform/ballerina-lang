...
public class FreezeAndIsFrozenTest {
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = ".*error: error, message: modification not allowed on frozen value.*",
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = ".*error: error, message: failed to set element to json: modification " +
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = ".*error: error, message: failed to remove element from json: " +
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = ".*error: error, message: failed to add children to xml element: " +
                    "modification not allowed on frozen value.*")
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = ".*error: error, message: failed to remove children form xml element: " +
                    "modification not allowed on frozen value.*")
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = ".*error: error, message: failed to remove attribute: modification not " +
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = ".*error: error, message: failed to set attributes: modification not " +
                    "allowed on frozen value.*")
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = ".*error: error, message: failed to set children to xml element: " +
                    "modification not allowed on frozen value.*")
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = ".*error: error, message: invalid map insertion: modification not " +
                    "allowed on frozen value.*")
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = ".*error: error, message: failed to remove element from map: " +
                    "modification not allowed on frozen value.*")
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = ".*error: error, message: failed to clear map: modification not allowed" +
                    " on frozen value.*")
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = ".*error: error, message: failed to add element: modification not " +
                    "allowed on frozen value.*")
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = ".*error: error, message: invalid update of record field: modification " +
                    "not allowed on frozen value.*")
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = ".*error: error, message: failed to add data to the table: modification" +
                    " not allowed on frozen value.*")
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = ".*error: error, message: failed to remove data from the table: " +
                    "modification not allowed on frozen value.*")
