...
function testStaticMatchOrPatterns3() returns string[] {
    ...
    AnotherFoo af4 = {x: 15, y: ("Tyrion", {x: 12, y: "Ballerina"}, "Lanister"), z: 56.9};
    int i1 = 16;
    int i2 = 12;
...
function caz2(Foo|AnotherFoo|map<any>|int f) returns string {
    ...
    match f {
        ...
        {x: 15, y: ("Stark", {x: 12, y: "Ballerina", z: true}, "Sansa"), z:15.1} |
            {x: 15, y: ("Tyrion", {x: 12, y: "Ballerina"}, "Lanister"), z: 56.9} => return "Value is : 3rd pattern - " + io:sprintf("%s", f);
