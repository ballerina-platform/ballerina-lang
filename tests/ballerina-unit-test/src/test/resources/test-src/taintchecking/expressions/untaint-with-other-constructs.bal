...
function untaintWithAddOperatorInReturn () returns (string) {
    string data1 = "input1";
    string data2 = "input2";
    return crypto:unsafeMarkUntainted((data1) + data2 + "input3" + globalvariable);
}
...
function untaintWithAddOperatorWithVariable () returns (string) {
    ...
    return crypto:unsafeMarkUntainted(data3);
}

function untaintWithFunctionParam () returns (string) {
    string data1 = "input1";
    string data2 = "input2";
    return returnInput(crypto:unsafeMarkUntainted((data1) + data2 + "input3" + globalvariable));
}

function untaintWithFunctionReturn () returns (string) {
    string data1 = "input1";
    string data2 = "input2";
    return crypto:unsafeMarkUntainted(returnInput(data1) + data2 + "input3" + globalvariable);
}

function untaintWithReceiver () returns (string) {
    string data1 = "input1";
    string data2 = "input2";
    return crypto:unsafeMarkUntainted(returnInput(data1) + data2 + "input3" + globalvariable).trim();
}

function untaintWithLengthOf () returns (int) {
    string data1 = "input1";
    string data2 = "input2";
    return crypto:unsafeMarkUntainted(returnInput(data1) + data2 + "input3" + globalvariable).length();
}
