...
function untaintWithAddOperatorInReturn (string... args) returns (string) {
    string data1 = "input1";
    string data2 = "input2";
    return crypto:unsafeMarkUntainted((data1) + data2 + args[0] + "input3" + globalvariable);
}
...
function untaintWithFunctionParam (string... args) returns (string) {
    string data1 = "input1";
    string data2 = "input2";
    return returnInput(crypto:unsafeMarkUntainted((data1) + data2 + args[0] + "input3" + globalvariable));
}

function untaintWithFunctionReturn (string... args) returns (string) {
    string data1 = "input1";
    string data2 = "input2";
    return crypto:unsafeMarkUntainted(returnInput(data1) + data2 + args[0] + "input3" + globalvariable);
}

function untaintWithReceiver (string... args) returns (string) {
    string data1 = "input1";
    string data2 = "input2";
    return crypto:unsafeMarkUntainted(returnInput(data1) + data2 + args[0] + "input3" + globalvariable).trim();
}
