...
object {public int age; public string name; function __init(int age, string name){}} p1;
...
function test () returns int {
    object {public int age; public string name; function __init(int age, string name){}} p4;
