...
function myWindow(int someValue) returns Teacher {
    Teacher t = {name: "gimantha", age: someValue, status: "Single", school: "ABC"};
    return t;
}
...
function testTimeWindow() {
    ...
    forever {
        from inputStreamTimeWindowTest window myWindow(1000)
