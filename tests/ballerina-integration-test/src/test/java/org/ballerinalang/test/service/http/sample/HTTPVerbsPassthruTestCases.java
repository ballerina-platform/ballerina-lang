...
public class HTTPVerbsPassthruTestCases extends IntegrationTestCase {
    ...
    @Test(description = "Test HTTP  binding with JSON payload with URL. /getQuote/employee")
    ...
    @Test(description = "Test HTTP  binding with incompatible payload with URL. /getQuote/employee")
    public void testDataBindingWithIncompatiblePayload() throws IOException {
        ...
        Assert.assertTrue(response.getData()
                .contains(" binding failed: Error in reading payload : failed to create json: unrecognized " +
