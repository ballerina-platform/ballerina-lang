...
public interface BServer {
     ...
     * @throws BallerinaTestException if services start fails
     */
    void startServer(String balFile, String[] args) throws BallerinaTestException;
     ...
     * @throws BallerinaTestException if services start fails
     */
    void startServer(String balFile, String[] args, Map<String, String> envProperties) throws BallerinaTestException;
     ...
     * @throws BallerinaTestException
     */
    void startServer(String sourceRoot, String packagePath, String[] args) throws BallerinaTestException;
