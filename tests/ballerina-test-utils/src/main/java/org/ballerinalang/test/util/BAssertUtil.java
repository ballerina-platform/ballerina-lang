...
public class BAssertUtil {
    ...
    public static void validateError(CompileResult result, int errorIndex, String expectedErrMsg, int expectedErrLine,
        ...
        Assert.assertEquals(diag.severity(), DiagnosticSeverity.ERROR, "incorrect diagnostic type");
    ...
    public static void validateWarning(CompileResult result, int warningIndex, String expectedWarnMsg,
        ...
        Assert.assertEquals(diag.severity(), DiagnosticSeverity.WARNING, "incorrect diagnostic type");
        ...
        Assert.assertEquals(diag.location().textRange().startOffset(), expectedWarnCol, "incorrect column position:");
    }
}
