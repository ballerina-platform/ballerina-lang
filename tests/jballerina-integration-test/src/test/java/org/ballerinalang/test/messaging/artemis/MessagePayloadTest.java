...
public class MessagePayloadTest extends ArtemisTestCommons {
    ...
    public void setup() throws URISyntaxException {
        ...
        anyCastResult = BCompileUtil.compile(producersPath.resolve("anycast_message.bal").toAbsolutePath().toString());
        multiCastResult = BCompileUtil.compile(producersPath.resolve("multicast_message.bal").toAbsolutePath()
                                                       .toString());
    }
    ...
    public void testSendMapByte() {
        String log = "map<int> message byte1=1 byte2=7";
    ...
    public void testClose() {
        ...
        CompileResult result = BCompileUtil.compile(producersPath.resolve("close.bal").toAbsolutePath().toString());
