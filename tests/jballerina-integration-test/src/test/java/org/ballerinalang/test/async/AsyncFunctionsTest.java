...
public class AsyncFunctionsTest extends BaseTest {
    ...
    public void setup() throws BallerinaTestException {
        ...
        LogLeecher buildLeecher = new LogLeecher("target/bala/testOrg-functionsLib-java25-0.1.0.bala");
        LogLeecher pushLeecher = new LogLeecher("Successfully pushed target/bala/testOrg-functionsLib-java25-0.1.0" +
