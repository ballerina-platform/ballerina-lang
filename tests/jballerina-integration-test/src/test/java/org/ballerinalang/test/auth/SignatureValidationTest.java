...
public class SignatureValidationTest extends AuthBaseTest {
    ...
    public void testScenario1() throws Exception {
        ...
        HttpResponse response = HttpsClientRequest.doGet(
                serverInstance.getServiceURLHttps(servicePortOfBothTrustStoreAndJwksConfig, "echo/test"),
    ...
    public void testScenario2() throws Exception {
        ...
        headers.put("Authorization", "Bearer eyJhbGciOiJSUzI1NiIsICJ0eXAiOiJKV1QiLCAia2lkIjoiTlRBeFptTXhORE15WkRnM0" +
                ...
                "15Y8JNJONJPJ52MsN6t297hyFV9AmyNPzwHxxmi753TclbapDqDnVPI1tpc-Q");
        HttpResponse response = HttpsClientRequest.doGet(
                serverInstance.getServiceURLHttps(servicePortOfOnlyJwksConfig, "echo/test"),
                headers, serverInstance.getServerHome());
        assertOK(response);
    }
    ...
    public void testScenario3() throws Exception {
        ...
        headers.put("Authorization", "Bearer eyJhbGciOiJSUzI1NiIsICJ0eXAiOiJKV1QiLCAia2lkIjoiTlRBeFptTXhORE15WkRnM0" +
                ...
                "15Y8JNJONJPJ52MsN6t297hyFV9AmyNPzwHxxmi753TclbapDqDnVPI1tpc-Q");
        HttpResponse response = HttpsClientRequest.doGet(
                serverInstance.getServiceURLHttps(servicePortOfOnlyTrustStoreConfig, "echo/test"),
                headers, serverInstance.getServerHome());
        assertOK(response);
    }
    ...
    public void testScenario4() throws Exception {
        ...
        headers.put("Authorization", "Bearer eyJhbGciOiJSUzI1NiIsICJ0eXAiOiJKV1QiLCAia2lkIjoiTlRBeFptTXhORE15WkRnM0" +
                ...
                "15Y8JNJONJPJ52MsN6t297hyFV9AmyNPzwHxxmi753TclbapDqDnVPI1tpc-Q");
        HttpResponse response = HttpsClientRequest.doGet(
                serverInstance.getServiceURLHttps(servicePortOfNoConfig, "echo/test"),
                headers, serverInstance.getServerHome());
        assertOK(response);
    }
