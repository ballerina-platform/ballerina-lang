...
/**
 * Test class for anonymous gRPC unary service with blocking and non-blocking client.
 */
@Test(groups = "grpc-test")
public class UnaryAnonymousServiceTestCase {
    ...
    private void setup() throws Exception {
        ...
        Path balFilePath = Paths.get("src", "test", "resources", "grpc", "src", "clients",
                "20_unary_client_for_anonymous_service.bal");
