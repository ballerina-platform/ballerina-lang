...
RetryServiceBlockingClient retryClient = new("http://localhost:9111", clientConfig);
RetryServiceBlockingClient failingRetryClient = new("http://localhost:9111", failingClientConfig);
