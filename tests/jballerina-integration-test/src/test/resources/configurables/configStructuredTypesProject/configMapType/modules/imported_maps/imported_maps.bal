...
function testMapIteration() {
    ...
    util:testMapIterator(doctorMap, 3);
    util:testMapIterator(readonlyDoctorMap, 3);
...
function testTableIteration() {
    ...
    util:testTableIterator(doctorMapTable);
    util:testTableIterator(readonlyDoctorMapTable);
