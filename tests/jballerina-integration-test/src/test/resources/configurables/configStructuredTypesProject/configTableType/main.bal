...
configurable table<type_defs:PersonWithFiniteFields> personWithFiniteFieldsTable = ?;
...
function testTables() {
    ...
    test:assertEquals(personWithFiniteFieldsTable.toString(), "[{\"stringRef\":\"stringRefType\",\"intRef\":10," +
    "\"floatRef\":3.14,\"doubleRef\":2.71828,\"booleanRef\":true},{\"stringRef\":\"stringRefType\",\"intRef\":10," +
    "\"floatRef\":3.14,\"doubleRef\":2.71828,\"booleanRef\":true}]");
}
