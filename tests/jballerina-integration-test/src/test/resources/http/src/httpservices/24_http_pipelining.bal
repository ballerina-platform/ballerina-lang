...
service pipelining on new http:Listener(9221, { timeoutInMillis: 1000, httpVersion: "1.1" }) {
...
service pipeliningLimit on new http:Listener(9222, { http1Settings: { maxPipelinedRequests: 2 }, httpVersion: "1.1" }) {
