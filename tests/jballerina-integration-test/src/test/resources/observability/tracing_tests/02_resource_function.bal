...
service /testServiceTwo on new testobserve:Listener(9092) {
    ...
    resource function post resourceFive(testobserve:Caller caller) returns error? {
    ...
    resource function post resourceSix(testobserve:Caller caller) returns error? {
    ...
    resource function post resourceSeven(testobserve:Caller caller) {
    ...
    resource function post resourceEight(testobserve:Caller caller) returns error? {
