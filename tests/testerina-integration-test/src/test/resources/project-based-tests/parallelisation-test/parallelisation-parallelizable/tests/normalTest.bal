...
@test:Config {parallelizable: false, dependsOn: [testAssertEquals1]}
function testAssertEquals2() {
    runtime:sleep(0.5);
    test:assertEquals(100, 100);
}

@test:Config {parallelizable: false, dependsOn: [testAssertEquals1, testAssertEquals2]}
...
@test:Config {parallelizable: false, dependsOn: [testAssertEquals4]}
function testAssertEquals5() {
    runtime:sleep(0.5);
    test:assertEquals(100, 100);
}

@test:Config {parallelizable: false, dependsOn: [testAssertEquals4, testAssertEquals5]}
...
@test:Config {parallelizable: false, dependsOn: [testAssertEquals6]}
function testAssertEquals8() {
    runtime:sleep(0.5);
    test:assertEquals(100, 100);
}

@test:Config {parallelizable: false, dependsOn: [testAssertEquals4, testAssertEquals8]}
function testAssertEquals9() {
    runtime:sleep(0.5);
    test:assertEquals(100, 100);
}

@test:Config {parallelizable: false, dependsOn: [testAssertEquals8, testAssertEquals7, testAssertEquals11]}
...
@test:Config {parallelizable: false, dependsOn: [testAssertEquals7]}
...
@test:Config {parallelizable: false, dependsOn: [testAssertEquals13]}
...
@test:Config {parallelizable: false, dependsOn: [testAssertEquals17]}
function testAssertEquals18() {
    runtime:sleep(0.5);
    test:assertEquals(100, 100);
}

@test:Config {parallelizable: false, dependsOn: [testAssertEquals16]}
...
@test:Config {parallelizable: false, dependsOn: [testAssertEquals14]}
function testAssertEquals21() {
    runtime:sleep(0.5);
    test:assertEquals(100, 100);
}

@test:Config {parallelizable: false, dependsOn: [testAssertEquals14, testAssertEquals15]}
function testAssertEquals22() {
    runtime:sleep(0.5);
    test:assertEquals(100, 100);
}

@test:Config {parallelizable: false, dependsOn: [testAssertEquals15, testAssertEquals21]}
function testAssertEquals23() {
    runtime:sleep(0.5);
    test:assertEquals(100, 100);
}

@test:Config {parallelizable: false, dependsOn: [testAssertEquals19, testAssertEquals20]}
function testAssertEquals24() {
    runtime:sleep(0.5);
    test:assertEquals(100, 100);
}

@test:Config {parallelizable: false, dependsOn: [testAssertEquals20, testAssertEquals24, testAssertEquals12, testAssertEquals11]}
function testAssertEquals25() {
    runtime:sleep(0.5);
    test:assertEquals(100, 100);
}

@test:Config {parallelizable: false, dependsOn: [testAssertEquals25, testAssertEquals24]}
function testAssertEquals26() {
    runtime:sleep(0.5);
    test:assertEquals(100, 100);
}

@test:Config {parallelizable: false, dependsOn: [testAssertEquals24, testAssertEquals26]}
...
@test:Config {parallelizable: false, dependsOn: [testAssertEquals28]}
...
@test:Config {parallelizable: false, dependsOn: [testAssertEquals1, testAssertEquals2, testAssertEquals4, testAssertEquals5, testAssertEquals6, testAssertEquals7, testAssertEquals8, testAssertEquals9, testAssertEquals10, testFunction]}
