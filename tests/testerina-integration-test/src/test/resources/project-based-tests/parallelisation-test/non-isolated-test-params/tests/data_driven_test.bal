...
function mapDataProviderTest(int value1, int value2, string fruit, string[] emptyArr) returns error? {
    test:assertEquals(value1, value2, msg = "The provided values are not equal");
    runtime:sleep(0.5);
    test:assertEquals(fruit.length(), 6);
}

function mapDataProvider() returns map<[int, int, string, string[]]>|error {
    map<[int, int, string, string[]]> dataSet = {
        "banana": [10, 10, "banana", []],
        "cherry": [5, 5, "cherry", []],
        "apple": [5, 5, "apple", []],
        "orange": [5, 5, "orange", []],
