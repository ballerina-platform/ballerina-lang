...
public class VariableReturnTypeTest {
    ...
    public void testNegatives() {
        ...
        validateError(errors, indx++, "incompatible types: expected 'typedesc<anydata>'," +
                " found 'function () returns (typedesc<anydata>)'", 97, 58);
        validateError(errors, indx++, "invalid token '('", 97, 70);
        validateError(errors, indx++, "invalid token ')'", 97, 73);
