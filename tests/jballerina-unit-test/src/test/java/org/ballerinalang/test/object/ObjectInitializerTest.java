...
public class ObjectInitializerTest {
    ...
    public void testCustomErrorReturn() {
        ...
        Assert.assertEquals(TypeUtils.getRepresentedType(getType(returns.get(0))).getTag(), TypeTags.ERROR_TAG);
        ...
        Assert.assertEquals(TypeUtils.getRepresentedType(getType(returns.get(1))).getTag(), TypeTags.ERROR_TAG);
    ...
    public void testCheckPanicObjectInit() {
        ...
        Assert.assertEquals(TypeUtils.getRepresentedType(getType(returns)).getTag(), TypeTags.ERROR_TAG);
