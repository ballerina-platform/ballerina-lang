...
//        //Will initialize the channel
//        BValue[] args = {new BString(getAbsoluteFilePath(resourceToRead)), new BString("UTF-8")};
//        BRunUtil.invokeStateful(characterInputOutputProgramFile, "initReadableChannel" +
//                "", args);
//
...
//        BRunUtil.invokeStateful(bytesInputOutputProgramFile, "initWritableChannel",
//                                                                args);
//
...
//        BRunUtil.invokeStateful(characterInputOutputProgramFile, "writeCharacters",
//                                                                args);
//
...
//        BRunUtil.invokeStateful(characterInputOutputProgramFile, "appendCharacters",
//                                                                args);
//
...
//        //Will initialize the channel
//        BValue[] args = {new BString(sourceToWrite), new BString("UTF-8")};
//        BRunUtil.invokeStateful(characterInputOutputProgramFile, "initWritableChannel" +
//                "", args);
//
...
//                                new String(Files.readAllBytes(Paths.get(sourceToWrite)), StandardCharsets.UTF_8)
//                                        .trim());
//        } catch (IOException e) {
...
//        //Will initialize the channel
//        BValue[] args = {new BString(sourceToWrite), new BString("UTF-8")};
//        BRunUtil.invokeStateful(characterInputOutputProgramFile,
//                                                                "initWritableChannel", args);
//
...
//        BValue[] result = BRunUtil.invokeStateful(stringInputOutputProgramFile,
//                                                                                  "getJson", args);
