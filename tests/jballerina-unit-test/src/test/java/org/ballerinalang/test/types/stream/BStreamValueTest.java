...
public class BStreamValueTest {
    ...
    public void testStreamTypeNegative() {
        ...
        BAssertUtil.validateError(negativeResult, i++, "invalid stream constructor. expected a subtype " +
                ...
                "'string'", 381, 31);
        BAssertUtil.validateError(negativeResult, i++, "no stream constructor provided. expected a subtype" +
                        " of 'object { public isolated function next() returns (record {| int value; |}|readonly); }'",
                387, 31);
