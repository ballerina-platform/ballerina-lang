...
//        validateWarning(compileResult, i++, expectedWarningMsg + "'BarRecord'", 128, 6);
        validateWarning(compileResult, i++, expectedWarningMsg + "'ChildFoo'", 143, 5);
        validateWarning(compileResult, i++, expectedWarningMsg + "'ChildRecord'", 144, 5);
        validateWarning(compileResult, i++, expectedWarningMsg + "'Foo'", 145, 5);
        validateWarning(compileResult, i++, expectedWarningMsg + "'Baz'", 146, 5);
        validateWarning(compileResult, i++, expectedWarningMsg + "'BarRecord'", 165, 1);
        validateWarning(compileResult, i++, expectedWarningMsg + "'Baz'", 165, 1);
        validateWarning(compileResult, i++, expectedWarningMsg + "'Foo'", 165, 1);
        validateWarning(compileResult, i++, expectedWarningMsg + "'BarRecord'", 175, 33);
        validateWarning(compileResult, i++, expectedWarningMsg + "'Baz'", 175, 33);
        validateWarning(compileResult, i++, expectedWarningMsg + "'Foo'", 175, 33);
...
//        validateWarning(compileResult, i++, expectedWarningMsg + "'BarTypeRecord'", 193, 1);
        validateWarning(compileResult, i++, expectedWarningMsg + "'Employee1'", 254, 1);
        validateWarning(compileResult, i++, expectedWarningMsg + "'Employee2'", 254, 1);
        validateWarning(compileResult, i++, expectedWarningMsg + "'Employee1'", 255, 1);
        validateWarning(compileResult, i++, expectedWarningMsg + "'Employee2'", 255, 1);
        validateWarning(compileResult, i++, expectedWarningMsg + "'Employee1'", 257, 33);
        validateWarning(compileResult, i++, expectedWarningMsg + "'Employee1'", 262, 51);
        validateWarning(compileResult, i++, expectedWarningMsg + "'Employee1'", 267, 1);
        validateWarning(compileResult, i++, expectedWarningMsg + "'Employee2'", 267, 1);
        validateWarning(compileResult, i++, expectedWarningMsg + "'Employee1'", 274, 1);
        validateWarning(compileResult, i++, expectedWarningMsg + "'Employee1'", 278, 1);
        validateWarning(compileResult, i++, expectedWarningMsg + "'Employee2'", 278, 1);
        validateWarning(compileResult, i++, expectedWarningMsg + "'Employee1'", 286, 34);
        validateWarning(compileResult, i++, expectedWarningMsg + "'Employee2'", 286, 34);
