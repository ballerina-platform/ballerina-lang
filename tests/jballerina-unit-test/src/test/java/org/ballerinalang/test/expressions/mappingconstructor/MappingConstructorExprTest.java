...
public class MappingConstructorExprTest {
    ...
    public void testSpreadOpFieldSemanticAnalysisNegative() {
        ...
        validateError(result, i++, "incompatible types: expected a map or a record, found 'int'", 60, 28);
        validateError(result, i++, "incompatible types: expected 'string', found '(int|float)'", 68, 25);
        validateError(result, i++, "incompatible types: expected 'string', found 'anydata'", 68, 39);
        validateError(result, i++, "undefined symbol 'b'", 72, 38);
        validateError(result, i++, "undefined function 'getFoo'", 72, 44);
        validateError(result, i++, "incompatible types: expected 'json', found 'any'", 82, 18);
        validateError(result, i++, "incompatible types: expected 'json', found 'anydata'", 82, 30);
        validateError(result, i++, "incompatible types: expected 'json', found 'any'", 83, 30);
        validateError(result, i++, "incompatible types: expected 'json', found 'anydata'", 83, 36);
        validateError(result, i++, "incompatible types: expected 'int', found 'string'", 96, 18);
        validateError(result, i++, "incompatible types: expected '(int|float)', found 'string'", 97, 32);
    }
