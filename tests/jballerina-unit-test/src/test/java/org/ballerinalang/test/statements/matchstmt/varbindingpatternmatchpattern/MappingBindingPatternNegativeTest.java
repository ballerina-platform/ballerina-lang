...
public class MappingBindingPatternNegativeTest {
    ...
    public void testMappingBindingPatternNegative() {
        ...
        BAssertUtil.validateWarning(warningResult, ++i, "unused variable 'b'", 20, 9);
        BAssertUtil.validateWarning(warningResult, ++i, patternNotMatched, 27, 9);
        BAssertUtil.validateWarning(warningResult, ++i, "unused variable 'a'", 27, 9);
        BAssertUtil.validateWarning(warningResult, ++i, "unused variable 'a'", 38, 9);
        BAssertUtil.validateWarning(warningResult, ++i, "unused variable 'b'", 38, 9);
        BAssertUtil.validateWarning(warningResult, ++i, unreachablePattern, 38, 28);
        BAssertUtil.validateWarning(warningResult, ++i, "unused variable 'a'", 40, 9);
        BAssertUtil.validateWarning(warningResult, ++i, "unused variable 'b'", 40, 9);
        ...
        BAssertUtil.validateWarning(warningResult, ++i, "unused variable 'a'", 53, 9);
        BAssertUtil.validateWarning(warningResult, ++i, "unused variable 'b'", 53, 9);
        BAssertUtil.validateWarning(warningResult, ++i, unreachablePattern, 54, 9);
        BAssertUtil.validateWarning(warningResult, ++i, "unused variable 'c'", 54, 9);
        BAssertUtil.validateWarning(warningResult, ++i, "unused variable 'd'", 54, 9);
        BAssertUtil.validateWarning(warningResult, ++i, "unused variable 'a'", 60, 9);
        BAssertUtil.validateWarning(warningResult, ++i, "unused variable 'b'", 60, 9);
        BAssertUtil.validateWarning(warningResult, ++i, unreachablePattern, 61, 9);
        BAssertUtil.validateWarning(warningResult, ++i, "unused variable 'a'", 61, 9);
        BAssertUtil.validateWarning(warningResult, ++i, "unused variable 'b'", 61, 9);
        BAssertUtil.validateWarning(warningResult, ++i, "unused variable 'c'", 61, 9);
        BAssertUtil.validateWarning(warningResult, ++i, patternNotMatched, 73, 9);
        BAssertUtil.validateWarning(warningResult, ++i, "unused variable 'rest'", 73, 9);
        BAssertUtil.validateWarning(warningResult, ++i, "unused variable 'x'", 73, 9);
        BAssertUtil.validateWarning(warningResult, ++i, "unused variable 'id'", 75, 9);
        BAssertUtil.validateWarning(warningResult, ++i, "unused variable 'name'", 75, 9);
        BAssertUtil.validateWarning(warningResult, ++i, "unused variable 'rest'", 75, 9);
        BAssertUtil.validateWarning(warningResult, ++i, unreachablePattern, 77, 9);
        BAssertUtil.validateWarning(warningResult, ++i, "unused variable 'id'", 77, 9);
        BAssertUtil.validateWarning(warningResult, ++i, "unused variable 'name'", 77, 9);
