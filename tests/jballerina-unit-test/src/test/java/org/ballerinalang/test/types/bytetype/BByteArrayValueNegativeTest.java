...
public class BByteArrayValueNegativeTest {
    ...
    public void testBlobValueNegative() {
        ...
        BAssertUtil.validateError(result, index++, "missing binary operator", 2, 22);
        BAssertUtil.validateError(result, index++, "missing binary operator", 2, 24);
        ...
        BAssertUtil.validateError(result, index++, "missing binary operator", 3, 21);
        BAssertUtil.validateError(result, index++, "missing binary operator", 3, 24);
        ...
        BAssertUtil.validateError(result, index++, "missing binary operator", 12, 22);
        BAssertUtil.validateError(result, index++, "missing binary operator", 12, 24);
        ...
        BAssertUtil.validateError(result, index++, "missing binary operator", 13, 21);
        BAssertUtil.validateError(result, index++, "missing binary operator", 13, 24);
