...
public class FunctionSignatureInBalaTest {
    ...
    public void testNegativeFunctionInvocations() {
        ...
        validateError(resultNegative, i++, "missing required parameter 'b' in call to 'functionWithAllTypesParams()'",
                4, 12);
        validateError(resultNegative, i++, "named arg followed by positional arg", 4, 56);
        validateError(resultNegative, i++, "named arg followed by positional arg", 4, 72);
        validateError(resultNegative, i++, "named arg followed by positional arg", 4, 76);
        validateError(resultNegative, i++, "missing required parameter 'b' in call to 'functionWithAllTypesParams()'",
                9, 12);
        validateError(resultNegative, i++, "named arg followed by positional arg", 9, 56);
        validateError(resultNegative, i++, "rest argument not allowed after named arguments", 9, 72);
        validateError(resultNegative, i++, "rest arg followed by another arg", 9, 82);
