...
public class NullLiteralUsageTest {
    ...
    public void testNullAssignment() {
        Object returns = JvmRunUtil.invoke(result, "testNullAssignment");
        assertNull(returns);
    }

    @Test
    public void testNullInField() {
        Object returns = JvmRunUtil.invoke(result, "testNullInField");
        assertNull(returns);
    }

    @Test
    public void testNullStringRepresentation() {
        Object returns = JvmRunUtil.invoke(result, "testNullStringRepresentation");
        assertEquals(returns.toString(), "");
    }

    @Test
    public void testNullStringRepresentation2() {
        Object returns = JvmRunUtil.invoke(result, "testNullStringRepresentation2");
        assertEquals(returns.toString(), "null");
    }

    @Test
    public void testNullStringRepresentation3() {
        Object returns = JvmRunUtil.invoke(result, "testNullStringRepresentation3");
        assertEquals(returns.toString(), "{\"name\":\"John Doe\",\"age\":25,\"location\":null}");
    }

    @Test
    public void testNullStringRepresentation4() {
        Object returns = JvmRunUtil.invoke(result, "testNullStringRepresentation4");
        assertEquals(returns.toString(), "{\"name\":\"John Doe\",\"age\":25,\"location\":null}");
    }

    @Test
    public void testNullStringRepresentation5() {
        Object returns = JvmRunUtil.invoke(result, "testNullStringRepresentation5");
        assertEquals(returns.toString(), "()");
    }

    @Test
    public void testNullReturn() {
        Object returns = JvmRunUtil.invoke(result, "testNullReturn");
        assertNull(returns);
    }

    @Test
    public void testNullReturn2() {
        Object returns = JvmRunUtil.invoke(result, "testNullReturn2");
        assertNull(returns);
    }

    @Test
    public void testNullInFnParams() {
        Object returns = JvmRunUtil.invoke(result, "testNullInFnParams");
        assertNull(returns);
    }

    @Test
    public void testNullInATuple() {
        Object arr = JvmRunUtil.invoke(result, "testNullInATuple");
    ...
    public void testNullWithTypeGuard() {
        Object returns = JvmRunUtil.invoke(result, "testNullWithTypeGuard");
        assertTrue((Boolean) returns);
    }

    @Test
    public void testNullWithMatch() {
        Object returns = JvmRunUtil.invoke(result, "testNullWithMatch");
        assertEquals(returns.toString(), "null");
    }

    @Test
    public void testNullInArray() {
        Object returns = JvmRunUtil.invoke(result, "testNullInArray");
        assertNull(returns);
    }

    @Test
    public void testNullInNestedTernaryExpr() {
        Object returns = JvmRunUtil.invoke(result, "testNullInNestedTernaryExpr");
        assertNull(returns);
    }
