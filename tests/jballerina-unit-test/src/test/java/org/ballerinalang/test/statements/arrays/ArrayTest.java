...
public class ArrayTest {
    ...
    public void testFloatArrayLength() {
        ...
        BArray returnVals = (BArray) JvmRunUtil.invoke(compileResult, "testFloatArrayLength", args);
    ...
    public void testIntArrayLength() {
        ...
        arrayValue.add(2, 12);
        Object[] args = {arrayValue};
        BArray returnVals = (BArray) JvmRunUtil.invoke(compileResult, "testIntArrayLength", args);
    ...
    public void testStringArrayLength() {
        ...
        Object[] args = {arrayValue};
        BArray returnVals = (BArray) JvmRunUtil.invoke(compileResult, "testStringArrayLength", args);
        Assert.assertFalse(returnVals == null || returnVals.size() == 0, "Invalid Return Values.");
        Assert.assertNotNull(returnVals.get(0));
        Assert.assertNotNull(returnVals.get(1));
    ...
    public void testXMLArrayLength() {
        Object returnVals = JvmRunUtil.invoke(compileResult, "testXMLArrayLength");
    ...
    public void testJSONArrayLength() {
        BArray returnVals = (BArray) JvmRunUtil.invoke(compileResult, "testJSONArrayLength");
        Assert.assertFalse(returnVals == null || returnVals.size() == 0, "Invalid Return Values.");
        Assert.assertNotNull(returnVals.get(0));
        Assert.assertNotNull(returnVals.get(1));
        Assert.assertEquals(returnVals.get(0), 2L, "Length didn't match");
    ...
    public void testArrayStringRepresentationWithANilElement() {
        Object returnVals = JvmRunUtil.invoke(compileResult, "testArrayWithNilElement");
    ...
    public void testElementTypesWithoutImplicitInitVal() {
        Object retVals = JvmRunUtil.invoke(compileResult, "testElementTypesWithoutImplicitInitVal");
    ...
    public void testArrayFieldInRecord() {
        Object retVals = JvmRunUtil.invoke(compileResult, "testArrayFieldInRecord");
    ...
    public void testArrayFieldInObject() {
        Object retVals = JvmRunUtil.invoke(compileResult, "testArrayFieldInObject");
    ...
    public void testArraysAsFuncParams() {
        Object retVals = JvmRunUtil.invoke(compileResult, "testArraysAsFuncParams");
        BArray arr = (BArray) retVals;
        Assert.assertEquals(((BArrayType) arr.getType()).getState().getValue(), BArrayState.CLOSED.getValue());
    ...
    public void testArraysOfCyclicDependentTypes() {
        Object retVals = JvmRunUtil.invoke(compileResult, "testArraysOfCyclicDependentTypes");
        BArray arr = (BArray) retVals;
    ...
    public void testArraysOfCyclicDependentTypes2() {
        Object retVals = JvmRunUtil.invoke(compileResult, "testArraysOfCyclicDependentTypes2");
        BArray arr = (BArray) retVals;
    ...
    public void testArraysOfCyclicDependentTypes3() {
        JvmRunUtil.invoke(compileResult, "testArraysOfCyclicDependentTypes3");
    }

    @Test(expectedExceptions = BLangRuntimeException.class, expectedExceptionsMessageRegExp = ".*error: " +
            "\\{ballerina}StackOverflow \\{\"message\":\"stack overflow\"}.*")
    public void testArraysOfCyclicDependentTypes4() {
        JvmRunUtil.invoke(compileResult, "testArraysOfCyclicDependentTypes4");
    }

    @Test
    public void testGetFromFrozenArray() {
        Object retVals = JvmRunUtil.invoke(compileResult, "testGetFromFrozenArray");
