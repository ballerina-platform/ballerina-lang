...
public class NativeConversionTest {
    ...
    public void testStructToMap() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testStructToMap");
    ...
    private void testMapToStruct(CompileResult compileResult, String functionName) {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, functionName);
        Assert.assertTrue(returns instanceof BMap);
    ...
    public void testJsonToStruct() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testJsonToStruct");
        Assert.assertTrue(returns instanceof BMap);
        BMap<String, Object> struct = (BMap<String, Object>) returns;
    ...
    public void testStructToJson() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testStructToJson");
        Assert.assertTrue(returns instanceof BMap);
    ...
    public void testAnyRecordToAnydataMap() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testAnyRecordToAnydataMap");
        Assert.assertTrue(returns instanceof BMap);
    ...
    public void testMapToJsonConversion() {
        ...
        Object result = JvmRunUtil.invoke(compileResult, "testComplexMapToJson");
    ...
    public void testStructWithIncompatibleTypeToJson() {
        ...
        JvmRunUtil.invoke(compileResult, "testStructWithIncompatibleTypeToJson");
    }
    ...
    public void testMapToStructWithMapValueForJsonField() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testMapToStructWithMapValueForJsonField");
        Assert.assertTrue(returns instanceof BMap);
    ...
    public void testMapWithMissingOptionalFieldsToStruct() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testMapWithMissingOptionalFieldsToStruct");
        Assert.assertTrue(returns instanceof BMap);
        BMap<String, Object> personStruct = (BMap<String, Object>) returns;
    ...
    public void testMapWithIncompatibleArrayToStruct() {
        ...
        JvmRunUtil.invoke(compileResult, "testMapWithIncompatibleArrayToStruct");
    }
    ...
    public void testMapWithIncompatibleStructToStruct() {
        ...
        JvmRunUtil.invoke(compileResult, "testMapWithIncompatibleStructToStruct");
    }
    ...
    public void testIncompatibleJsonToStruct() {
        ...
        JvmRunUtil.invoke(compileResult, "testIncompatibleJsonToStruct");
    }
    ...
    public void testJsonToStructWithMissingOptionalFields() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testJsonToStructWithMissingOptionalFields");
        Assert.assertTrue(returns instanceof BMap);
    ...
    public void testJsonToStructWithMissingRequiredFields() {
        ...
        JvmRunUtil.invoke(compileResult, "testJsonToStructWithMissingRequiredFields");
    }
    ...
    public void testJsonWithIncompatibleMapToStruct() {
        ...
        JvmRunUtil.invoke(compileResult, "testJsonWithIncompatibleMapToStruct");
    }
    ...
    public void testJsonWithIncompatibleStructToStruct() {
        ...
        JvmRunUtil.invoke(compileResult, "testJsonWithIncompatibleStructToStruct");
    }
    ...
    public void testJsonArrayToStruct() {
        ...
        JvmRunUtil.invoke(compileResult, "testJsonArrayToStruct");
    }
    ...
    public void testJsonWithIncompatibleTypeToStruct() {
        ...
        JvmRunUtil.invoke(compileResult, "testJsonWithIncompatibleTypeToStruct");
    }
    ...
    public void testStructWithIncompatibleTypeMapToJson() {
        ...
        JvmRunUtil.invoke(compileResult, "testStructWithIncompatibleTypeMapToJson");
    }

    @Test(description = "Test converting a JSON array to any data array")
    public void testJsonToAnyArray() {

        Object returns = JvmRunUtil.invoke(compileResult, "testJsonToAnyArray");
        Assert.assertTrue(returns instanceof BMap);
    ...
    public void testJsonToIntArray() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testJsonToIntArray");
        Assert.assertTrue(returns instanceof BMap);
        BMap<String, Object> anyArrayStruct = (BMap<String, Object>) returns;
    ...
    public void testJsonToStringArray() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testJsonToStringArray");
        Assert.assertTrue(returns instanceof BMap);
        BMap<String, Object> anyArrayStruct = (BMap<String, Object>) returns;
        BArray array = (BArray) anyArrayStruct.get(StringUtils.fromString("a"));
    ...
    public void testJsonIntArrayToStringArray() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testJsonIntArrayToStringArray");
    ...
    public void testJsonToXmlArray() {
        ...
        JvmRunUtil.invoke(compileResult, "testJsonToXmlArray");
    }
    ...
    public void testNullJsonToArray() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testNullJsonToArray");
    ...
    public void testNullJsonArrayToArray() {
        ...
        JvmRunUtil.invoke(compileResult, "testNullJsonArrayToArray");
    }
    ...
    public void testNonArrayJsonToArray() {
        ...
        JvmRunUtil.invoke(compileResult, "testNonArrayJsonToArray");
    }
    ...
    public void testNullJsonToStruct() {
        ...
        JvmRunUtil.invoke(compileResult, "testNullJsonToStruct");
    }

    @Test(description = "Test converting a null Struct to json")
    public void testNullStructToJson() {

        Object returns = JvmRunUtil.invoke(compileResult, "testNullStructToJson");
        Assert.assertNull(returns);
    }
    ...
    public void testStructToMapWithRefTypeArray() {
        ...
        Object arr = JvmRunUtil.invoke(compileResult, "testStructToMapWithRefTypeArray");
    ...
    public void testStructWithStringArrayToJSON() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testStructWithStringArrayToJSON");
        Assert.assertTrue(returns instanceof BMap);
    ...
    public void testEmptyJSONtoStructWithOptionals() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testEmptyJSONtoStructWithOptionals");
        Assert.assertTrue(returns instanceof BMap);
    ...
    public void structWithComplexMapToJson() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "structWithComplexMapToJson");
    ...
    public void structWithComplexArraysToJson() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "structWithComplexArraysToJson");
        Assert.assertNotNull(returns);
    ...
    public void testJsonToRecordInPackage() {
        ...
        Object returns = JvmRunUtil.invoke(packageResult, "testJsonToRecord");
        Assert.assertTrue(returns instanceof BMap);
        BMap<String, Object> struct = (BMap<String, Object>) returns;
    ...
    public void testMapToRecordInPackage() {
        ...
        Object returns = JvmRunUtil.invoke(packageResult, "testMapToRecord");
        Assert.assertTrue(returns instanceof BMap);
        BMap<String, Object> struct = (BMap<String, Object>) returns;
    ...
    public void testJsonToMapUnconstrained() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testJsonToMapUnconstrained");
        Assert.assertTrue(returns instanceof BMap);
        BMap<String, ?> map = (BMap<String, ?>) returns;
    ...
    public void testJsonToMapConstrained1() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testJsonToMapConstrained1");
        Assert.assertTrue(returns instanceof BMap);
        BMap<String, ?> map = (BMap<String, ?>) returns;
    ...
    public void testJsonToMapConstrained2() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testJsonToMapConstrained2");
        Assert.assertTrue(returns instanceof BMap);
        BMap<String, ?> map = (BMap<String, ?>) returns;
    ...
    public void testJsonToMapConstrainedFail() {
        ...
        JvmRunUtil.invoke(compileResult, "testJsonToMapConstrainedFail");
    }

    @Test
    public void testStructArrayConversion1() {

        Object returns = JvmRunUtil.invoke(compileResult, "testStructArrayConversion1");
        Assert.assertTrue(returns instanceof BMap);
        BMap<String, Object> struct = (BMap<String, Object>) returns;
    ...
    public void testStructArrayConversion2() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testStructArrayConversion2");
        Assert.assertTrue(returns instanceof BMap);
        BMap<String, Object> struct = (BMap<String, Object>) returns;
    ...
    public void testTupleConversion1() {
        ...
        JvmRunUtil.invoke(compileResult, "testTupleConversion1");
    }

    @Test
    public void testTupleConversion2() {

        Object arr = JvmRunUtil.invoke(compileResult, "testTupleConversion2");
        BArray returns = (BArray) arr;
    ...
    public void testArrayToJson1() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testArrayToJson1");
    ...
    public void testArrayToJson2() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testArrayToJson2");
    ...
    public void testJsonToArray1() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testJsonToArray1");
    }

    @Test
    public void testJsonToArray2() {

        Object returns = JvmRunUtil.invoke(compileResult, "testJsonToArray2");
    ...
    public void testJsonToArrayFail() {
        ...
        JvmRunUtil.invoke(compileResult, "testJsonToArrayFail");
    }

    @Test
    public void testJsonFloatToRecordWithFloat() {

        Object returns = JvmRunUtil.invoke(compileResult, "testJsonFloatToRecordWithFloat");
        Assert.assertTrue(returns instanceof BMap);
    ...
    public void testRecordToJsonWithIsJson() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testRecordToJsonWithIsJson");
    ...
    public void testImplicitConversionToString() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testImplicitConversionToString");
        Assert.assertTrue(returns instanceof BMap);
        BMap<String, ?> map = (BMap<String, ?>) returns;
    ...
    public void testConvertWithFuncCall() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testConvertWithFuncCall");
    ...
    public void testConvertWithFuncReturnUnion() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testConvertWithFuncReturnUnion");
        Assert.assertTrue(returns instanceof Long);
