...
public class IsolatedVariableTest {
    ...
    public void testIsolatedVariablesIsolationNegative() {
        ...
        validateWarning(result, i++, "unused variable 'e'", 342, 15);
