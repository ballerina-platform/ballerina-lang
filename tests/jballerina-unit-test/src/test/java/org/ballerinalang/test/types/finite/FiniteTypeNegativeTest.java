...
public class FiniteTypeNegativeTest {
    ...
    public void testInvalidLiteralAssignment() {
        ...
        validateError(result, i++, "incompatible types: expected 'Foo', found 'float'", 116, 14);
        ...
        validateError(result, i++, "incompatible types: expected '1f', found 'float'", 123, 12);
        validateError(result, i++, "incompatible types: expected '1.0f', found 'float'", 124, 13);
        validateError(result, i++, "incompatible types: expected '1.121f', found 'float'", 125, 15);
        ...
        validateError(result, i++, "incompatible types: expected '2d', found 'decimal'", 131, 12);
        ...
        validateError(result, i++, "incompatible types: expected '2d', found 'decimal'", 142, 16);
        validateError(result, i++, "incompatible types: expected '1.2d', found 'float'", 143, 18);
        validateError(result, i++, "incompatible types: expected 'Float1', found 'float'", 148, 12);
        validateError(result, i++, "incompatible types: expected '1f', found 'float'", 150, 8);
        validateError(result, i++, "incompatible types: expected '1.0f', found 'float'", 151, 9);
        validateError(result, i++, "incompatible types: expected '1.121f', found 'float'", 152, 11);
        ...
        validateError(result, i++, "incompatible types: expected '2d', found 'decimal'", 158, 8);
        ...
        validateError(result, i++, "incompatible types: expected '2d', found 'decimal'", 165, 9);
        validateError(result, i++, "incompatible types: expected '1f', found 'float'", 165, 12);
        validateError(result, i++, "incompatible types: expected '0.1219e-1f', found 'float'", 166, 9);
        validateError(result, i++, "incompatible types: expected '0x.12p12f', found 'float'", 166, 12);
        ...
        validateError(result, i++, "incompatible types: expected '1f', found 'float'", 183, 12);
        ...
        validateError(result, i++, "incompatible types: expected 'FloatOne', found 'IntOne'", 256, 18);
        validateError(result, i++, "incompatible types: expected '1.0f', found 'IntOne'", 257, 13);
        validateError(result, i++, "incompatible types: expected 'float', found 'IntOne'", 258, 15);
        validateError(result, i++, "incompatible types: expected 'DecimalOne', found 'IntOne'", 259, 20);
        validateError(result, i++, "incompatible types: expected 'IntOne', found 'FloatOne'", 262, 16);
        validateError(result, i++, "incompatible types: expected '1', found 'FloatOne'", 263, 11);
        validateError(result, i++, "incompatible types: expected 'DecimalOne', found 'FloatOne'", 264, 20);
        validateError(result, i++, "incompatible types: expected 'DecimalOne', found 'float'", 265, 20);
        validateError(result, i++, "incompatible types: expected '(FloatOne|StringA)', found 'IntOne'", 266, 26);
        validateError(result, i++, "incompatible types: expected 'IntOne', found 'DecimalOne'", 270, 16);
        validateError(result, i++, "incompatible types: expected 'FloatOne', found 'DecimalOne'", 271, 18);
        validateError(result, i, "incompatible types: expected '(FloatOne|IntOne)', found 'DecimalOne'", 272, 25);
    }
}
