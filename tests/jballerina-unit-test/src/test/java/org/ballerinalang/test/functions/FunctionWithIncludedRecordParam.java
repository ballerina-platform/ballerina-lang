...
public class FunctionWithIncludedRecordParam {
    ...
    public void testFuncSignatureSemanticsNegative() {
        ...
        BAssertUtil.validateError(result, i++, "duplicate arguments may have been specified for 'name' via the named" +
                " argument and the argument for the included record parameter", 166, 42);
        ...
        BAssertUtil.validateError(result, i++, "duplicate arguments may have been specified for 'id' via the named " +
                "argument and the argument for the included record parameter", 217, 9);
        BAssertUtil.validateError(result, i++, "duplicate arguments may have been specified for 'id' via the named" +
                " argument and the argument for the included record parameter", 218, 38);
        BAssertUtil.validateError(result, i++, "duplicate arguments may have been specified for 'name' via the named" +
                " argument and the argument for the included record parameter", 219, 38);
        BAssertUtil.validateError(result, i++, "duplicate arguments may have been specified for 'name' via the named" +
                " argument and the argument for the included record parameter", 220, 28);
        BAssertUtil.validateError(result, i++, "duplicate arguments may have been specified for 'name' via the named" +
                " argument and the argument for the included record parameter", 221, 38);
        BAssertUtil.validateError(result, i++, "duplicate arguments may have been specified for 'id' via the named" +
                " argument and the argument for the included record parameter", 223, 9);
        BAssertUtil.validateError(result, i++, "duplicate arguments may have been specified for 'id' via the named" +
                        " argument and the argument for the included record parameter", 224, 31);
        BAssertUtil.validateError(result, i++, "duplicate arguments may have been specified for 'name' via the named" +
                " argument and the argument for the included record parameter", 225, 31);
        BAssertUtil.validateError(result, i++, "duplicate arguments may have been specified for 'idNew' via the named" +
                " argument and the argument for the included record parameter", 239, 38);
        BAssertUtil.validateError(result, i++, "duplicate arguments may have been specified for 'idNew' via the named" +
                " argument and the argument for the included record parameter", 240, 38);
        BAssertUtil.validateError(result, i++, "duplicate arguments may have been specified for 'idNew' via the named" +
                " argument and the argument for the included record parameter", 241, 43);
        BAssertUtil.validateError(result, i++, "duplicate arguments may have been specified for 'idNew' via the named" +
                " argument and the argument for the included record parameter", 242, 36);
        BAssertUtil.validateError(result, i++, "duplicate arguments may have been specified for 'id' via the named" +
                        " argument and the argument for the included record parameter", 242, 48);
        BAssertUtil.validateError(result, i++, "duplicate arguments may have been specified for 'id' via the named" +
                        " argument and the argument for the included record parameter", 243, 9);
        BAssertUtil.validateError(result, i++, "duplicate arguments may have been specified for 'idNew' via the named" +
                " argument and the argument for the included record parameter", 244, 9);
        BAssertUtil.validateError(result, i++, "duplicate arguments may have been specified for 'idNew' via the named" +
                " argument and the argument for the included record parameter", 245, 9);
        BAssertUtil.validateError(result, i++, "duplicate arguments may have been specified for 'id' via the named" +
                        " argument and the argument for the included record parameter", 245, 20);
        BAssertUtil.validateError(result, i++, "duplicate arguments may have been specified for 'rec' via the named" +
                        " argument and the argument for the included record parameter", 259, 9);
