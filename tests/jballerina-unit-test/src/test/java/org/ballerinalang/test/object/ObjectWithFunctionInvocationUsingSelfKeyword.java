...
public class ObjectWithFunctionInvocationUsingSelfKeyword {
    ...
    public void testSelfKeywordInvocationNegative() {
        ...
        BAssertUtil.validateError(compileResult, 1, "fields 'name, city' not initialized", 30, 13);
        BAssertUtil.validateError(compileResult, 2, "fields 'name, city' not initialized", 55, 13);
        BAssertUtil.validateError(compileResult, 3, "fields 'name, city' not initialized", 84, 9);
        BAssertUtil.validateError(compileResult, 4, "fields 'name, city' not initialized", 105, 17);
    }
}
