...
public class DoStmtsTest {
    ...
    public void testNegative1() {
        ...
        BAssertUtil.validateWarning(negativeFile1, index++, "unused variable 'e'", 17, 12);
        BAssertUtil.validateError(negativeFile1, index++, "incompatible error definition type: " +
                "'ErrorTypeA' will not be matched to 'ErrorTypeB'", 30, 12);
        BAssertUtil.validateWarning(negativeFile1, index++, "unused variable 'e'", 30, 12);
        BAssertUtil.validateWarning(negativeFile1, index++, "unused variable 'e'", 43, 12);
        BAssertUtil.validateWarning(negativeFile1, index++, "unused variable 'e'", 57, 12);
        ...
        BAssertUtil.validateError(negativeFile1, index++, "incompatible error definition type: " +
                "'ErrorTypeB' will not be matched to 'ErrorTypeA'", 90, 12);
