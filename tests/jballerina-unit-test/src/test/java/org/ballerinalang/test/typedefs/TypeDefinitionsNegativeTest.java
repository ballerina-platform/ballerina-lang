...
public class TypeDefinitionsNegativeTest {
    ...
    public void testSemanticsNegative() {
        ...
        BAssertUtil.validateError(compileResult, index++, "invalid intersection type 'int & string': no intersection",
                20, 30);
        BAssertUtil.validateError(compileResult, index++, "unsupported intersection", 20, 30);
