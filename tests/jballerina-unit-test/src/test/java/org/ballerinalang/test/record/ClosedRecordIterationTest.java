...
public class ClosedRecordIterationTest {
    ...
    public void testForeachWithClosedRecords() {
        ...
        BArray returns = (BArray) JvmRunUtil.invoke(result, "testForeachWithClosedRecords");
    ...
    public void testForeachOpWithClosedRecords() {
        BArray returns = (BArray) JvmRunUtil.invoke(result, "testForeachOpWithClosedRecords");
    ...
    public void testMapOpWithClosedRecords() {
        String[] expectedFields = new String[]{"name", "age", "address"};
        Object returns = JvmRunUtil.invoke(result, "testMapOpWithClosedRecords");
    ...
    public void testFilterOpWithClosedRecords() {
        ...
        Object returns = JvmRunUtil.invoke(result, "testFilterOpWithClosedRecords");
    ...
    public void testReduceOpWithClosedRecords() {
        Object returns = JvmRunUtil.invoke(result, "testReduceOpWithClosedRecords");
    ...
    public void testChainedOpsWithClosedRecords() {
        Object returns = JvmRunUtil.invoke(result, "testChainedOpsWithClosedRecords");
    ...
    public void testMapWithAllStringClosedRecord() {
        Object returns = JvmRunUtil.invoke(result, "testMapWithAllStringClosedRecord");
    ...
    public void testMapWithAllIntClosedRecord() {
        ...
        Object returns = JvmRunUtil.invoke(result, "testMapWithAllIntClosedRecord", args);
    ...
    public void testMapWithAllFloatClosedRecord() {
        ...
        Object returns = JvmRunUtil.invoke(result, "testMapWithAllFloatClosedRecord", args);
    ...
    public void testFilterWithAllStringClosedRecord() {
        ...
        Object returns = JvmRunUtil.invoke(result, "testFilterWithAllStringClosedRecord");
    ...
    public void testFilterWithAllIntClosedRecord() {
        ...
        Object returns = JvmRunUtil.invoke(result, "testFilterWithAllIntClosedRecord");
    ...
    public void testFilterWithAllFloatClosedRecord() {
        final double a = 20.15, b = 7.89, c = 5.15;
        Object[] args = new Object[]{(a), (b), (c)};
        Object returns = JvmRunUtil.invoke(result, "testFilterWithAllFloatClosedRecord", args);
    ...
    public void testTerminalOpsOnAllIntClosedRecord() {
        ...
        BArray returns = (BArray) JvmRunUtil.invoke(result, "testTerminalOpsOnAllIntClosedRecord", args);
    ...
    public void testTerminalOpsOnAllIntClosedRecord2() {
        ...
        BArray returns = (BArray) JvmRunUtil.invoke(result, "testTerminalOpsOnAllIntClosedRecord2", args);
    ...
    public void testChainedOpsWithClosedRecords2() {
        Object returns = JvmRunUtil.invoke(result, "testChainedOpsWithClosedRecords2");
