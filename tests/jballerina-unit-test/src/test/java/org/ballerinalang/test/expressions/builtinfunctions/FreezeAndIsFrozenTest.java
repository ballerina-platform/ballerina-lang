...
public class FreezeAndIsFrozenTest {
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp =
                    "error: modification not allowed on readonly value.*",
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp =
                    "error: Invalid map insertion, modification not allowed on readonly value.*")
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp =
                    "error: Failed to remove element from map, modification not allowed on readonly value.*")
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp =
                    "error: Failed to set children, modification not allowed on readonly value.*")
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp =
                    "error: Failed to clear map, modification not allowed on readonly value.*")
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp =
                    "error: Invalid update of record field, modification not allowed on readonly value.*")
    ...
    public void testFrozenValueUpdatePanicWithCheckTrap() {
        ...
        Assert.assertEquals(((BError) returns[0]).getMessage(), "modification not allowed on readonly value");
    }
