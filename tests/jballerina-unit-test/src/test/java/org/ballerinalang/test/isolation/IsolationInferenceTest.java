...
public class IsolationInferenceTest {
    ...
    public void testIsolatedNonInferencePubliclyExposedConstructs() {
        ...
        int i = 0;
        validateWarning(result, i++, getAttemptToExposeSymbolError("NonPubliclyExposedInferredClassUsedInNonPublicTypes"),
                93, 5);
        validateWarning(result, i++, getAttemptToExposeSymbolError("NonPubliclyExposedInferredClassUsedInNonPublicTypes"),
                95, 43);
        validateWarning(result, i++, getAttemptToExposeSymbolError(
                "NonPubliclyExposedInferredReadOnlyClassUsedInNonPublicTypes"), 96, 45);
        validateWarning(result, i++, getAttemptToExposeSymbolError("ClassPubliclyExposedViaVariable"), 141, 1);
        ...
        validateWarning(result, i++, getAttemptToExposeSymbolError("PubliclyExposedInferableClassUsedInRecord"), 158, 5);
        ...
        validateWarning(result, i++, getAttemptToExposeSymbolError("PubliclyExposedInferableClassUsedInClassMethodParam"),
                464, 5);
        validateWarning(result, i++, getAttemptToExposeSymbolError("PubliclyExposedInferableClassUsedInClassMethodParam"),
                466, 43);
        validateWarning(result, i++, getAttemptToExposeSymbolError(
        ...
        validateWarning(result, i++, getAttemptToExposeSymbolError("PubliclyExposedInferableClassUsedInFunctionParam"),
                515, 1);
        validateWarning(result, i++, getAttemptToExposeSymbolError("PubliclyExposedInferableClassUsedInFunctionParam"),
                517, 39);
        validateWarning(result, i++, getAttemptToExposeSymbolError(
