...
public class FreezeAndIsFrozenTest {
    ...
    public void testFreezeAndIsFrozenSemanticsNegativeCases() {
        ...
        validateError(semanticsNegativeResult, index++,
                "incompatible types: expected '(readonly|xml|...[]|map<...>|table<map<...>>)', found 'PersonObj'",
                19, 39);
        validateError(semanticsNegativeResult, index++,
                "incompatible types: expected '(readonly|xml|...[]|map<...>|table<map<...>>)', found 'map<PersonObj>'",
                24, 9);
        validateError(semanticsNegativeResult, index++,
                "incompatible types: expected '(readonly|xml|...[]|map<...>|table<map<...>>)', found 'PersonObj[]'",
                29, 9);
        ...
        validateError(semanticsNegativeResult, index++,
                "incompatible types: expected '(readonly|xml|...[]|map<...>|table<map<...>>)', found '[int," +
