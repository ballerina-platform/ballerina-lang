...
public class BFloatValueTest {
    ...
    public void testInvalidValuesWithFloatType() {
        ...
        int i = 0;
        BAssertUtil.validateError(result, i++, "'0xFFFFFFFFFFFFFFFF' is out of range for Hexadecimal", 2, 15);
        BAssertUtil.validateError(result, i++, "'0xabc435de769FEAB0' is out of range for Hexadecimal", 4, 9);
        BAssertUtil.validateError(result, i++, "'0xaaaaaaaaaaaaaaa0' is out of range for Hexadecimal", 6, 9);
        BAssertUtil.validateError(result, i++, "'0xAAAAAAAAAAAAAAA0' is out of range for Hexadecimal", 8, 9);
        BAssertUtil.validateError(result, i++, "'0xFFFFFFFFFFFFFFFF' is out of range for Hexadecimal", 10, 23);
        BAssertUtil.validateError(result, i++, "'0xabc435de769FEAB0' is out of range for Hexadecimal", 12, 9);
        BAssertUtil.validateError(result, i++, "'0xaaaaaaaaaaaaaaa0' is out of range for Hexadecimal", 14, 9);
        BAssertUtil.validateError(result, i++, "H'0xAAAAAAAAAAAAAAA0' is out of range for Hexadecimal", 16, 9);
        BAssertUtil.validateError(result, i++, "'0xFFFFFFFFFFFFFFFF' is out of range for Hexadecimal", 19, 12);
        BAssertUtil.validateError(result, i++, "'0xabc435de769FEAB0' is out of range for Hexadecimal", 21, 12);
        BAssertUtil.validateError(result, i++, "'0xaaaaaaaaaaaaaaa0' is out of range for Hexadecimal", 23, 12);
        BAssertUtil.validateError(result, i++, "'0xAAAAAAAAAAAAAAA0' is out of range for Hexadecimal", 25, 12);
        BAssertUtil.validateError(result, i++, "'0xFFFFFFFFFFFFFFFF' is out of range for Hexadecimal", 27, 20);
        BAssertUtil.validateError(result, i++, "'0xabc435de769FEAB0' is out of range for Hexadecimal", 29, 20);
        BAssertUtil.validateError(result, i++, "'0xaaaaaaaaaaaaaaa0' is out of range for Hexadecimal", 31, 20);
        BAssertUtil.validateError(result, i++, "'0xAAAAAAAAAAAAAAA0' is out of range for Hexadecimal", 33, 20);
        BAssertUtil.validateError(result, i++, "'0xFFFFFFFFFFFFFFFF' is out of range for Hexadecimal", 37, 16);
        BAssertUtil.validateError(result, i++, "'0xFFFFFFFFFFFFFFFF' is out of range for Hexadecimal", 41, 17);
        BAssertUtil.validateError(result, i++, "'0xFFFFFFFFFFFFFFFF' is out of range for Hexadecimal", 44, 20);
        BAssertUtil.validateError(result, i++, "'0Xffffffffffffffff' is out of range for Hexadecimal", 45, 20);
        BAssertUtil.validateError(result, i++, "'0XFFFFFFFFFFFFFFFF' is out of range for Hexadecimal", 46, 21);
        BAssertUtil.validateError(result, i++, "'0x' is out of range for Hexadecimal", 48, 16);
        BAssertUtil.validateError(result, i++, "missing hex number after hex indicator", 48, 16);
        BAssertUtil.validateError(result, i++, " '0X' is out of range for Hexadecimal", 49, 10);
        BAssertUtil.validateError(result, i++, "missing hex number after hex indicator", 49, 10);
        BAssertUtil.validateError(result, i++, "'0x' is out of range for Hexadecimal", 51, 20);
        BAssertUtil.validateError(result, i++, "missing hex number after hex indicator", 51, 20);
        BAssertUtil.validateError(result, i++, "'0x' is out of range for Hexadecimal", 53, 24);
        BAssertUtil.validateError(result, i++, "missing hex number after hex indicator", 53, 24);
        BAssertUtil.validateError(result, i++, "'0X' is out of range for Hexadecimal", 54, 10);
