...
public class StructEquivalencyNegativeTest {
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = "error: Conversion error: 'struct-eq-neg:employee01' " +
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = "error: Conversion error: 'struct-eq-neg:employee02' " +
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = "error: Conversion error: 'struct-eq-neg:employee03' " +
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = "error: Conversion error: 'struct-eq-neg:employee06' " +
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = "error: Conversion error: 'org.foo.bar:userBar' " +
