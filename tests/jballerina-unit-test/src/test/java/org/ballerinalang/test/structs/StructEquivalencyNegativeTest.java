...
public class StructEquivalencyNegativeTest {
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = ".*ConversionError message='struct-eq-neg:employee01' value cannot be converted to 'struct-eq-neg:person01'")
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = ".*ConversionError message='struct-eq-neg:employee02' value cannot be converted to 'struct-eq-neg:person02'")
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = ".*ConversionError message='struct-eq-neg:employee03' value cannot be converted to 'struct-eq-neg:person03'")
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = ".*ConversionError message='struct-eq-neg:employee06' value cannot be converted to 'struct-eq-neg:person06'")
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = ".*ConversionError message='org.foo.bar:userBar' value cannot be converted to 'org.foo:userFoo'")
