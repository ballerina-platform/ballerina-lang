...
public class SimpleConstantAccessInBalaTest {
    ...
    public void testAccessConstantWithoutType() {
        Object returns = JvmRunUtil.invoke(compileResult, "testAccessConstantWithoutType");
        Assert.assertEquals(returns.toString(), "Ballerina");
    }

    @Test
    public void testAccessConstantWithoutTypeAsString() {
        Object returns = JvmRunUtil.invoke(compileResult, "testAccessConstantWithoutTypeAsString");
        Assert.assertEquals(returns.toString(), "Ballerina");
    }

    @Test
    public void testAccessConstantWithType() {
        Object returns = JvmRunUtil.invoke(compileResult, "testAccessConstantWithType");
        Assert.assertEquals(returns.toString(), "Colombo");
    }

    @Test
    public void testAccessFiniteType() {
        Object returns = JvmRunUtil.invoke(compileResult, "testAccessFiniteType");
        Assert.assertEquals(returns.toString(), "A");
    }

    @Test
    public void testReturnFiniteType() {
        Object returns = JvmRunUtil.invoke(compileResult, "testReturnFiniteType");
        Assert.assertEquals(returns.toString(), "A");
    }

    @Test
    public void testAccessTypeWithContInDef() {
        Object returns = JvmRunUtil.invoke(compileResult, "testAccessTypeWithContInDef");
