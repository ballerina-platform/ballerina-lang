...
package org.ballerinalang.test.bala.documentation;
...
public class DocumentationTest {
    ...
    @BeforeClass
    public void setup() {
        BCompileUtil.compileAndCacheBala("test-src/bala/test_projects/test_documentation");
        CompileResult result = BCompileUtil.compile("test-src/bala/test_bala/documentation/test_documentation.bal");
        Assert.assertEquals(result.getErrorCount(), 0);
        symbol = ((BLangPackage) result.getAST()).symbol;
    }

    @Test(description = "Test Doc attachments in Bala.")
    public void testDocAttachmentBala() {
