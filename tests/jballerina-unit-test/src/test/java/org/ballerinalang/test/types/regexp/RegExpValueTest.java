...
public class RegExpValueTest {
    ...
    public void testRegExpValueNegative() {
        ...
        validateError(negativeResult, index++, "incompatible types: expected 'boolean', found " +
                "'regexp:RegExp'", 33, 9);
        validateError(negativeResult, index++, "missing backtick token", 35, 1);
        validateError(negativeResult, index++, "missing close brace token", 35, 1);
        validateError(negativeResult, index++, "missing colon token", 35, 1);
        validateError(negativeResult, index++, "missing expression", 35, 1);
        validateError(negativeResult, index++, "missing semicolon token", 35, 1);
