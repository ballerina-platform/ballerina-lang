...
package org.ballerinalang.test.balo.isolation;
 ...
 * @since 2.0.0
 */
public class IsolationAnalysisBaloTest {
    private CompileResult result;

    @BeforeClass
    public void setup() {
        BCompileUtil.compileAndCacheBalo("test-src/balo/test_projects/test_project_isolation");
        result = BCompileUtil.compile("test-src/balo/test_balo/isolation/test_isolation.bal");
    }
    ...
    public void testIsolationNegative() {
        CompileResult negativeRes =
                BCompileUtil.compile("test-src/balo/test_balo/isolation/test_isolation_negative.bal");
        int index = 0;
