...
public class OpenRecordTypeInclusionTest {
    ...
    public void negativeTests() {
        ...
        BAssertUtil.validateError(negative, index++, "invalid cyclic type reference in 'PersonOne'", 84, 1);
        BAssertUtil.validateError(negative, index++, "invalid cyclic type reference in 'PersonTwo'", 89, 1);
