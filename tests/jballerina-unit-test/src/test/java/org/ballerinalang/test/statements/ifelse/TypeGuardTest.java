...
//                "incompatible types: 'string' will not be matched to 'float'", 117, 37);
        ...
        // TODO : Fix me : #21609
//        BAssertUtil.validateError(negativeResult, i++,
//                "incompatible types: 'Person' will not be matched to 'float'", 147, 40);
        BAssertUtil.validateError(negativeResult, i,
...
//                238, 17);
    ...
    @Test(description = "Test Typetest for TypeDefs when types are not equal", groups = "brokenOnXMLLangLibChange")
