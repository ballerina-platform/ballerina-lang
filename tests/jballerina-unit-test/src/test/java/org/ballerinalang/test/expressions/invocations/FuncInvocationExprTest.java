...
public class FuncInvocationExprTest {
    ...
    public void testFunctionCallNegativeCases() {
        ...
        validateError(funcInvocationNegative, i++,
                "named argument is not allowed for rest parameter", 102, 18);
        validateError(funcInvocationNegative, i++,
        ...
        validateError(funcInvocationNegative, i++,
                "named argument is not allowed for rest parameter", 121, 11);
        validateError(funcInvocationNegative, i++,
                "named argument is not allowed for rest parameter", 122, 11);
        validateError(funcInvocationNegative, i++,
                "named argument is not allowed for rest parameter", 123, 14);
        validateError(funcInvocationNegative, i++,
                "named argument is not allowed for rest parameter", 124, 18);
