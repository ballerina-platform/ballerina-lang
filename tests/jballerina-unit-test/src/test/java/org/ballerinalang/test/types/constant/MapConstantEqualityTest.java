...
public class MapConstantEqualityTest {
    ...
    public void testComplexBooleanMapValueEqualityUsingDifferentReference() {
        Object returns = BRunUtil.invoke(compileResult, "testComplexBooleanMapValueEqualityUsingDifferentReference");
        Assert.assertNotNull(returns);
        Assert.assertTrue((Boolean) returns);
    }
    ...
    public void testComplexIntMapReferenceEqualityUsingDifferentReference() {
        Object returns = BRunUtil.invoke(compileResult, "testComplexIntMapReferenceEqualityUsingDifferentReference");
        Assert.assertNotNull(returns);
        Assert.assertFalse((Boolean) returns);
    }
    ...
    public void testComplexIntMapValueEqualityUsingMapAccessSameReference() {
        Object returns = BRunUtil.invoke(compileResult, "testComplexIntMapValueEqualityUsingMapAccessSameReference");
        Assert.assertNotNull(returns);
        Assert.assertTrue((Boolean) returns);
    }
    ...
    public void testSimpleByteMapReferenceEqualityUsingDifferentReference() {
        Object returns = BRunUtil.invoke(compileResult, "testSimpleByteMapReferenceEqualityUsingDifferentReference");
        Assert.assertNotNull(returns);
        Assert.assertFalse((Boolean) returns);
    }
    ...
    public void testComplexByteMapReferenceEqualityUsingDifferentReference() {
        Object returns = BRunUtil.invoke(compileResult, "testComplexByteMapReferenceEqualityUsingDifferentReference");
        Assert.assertNotNull(returns);
        Assert.assertFalse((Boolean) returns);
    }
    ...
    public void testComplexByteMapValueEqualityUsingMapAccessSameReference() {
        Object returns = BRunUtil.invoke(compileResult, "testComplexByteMapValueEqualityUsingMapAccessSameReference");
        Assert.assertNotNull(returns);
        Assert.assertTrue((Boolean) returns);
    }
    ...
    public void testSimpleFloatMapReferenceEqualityUsingDifferentReference() {
        Object returns = BRunUtil.invoke(compileResult, "testSimpleFloatMapReferenceEqualityUsingDifferentReference");
        Assert.assertNotNull(returns);
        Assert.assertFalse((Boolean) returns);
    }
    ...
    public void testComplexDecimalMapValueEqualityUsingDifferentReference() {
        Object returns = BRunUtil.invoke(compileResult, "testComplexDecimalMapValueEqualityUsingDifferentReference");
        Assert.assertNotNull(returns);
        Assert.assertTrue((Boolean) returns);
    }
    ...
    public void testComplexNilMapValueEqualityUsingMapAccessSameReference() {
        Object returns = BRunUtil.invoke(compileResult, "testComplexNilMapValueEqualityUsingMapAccessSameReference");
        Assert.assertNotNull(returns);
        Assert.assertTrue((Boolean) returns);
    }
