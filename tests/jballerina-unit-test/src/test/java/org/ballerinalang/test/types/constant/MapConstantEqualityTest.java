...
public class MapConstantEqualityTest {
    ...
    public void testComplexBooleanMapValueEqualityUsingDifferentReference() {
        Object returns = JvmRunUtil.invoke(compileResult, "testComplexBooleanMapValueEqualityUsingDifferentReference");
        Assert.assertNotNull(returns);
        Assert.assertTrue((Boolean) returns);
    }
    ...
    public void testComplexIntMapReferenceEqualityUsingDifferentReference() {
        Object returns = JvmRunUtil.invoke(compileResult, "testComplexIntMapReferenceEqualityUsingDifferentReference");
        Assert.assertNotNull(returns);
        Assert.assertFalse((Boolean) returns);
    }
    ...
    public void testComplexIntMapValueEqualityUsingMapAccessSameReference() {
        Object returns = JvmRunUtil.invoke(compileResult, "testComplexIntMapValueEqualityUsingMapAccessSameReference");
        Assert.assertNotNull(returns);
        Assert.assertTrue((Boolean) returns);
    }
    ...
    public void testSimpleByteMapReferenceEqualityUsingDifferentReference() {
        Object returns = JvmRunUtil.invoke(compileResult, "testSimpleByteMapReferenceEqualityUsingDifferentReference");
        Assert.assertNotNull(returns);
        Assert.assertFalse((Boolean) returns);
    }
    ...
    public void testComplexByteMapReferenceEqualityUsingDifferentReference() {
        Object returns = JvmRunUtil.invoke(compileResult, "testComplexByteMapReferenceEqualityUsingDifferentReference");
        Assert.assertNotNull(returns);
        Assert.assertFalse((Boolean) returns);
    }
    ...
    public void testComplexByteMapValueEqualityUsingMapAccessSameReference() {
        Object returns = JvmRunUtil.invoke(compileResult, "testComplexByteMapValueEqualityUsingMapAccessSameReference");
        Assert.assertNotNull(returns);
        Assert.assertTrue((Boolean) returns);
    }
    ...
    public void testSimpleFloatMapReferenceEqualityUsingDifferentReference() {
        Object returns = JvmRunUtil.invoke(compileResult, "testSimpleFloatMapReferenceEqualityUsingDifferentReference");
        Assert.assertNotNull(returns);
        Assert.assertFalse((Boolean) returns);
    }
    ...
    public void testComplexDecimalMapValueEqualityUsingDifferentReference() {
        Object returns = JvmRunUtil.invoke(compileResult, "testComplexDecimalMapValueEqualityUsingDifferentReference");
        Assert.assertNotNull(returns);
        Assert.assertTrue((Boolean) returns);
    }
    ...
    public void testComplexNilMapValueEqualityUsingMapAccessSameReference() {
        Object returns = JvmRunUtil.invoke(compileResult, "testComplexNilMapValueEqualityUsingMapAccessSameReference");
        Assert.assertNotNull(returns);
        Assert.assertTrue((Boolean) returns);
    }
