...
public class NegativeValidationTest {
    ...
    public void testClassNotFound() {
        ...
        BAssertUtil.validateError(compileResult, 0,
                "{ballerinax/java}CLASS_NOT_FOUND 'org.ballerinalang.nativeimpl.jvm.tests.PublicStaticMethods'",
    ...
    public void testMethodNotFound1() {
        ...
        Assert.assertEquals(compileResult.getDiagnostics().length, 1);
        BAssertUtil.validateError(compileResult, 0,
                "{ballerinax/java}METHOD_NOT_FOUND 'No such public method 'acceptStringOrErrorReturn' found in " +
    ...
    public void testMethodNotFound2() {
        ...
        Assert.assertEquals(compileResult.getDiagnostics().length, 1);
        BAssertUtil.validateError(compileResult, 0,
                "{ballerinax/java}METHOD_NOT_FOUND 'No such public method 'acceptObjectAndObjectReturn' with '3' " +
    ...
    public void testMethodNotFound3() {
        ...
        Assert.assertEquals(compileResult.getDiagnostics().length, 1);
        BAssertUtil.validateError(compileResult, 0,
                "{ballerinax/java}METHOD_NOT_FOUND 'No such public method 'acceptRecordAndRecordReturn' with '3' " +
                        "parameter(s) found in class 'class org.ballerinalang.nativeimpl.jvm.tests.StaticMethods''",
    ...
    public void testMethodNotFound4() {
        ...
        Assert.assertEquals(compileResult.getDiagnostics().length, 1);
        BAssertUtil.validateError(compileResult, 0,
                "{ballerinax/java}METHOD_NOT_FOUND 'No such public method 'acceptIntAndUnionReturn' found in class " +
    ...
    public void testMethodNotFound5() {
        ...
        Assert.assertEquals(compileResult.getDiagnostics().length, 1);
        BAssertUtil.validateError(compileResult, 0,
                "{ballerinax/java}METHOD_NOT_FOUND 'No such public method 'acceptIntStringAndUnionReturn' found in " +
                        "class 'class org.ballerinalang.nativeimpl.jvm.tests.StaticMethods''",
    ...
    public void testMethodSignatureNotMatch1() {
        ...
        Assert.assertEquals(compileResult.getDiagnostics().length, 1);
        BAssertUtil.validateError(compileResult, 0,
                "{ballerinax/java}METHOD_SIGNATURE_DOES_NOT_MATCH 'No such Java method " +
    ...
    public void testMethodSignatureNotMatch7() {
        ...
        Assert.assertEquals(compileResult.getDiagnostics().length, 1);
        BAssertUtil.validateError(compileResult, 0,
                "{ballerinax/java}METHOD_SIGNATURE_DOES_NOT_MATCH 'Incompatible param type for method 'split' in " +
    ...
    public void testMethodSignatureNotMatch8() {
        ...
        Assert.assertEquals(compileResult.getDiagnostics().length, 1);
        BAssertUtil.validateError(compileResult, 0,
                "{ballerinax/java}METHOD_SIGNATURE_DOES_NOT_MATCH 'Parameter count does not match with Java method " +
