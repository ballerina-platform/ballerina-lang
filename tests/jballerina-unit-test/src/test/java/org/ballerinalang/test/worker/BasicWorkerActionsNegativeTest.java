...
public class BasicWorkerActionsNegativeTest {
    ...
    public void setup() {
        ...
        Assert.assertEquals(result.getErrorCount(), 18, "Worker actions negative test error count");
    }
    ...
    public void testNegativeWorkerActions() {
        ...
        BAssertUtil.validateError(result, index++, "invalid worker reference 'wy'", 142, 26);
        BAssertUtil.validateError(result, index++, "invalid worker reference 'wiy'", 153, 28);
        BAssertUtil.validateError(result, index++, "invalid worker reference 'wix'", 159, 26);
        BAssertUtil.validateError(result, index++, "invalid worker reference 'wx'", 160, 26);
        BAssertUtil.validateError(result, index++, "invalid worker reference 'wx'", 166, 26);
        BAssertUtil.validateError(result, index++, "invalid worker reference 'wx'", 167, 21);
        BAssertUtil.validateError(result, index++, "invalid worker reference 'lw1'", 172, 22);
    }
}
