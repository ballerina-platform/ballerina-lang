 ...
 * Constant test cases.
 */
public class MapConstantEqualityInDifferentBalaTest {
    ...
    public void setup() {
        ...
        BCompileUtil.compileAndCacheBala("test-src/bala/test_projects/test_project_bar");
        compileResult = BCompileUtil.compile(
                "test-src/bala/test_bala/constant/map-literal-constant-equality-different-modules.bal");
    }
