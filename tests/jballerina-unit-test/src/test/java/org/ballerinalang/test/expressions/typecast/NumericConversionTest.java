...
public class NumericConversionTest {
    ...
    @Test(dataProvider = "invalidByteValues", expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = "error: 'int' " +
    ...
    @Test(dataProvider = "invalidByteValues", expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = "error: 'decimal'" +
                    " value '.*' cannot be converted to 'byte'.*")
    ...
    @Test(dataProvider = "invalidByteValues", expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = "error: 'decimal' cannot be cast to '(byte\\|Employee)'.*")
