...
public class QueryNegativeTests {
    ...
    public void testFromClauseWithInvalidType() {
        ...
        validateError(compileResult, index++, "incompatible types: expected 'Person', found 'Teacher'",
                64, 18);
        validateError(compileResult, index++, "undefined field 'lastName' in record 'Teacher'", 67, 30);
        validateError(compileResult, index++, "undefined field 'age' in record 'Teacher'", 68, 25);
