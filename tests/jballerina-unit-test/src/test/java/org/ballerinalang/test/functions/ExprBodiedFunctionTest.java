...
public class ExprBodiedFunctionTest {
    ...
    @Test
    public void testRecordAsAnExpr() {
        BRunUtil.invoke(compileResult, "testRecordAsAnExpr");
    }

    @Test
    public void testBinaryExprs() {
        BRunUtil.invoke(compileResult, "testBinaryExprs");
    }
