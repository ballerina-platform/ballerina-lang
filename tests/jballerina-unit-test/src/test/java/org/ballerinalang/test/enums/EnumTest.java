...
public class EnumTest {
    ...
    public void testNegative() {
        ...
        validateError(negativeTest, i++, "expression is not a constant expression", 79, 15);
        validateError(negativeTest, i++, "undefined symbol 'CYCLIC1'", 79, 15);
        validateError(negativeTest, i++, "illegal cyclic reference '[E, D]'", 82, 1);
        validateError(negativeTest, i++, "expression is not a constant expression", 83, 18);
