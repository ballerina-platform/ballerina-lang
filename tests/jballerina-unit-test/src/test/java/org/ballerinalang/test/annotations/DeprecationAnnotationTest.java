...
public class DeprecationAnnotationTest {
    ...
    public void testDeprecationAnnotation() {
        ...
        BAssertUtil.validateWarning(compileResult, i++, "usage of construct 'fieldOne' is deprecated", 151, 9);
        BAssertUtil.validateWarning(compileResult, i++, "usage of construct 't' is deprecated", 152, 9);
        BAssertUtil.validateWarning(compileResult, i++, "usage of construct 'fieldOne' is deprecated", 174, 9);
        BAssertUtil.validateWarning(compileResult, i++, "usage of construct 't' is deprecated", 175, 9);
        BAssertUtil.validateWarning(compileResult, i++, "usage of construct 'fieldOne' is deprecated", 194, 9);
        BAssertUtil.validateWarning(compileResult, i++, "usage of construct 't' is deprecated", 195, 9);
        ...
        BAssertUtil.validateWarning(compileResult, i++, "usage of construct 'name' is deprecated", 266, 16);
        ...
        BAssertUtil.validateWarning(compileResult, i++, "usage of construct 'id' is deprecated", 283, 13);
        BAssertUtil.validateWarning(compileResult, i++, "usage of construct 'getId' is deprecated", 284, 13);
        ...
        BAssertUtil.validateWarning(compileResult, i++, "usage of construct 'name' is deprecated", 287, 16);
        BAssertUtil.validateWarning(compileResult, i++, "usage of construct 'getName' is deprecated", 288, 16);
