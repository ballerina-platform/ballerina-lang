...
public class FunctionSignatureNegativeTest {
    ...
    public void testExternalResourceFunction() {
        ...
        BAssertUtil.validateError(result, 0,
                "external resource methods of service objects are not supported by the implementation", 19, 5);
        BAssertUtil.validateError(result, 1,
                "external resource methods of service objects are not supported by the implementation", 21, 5);
        BAssertUtil.validateError(result, 2,
                "external resource methods of service objects are not supported by the implementation", 23, 5);
    }
}
