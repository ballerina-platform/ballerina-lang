...
public class TemplateExpressionTest {
    ...
    public void testJSONInit() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testJSONInit", args);
    ...
    public void testStringVariableAccessInJSONInit() {
        Object[] args = {StringUtils.fromString("WSO2")};
        Object returns = JvmRunUtil.invoke(compileResult, "testStringVariableAccessInJSONInit", args);
        Assert.assertTrue(returns instanceof BMap);
    ...
    public void testIntegerVariableAccessInJSONInit() {
        Object[] args = {(11)};
        Object returns = JvmRunUtil.invoke(compileResult, "testIntegerVariableAccessInJSONInit", args);
        Assert.assertTrue(returns instanceof BMap);
    ...
    public void testEnrichFullJSON() {
        Object[] args = {(11)};
        Object returns = JvmRunUtil.invoke(compileResult, "testEnrichFullJSON", args);
        Assert.assertTrue(returns instanceof BMap);
        String expected = "{\"name\":\"John\"}";
        Assert.assertEquals(returns.toString(), expected);
    }
    ...
    public void testMultipleVariablesInJSONInit() {
        ...
        Object returns = JvmRunUtil.invoke(compileResult, "testMultipleVariablesInJSONInit", args);
        Assert.assertTrue(returns instanceof BMap);
    ...
    public void testArrayVariableAccessInJSONInit() {
        Object returns = JvmRunUtil.invoke(compileResult, "testArrayVariableAccessInJSONInit");
        Assert.assertTrue(returns instanceof BMap);
    ...
    public void testMapVariableAccessInJSONInit() {
        Object returns = JvmRunUtil.invoke(compileResult, "testMapVariableAccessInJSONInit");
        Assert.assertTrue(returns instanceof BMap);
    ...
    public void testBooleanIntegerValuesAsStringsInJSONInit() {
        Object returns = JvmRunUtil.invoke(compileResult, "testBooleanIntegerValuesAsStringsInJSONInit");
        Assert.assertTrue(returns instanceof BMap);
