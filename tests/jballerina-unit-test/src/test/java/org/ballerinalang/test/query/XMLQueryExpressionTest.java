...
public class XMLQueryExpressionTest {
    ...
    public void testSimpleQueryExprForXML() {
        Object returnValues = JvmRunUtil.invoke(result, "testSimpleQueryExprForXML");
    ...
    public void testSimpleQueryExprForXML2() {
        Object returnValues = JvmRunUtil.invoke(result, "testSimpleQueryExprForXML2");
        Assert.assertNotNull(returnValues);
    ...
    public void testSimpleQueryExprForXML3() {
        Object returnValues = JvmRunUtil.invoke(result, "testSimpleQueryExprForXML3");
        Assert.assertNotNull(returnValues);
    ...
    public void testQueryExprWithLimitForXML() {
        Object returnValues = JvmRunUtil.invoke(result, "testQueryExprWithLimitForXML");
        Assert.assertNotNull(returnValues);
    ...
    public void testQueryExprWithWhereLetClausesForXML() {
        Object returnValues = JvmRunUtil.invoke(result, "testQueryExprWithWhereLetClausesForXML");
        Assert.assertNotNull(returnValues);
    ...
    public void testQueryExprWithMultipleFromClausesForXML() {
        Object returnValues = JvmRunUtil.invoke(result, "testQueryExprWithMultipleFromClausesForXML");
        Assert.assertNotNull(returnValues);
    ...
    public void testSimpleQueryExprForXMLOrNilResult() {
        Object returnValues = JvmRunUtil.invoke(result, "testSimpleQueryExprForXMLOrNilResult");
        Assert.assertNotNull(returnValues);
    ...
    public void testSimpleQueryExprForXMLOrNilResult2() {
        Object returnValues = JvmRunUtil.invoke(result, "testSimpleQueryExprForXMLOrNilResult2");
        Assert.assertNotNull(returnValues);
    ...
    public void testSimpleQueryExprForXMLOrNilResult3() {
        Object returnValues = JvmRunUtil.invoke(result, "testSimpleQueryExprForXMLOrNilResult3");
        Assert.assertNotNull(returnValues);
    ...
    public void testQueryExprWithLimitForXMLOrNilResult() {
        Object returnValues = JvmRunUtil.invoke(result, "testQueryExprWithLimitForXMLOrNilResult");
        Assert.assertNotNull(returnValues);
    ...
    public void testQueryExprWithWhereLetClausesForXMLOrNilResult() {
        Object returnValues = JvmRunUtil.invoke(result, "testQueryExprWithWhereLetClausesForXMLOrNilResult");
        Assert.assertNotNull(returnValues);
    ...
    public void testQueryExprWithMultipleFromClausesForXMLOrNilResult() {
        Object returnValues = JvmRunUtil.invoke(result, "testQueryExprWithMultipleFromClausesForXMLOrNilResult");
        Assert.assertNotNull(returnValues);
    ...
    public void testSimpleQueryExprWithVarForXML() {
        Object returnValues = JvmRunUtil.invoke(result, "testSimpleQueryExprWithVarForXML");
        Assert.assertNotNull(returnValues);
    ...
    public void testSimpleQueryExprWithListForXML() {
        BArray returnValues = (BArray) JvmRunUtil.invoke(result, "testSimpleQueryExprWithListForXML");
        Assert.assertNotNull(returnValues);
    ...
    public void testSimpleQueryExprWithUnionTypeForXML() {
        Object returnValues = JvmRunUtil.invoke(result, "testSimpleQueryExprWithUnionTypeForXML");
        Assert.assertNotNull(returnValues);
    ...
    public void testSimpleQueryExprWithUnionTypeForXML2() {
        BArray returnValues = (BArray) JvmRunUtil.invoke(result, "testSimpleQueryExprWithUnionTypeForXML2");
        Assert.assertNotNull(returnValues);
    ...
    public void testSimpleQueryExprWithXMLElementLiteral() {
        Object returnValues = JvmRunUtil.invoke(result, "testSimpleQueryExprWithXMLElementLiteral");
        Assert.assertNotNull(returnValues);
    ...
    public void testSimpleQueryExprWithNestedXMLElements() {
        Object returnValues = JvmRunUtil.invoke(result, "testSimpleQueryExprWithNestedXMLElements");
        Assert.assertNotNull(returnValues);
    ...
    public void testQueryExpressionIteratingOverXMLInFrom() {
        Object returnValues = JvmRunUtil.invoke(result, "testQueryExpressionIteratingOverXMLInFrom");
        Assert.assertNotNull(returnValues);
    ...
    public void testQueryExpressionIteratingOverXMLTextInFrom() {
        Object returnValues = JvmRunUtil.invoke(result, "testQueryExpressionIteratingOverXMLTextInFrom");
        Assert.assertNotNull(returnValues);
    ...
    public void testQueryExpressionIteratingOverXMLElementInFrom() {
        Object returnValues = JvmRunUtil.invoke(result, "testQueryExpressionIteratingOverXMLElementInFrom");
        Assert.assertNotNull(returnValues);
        Assert.assertEquals(returnValues.toString(), "<foo>Hello<bar>World</bar></foo>");
    }
    ...
    public void testQueryExpressionIteratingOverXMLPIInFrom() {
        Object returnValues = JvmRunUtil.invoke(result, "testQueryExpressionIteratingOverXMLPIInFrom");
        Assert.assertNotNull(returnValues);
    ...
    public void testQueryExpressionIteratingOverXMLWithOtherClauses() {
        Object returnValues = JvmRunUtil.invoke(result, "testQueryExpressionIteratingOverXMLWithOtherClauses");
        Assert.assertNotNull(returnValues);
    ...
    public void testQueryExpressionIteratingOverXMLInFromWithXMLOrNilResult() {
        Object returnValues = JvmRunUtil.invoke(result, "testQueryExpressionIteratingOverXMLInFromWithXMLOrNilResult");
        Assert.assertNotNull(returnValues);
    ...
    public void testQueryExpressionIteratingOverXMLInFromInInnerQueries() {
        Object returnValues = JvmRunUtil.invoke(result, "testQueryExpressionIteratingOverXMLInFromInInnerQueries");
        Assert.assertNotNull(returnValues);
    ...
    public void testXMLTemplateWithQueryExpression() {
        Object returnValues = JvmRunUtil.invoke(result, "testXMLTemplateWithQueryExpression");
        Assert.assertNotNull(returnValues);
    ...
    public void testXMLTemplateWithQueryExpression2() {
        Object returnValues = JvmRunUtil.invoke(result, "testXMLTemplateWithQueryExpression2");
        Assert.assertNotNull(returnValues);
    ...
    public void testXMLTemplateWithQueryExpression3() {
        Object returnValues = JvmRunUtil.invoke(result, "testXMLTemplateWithQueryExpression3");
        Assert.assertNotNull(returnValues);
        Assert.assertEquals(returnValues.toString(), "<data><person country=\"Germany\">Mike</person>" +
                "<person country=\"France\">Anne</person><person country=\"Russia\">John</person></data>");
    }
    ...
    public void testXMLTemplateWithQueryExpression4() {
        Object returnValues = JvmRunUtil.invoke(result, "testXMLTemplateWithQueryExpression4");
        Assert.assertNotNull(returnValues);
    ...
    public void testQueryExpressionIteratingOverXMLWithNamespaces() {
        Object returnValues = JvmRunUtil.invoke(result, "testQueryExpressionIteratingOverXMLWithNamespaces");
        Assert.assertNotNull(returnValues);
    ...
    public void testQueryExpressionIteratingOverTableReturningXML() {
        Object returnValues = JvmRunUtil.invoke(result, "testQueryExpressionIteratingOverTableReturningXML");
        Assert.assertNotNull(returnValues);
    ...
    public void testQueryExpressionIteratingOverStreamReturningXML() {
        Object returnValues = JvmRunUtil.invoke(result, "testQueryExpressionIteratingOverStreamReturningXML");
        Assert.assertNotNull(returnValues);
        Assert.assertEquals(returnValues.toString(), "<person country=\"Russia\">John</person>" +
                "<person country=\"Germany\">Mike</person>");
    }
