...
public class BByteValueNegativeTest {
    ...
    public void byteValueRuntimeNegative1() {
        ...
        Assert.assertEquals(returnValue[0].stringValue(), "'int' value '-12' cannot be converted to 'byte' {}");
    }
    ...
    public void byteValueRuntimeNegative2() {
        ...
        Assert.assertEquals(returnValue.length, 1);
        Assert.assertTrue(returnValue[0] instanceof BError);
        Assert.assertEquals(returnValue[0].stringValue(), "'int' value '-257' cannot be converted to 'byte' {}");
    }
    ...
    public void byteValueRuntimeNegative3() {
        ...
        Assert.assertEquals(returnValue.length, 1);
        Assert.assertTrue(returnValue[0] instanceof BError);
        Assert.assertEquals(returnValue[0].stringValue(), "'int' value '12,345' cannot be converted to 'byte' {}");
    }
}
