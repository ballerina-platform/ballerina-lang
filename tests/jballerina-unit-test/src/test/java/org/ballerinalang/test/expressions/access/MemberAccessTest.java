...
public class MemberAccessTest {
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = "error: tuple index out of range: index: 3, size: 2.*")
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = "error: tuple index out of range: index: 9, size: 3.*")
    ...
    @Test(expectedExceptions = BLangRuntimeException.class,
            expectedExceptionsMessageRegExp = "error: string index out of range: " +
                    "index: -1, size: 5.*")
