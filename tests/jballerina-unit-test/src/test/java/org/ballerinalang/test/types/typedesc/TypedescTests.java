...
public class TypedescTests {
    ...
    public void testNegative() {
        ...
        BAssertUtil.validateError(compileResult, index++, "invalid operation: type 'byte' does not support indexing", 9, 18);
        BAssertUtil.validateError(compileResult, index++, "missing key expr in member access expr", 9, 23);
        BAssertUtil.validateError(compileResult, index++, "invalid operation: type 'int' does not support indexing", 10, 18);
        BAssertUtil.validateError(compileResult, index++, "missing key expr in member access expr", 10, 22);
        BAssertUtil.validateError(compileResult, index++, "invalid operation: type 'string' does not support indexing", 10, 24);
        BAssertUtil.validateError(compileResult, index++, "missing key expr in member access expr", 10, 31);
