...
/*    @Test(description = "Test struct operations inside a connector")
    ...
    public void testStructLiteral() {
        CompileResult compileResult = BCompileUtil.compile("test-src/structs/src/default/struct-literals.bal");
    ...
    public void testStructLiteralInitFunc() {
        CompileResult result = BCompileUtil.compile("test-src/structs/src/default/nested-struct-inline-init.bal");
