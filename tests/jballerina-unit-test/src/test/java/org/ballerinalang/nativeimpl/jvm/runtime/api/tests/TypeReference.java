...
public class TypeReference {
    ...
    public static Boolean validateGetDetailType(BTypedesc typedesc) {
        BErrorType errorType = (BErrorType) TypeUtils.getRepresentedType(typedesc.getDescribingType());
    ...
    public static Boolean validateFunctionType(BTypedesc typedesc) {
        BFunctionType functionType = (BFunctionType) TypeUtils.getRepresentedType(typedesc.getDescribingType());
    ...
    public static Boolean validateMapType(BTypedesc typedesc) {
        BMapType mapType = (BMapType) TypeUtils.getRepresentedType(typedesc.getDescribingType());
    ...
    public static Boolean validateRecordType(BTypedesc typedesc) {
        BRecordType recordType =
                (BRecordType) (TypeUtils.getRepresentedType(typedesc.getDescribingType()));
    ...
    public static Boolean validateStreamType(BTypedesc value1, BStream value2) {
        BStreamType streamType = (BStreamType) TypeUtils.getRepresentedType(value1.getDescribingType());
    ...
    public static Boolean validateTableType(BTypedesc typedesc, TableValue tableValue) {
        BTableType tableType = (BTableType) TypeUtils.getRepresentedType(typedesc.getDescribingType());
    ...
    public static Boolean validateTypedescType(BTypedesc typedesc) {
        BTypedescType typedescType = (BTypedescType) TypeUtils.getRepresentedType(typedesc.getDescribingType());
    ...
    public static Boolean validateUnionType(BTypedesc typedesc) {
        BUnionType unionType = (BUnionType) TypeUtils.getRepresentedType(typedesc.getDescribingType());
