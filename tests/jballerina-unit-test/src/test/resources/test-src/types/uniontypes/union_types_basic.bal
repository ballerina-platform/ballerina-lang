...
function testCastToImmutableUnion() {
    ...
    assertEquality(true, y is error:TypeCastError);
    error:TypeCastError err2 = <error:TypeCastError> y;
    assertEquality("{ballerina/lang.error}TypeCastError", err2.message());
