...
object {public int age = 0; public string name = ""; function init(int age, string name){}} p1 = new(1, "Anne");
object {public int age = 0; public string name = ""; function test();} p2 = new;

function test () returns int {
    object {public int age = 0; public string name = ""; function init(int age, string name){}} p3;
