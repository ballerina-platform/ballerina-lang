...
public function testToHandleWithBoolean() returns handle|error {
    ...
    return java:toHandle(array, "boolean");
}
...
public function testFromHandleWithString(handle arrayHandle) returns boolean {
    ...
    any[]|error value = java:fromHandle(arrayHandle, "string");
    if (value is error) {
        return false;
    }
...
public function testFromHandleWithBoolean(handle arrayHandle) returns boolean {
    ...
    any[]|error value = java:fromHandle(arrayHandle, "boolean");
    if (value is error) {
        return false;
    }
...
public function testFromHandleWithFloat(handle arrayHandle) returns boolean {
    ...
    any[]|error value = java:fromHandle(arrayHandle, "float");
    if (value is error) {
        return false;
    }
...
public function testFromHandleWithDouble(handle arrayHandle) returns boolean {
    ...
    any[]|error value = java:fromHandle(arrayHandle, "double");
    if (value is error) {
        return false;
    }
    float[] array = <float[]>value;
...
public function testFromHandleWithInt(handle arrayHandle) returns boolean {
    ...
    any[]|error value = java:fromHandle(arrayHandle, "int");
    if (value is error) {
        return false;
    }
    int[] array = <int[]>value;
...
public function testFromHandleWithIntFloat(handle arrayHandle) returns boolean {
    ...
    any[]|error value = java:fromHandle(arrayHandle, "int", "float");
    if (value is error) {
        return false;
    }
    float[] array = <float[]>value;
...
public function testFromHandleWithByte(handle arrayHandle) returns boolean {
    ...
    any[]|error value = java:fromHandle(arrayHandle, "byte");
    if (value is error) {
        return false;
    }
...
public function testFromHandleWithByteFloat(handle arrayHandle) returns boolean {
    ...
    any[]|error value = java:fromHandle(arrayHandle, "byte", "float");
    if (value is error) {
        return false;
    }
    float[] array = <float[]>value;
...
public function testFromHandleWithByteInt(handle arrayHandle) returns boolean {
    ...
    any[]|error value = java:fromHandle(arrayHandle, "byte", "int");
    if (value is error) {
        return false;
    }
    int[] array = <int[]>value;
...
public function testFromHandleWithShort(handle arrayHandle) returns boolean {
    int[] arrayIntended = [34, 76, 12, 90, 45];
    any[]|error value = java:fromHandle(arrayHandle, "short", "int");
    if (value is error) {
        return false;
    }
    int[] array = <int[]>value;
...
public function testFromHandleWithShortFloat(handle arrayHandle) returns boolean {
    float[] arrayIntended = [34, 76, 12, 90, 45];
    any[]|error value = java:fromHandle(arrayHandle, "short", "float");
    if (value is error) {
        return false;
    }
    float[] array = <float[]>value;
...
public function testFromHandleWithLong(handle arrayHandle) returns boolean {
    int[] arrayIntended = [34, 76, 12, 90, 45];
    any[]|error value = java:fromHandle(arrayHandle, "long");
    if (value is error) {
        return false;
    }
    int[] array = <int[]>value;
...
public function testFromHandleWithLongFloat(handle arrayHandle) returns boolean {
    float[] arrayIntended = [34, 76, 12, 90, 45];
    any[]|error value = java:fromHandle(arrayHandle, "long", "float");
    if (value is error) {
        return false;
    }
    float[] array = <float[]>value;
...
public function testFromHandleWithCharacter(handle arrayHandle) returns boolean {
    ...
    any[]|error value = java:fromHandle(arrayHandle, "char");
        if (value is error) {
            return false;
        }
    int[] array = <int[]>value;
...
public function testFromHandleWithCharacterFloat(handle arrayHandle) returns boolean {
    ...
    any[]|error value = java:fromHandle(arrayHandle, "char", "float");
        if (value is error) {
            return false;
        }
    float[] array = <float[]>value;
...
public function testFromHandleWithHandle(handle arrayHandle) returns boolean {
    ...
    any[]|error value = java:fromHandle(arrayHandle, "handle");
    if (value is error) {
        return false;
    }
