...
import testorg/project_two as foo2;
...
public function testObjectReferingTypeFromBala_1() returns [string, float] {
...
public function testObjectReferingTypeFromBala_2() returns [string, float] {
...
public function testObjectReferingTypeFromBala_3() returns [string, float] {
    Manager3 mgr3 = new("Jane");
    return [mgr3.getName(), mgr3.getBonus(0.1)];
}

public function testObjectReferingNonAbstractObjFromBala() {
...
public function testObjectReferingNonAbstractObjLoadedFromBala() {
