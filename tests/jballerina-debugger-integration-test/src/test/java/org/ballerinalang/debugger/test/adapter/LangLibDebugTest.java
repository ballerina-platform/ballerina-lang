...
public class LangLibDebugTest {
    ...
    public void testLangLibDebugHits() throws BallerinaTestException {
        ...
        Assert.assertEquals(debugHitInfo.getLeft().getDAPBreakPoint().getLine().intValue(), 86);
        ...
        Assert.assertEquals(debugHitInfo.getLeft().getDAPBreakPoint().getLine().intValue(), 123);
    }
