...
/**
 * Test cases to find the expected types in table constructor expressions.
 *
 * @since 2201.4.0
 */
public class TableConstructorExpressionTest {
    ...
    public Object[][] getLinePos() {
        return new Object[][]{
                ...
                {26, 22, TypeDescKind.ANYDATA},
                {36, 45, TypeDescKind.TYPE_REFERENCE},
        };
    }
}
