...
/**
 * Test cases for the find expected types in variable declarations.
 *
 * @since 2.3.0
 */
public class VariableDeclarationTest {
    ...
    @BeforeClass
    public void setup() {
        Project project = BCompileUtil.loadProject("test-src/expected-type/variable_declaration_tests.bal");
    ...
    public Object[][] getLinePos() {
        return new Object[][]{
                {16, 8, TypeDescKind.INT},
                {18, 24, TypeDescKind.INT},
                {21, 19, TypeDescKind.STRING}
        };
    }
}
