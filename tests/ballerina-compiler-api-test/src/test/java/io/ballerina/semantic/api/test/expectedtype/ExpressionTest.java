...
/**
 * Test cases to find the expected types in expressions.
 *
 * @since 2201.4.0
 */
public class ExpressionTest {
    ...
    public Object[][] getLinePos() {
        return new Object[][]{
                ...
                {49, 20, TypeDescKind.STRING},
                {55, 14, TypeDescKind.INT},
                {60, 8, TypeDescKind.BOOLEAN},
                {66, 11, TypeDescKind.BOOLEAN},
                {87, 32, TypeDescKind.STRING},
                {88, 40, TypeDescKind.INT},
                {89, 44, TypeDescKind.INT},
                {94, 19, TypeDescKind.ANY},
                {109, 31, TypeDescKind.STRING},
                {109, 31, TypeDescKind.STRING},
                {110, 33, TypeDescKind.TYPE_REFERENCE},
                {115, 28, TypeDescKind.INT},
                {116, 19, TypeDescKind.INT},
                {117, 18, TypeDescKind.ARRAY}
        };
    }
}
