...
public class WaitActionsNegativeTest {
    ...
    public void testNegativeWorkerActions() {
        ...
        BAssertUtil.validateError(resultNegative, index++,
                                  "incompatible types: expected 'future<(int|boolean)>', found 'future<string>'", 67,
                                  36);
        BAssertUtil.validateError(resultNegative, index++,
                                  "incompatible types: expected 'future<map<(int|boolean)>>', found 'future<int>'", 68,
                                  37);
        BAssertUtil.validateError(resultNegative, index++,
                                  "incompatible types: expected 'future<map<(int|boolean)>>', found 'future<string>'",
                                  68, 41);
        BAssertUtil.validateError(resultNegative, index++,
                                  "incompatible types: expected 'future<map<(int|boolean)>>', found 'future<boolean>'",
                                  68, 44);
        ...
        BAssertUtil.validateError(resultNegative, index++,
                                  "incompatible types: expected 'future<future<(int|string)>>', found 'future<int>'",
                                  71, 40);
        BAssertUtil.validateError(resultNegative, index++,
                                  "incompatible types: expected 'future<future<(int|string)>>', found 'future<string>'",
                                  71, 43);
        BAssertUtil.validateError(resultNegative, index++,
                                  "incompatible types: expected 'future<int>', found 'future<string>'", 81, 34);
        BAssertUtil.validateError(resultNegative, index++,
                                  "incompatible types: expected 'future<(boolean|string)>', found 'future<int>'", 82,
                                  41);
        BAssertUtil.validateError(resultNegative, index++,
                                  "incompatible types: expected 'future<(boolean|string)>', found 'future<int>'", 82,
                                  45);
