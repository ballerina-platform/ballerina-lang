...
/**
 * This class is used to test the behaviours of BDecimal and BFloat types by comparing them. This class contains tests,
 * 1) demonstrating how very large numbers can be represented using BDecimal type. 2) demonstrating how BDecimal type
 * solves the floating point error problem that exists in the BFloat type.
 *
 * @since 0.985.0
 */
