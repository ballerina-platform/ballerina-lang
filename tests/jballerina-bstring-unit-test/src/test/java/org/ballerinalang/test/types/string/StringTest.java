...
public class StringTest {
    ...
    public void testHasPrefix() {
        ...
        BValue[] results = BRunUtil.invoke_bstring(result, "hasPrefix", args);
    ...
    public void testHasSuffix() {
        ...
        BValue[] results = BRunUtil.invoke_bstring(result, "hasSuffix", args);
        Assert.assertTrue(((BBoolean) results[0]).booleanValue());
    }
    ...
    public void testIndexOf() {
        ...
        BValue[] results = BRunUtil.invoke_bstring(result, "indexOf", args);
    ...
    public void testLength() {
        ...
        BValue[] returns = BRunUtil.invoke_bstring(result, "lengthOfStr", args);
    ...
    public void testStringValueOf() {
        ...
        BValue[] returns = BRunUtil.invoke_bstring(result, "stringValueOf", args);
        Assert.assertTrue(returns[0] instanceof BString);
    ...
    public void testSubString() {
        ...
        BValue[] returns = BRunUtil.invoke_bstring(result, "substring", args);
        Assert.assertTrue(returns[0] instanceof BString);
    ...
    public void testToLowerCase() {
        ...
        BValue[] returns = BRunUtil.invoke_bstring(result, "toLower", args);
        Assert.assertTrue(returns[0] instanceof BString);
    ...
    public void testToUpperCase() {
        BValue[] args = {new BString("company")};
        BValue[] returns = BRunUtil.invoke_bstring(result, "toUpper", args);
        Assert.assertTrue(returns[0] instanceof BString);
        Assert.assertEquals(returns[0].stringValue(), "COMPANY");
    }
    ...
    public void testTrim() {
        BValue[] args = {new BString(" This is a String ")};
        BValue[] returns = BRunUtil.invoke_bstring(result, "trim", args);
        Assert.assertTrue(returns[0] instanceof BString);
    ...
    public void testToByteArray() {
        ...
        BValue[] returns = BRunUtil.invoke_bstring(result, "toByteArray", args);
