 ...
 * <p>
 * Valid conversions: decimal --> int decimal --> float decimal --> string decimal --> boolean decimal --> any decimal
 * --> json
 * <p>
 * int --> decimal float --> decimal string --> decimal (Checked) boolean --> decimal any --> decimal (checked) json -->
 * decimal (checked)
 *
 * @since 0.985.0
 **/
