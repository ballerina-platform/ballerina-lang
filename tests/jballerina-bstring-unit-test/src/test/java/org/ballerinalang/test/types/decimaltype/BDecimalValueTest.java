...
/**
 * This test class will test the behaviour of decimal values with expressions. Addition Multiplication Division
 * Subtraction Modulus Negation
 * <p>
 * Defining a decimal value Decimal d; d = new Decimal("10.234");
 *
 * @since 0.985.0
 */
