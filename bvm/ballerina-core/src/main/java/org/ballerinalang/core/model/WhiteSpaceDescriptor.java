...
/**
 * {@code WhiteSpaceDescriptor} contains information about whitespace associated with a particular language construct
 * in the source file.
 *
 * @since 0.8.4
 */
public class WhiteSpaceDescriptor {
    ...
    public void addWhitespaceRegion(int regionId, String whiteSpace) {
       this.whiteSpaceRegions.put(regionId, whiteSpace);
    }
