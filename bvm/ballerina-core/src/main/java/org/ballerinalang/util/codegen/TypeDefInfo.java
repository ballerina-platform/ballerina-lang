...
/**
 * {@code TypeDefInfo} contains metadata of a Ballerina type def info entry in the program file.
 *
 * @since 0.971.0
 */
public class TypeDefInfo extends CustomTypeInfo {
    ...
    public TypeDefInfo(int pkgPathCPIndex, String packagePath,
    ...
    public boolean equals(Object obj) {
        return obj instanceof TypeDefInfo && pkgPathCPIndex == (((TypeDefInfo) obj).pkgPathCPIndex)
