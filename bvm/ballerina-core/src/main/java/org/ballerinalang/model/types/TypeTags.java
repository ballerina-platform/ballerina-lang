...
public class TypeTags {
    ...
    public static final int TYPEDESC_TAG = 23;
    public static final int ENUM_TAG = 24;
    public static final int ITERATOR_TAG = 25;
    public static final int SERVICE_TAG = 26;
    public static final int STREAM_TAG = 27;
    public static final int FUTURE_TAG = 28;
    public static final int UNION_TAG = 29;
    public static final int TUPLE_TAG = 30;
