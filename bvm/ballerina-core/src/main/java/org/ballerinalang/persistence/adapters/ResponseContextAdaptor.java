 ...
 * @since 0.981.1
 */
public class ResponseContextAdaptor implements JsonSerializer<SerializableResponseContext>,
        JsonDeserializer<SerializableResponseContext> {
    @Override
    public JsonElement serialize(SerializableResponseContext src, Type typeOfSrc, JsonSerializationContext context) {
    ...
    @Override
    public SerializableResponseContext deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) {
