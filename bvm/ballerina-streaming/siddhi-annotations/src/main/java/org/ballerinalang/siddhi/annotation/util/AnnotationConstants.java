...
public class AnnotationConstants {
    public static final String SINK_MAPPER_SUPER_CLASS = "org.ballerinalang.siddhi.core.stream.output.sink.SinkMapper";
    public static final String SINK_SUPER_CLASS =
            "org.ballerinalang.siddhi.core.stream.output.sink.Sink";
    public static final String SCRIPT_SUPER_CLASS =
            "org.ballerinalang.siddhi.core.function.Script";
    public static final String FUNCTION_EXECUTOR_SUPER_CLASS =
            "org.ballerinalang.siddhi.core.executor.function.FunctionExecutor";
    public static final String AGGREGATION_ATTRIBUTE_SUPER_CLASS =
            "org.ballerinalang.siddhi.core.query.selector.attribute.aggregator.AttributeAggregator";
    public static final String DISTRIBUTION_STRATEGY_SUPER_CLASS =
            "org.ballerinalang.siddhi.core.stream.output.sink.distributed.DistributionStrategy";
    public static final String STREAM_PROCESSOR_SUPER_CLASS =
            "org.ballerinalang.siddhi.core.query.processor.stream.StreamProcessor";
