 ...
 * executor.
 */
public class NotEqualCompareConditionExpressionExecutorIntDouble extends
        NotEqualCompareConditionExpressionExecutor {


    public NotEqualCompareConditionExpressionExecutorIntDouble(
    ...
    public ExpressionExecutor cloneExecutor(String key) {
        return new NotEqualCompareConditionExpressionExecutorIntDouble(leftExpressionExecutor.cloneExecutor(key),
