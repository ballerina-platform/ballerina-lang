...
public class SetUpdateOrInsertInMemoryTableTestCase {
    ...
    public void updateFromTableTest1() throws InterruptedException, SQLException {
        log.info("SET-InMemory-update-or-insert test case 1: setting all columns");
    ...
    public void updateFromTableTest2() throws InterruptedException, SQLException {
        log.info("SET-InMemory-update-or-insert test case 2: setting a subset of columns");
        SiddhiManager siddhiManager = new SiddhiManager();
        String streams = "" +
                "define stream StockStream (symbol string, price float, volume long); " +
                "define stream UpdateStockStream (symbol string, price float, volume long); " +
    ...
    public void updateFromTableTest4() throws InterruptedException, SQLException {
        log.info("SET-InMemory-update-or-insert test case 4: using one of the output attribute values in the " +
...
//                    "select price, symbol, volume " +
    ...
    public void updateFromTableTest5() throws InterruptedException, SQLException {
        log.info("SET-InMemory-update-or-insert test case 5: assignment expression containing an output attribute " +
