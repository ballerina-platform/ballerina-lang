 ...
 * under the License.
 */
package org.ballerinalang.siddhi.query.api.expression.math;
...
public class Subtract extends Expression {
    ...
    public boolean equals(Object o) {
        ...
        if (leftValue != null ? !leftValue.equals(subtract.leftValue) : subtract.leftValue != null) {
            return false;
        }
        if (rightValue != null ? !rightValue.equals(subtract.rightValue) : subtract.rightValue != null) {
            return false;
        }
