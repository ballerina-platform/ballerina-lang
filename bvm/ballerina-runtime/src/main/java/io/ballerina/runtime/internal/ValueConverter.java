...
public class ValueConverter {
    ...
    private static Object convert(Object value, Type targetType, Set<TypeValuePair> unresolvedValues) {
        ...
        Type sourceType = TypeUtils.getRepresentedType(TypeChecker.getType(value));
        ...
        Object newValue;
        Type matchingType = TypeUtils.getRepresentedType(convertibleType);
    ...
    private static Type getTargetFromTypeDesc(Type targetType) {
        Type referredType = TypeUtils.getRepresentedType(targetType);
