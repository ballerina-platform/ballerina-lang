...
import static io.ballerina.runtime.internal.types.semtype.BListSubType.fixedArrayShallowCopy;
...
public final class ListProj {
    ...
    private static Pair<Integer[], Integer[]> listProjSamples(Integer[] indices, SubTypeData k) {
        ...
        // FIXME: refactor this so we don't have to expose the internal details of BIntSubType
        // Maybe we can return optional partitions
