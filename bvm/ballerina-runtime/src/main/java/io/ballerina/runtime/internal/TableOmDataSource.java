...
public class TableOmDataSource extends AbstractPushOMDataSource {
    ...
    public void serialize(XMLStreamWriter xmlStreamWriter) throws XMLStreamException {
        ...
        while (itr.hasNext()) {
            ...
            for (int i = 0; i < structFields.length; i++) {
                ...
                int type = TypeUtils.getConclusiveType(internalStructField.getFieldType()).getTag();
    ...
    private void processStruct(XMLStreamWriter xmlStreamWriter, BMap structData,
        ...
        Type internalType = TypeUtils.getConclusiveType(structFields[index].getFieldType());
