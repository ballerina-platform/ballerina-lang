...
public enum RuntimeErrors implements DiagnosticCode {
    ...
    INCOMPATIBLE_CONVERT_OPERATION_AMBIGUOUS_TARGET("ambiguous.target.convert.operation", "RUNTIME_0096"),
    ...
    SUBSTRING_INDEX_OUT_OF_RANGE("substring.index.out.of.range", "RUNTIME_0084"),
    CODEPOINT_INDEX_OUT_OF_RANGE("codepoint.index.out.of.range", "RUNTIME_0088"),
    ...
    INVALID_XML_ATTRIBUTE_ERROR("invalid.xml.attribute", "RUNTIME_0089"),
    ATTRIBUTE_NOT_FOUND_ERROR("attribute.not.found", "RUNTIME_0090"),
    ...
    INT_RANGE_OVERFLOW_ERROR("int.range.overflow", "RUNTIME_0083"),
    INVALID_OBJECT_FIELD_VALUE_ERROR("invalid.value.for.object.field", "RUNTIME_0085"),
    KEY_NOT_FOUND_ERROR("key.not.found", "RUNTIME_0086"),
    KEY_NOT_FOUND_IN_VALUE("key.not.found.in.value", "RUNTIME_0094"),
    TABLE_HAS_A_VALUE_FOR_KEY("table.has.a.value.for.key", "RUNTIME_0095"),
    KEY_NOT_FOUND_IN_JSON_MAPPING("key.not.found.in.json.mapping", "RUNTIME_0092"),
    MERGE_JSON_ERROR("merge.json.error", "RUNTIME_0093"),
    FIELD_REMOVAL_NOT_ALLOWED("field.removal.not.allowed", "RUNTIME_0087"),
    OPERATION_NOT_SUPPORTED_ERROR("operation.not.supported", "RUNTIME_0091"),
