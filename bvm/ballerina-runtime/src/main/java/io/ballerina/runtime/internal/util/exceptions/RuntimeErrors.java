...
public enum RuntimeErrors implements DiagnosticCode {
    ...
    CONFIG_TOML_INVALID_FILE("config.toml.invalid.file", "RUNTIME_0056"),
    CONFIG_TOML_FILE_NOT_FOUND("config.toml.file.not.found", "RUNTIME_0057"),
    CONFIG_TOML_TYPE_NOT_SUPPORTED("config.toml.type.not.supported", "RUNTIME_0058"),
    CONFIG_TOML_INVALID_ADDTIONAL_RECORD_FIELD("config.toml.invalid.additional.record.field", "RUNTIME_0059"),
    CONFIG_TOML_FILED_NOT_SUPPORTED("config.toml.field.not.supported", "RUNTIME_0060"),
    CONFIG_TOML_REQUIRED_FILED_NOT_PROVIDED("config.toml.required.field.not.provided", "RUNTIME_0061"),
    CONFIG_TOML_TABLE_KEY__NOT_PROVIDED("config.toml.table.key.not.provided", "RUNTIME_0062"),
    CONFIG_INVALID_BYTE_RANGE("config.invalid.byte.range", "RUNTIME_0063"),
    CONFIG_TOML_INVALID_MODULE_STRUCTURE("config.toml.invalid.module.structure", "RUNTIME_0064"),
    CONFIG_TOML_CONSTRAINT_TYPE_NOT_SUPPORTED("config.toml.constraint.type.not.supported", "RUNTIME_0065"),
    CONFIG_TOML_DEFAULT_FILED_NOT_SUPPORTED("config.toml.default.field.not.supported", "RUNTIME_0066"),
    CONFIG_TOML_EMPTY_FILE("config.toml.empty.file", "RUNTIME_0067"),
    CONFIG_TOML_EMPTY_CONTENT("config.toml.empty.content", "RUNTIME_0068"),
    CONFIG_VALUE_NOT_PROVIDED("config.value.not.provided", "RUNTIME_0069"),
    CONFIG_CLI_TYPE_NOT_SUPPORTED("config.cli.type.not.supported", "RUNTIME_0070"),
    CONFIG_TYPE_NOT_SUPPORTED("config.type.not.supported", "RUNTIME_0071"),
    CONFIG_INCOMPATIBLE_TYPE("config.incompatible.type", "RUNTIME_0072"),
