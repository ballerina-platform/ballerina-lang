...
public class TypeConverter {
    ...
    private static boolean isConvertibleToTableType(Object sourceValue, BTableType tableType,
        ...
        int sourceTypeReferredTypeTag = TypeUtils.getConclusiveType(TypeChecker.getType(sourceValue)).getTag();
    ...
    private static boolean isConvertibleToArrayType(Object sourceValue, BArrayType targetType,
        ...
        Type targetTypeElementType = TypeUtils.getConclusiveType(targetType.getElementType());
        Type sourceType = source.getType();
        if (sourceType.getTag() == TypeTags.ARRAY_TAG) {
            Type sourceElementType = TypeUtils.getConclusiveType(((BArrayType) sourceType).getElementType());
