...
public class RuntimeConstants {
    ...
    public static final String ERROR_LANG_LIB = "lang.error";
    ...
    public static final Module BALLERINA_LANG_ARRAY_PKG_ID = new Module(BALLERINA_BUILTIN_PKG_PREFIX,
            ARRAY_LANG_LIB, "1.1.0");
    public static final Module BALLERINA_LANG_RUNTIME_PKG_ID = new Module(BALLERINA_BUILTIN_PKG_PREFIX,
            RUNTIME_LANG_LIB, "0.0.1");
    public static final Module BALLERINA_LANG_XML_PKG_ID = new Module(BALLERINA_BUILTIN_PKG_PREFIX,
            XML_LANG_LIB, "0.8.0");
    public static final Module BALLERINA_LANG_STRING_PKG_ID = new Module(BALLERINA_BUILTIN_PKG_PREFIX,
            STRING_LANG_LIB, "1.1.0");
    public static final Module BALLERINA_LANG_MAP_PKG_ID = new Module(BALLERINA_BUILTIN_PKG_PREFIX,
            MAP_LANG_LIB, "1.1.0");
    public static final Module BALLERINA_LANG_TABLE_PKG_ID = new Module(BALLERINA_BUILTIN_PKG_PREFIX,
            TABLE_LANG_LIB, "0.4.0");
    public static final Module BALLERINA_LANG_OBJECT_PKG_ID = new Module(BALLERINA_BUILTIN_PKG_PREFIX,
            OBJECT_LANG_LIB, "1.0.0");
    public static final Module BALLERINA_LANG_TYPEDESC_PKG_ID = new Module(BALLERINA_BUILTIN_PKG_PREFIX,
