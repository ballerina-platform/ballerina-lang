...
////    }
//
//    public static ObjectValue getService(ObjectValue serviceValue) {
//        final BObjectType serviceType = serviceValue.getType();
...
////        return createService(programFile, serviceInfo, serviceValue);
...
//        Arrays.stream(serviceValue.getType().getAttachedFunctions()).forEach(resourceInfo -> {
...
//        for (String key : annotationMap.keys()) { //key ballerina/http:WebSocketServiceConfig$0
...
//            }
//            final String annotaionQName = key.split("\\$")[0]; //ballerina/http:WebSocketServiceConfig
