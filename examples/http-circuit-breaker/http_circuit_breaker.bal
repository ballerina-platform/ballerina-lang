...
// Create an endpoint with port 9090 for the `circuitbreaker` service.
endpoint http:Listener circuitBreakerEP {
    port:9090
};
...
service<http:Service> circuitbreaker bind circuitBreakerEP {
