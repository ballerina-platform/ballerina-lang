...
public function main() {
    // To create the `time:Time` object you can use either the `currentTime()`,
    ...
    // This subtracts a given duration from a time. In this example, let's
    // subtract one year, one month, and one second from the current time.
