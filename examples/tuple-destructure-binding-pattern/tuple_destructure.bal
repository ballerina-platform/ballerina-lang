...
public function main() {
    ...
    (string, (int, (boolean, float))) (c1, (c2, (c3, c4))) = ("Test", (123, (true, 5.6)));
    ...
    ((string, (int, (boolean, int))), (float, int)) v1 = (("Ballerina", (3, (true, 34))), (5.6, 45));
    ((string, (int, (boolean, int))), (float, int)) ((d1, (d2, (d3, d4))), (d5, d6)) = v1;
