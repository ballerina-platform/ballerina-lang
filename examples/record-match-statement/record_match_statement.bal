...
function basicMatch(any a) {
    match a {
        ...
        var {var1, var2, var3} => io:println("Matched with three vars : " + io:sprintf("%s", var1) + ", " +
        ...
        var {var1, var2} => io:println("Matched with two vars : " + io:sprintf("%s", var1) + ", " + io:sprintf("%s", var2));
        // This pattern checks for a mapping value with three fields `var1` and type will be any in the pattern block.
        var {var1} => io:println("Matched with single var : " + io:sprintf("%s", var1));
    }
}
...
function matchWithTypeGuard(any matchExpr) {
    ...
    match matchExpr {
        ...
        var {var1, var2} if var2 is string => io:println("Matched with string typeguard");
        // This pattern will only match if `var1` is of type `int` `var2` is of type `int`.
        var {var1, var2} if (var1 is int && var2 is int) => io:println("Matched with int and int typeguard : " + io:sprintf("%s", var1));
        // This pattern will only match if `var1` is of type `string` `var2` is of type `int`.
        var {var1, var2} if (var1 is string && var2 is int) => io:println("Matched with string and int typeguard : " + io:sprintf("%s", var1));
        // This pattern will only match if `var1` is of type `int` `var2` is of type `RecordTwo`.
        var {var1, var2} if (var1 is int && var2 is RecordTwo) => io:println("Matched with int and RecordTwo typeguard : " + io:sprintf("%s", var1));
        // This pattern will only match if `var1` is of type `string` `var2` is of type `RecordTwo`.
        var {var1, var2} if (var1 is string && var2 is RecordTwo) => io:println("Matched with string and RecordTwo typeguard : " + io:sprintf("%s", var2.var1));
