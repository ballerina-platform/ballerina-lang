...
function main(string... args) {
    ...
    // Allow for receipt by subscribers. The `printTemperature` function is invoked for each published event.
    runtime:sleep(1000);
    ...
    // Allow for receipt by subscribers. The `printEvent` function is invoked for each published event.
    runtime:sleep(1000);
