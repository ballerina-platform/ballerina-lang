...
@Description {value:
"Defines a struct called 'Person'. It contains fields and their types. <br/>Optionally, for value type fields, the default value can be defined. If not, the default value is set to the zero-value."
}
type Person {
    string name;
    int age = -1;
