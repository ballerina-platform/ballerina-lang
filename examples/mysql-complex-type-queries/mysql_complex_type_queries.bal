...
// Username and password of the MySQL database. This is used in below examples when initializing the
// MySQL connector. You need to change these based on your setup if you are trying locally.
string dbUser = "root";
