...
function main (string... args) {
    ...
    // ensures that tainted data cannot be passed into the security sensitive parameter.
    //
    ...
    while (dataTable.hasNext()) {
        ...
        // the return value is annotated with "@untainted" annotation. This means the return value is safe and can be
        // trusted.
