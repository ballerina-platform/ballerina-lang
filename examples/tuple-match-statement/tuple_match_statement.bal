...
public function main() {
    // In here there are four different variables created and they will be used with
    // function `basicMatch`, which does the match.
    ...
    // with function 'matchWithTypeGuard', which does the match along with type guard conditions.
