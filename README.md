...
## Usage
Add the `ballerina-container-support-0.95.0.jar` file to `bre/lib/` folder in the Ballerina distribution.
...
docker run -v ~/ballerina/packages:/ballerina/files -it ballerinalang/ballerina:0.95.0
```
...
docker run -v /tmp/testb:/ballerina/files -p 9090:9090 -it ballerinalang/ballerina:0.95.0
```
## License
