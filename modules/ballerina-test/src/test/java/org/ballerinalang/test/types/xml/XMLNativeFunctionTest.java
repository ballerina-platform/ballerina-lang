...
public class XMLNativeFunctionTest {
    ...
    public void testGetXMLLarge() {
        // Load large xml
        l1 = BCompileUtil.readFileAsString("test-src/types/xml/message13k.xml");
    ...
    public void testGetXMLFromDocumentElement() {
        String d1 = BCompileUtil.readFileAsString("test-src/types/xml/xmlDocumentSample.xml");
    ...
    public void testGetXMLFromAttribute() {
        String a1 = BCompileUtil.readFileAsString("test-src/types/xml/messageComplex.xml");
    ...
    public void testSetStringToAttribute() {
        String a1 = BCompileUtil.readFileAsString("test-src/types/xml/messageSimple.xml");
