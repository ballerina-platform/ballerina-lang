...
public class EndpointConnectorTest {
    ...
    public void testConnectorNegativeCases() {
        ...
        BAssertUtil.validateError(resultNegative, 5, "incompatible types: expected 'Foo', found 'string'", 58, 10);
        BAssertUtil.validateError(resultNegative, 6, "cannot assign a value to endpoint 'en'", 59, 5);
        BAssertUtil.validateError(resultNegative, 7, "unreachable code", 48, 5);
        BAssertUtil.validateError(resultNegative, 8, "this function must return a result", 42, 1);
