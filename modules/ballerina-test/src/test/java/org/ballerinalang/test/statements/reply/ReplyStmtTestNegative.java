 ...
 */
public class ReplyStmtTestNegative {
    //TODO delete
    @BeforeClass
    public void setup() {
    ...
    public void testReplyFromFunction() {
        BTestUtils.compile("lang/statements/replyStmt/reply-from-function.bal");
    }
    ...
    public void testReplyFromAction() {
        BTestUtils.compile("lang/statements/replyStmt/reply-from-action.bal");
    }
}
