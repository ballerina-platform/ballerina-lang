...
service<http> helloServer {
    ...
    resource echo2 (http:Connection con, http:Request req, string phase) {
        http:Response res = {};
    ...
    resource addheader (http:Connection con, http:Request req, string key, string value) {
        http:Response res = {};
        res.addHeader(key, value);
    ...
    resource addResHeader (http:Connection con, http:Request req) {
    ...
    resource addResHeaderFunc (http:Connection con, http:Request req) {
        http:Response res = {};
        http:HeaderValue[] headers = [{value:"ballerina", param:{b:"6", c:7}}, {value:"transport", param:{a:6}}];
    ...
    resource addResHeaderNoParam (http:Connection con, http:Request req) {
        http:Response res = {headers:{}};
    ...
    resource GetContentLength (http:Connection con, http:Request req, string header, string length) {
        http:Response res = {};
    ...
    resource getHeader (http:Connection con, http:Request req, string header, string value) {
        http:Response res = {};
    ...
    resource getResHeader (http:Connection con, http:Request req) {
        http:Response res = {headers:{}};
    ...
    resource getHeaders (http:Connection con, http:Request req) {
        http:Response res = {headers:{}};
        http:HeaderValue[] headers = [{value:"ballerina"}, {value:"transport", param:{a:"6"}}];
        res.headers["wso2"] = headers;
    ...
    resource GetJsonPayload(http:Connection con, http:Request req, string value) {
        http:Response res = {};
    ...
    resource GetProperty (http:Connection con, http:Request req,string key, string value) {
        http:Response res = {};
    ...
    resource GetStringPayload(http:Connection con, http:Request req, string valueStr) {
        http:Response res = {};
    ...
    resource GetXmlPayload(http:Connection con, http:Request req) {
        http:Response res = {};
    ...
    resource RemoveHeader (http:Connection con, http:Request req, string key, string value) {
        http:Response res = {};
        res.setHeader(key, value);
        res.removeHeader(key);
    ...
    resource RemoveAllHeaders (http:Connection con, http:Request req) {
        http:Response res = {};
