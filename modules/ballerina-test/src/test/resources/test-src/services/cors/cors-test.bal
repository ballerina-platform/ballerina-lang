...
service<http> echo1 {
    ...
    resource info1 (http:Connection con, http:Request req) {
        http:Response res = {};
    ...
    resource info2 (http:Connection con, http:Request req) {
        http:Response res = {};
    ...
    resource info3 (http:Connection con, http:Request req) {
        http:Response res = {};
