...
//        Service.ServiceBuilder serviceBuilder = new Service.ServiceBuilder(new
// BLangPackage(GlobalScope.getInstance()));
...
//                resourceBuilder.addAnnotation(createSingleValuedAnnotationAttachment("Consumes", "http",
// entry.consumes
//                        .get(0).get("mediaType")));
//            }
...
//                    for (AnnotationAttachment annotation :
// mergeAnnotations(originalResource.getAnnotations(), resource
//                            .getAnnotations())) {
