...
public class LangServerUtils {
    ...
    public static int getFreePort() {
        for (int i = LangServerConstants.MIN_PORT_NUMBER; i < LangServerConstants.MAX_PORT_NUMBER; i++) {
            if (available(i)) {
                return i;
            }
        }
    ...
    public static boolean available(int port) throws IllegalArgumentException {
        if (port < LangServerConstants.MIN_PORT_NUMBER || port > LangServerConstants.MAX_PORT_NUMBER) {
