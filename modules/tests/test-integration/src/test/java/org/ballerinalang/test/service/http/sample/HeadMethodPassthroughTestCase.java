 ...
 */
public class HeadMethodPassthroughTestCase extends IntegrationTestCase {

    @Test(description = "Test the response payload of HEAD request")
    ...
    @Test(description = "Test simple passthrough test case For HEAD")
