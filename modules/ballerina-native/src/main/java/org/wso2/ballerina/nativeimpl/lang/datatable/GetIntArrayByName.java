...
/**
 * Native function to get int array value of a given column name.
 * ballerina.lang.datatables:getIntArray(datatable, int)
 *
 * @since 0.8.0
 */
@BallerinaFunction(
...
public class GetIntArrayByName extends AbstractNativeFunction {
    ...
    public BValue[] execute(Context ctx) {
        ...
        int[] intArray = dataTable.getIntArray(columnName);
