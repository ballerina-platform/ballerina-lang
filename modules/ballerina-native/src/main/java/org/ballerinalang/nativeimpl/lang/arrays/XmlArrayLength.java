...
/**
 * Native function ballerina.model.arrays:length(xml[]).
 */
@BallerinaFunction(
        packageName = "ballerina.lang.arrays",
        functionName = "length",
        args = {@Argument(name = "xmlArray", type = TypeEnum.ARRAY, elementType = TypeEnum.XML)},
        returnType = {@ReturnType(type = TypeEnum.INT)},
        isPublic = true
)
@BallerinaAnnotation(annotationName = "Description", attributes = {@Attribute(name = "value",
        value = "Returns the length of the specified XML array") })
