...
package org.ballerinalang.nativeimpl.lang.json;
...
public class AddBooleanToObject extends AbstractJSONFunction {
    ...
    private static final String OPERATION = "add boolean to json object";
    ...
    public BValue[] execute(Context ctx) {
        ...
        try {
            ...
            boolean value = ((BBoolean) getArgument(ctx, 3)).booleanValue();
