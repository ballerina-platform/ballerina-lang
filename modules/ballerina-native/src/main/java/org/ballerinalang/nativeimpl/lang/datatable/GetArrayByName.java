...
/**
 * Native function to get array values of a given column name.
 * ballerina.model.datatables:getArray(datatable, string)
 *
 * @since 0.8.0
 */
@BallerinaFunction(
...
public class GetArrayByName extends AbstractNativeFunction {
    ...
    public BValue[] execute(Context ctx) {
        ...
        String name = getArgument(ctx, 1).stringValue();
        Map<String, Object> arrayMap = dataTable.getArray(name);
