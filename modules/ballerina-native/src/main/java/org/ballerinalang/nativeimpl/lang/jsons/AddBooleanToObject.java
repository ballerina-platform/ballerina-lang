...
@BallerinaAnnotation(annotationName = "Description", attributes = {@Attribute(name = "value",
        value = "Inserts a named element to a JSON object. This function will add a new Boolean element with the"
                + " given name (key) to the location identified by the given JSONPath.") })
