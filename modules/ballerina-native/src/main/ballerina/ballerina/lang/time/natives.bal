...
@doc:Description {value:"Ballerina Timezone struct represents a timezone info associated with a particular time."}
...
@doc:Description {value:"Returns the time of the date and time components and time zone."}
...
@doc:Description {value:"Returns the week day representation of the given time."}
...
@doc:Description {value:"Returns the milli second representation of the given time."}
