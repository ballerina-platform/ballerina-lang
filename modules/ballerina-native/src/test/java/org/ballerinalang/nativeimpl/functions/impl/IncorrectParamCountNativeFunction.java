...
/**
 * Test Class to check invalid param.
 */
@BallerinaFunction(
        packageName = "ballerina.test.incorrect",
        functionName = "paramCount",
        args = {@Argument(name = "param1", type = TypeEnum.STRING)},
        returnType = {@ReturnType(type = TypeEnum.STRING)},
        isPublic = true
)
public class IncorrectParamCountNativeFunction extends AbstractNativeFunction {
