...
public class BallerinaUtilsTest {
    ...
    @BeforeClass
    public void setup() {
        programFile = BTestUtils.getProgramFile("samples/utilsTest.bal");
    }
    ...
    public void testEncoding() {
        ...
        for (String s : stringsToTest) {
            BValue[] returnVals = BLangFunctions.invokeNew(
                    programFile, "testEncodeDecode", new BValue[]{new BString(s)});
    ...
    public void testRandomString() {
        BValue[] returnVals = BLangFunctions.invokeNew(programFile, "testRandomString");
        Assert.assertFalse(returnVals == null || returnVals.length == 0 || returnVals[0] == null,
    ...
    public void testHmac() {
        ...
        for (BValue[] args : argsList) {
            BValue[] returnVals = BLangFunctions.invokeNew(programFile, "testHmac", args);
            Assert.assertFalse(returnVals == null || returnVals.length == 0 || returnVals[0] == null,
                    "Invalid Return Values for");
        }
    }
    ...
    public void testHmacNagativeInvalidAlgo() {
        final String key = "abcdefghijk";
        BValue[] returnVals = BLangFunctions.invokeNew(programFile, "testHmac",
                                                       new BValue[]{new BString("Ballerina HMAC test"),
                                                       new BString(key), new BString("SHA124")});
        Assert.assertFalse(returnVals == null || returnVals.length == 0 || returnVals[0] == null,
                "Invalid Return Values for");
    ...
    public void testHmacNagativeInvalidKey() {
        ...
        BValue[] returnVals = BLangFunctions.invokeNew(programFile, "testHmac",
                                                    new BValue[]{new BString("Ballerina HMAC test"),
                                                    new BString(key), new BString("SHA1")});
        Assert.assertFalse(returnVals == null || returnVals.length == 0 || returnVals[0] == null,
                "Invalid Return Values for");
    ...
    public void testHmacBase64() {
        ...
        for (BValue[] args : argsList) {
            BValue[] returnVals = BLangFunctions.invokeNew(programFile, "testHmacFromBase64", args);
            Assert.assertFalse(returnVals == null || returnVals.length == 0 || returnVals[0] == null,
                               "Invalid Return Values for");
        }
    }
    ...
    public void testMessageDigest() {
        ...
        for (BValue[] args : argsList) {
            BValue[] returnVals = BLangFunctions.invokeNew(programFile, "testMessageDigest", args);
            Assert.assertFalse(returnVals == null || returnVals.length == 0 || returnVals[0] == null,
                               "Invalid Return Values for");
        }
    }
    ...
    public void testBase64toBase16Encode() {
        ...
        BValue[] returnVals = BLangFunctions.invokeNew(programFile, "testBase64ToBase16Encode", args);
        Assert.assertFalse(returnVals == null || returnVals.length == 0 || returnVals[0] == null,
                           "Invalid Return Values for");
    }
