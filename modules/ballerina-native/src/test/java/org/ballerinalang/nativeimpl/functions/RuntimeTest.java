...
public class RuntimeTest {
    ...
    @BeforeClass
    public void setup() {
        programFile = BTestUtils.getProgramFile("samples/runtimeTest.bal");
    }
    ...
    public void testSleepCurrentThread() {
        ...
        BValue[] args = {};
        BLangFunctions.invokeNew(programFile, "testSleepCurrentThread", args);
    ...
    public void testSetProperty() {
        ...
        BLangFunctions.invokeNew(programFile, "testSetProperty", args);
    ...
    public void testGetProperty() {
        ...
        args[0] = new BString(key);
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testGetProperty", args);
    ...
    public void testGetProperties() {
        BValue[] args = {};
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testGetProperties", args);
    ...
    public void testGetCurrentDirectory() {
        BValue[] args = {};
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testGetCurrentDirectory", args);
        Assert.assertTrue(returns[0] instanceof BString);
    ...
    public void testGetFileEncoding() {
        BValue[] args = {};
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testGetFileEncoding", args);
        Assert.assertTrue(returns[0] instanceof BString);
