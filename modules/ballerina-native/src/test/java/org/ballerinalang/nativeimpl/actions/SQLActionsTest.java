...
public class SQLActionsTest {
    ...
    @BeforeClass()
    public void setup() {
        programFile = BTestUtils.getProgramFile("samples/sqlConnectorTest.bal");
    ...
    public void testInsertTableData() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testInsertTableData");
    ...
    public void testCreateTable() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testCreateTable");
        BInteger retValue = (BInteger) returns[0];
    ...
    public void testUpdateTableData() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testUpdateTableData");
        BInteger retValue = (BInteger) returns[0];
        Assert.assertEquals(retValue.intValue(), 1);
    }
    ...
    public void testGeneratedKeyOnInsert() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testGeneratedKeyOnInsert");
    ...
    public void testGeneratedKeyWithColumn() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testGeneratedKeyWithColumn");
        BString retValue = (BString) returns[0];
        Assert.assertTrue(retValue.intValue() > 0);
    }
    ...
    public void testSelectData() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testSelectData");
        BString retValue = (BString) returns[0];
    ...
    public void testSelectIntFloatData() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testSelectIntFloatData");
    ...
    public void testCallProcedure() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testCallProcedure");
        BString retValue = (BString) returns[0];
    ...
    public void testCallProcedureWithResultSet() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testCallProcedureWithResultSet");
        BString retValue = (BString) returns[0];
        final String expected = "Peter";
        Assert.assertEquals(retValue.stringValue(), expected);
    }
    ...
    public void testConnectorWithDataSource() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testConnectorWithDataSource");
        BString retValue = (BString) returns[0];
        final String expected = "Peter";
        Assert.assertEquals(retValue.stringValue(), expected);
    }
    ...
    public void testConnectionPoolProperties() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testConnectionPoolProperties");
        BString retValue = (BString) returns[0];
        final String expected = "Peter";
        Assert.assertEquals(retValue.stringValue(), expected);
    }
    ...
    public void testQueryParameters() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testQueryParameters");
        BString retValue = (BString) returns[0];
        final String expected = "Peter";
        Assert.assertEquals(retValue.stringValue(), expected);
    }
    ...
    public void testInsertTableDataWithParameters() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testInsertTableDataWithParameters");
        BInteger retValue = (BInteger) returns[0];
        Assert.assertEquals(retValue.intValue(), 1);
    }
    ...
    public void testOutParameters() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testOutParameters");
    ...
    public void testNullOutParameters() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testNullOutParameters");
        Assert.assertEquals(returns.length, 14);
    ...
    public void testINParameters() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testINParameters");
        BInteger retValue = (BInteger) returns[0];
        Assert.assertEquals(retValue.intValue(), 1);
    }
    ...
    public void testNullINParameters() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testNullINParameters");
        BInteger retValue = (BInteger) returns[0];
        Assert.assertEquals(retValue.intValue(), 1);
    }
    ...
    public void testINOutParameters() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testINOutParameters");
        Assert.assertEquals(returns.length, 14);
        Assert.assertEquals(((BInteger) returns[0]).intValue(), 10);
        Assert.assertEquals(((BInteger) returns[1]).intValue(), 9223372036854774807L);
        Assert.assertEquals(((BFloat) returns[2]).floatValue(), 123.34D, DELTA);
    ...
    public void testNullINOutParameters() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testNullINOutParameters");
        Assert.assertEquals(returns.length, 14);
        Assert.assertEquals(((BInteger) returns[0]).intValue(), 0);
        Assert.assertEquals(((BInteger) returns[1]).intValue(), 0);
        Assert.assertEquals(((BFloat) returns[2]).floatValue(), 0.0D);
    ...
    public void testEmptySQLType() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testEmptySQLType");
        BInteger retValue = (BInteger) returns[0];
        Assert.assertEquals(retValue.intValue(), 1);
    }
    ...
    public void testArrayInParameters() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testArrayInParameters");
        BInteger retValue = (BInteger) returns[0];
        Assert.assertEquals(retValue.intValue(), 1);
    ...
    public void testArrayOutParameters() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testArrayOutParameters");
    ...
    public void testArrayInOutParameters() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testArrayInOutParameters");
    ...
    public void testBatchUpdate() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testBatchUpdate");
    ...
    public void testLocalTransacton() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testLocalTransacton");
        Assert.assertEquals(((BInteger) returns[0]).intValue(), 0);
    ...
    public void testTransactonRollback() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testTransactonRollback");
    ...
    public void testTransactonAbort() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testTransactonAbort");
        Assert.assertEquals(((BInteger) returns[0]).intValue(), -1);
        Assert.assertEquals(((BInteger) returns[1]).intValue(), 0);
    }
    ...
    public void testTransactonThrow() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testTransactonErrorThrow");
        Assert.assertEquals(((BInteger) returns[0]).intValue(), -1);
    ...
    public void testTransactonThrowAndCatch() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testTransactionErrorThrowAndCatch");
        Assert.assertEquals(((BInteger) returns[0]).intValue(), 0);
        Assert.assertEquals(((BInteger) returns[1]).intValue(), -1);
    ...
    public void testTransactonCommitted() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testTransactonCommitted");
        Assert.assertEquals(((BInteger) returns[0]).intValue(), 1);
        Assert.assertEquals(((BInteger) returns[1]).intValue(), 2);
    }
    ...
    public void testTransactonHandlerOrder() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testTransactonHandlerOrder");
        Assert.assertEquals(((BInteger) returns[0]).intValue(), 1);
        Assert.assertEquals(((BInteger) returns[1]).intValue(), 1);
    ...
    public void testTransactonWithoutHandlers() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testTransactonWithoutHandlers");
        Assert.assertEquals(((BInteger) returns[0]).intValue(), 2);
    }

    @Test(groups = "ConnectorTest")
    public void testInsertTimeData() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testDateTimeInParameters");
    ...
    public void testCloseConnectionPool() {
        BValue[] returns = BLangFunctions.invokeNew(programFile, "testCloseConnectionPool");
        BInteger retValue = (BInteger) returns[0];
        Assert.assertEquals(retValue.intValue(), 1);
    }
