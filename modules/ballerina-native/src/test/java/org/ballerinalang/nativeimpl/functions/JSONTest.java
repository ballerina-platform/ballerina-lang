...
public class JSONTest {
    ...
    @BeforeClass
    public void setup() {
        programFile = BTestUtils.getProgramFile("samples/jsonTest.bal");
    }
    ...
    public void testGetInt() {
        ...
        BValue[] returns = BLangFunctions.invokeNew(programFile, "getInt", args);
    ...
    public void testGetJSON() {
        ...
        BValue[] returns = BLangFunctions.invokeNew(programFile, "getJson", args);
    ...
    public void testGetFloat() {
        ...
        BValue[] returns = BLangFunctions.invokeNew(programFile, "getFloat", args);
    ...
    public void testGetBoolean() {
        ...
        BValue[] returns = BLangFunctions.invokeNew(programFile, "getBoolean", args);
    ...
    public void testGetValueOfIncorrectType() {
        BValue[] args = {new BJSON(json1), new BString("$.name")};
        BLangFunctions.invokeNew(programFile, "getInt", args);
    }
    ...
    public void testSetInteger() {
        ...
        BValue[] returns = BLangFunctions.invokeNew(programFile, "setInt", args);
    ...
    public void testSetFloat() {
        ...
        BValue[] returns = BLangFunctions.invokeNew(programFile, "setFloat", args);
    ...
    public void testSetBoolean() {
        ...
        BValue[] returns = BLangFunctions.invokeNew(programFile, "setBoolean", args);
    ...
    public void testSetJSON() {
        ...
        BValue[] returns = BLangFunctions.invokeNew(programFile, "setJson", args);
    ...
    public void testAddStringToObject() {
        BValue[] args = {new BJSON(json1), new BString("$.name"), new BString("nickName"),
                new BString("Paul")};
        BValue[] returns = BLangFunctions.invokeNew(programFile, "addStringToObject", args);
    ...
    public void testAddIntToObject() {
        BValue[] args = {new BJSON(json1), new BString("$"), new BString("zipCode"),
                new BInteger(90001)};
        BValue[] returns = BLangFunctions.invokeNew(programFile, "addIntToObject", args);
    ...
    public void testAddFloatToObject() {
        BValue[] args = {new BJSON(json2), new BString("$.item"), new BString("discount"),
                new BFloat(0.15)};
        BValue[] returns = BLangFunctions.invokeNew(programFile, "addFloatToObject", args);
    ...
    public void testAddBooleanToObject() {
        BValue[] args = {new BJSON(json2), new BString("$.item"), new BString("vegi"),
                new BBoolean(true)};
        BValue[] returns = BLangFunctions.invokeNew(programFile, "addBooleanToObject", args);
    ...
    public void testAddElementToObject() {
        ...
        BValue[] returns = BLangFunctions.invokeNew(programFile, "addElementToObject", args);
    ...
    public void testAddToInvalidJsonpathObject() {
        BValue[] args = {new BJSON(json1), new BString("$/wrong/path."), new BString("nickName"),
                new BString("Paul")};
        BLangFunctions.invokeNew(programFile, "addStringToObject", args);
    }
    ...
    public void testAddStringToArray() {
        ...
        BValue[] returns = BLangFunctions.invokeNew(programFile, "addStringToArray", args);
    ...
    public void testAddIntToArray() {
        ...
        BValue[] returns = BLangFunctions.invokeNew(programFile, "addIntToArray", args);
    ...
    public void testAddFloatToArray() {
        BValue[] args = {new BJSON(jsonFloatArray), new BString("$.prices"),
                new BFloat(5.96)};
        BValue[] returns = BLangFunctions.invokeNew(programFile, "addFloatToArray", args);
    ...
    public void testAddBooleanToArray() {
        BValue[] args = {new BJSON(jsonBooleanArray), new BString("$.availability"),
                new BBoolean(true)};
        BValue[] returns = BLangFunctions.invokeNew(programFile, "addBooleanToArray", args);
    ...
    public void testAddElementToArray() {
        ...
        BValue[] returns = BLangFunctions.invokeNew(programFile, "addElementToArray", args);
    ...
    public void testAddToInvalidJsonpathArray() {
        ...
        BLangFunctions.invokeNew(programFile, "addIntToArray", args);
    }
    ...
    public void testRename() {
        ...
        BValue[] returns = BLangFunctions.invokeNew(programFile, "rename", args);
    ...
    public void testToString() {
        ...
        BValue[] returns = BLangFunctions.invokeNew(programFile, "toString", args);
