...
public class NetURITest {
    ...
    @BeforeClass
    public void setup() {
        programFile = BTestUtils.getProgramFile("samples/netUri.bal");
    }
    ...
    public void testEncode() {
        ...
        for (BValue arg : args) {
            BValue[] inputArg = {arg};
            BValue[] returnVals = BLangFunctions.invokeNew(programFile, "testEncode", inputArg);
    ...
    public void testEncodeNegative() {
        ...
        BLangFunctions.invokeNew(programFile, "testEncode", inputArg);
    }
    ...
    public void testGetQueryParam() {
        ...
        for (String qparam : paramsExpected.keySet()) {
            ...
            BValue[] returnVals = BLangFunctions.invokeNew(programFile, "testGetQueryParam", inputArg);
            Assert.assertFalse(returnVals == null || returnVals.length == 0 || returnVals[0] == null,
