...
define(['require', 'jquery', 'log'], function (require, $, log) {

    var CreateNewFileDialog = function (options) {
    ...
    CreateNewFileDialog.prototype.show = function () {
                this._modalContainer.modal('show');
                this._errorsContainer.hide();
    };

    CreateNewFileDialog.prototype.render = function () {
        var fileBrowser,
