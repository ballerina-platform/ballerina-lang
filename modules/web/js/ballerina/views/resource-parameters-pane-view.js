...
import ResourceParameterView from './resource-parameter-view';
 ...
 */
class ResourceParametersPaneView {
    constructor(args) {
     ...
     * @private
     */
    _createCurrentParametersView(wrapper) {
        var self = this;
     ...
     * @private
     */
    _addSupportedAnnotations(annotationTypeDropdown) {
        // Copying the array
...
export default ResourceParametersPaneView;
