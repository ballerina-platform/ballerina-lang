...
import ReplyStatement from '../ast/statements/reply-statement';
 ...
 */
class ReplyStatementView extends SimpleStatementView {
    constructor(args) {
        super(args);
    ...
    updateResponseMessage(newMessageText, propertyKey) {
     ...
     * @param {number} dy delta y distance
     */
    onMoveInitiatedByReplyReceiver(dy) {
...
export default ReplyStatementView;
