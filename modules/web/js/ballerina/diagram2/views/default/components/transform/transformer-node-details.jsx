    ...
    render() {
        ...
        return (
            <g className='statement-body'>
                <text x={typeTextX} y={typeTextY}
                    dominantBaseline= 'central'
                    cursor='pointer'
                    onClick={this.props.onExpand}>{viewState.typeText}</text>
                <EditableText
                    x={nameTextX}
                    y={nameTextY}
                ...
                <text x={paramTextX} y={paramTextY}
                    dominantBaseline= 'central'
                    cursor='pointer'
                    onClick={this.props.onExpand}>{viewState.paramText}</text>
            </g>
        );
    }
}
