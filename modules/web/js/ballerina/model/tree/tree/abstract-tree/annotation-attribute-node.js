...
class AnnotationAttributeNodeAbstract extends Node {


    setTypeNode(newValue, title) {
    ...
    setInitialExpression(newValue, title) {
...
export default AnnotationAttributeNodeAbstract;
