...
define(['log', 'lodash', './../env/package', './../tool-palette/tool-palette', './../tool-palette/tool-group',
    ...
    function (log, _, Package, ToolPalette, ToolGroup, Environment, InitialTools, EventChannel, BallerinaASTFactory,
         ...
         */
        ToolPaletteItemProvider.prototype.addImport = function (pckg, index) {
         ...
         */
        ToolPaletteItemProvider.prototype.addImportToolGroup = function (pckg, opts) {
         ...
         */
        ToolPaletteItemProvider.prototype.getToolGroup = function (pckg) {
            var definitions = [];
            var self = this;
