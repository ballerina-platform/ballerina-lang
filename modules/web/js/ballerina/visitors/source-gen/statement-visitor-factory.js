...
define(['lodash', 'log', 'event_channel', '../../ast/module', './try-catch-statement-visitor',
        ...
        './logical-expression-visitor', './return-statement-visitor', './function-invocation-visitor',
        './function-invocation-expression-visitor', './assignment-visitor', './left-operand-expression-visitor',
        './right-operand-expression-visitor', './variable-definition-statement-visitor', './worker-invoke-visitor',
        './worker-receive-visitor', './break-statement-visitor', './throw-statement-visitor',
        './comment-statement-visitor'],
function (_, log, EventChannel, AST, TryCatchStatementVisitor, TryStatementVisitor, CatchStatementVisitor,
          ...
          LogicalExpressionVisitor, ReturnStatementVisitor, FunctionInvocationVisitor,
          FunctionInvocationExpressionVisitor, AssignmentVisitor, LeftOperandExpressionVisitor,
          RightOperandExpressionVisitor, VariableDefinitionStatement, WorkerInvoke, WorkerReceive,
