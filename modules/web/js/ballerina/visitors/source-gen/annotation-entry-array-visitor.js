...
class AnnotationEntryArrayVisitor extends AbstractSourceGenVisitor {
    ...
    beginVisitAnnotationEntryArray (annotationEntryArray) {
        this.appendSource(annotationEntryArray.toString());
        log.debug('Begin Visit AnnotationEntryArray');
    }

    visitAnnotationEntryArray (annotationEntryArray) {
        log.debug('Visit AnnotationEntryArray');
    }
...
export default AnnotationEntryArrayVisitor;
