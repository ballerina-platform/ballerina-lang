...
class ParameterDefinition extends React.Component {
    ...
    render() {
        ...
        return (<g>
            <rect x={viewState.bBox.x + 7} y={viewState.bBox.y + 15 } width={viewState.w + 5} height={viewState.h + 2} rx="0" ry="0"
                  className="parameter-wrapper"/>
            <text x={viewState.bBox.x + 10} y={viewState.bBox.y + 16}
                  className="parameter-text">{util.getTextWidth(model.getParameterDefinitionAsString()).text}</text>
            <rect x={viewState.components.deleteIcon.x } y={viewState.components.deleteIcon.y + 15}
            ...
            <text x={viewState.components.deleteIcon.x + 5} y={viewState.components.deleteIcon.y + 28} width="14"
            ...
            <rect x={viewState.components.deleteIcon.x + viewState.components.deleteIcon.w + 4}
                  y={viewState.components.deleteIcon.y + 14} width={1} height={viewState.h - 2} rx="0" ry="0"
