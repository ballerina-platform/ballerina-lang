        ...
        return (
            <div style={style} className="struct-content-operations-wrapper">
              <div className="type-drop-wrapper struct-view">
                  <select tabIndex="-1" style={{width: 188, height: 25}}>
                    {
                        types.map( type =>{
              ...
              <input type="text" className="struct-identifier-text-input" placeholder="Identifier" />
              <input type="text" className="struct-default-value-text-input" placeholder="Default Value" />
              <div className="add-struct-variable-button pull-left">
