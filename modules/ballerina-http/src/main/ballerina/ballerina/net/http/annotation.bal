...
@Field {value:"basePath: Service basePath"}
...
@Field {value:"allowOrigins: The array of origins which the response is shared by the service"}
@Field {value:"allowCredentials: Enables the need of credentials to the service"}
...
@Field {value:"methods: The array of HTTP methods"}
...
@Field {value:"allowOrigins: The array of origins which the response is shared by the resource"}
@Field {value:"allowCredentials: Enables the need of credentials to the resource"}
