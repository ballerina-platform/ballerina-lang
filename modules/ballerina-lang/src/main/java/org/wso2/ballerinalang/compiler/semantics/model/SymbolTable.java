...
public class SymbolTable {
    ...
    private void defineOperators() {
        ...
        defineBinaryOperator(OperatorKind.EQUAL, stringType, nullType, booleanType, InstructionCodes.SEQ);
        defineBinaryOperator(OperatorKind.EQUAL, nullType, stringType, booleanType, InstructionCodes.SEQ);
        ...
        defineBinaryOperator(OperatorKind.NOT_EQUAL, stringType, nullType, booleanType, InstructionCodes.SNE);
        defineBinaryOperator(OperatorKind.NOT_EQUAL, nullType, stringType, booleanType, InstructionCodes.SNE);
    ...
    private void defineCastOperators() {
        ...
        defineCastOperator(nullType, stringType, true, InstructionCodes.NOP);
