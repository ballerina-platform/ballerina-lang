...
public native function toUpperCase (string s) (string);
...
public native function lastIndexOf (string mainString, string subString) (int);
...
public native function replaceFirst (string mainString, string replacePattern, string replaceWith) (string);

@doc:Description { value:"Returns the length of the specified string "}
@doc:Param { value:"s: The original string argument" }
@doc:Return { value:"int: The length of the specified string" }
public native function length (string s) (int);
...
public native function contains (string mainString, string subString) (boolean);
...
public native function hasSuffix (string mainString, string suffix) (boolean);

@doc:Description { value:"Returns an unescaped string by omitting the escape characters of the original string"}
@doc:Param { value:"s: The original string argument" }
@doc:Return { value:"string: The derived string" }
public native function unescape (string s) (string);
...
public native function toLowerCase (string s) (string);
...
public native function hasPrefix (string mainString, string prefix) (boolean);
...
@doc:Param { value:"replaceWith: The replacement string" }
@doc:Return { value:"string: The derived string" }
public native function replaceAll (string mainString, string replacePattern, string replaceWith) (string);
...
@doc:Param { value:"replaceWith: The replacement string" }
@doc:Return { value:"string: The derived string" }
public native function replace (string mainString, string replacePattern, string replaceWith) (string);
...
public native function split (string mainString, string regex) (string[]);
...
public native function toBlob (string s, string encoding) (blob);