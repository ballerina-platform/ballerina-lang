...
public native function getJsonPayload (message m) (json);
...
public native function getXmlPayload (message m) (xml);
...
public native function getBinaryPayload (message m) (blob);
...
public native function setProperty (message msg, string propertyName, string propertyValue);
...
public native function setStringPayload (message m, string payload);
...
public native function getHeader (message m, string headerName) (string);
...
public native function getStringPayload (message m) (string);
...
public native function clone (message m) (message);

@doc:Description { value:"Sets the value of a transport header"}
@doc:Param { value:"m: The message object" }
@doc:Param { value:"key: The header name" }
@doc:Param { value:"value: The header value" }
public native function setHeader (message m, string key, string value);

@doc:Description { value:"Sets the message payload using a map object"}
@doc:Param { value:"msg: The current message object" }
@doc:Param { value:"payload: The map payload object" }
public native function setMapPayload (message msg, map payload);
...
public native function getStringValue (message m, string propertyName) (string);
