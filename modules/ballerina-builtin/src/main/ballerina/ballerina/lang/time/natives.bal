...
public native function toString(Time time)(string);
...
public native function format(Time time, string format)(string);
...
public native function year(Time time)(int);
...
public native function month(Time time)(int);
...
public native function day(Time time)(int);
...
public native function weekday(Time time)(string);
...
public native function hour(Time time)(int);
...
public native function minute(Time time)(int);
...
public native function second(Time time)(int);
...
public native function milliSecond(Time time)(int);
...
@doc:Return {value:"int: The month-of-year, from 1 (January) to 12 (December)."}
@doc:Return {value:"int: The day-of-month, from 1 to 31."}
public native function getDate(Time time)(int, int, int);
...
@doc:Return {value:"int: The second-of-minute, from 0 to 59."}
@doc:Return {value:"int: The milli-of-second, from 0 to 999."}
public native function getTime(Time time)(int, int, int, int);
...
public native function addDuration(Time timeData, int years, int months, int days, int hours, int minutes, int seconds,
...
public native function subtractDuration(Time timeData, int years, int months, int days, int hours, int minutes, int seconds,
                             int milliSeconds)(Time);
...
public native function toTimezone(Time timeData, string zoneId)(Time);
