...
public const string HEADER_MESSAGE_ID = "JMS_MESSAGE_ID";
...
public const string HEADER_PRIORITY = "JMS_PRIORITY";

@doc:Description { value:"Header for JMS message expiry. "}
public const string HEADER_EXPIRATION = "JMS_EXPIRATION";
...
public const string HEADER_REDELIVERED = "JMS_REDELIVERED";

@doc:Description { value:"JMS correlation id message header"}
public const string HEADER_CORRELATION_ID = "JMS_CORRELATION_ID";

@doc:Description { value:"JMS destination message header"}
public const string HEADER_DESTINATION = "JMS_DESTINATION";

@doc:Description { value:"JMS timestamp message header"}
public const string HEADER_TIMESTAMP = "JMS_TIMESTAMP";

@doc:Description { value:"JMS reply to message header"}
public const string HEADER_REPLY_TO = "JMS_REPLY_TO";
...
public const string HEADER_MESSAGE_TYPE = "JMS_TYPE";
...
public const string HEADER_DELIVERY_MODE = "JMS_DELIVERY_MODE";

@doc:Description { value:"Value for persistent JMS message delivery mode"}
public const string PERSISTENT_DELIVERY_MODE = "2";

@doc:Description { value:"Value for non persistent JMS message delivery mode"}
public const string NON_PERSISTENT_DELIVERY_MODE = "1";
