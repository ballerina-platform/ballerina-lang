...
/**
 * Represents node Where BinaryExpression ends.
 */
public class BinaryExpressionEndNode extends AbstractLinkedNode {

    private BinaryExpression expression;

    public BinaryExpressionEndNode(BinaryExpression expression) {
