...
/**
 * Native function to get long array value of a given column index.
 * ballerina.lang.dataframe:getLongArray(dataframe, int)
 */
@BallerinaFunction(
...
public class GetLongArrayByIndex extends AbstractNativeFunction {
    ...
    public BValue[] execute(Context ctx) {
        ...
        long[] longArray = dataframe.getLongArray(index);
