...
/**
 * Native function to get boolean array value of a given column index.
 * ballerina.lang.datatable:getBooleanArray(datatable, int)
 */
@BallerinaFunction(
...
public class GetBooleanArrayByIndex extends AbstractNativeFunction {
    ...
    public BValue[] execute(Context ctx) {
        ...
        boolean[] booleanArray = dataframe.getBooleanArray(index);
