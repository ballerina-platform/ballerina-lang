...
@BallerinaAction(
        ...
        args = {
                ...
                @Argument(name = "document", type = TypeEnum.JSON)
        },
        returnType = {TypeEnum.EMPTY})
@Component(
        name = "action.data.mongodb.insert",
        immediate = true,
        service = AbstractNativeAction.class)
public class Insert extends AbstractNativeAction {
    ...
    public BValue execute(Context context) {
        ...
        BJSON document = ((BJSON) getArgument(context, 2));
        ...
        mdb.insert(collection, document);
        return null;
    }
