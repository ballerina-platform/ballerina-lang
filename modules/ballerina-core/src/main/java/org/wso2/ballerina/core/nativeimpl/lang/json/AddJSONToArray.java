...
/**
 * Insert a JSON element to a JSON Array. This method will add a new JSON element
 * (object or array) to the end of the JSON Array identified by the given jsonpath.
 */
@BallerinaFunction(
...
public class AddJSONToArray extends AbstractJSONFunction {
    ...
    private static final String OPERATION = "add element to json array";
