...
/**
 * Native function to get string array value of a given column name.
 * ballerina.lang.datatable:getStringArray(datatable, int)
 */
@BallerinaFunction(
...
public class GetStringArrayByName extends AbstractNativeFunction {
    ...
    public BValue[] execute(Context ctx) {
        ...
        String[] stringArray = dataframe.getStringArray(columnName);
