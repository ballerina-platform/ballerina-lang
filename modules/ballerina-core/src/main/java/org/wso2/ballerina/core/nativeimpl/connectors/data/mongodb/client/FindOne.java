...
/**
 * The FindOne action for MongoDB.
 */
@BallerinaAction(
...
@Component(
        name = "action.data.mongodb.findOne",
        immediate = true,
        service = AbstractNativeAction.class)
public class FindOne extends AbstractNativeAction {
    ...
    public BValue execute(Context context) {
        ...
        BValue result = mdb.findOne(collection, null);
