...
@BallerinaAction(
        ...
        args = {
                ...
                @Argument(name = "upsert", type = TypeEnum.BOOLEAN)
        },
        returnType = {TypeEnum.EMPTY})
@Component(
        name = "action.data.mongodb.update",
        immediate = true,
        service = AbstractNativeAction.class)
public class Update extends AbstractNativeAction {
    ...
    public BValue execute(Context context) {
        ...
        BJSON document = ((BJSON) getArgument(context, 3));
        BBoolean multi = ((BBoolean) getArgument(context, 4));
        BBoolean upsert = ((BBoolean) getArgument(context, 5));
        ...
        mdb.update(collection, filter, document, multi, upsert);
        return null;
    }
