...
/**
 * Service not found exception, thrown when a matching service is not found.
 *
 * @since 0.8.0
 */
public class ServiceNotFoundException extends BallerinaException {
    ...
    /**
     * Constructs a new {@link ServiceNotFoundException} with the specified detail message and cause.
     *
     * @param message Error message
     * @param cause   Cause
     */
