...
public class LessEqualExpression extends BinaryCompareExpression {
    ...
    public static final TriFunction<Context, Expression, Expression, BValueRef> LESS_EQUAL_INT_FUNC =
            (ctx, lExpr, rExpr) -> {
    ...
    public static final TriFunction<Context, Expression, Expression, BValueRef> LESS_EQUAL_LONG_FUNC =
            (ctx, lExpr, rExpr) -> {
    ...
    public static final TriFunction<Context, Expression, Expression, BValueRef> LESS_EQUAL_FLOAT_FUNC =
            (ctx, lExpr, rExpr) -> {
    ...
    public static final TriFunction<Context, Expression, Expression, BValueRef> LESS_EQUAL_DOUBLE_FUNC =
            (ctx, lExpr, rExpr) -> {
    ...
    public LessEqualExpression(Expression lExpr, Expression rExpr) {
        super(lExpr, LESS_EQUAL, rExpr);
    }
