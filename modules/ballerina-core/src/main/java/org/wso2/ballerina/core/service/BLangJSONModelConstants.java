...
public class BLangJSONModelConstants {
    ...
    public static final String ARRAY_ACCESS_SYMBOL_NAME = "array_access_symbol_name";

    public static final String ARRAY_ACCESS_IS_LHS_EXPRESSION = "array_access_is_lhs_expr";
