...
public class NotEqualExpression extends BinaryEqualityExpression {
    ...
    public static final BiFunction<BValueRef, BValueRef, BValueRef> NOT_EQUAL_INT_FUNC =
            (lVal, rVal) -> {
                BValue resultVal = new BooleanValue(lVal.getInt() != rVal.getInt());
                return new BValueRef(resultVal);
            };

    public static final BiFunction<BValueRef, BValueRef, BValueRef> NOT_EQUAL_LONG_FUNC =
            (lVal, rVal) -> {
                BValue resultVal = new BooleanValue(lVal.getLong() != rVal.getLong());
                return new BValueRef(resultVal);
            };

    public static final BiFunction<BValueRef, BValueRef, BValueRef> NOT_EQUAL_FLOAT_FUNC =
            (lVal, rVal) -> {
                BValue resultVal = new BooleanValue(lVal.getFloat() != rVal.getFloat());
                return new BValueRef(resultVal);
            };

    public static final BiFunction<BValueRef, BValueRef, BValueRef> NOT_EQUAL_DOUBLE_FUNC =
            (lVal, rVal) -> {
                BValue resultVal = new BooleanValue(lVal.getDouble() != rVal.getDouble());
                return new BValueRef(resultVal);
            };

    public static final BiFunction<BValueRef, BValueRef, BValueRef> NOT_EQUAL_STRING_FUNC =
            (lVal, rVal) -> {
