...
public class GetDouble extends AbstractJSONFunction {
    ...
    private static final Logger log = LoggerFactory.getLogger(GetDouble.class);
        ...
        if (element == null) {
            ...
            if (value.isNumber()) {
                ...
                if (number instanceof Double) {
                    ...
                    String errorMsg = "The element matching path: " + jsonPath + " is not a Double.";
                    log.error(errorMsg);
            ...
            String errorMsg = "The element matching path: " + jsonPath + " is a JSON, not a Double.";
            log.error(errorMsg);
            throw new RuntimeException(errorMsg);
        }
