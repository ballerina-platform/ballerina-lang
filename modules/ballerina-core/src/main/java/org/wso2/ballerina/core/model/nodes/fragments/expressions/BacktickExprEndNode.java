...
/**
 * Represents node Where BacktickExpr ends.
 */
public class BacktickExprEndNode extends AbstractLinkedNode {

    private BacktickExpr expression;

    public BacktickExprEndNode(BacktickExpr expression) {
        this.expression = expression;
        this.parent = expression;
    }

    public BacktickExpr getExpression() {
        return expression;
    }
