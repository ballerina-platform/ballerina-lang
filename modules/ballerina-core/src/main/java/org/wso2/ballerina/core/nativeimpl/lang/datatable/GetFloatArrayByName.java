...
/**
 * Native function to get float array value of a given column name.
...
public class GetFloatArrayByName extends AbstractNativeFunction {
    ...
    public BValue[] execute(Context ctx) {
        ...
        float[] floatArray = dataframe.getFloatArray(columnName);
