...
public class GreaterEqualExpression extends BinaryCompareExpression {
    ...
    public static final TriFunction<Context, Expression, Expression, BValueRef> GREATER_EQUAL_INT_FUNC =
            (ctx, lExpr, rExpr) -> {
    ...
    public static final TriFunction<Context, Expression, Expression, BValueRef> GREATER_EQUAL_LONG_FUNC =
            (ctx, lExpr, rExpr) -> {
    ...
    public static final TriFunction<Context, Expression, Expression, BValueRef> GREATER_EQUAL_FLOAT_FUNC =
            (ctx, lExpr, rExpr) -> {
    ...
    public static final TriFunction<Context, Expression, Expression, BValueRef> GREATER_EQUAL_DOUBLE_FUNC =
            (ctx, lExpr, rExpr) -> {
