...
/**
 * Represents node Where BinaryEqualityExpressionEndNode ends.
 */
public class BinaryEqualityExpressionEndNode extends AbstractLinkedNode {

    private BinaryEqualityExpression expression;

    public BinaryEqualityExpressionEndNode(BinaryEqualityExpression expression) {
        this.expression = expression;
        this.parent = expression;
    }

    public BinaryEqualityExpression getExpression() {
        return expression;
    }
