 ...
 * @since 0.87
 */
public class TypeConversionExpression extends AbstractExpression implements CallableUnitInvocationExpr<TypeMapper> {
    private String name;
    ...
    public TypeConversionExpression(NodeLocation location, WhiteSpaceDescriptor whiteSpaceDescriptor, Expression rExpr,
                              BType targetType) {
    ...
    public TypeConversionExpression(NodeLocation location, WhiteSpaceDescriptor whiteSpaceDescriptor, 
