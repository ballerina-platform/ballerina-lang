...
/**
 * Represents node Where ArrayLengthAccessExpr ends.
 */
public class ArrayLengthAccessExprEndNode extends AbstractLinkedNode {

    private ArrayLengthAccessExpr expression;

    public ArrayLengthAccessExprEndNode(ArrayLengthAccessExpr expression) {
        this.expression = expression;
        this.parent = expression;
    }

    public ArrayLengthAccessExpr getExpression() {
        return expression;
    }
