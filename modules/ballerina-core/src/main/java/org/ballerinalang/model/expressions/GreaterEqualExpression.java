...
public class GreaterEqualExpression extends BinaryCompareExpression {
    ...
    public static final BiFunction<BValue, BValue, BValue> GREATER_EQUAL_INT_FUNC =
            (lVal, rVal) -> new BBoolean(((BValueType) lVal).intValue() >= ((BValueType) rVal).intValue());

    public static final BiFunction<BValue, BValue, BValue> GREATER_EQUAL_FLOAT_FUNC =
