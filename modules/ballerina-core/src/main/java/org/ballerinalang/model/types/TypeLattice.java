...
public class TypeLattice {
    ...
    public static void loadImplicitCastLattice(SymbolScope scope) {
        ...
        implicitCastLattice.addVertex(anyV, false);
        ...
        implicitCastLattice.addEdge(intV, anyV, NativeCastMapper.INT_TO_INT_FUNC);
        ...
        implicitCastLattice.addEdge(longV, anyV, NativeCastMapper.LONG_TO_LONG_FUNC);
        ...
        implicitCastLattice.addEdge(floatV, anyV, NativeCastMapper.FLOAT_TO_FLOAT_FUNC);

        implicitCastLattice.addEdge(doubleV, stringV, NativeCastMapper.DOUBLE_TO_STRING_FUNC);
        implicitCastLattice.addEdge(doubleV, anyV, NativeCastMapper.DOUBLE_TO_DOUBLE_FUNC);
        ...
        implicitCastLattice.addEdge(booleanV, anyV, NativeCastMapper.BOOLEAN_TO_BOOLEAN_FUNC);
    }
    ...
    public static void loadExplicitCastLattice(SymbolScope scope) {
        ...
        explicitCastLattice.addEdge(intV, anyV, NativeCastMapper.INT_TO_INT_FUNC);
        ...
        explicitCastLattice.addEdge(longV, anyV, NativeCastMapper.LONG_TO_LONG_FUNC);
        ...
        explicitCastLattice.addEdge(doubleV, anyV, NativeCastMapper.DOUBLE_TO_DOUBLE_FUNC);
        ...
        explicitCastLattice.addEdge(floatV, anyV, NativeCastMapper.FLOAT_TO_FLOAT_FUNC);
        ...
        explicitCastLattice.addEdge(stringV, anyV, NativeCastMapper.STRING_TO_STRING_FUNC);
        ...
        explicitCastLattice.addEdge(booleanV, anyV, NativeCastMapper.BOOLEAN_TO_BOOLEAN_FUNC);
