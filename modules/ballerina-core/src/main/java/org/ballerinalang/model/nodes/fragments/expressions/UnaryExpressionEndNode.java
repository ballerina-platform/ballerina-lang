...
/**
 * Represents node Where UnaryExpression ends.
 */
public class UnaryExpressionEndNode extends AbstractLinkedNode {

    private UnaryExpression expression;

    public UnaryExpressionEndNode(UnaryExpression expression) {
