 ...
 * @since 0.8.0
 */
public class ProgramPackageRepository extends PackageRepository {
    ...
    public ProgramPackageRepository(Path programDirPath,
                                    SystemPackageRepository systemPackageRepo,
                                    UserPackageRepository userPackageRepo) {
