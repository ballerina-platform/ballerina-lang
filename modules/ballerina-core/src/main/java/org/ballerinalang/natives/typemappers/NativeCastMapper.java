...
public class NativeCastMapper {
    ...
    public static final TriFunction<BValue, BType, Boolean, BValue[]> JSON_TO_MAP_FUNC = 
            (rVal, targetType, returnErrors) -> {
                ...
                try {
                    ...
                    String errorMsg = BLangExceptionHelper.getErrorMessage(RuntimeErrors.CASTING_FAILED_WITH_CAUSE, BTypes.typeJSON,
    ...
    public static final TriFunction<BValue, BType, Boolean, BValue[]> MAP_TO_JSON_FUNC =
            (rVal, targetType, returnErrors) -> {
                ...
                try {
                    ...
                    String errorMsg = BLangExceptionHelper.getErrorMessage(RuntimeErrors.CASTING_FAILED_WITH_CAUSE, BTypes.typeMap,
    ...
    public static final TriFunction<BValue, BType, Boolean, BValue[]> STRUCT_TO_STRUCT_FUNC = 
            (rVal, targetType, returnErrors) -> {
                ...
                String errorMsg = BLangExceptionHelper.getErrorMessage(RuntimeErrors.INCOMPATIBLE_TYPE_FOR_CASTING, targetType,
                        rVal.getType());
                return getError(returnErrors, errorMsg, targetType);
            };
    ...
    public static final TriFunction<BValue, BType, Boolean, BValue[]> ARRAY_TO_JSON_FUNC = 
            (rVal, targetType, returnErrors) -> {
                ...
                try {
                    ...
                    String errorMsg = BLangExceptionHelper.getErrorMessage(RuntimeErrors.CASTING_FAILED_WITH_CAUSE, rVal.getType(),
                        BTypes.typeJSON, e.getMessage());
                    return getError(returnErrors, errorMsg, targetType);
                }
            };
