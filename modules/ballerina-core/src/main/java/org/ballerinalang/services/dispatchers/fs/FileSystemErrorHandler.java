...
/**
 * Error handler for File System Server Connector.
 */
@Component(
        name = "ballerina.net.fs.error.handler",
        immediate = true,
        service = ServerConnectorErrorHandler.class)
public class FileSystemErrorHandler implements ServerConnectorErrorHandler {

    private static final Logger log = LoggerFactory.getLogger(FileSystemErrorHandler.class);
