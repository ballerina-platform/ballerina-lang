...
public class BallerinaConfiguration {
    @Element(description = "ballerina service interceptor configuration")
    private List<ServiceInterceptorConfig> serviceInterceptors = new ArrayList<>();

    public List<ServiceInterceptorConfig> getServiceInterceptors() {
