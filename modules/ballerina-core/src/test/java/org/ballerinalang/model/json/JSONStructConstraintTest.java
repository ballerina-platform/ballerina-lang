...
public class JSONStructConstraintTest {
    ...
    @Test(description = "Validate json struct with function return")
    public void testFunctionJsonReturn() {
        BLangFunctions.invokeNew(BTestUtils.getProgramFile("lang/jsontype/json-struct-constraint-function-returns.bal"),
                                 "testJsonStructConstraint");
    }
}
