...
public class ArrayIndexTooLargeTest {
    ...
    @BeforeClass
    public void setup() {
        bLangProgram = BTestUtils.getProgramFile("lang/expressions/array-index-too-large.bal");
    }
    ...
    public void addTooLargeIndex() {
        ...
        BLangFunctions.invokeNew(bLangProgram, "addTooLargeIndex", args);
    }
    ...
    public void accessTooLargeIndex() {
        ...
        BValue[] returns = BLangFunctions.invokeNew(bLangProgram, "accessTooLargeIndex", args);
    }
    ...
    public void addMinusIndex() {
        ...
        BLangFunctions.invokeNew(bLangProgram, "addMinusIndex", args);
    }
    ...
    public void accessMinusIndex() {
        ...
        BValue[] returns = BLangFunctions.invokeNew(bLangProgram, "accessMinusIndex", args);
    }
}
