...
/**
 * Test error handler used with handling server connector error with jms related test cases.
 */
public class TestJmsErrorHandler implements ServerConnectorErrorHandler {
    @Override
