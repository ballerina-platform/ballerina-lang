...
public class TemplateExpressionTest {
    ...
    public void setup() {
        ...
        bFile = BTestUtils.parseBalFile("lang/expressions/template-expr.bal", symScope);
    }

    @Test(description = "Test XML backtick expression definition")
    public void testBacktickXMLExpr() {
        BValue[] args = { new BString("WSO2")};
        BValue[] returns = BLangFunctions.invoke(bFile, "backtickXMLTest", args);
    ...
    public void testBacktickJSONExpr() {
        BValue[] args = { new BString("WSO2")};
        BValue[] returns = BLangFunctions.invoke(bFile, "backtickJSONTest", args);
        Assert.assertEquals(returns.length, 1);
    ...
    public void testBacktickJSONVariableAccessExpr() {
        BValue[] args = { new BString("WSO2")};
        BValue[] returns = BLangFunctions.invoke(bFile, "backtickStringVariableAccessJSON", args);
        Assert.assertEquals(returns.length, 1);
        Assert.assertSame(returns[0].getClass(), BJSON.class);
    ...
    public void testBacktickXMLVariableAccessExpr() {
        BValue[] args = { new BString("WSO2")};
        BValue[] returns = BLangFunctions.invoke(bFile, "backtickVariableAccessXML", args);
        Assert.assertEquals(returns.length, 1);
        Assert.assertSame(returns[0].getClass(), BXML.class);
    ...
    public void testBacktickJSONIntegerVariableAccessExpr() {
        ...
        BValue[] returns = BLangFunctions.invoke(bFile, "backtickIntegerVariableAccessJSON", args);
        Assert.assertEquals(returns.length, 1);
        Assert.assertSame(returns[0].getClass(), BJSON.class);
    ...
    public void testBacktickJSONFullReplacement() {
        BValue[] args = { new BInteger(11)};
        BValue[] returns = BLangFunctions.invoke(bFile, "backticJSONEnrichFullJSON", args);
        Assert.assertEquals(returns.length, 1);
        Assert.assertSame(returns[0].getClass(), BJSON.class);
        String expected =  "{\"name\":\"John\"}";
        Assert.assertEquals(returns[0].stringValue(), expected);
    ...
    public void testBacktickMultipleVariablesFullJSONReplacement() {
        ...
        BValue[] returns = BLangFunctions.invoke(bFile, "backticJSONMultipleVariables", args);
        Assert.assertEquals(returns.length, 1);
        Assert.assertSame(returns[0].getClass(), BJSON.class);
    ...
    public void testBacktickPartsJSON() {
        ...
        BValue[] returns = BLangFunctions.invoke(bFile, "backticJSONParts", args);
        Assert.assertEquals(returns.length, 1);
        Assert.assertSame(returns[0].getClass(), BJSON.class);
    ...
    public void testBacktickJSONArrayVariableAccess() {
        BValue[] returns = BLangFunctions.invoke(bFile, "backtickJSONArrayVariableAccess");
        Assert.assertEquals(returns.length, 1);
        Assert.assertSame(returns[0].getClass(), BJSON.class);
    ...
    public void testBacktickXMLArrayVariableAccess() {
        BValue[] returns = BLangFunctions.invoke(bFile, "backtickXMLArrayVariableAccess");
        Assert.assertEquals(returns.length, 1);
        Assert.assertSame(returns[0].getClass(), BXML.class);
    ...
    public void testBacktickJSONMapVariableAccess() {
        BValue[] returns = BLangFunctions.invoke(bFile, "backtickJSONMapVariableAccess");
        Assert.assertEquals(returns.length, 1);
        Assert.assertSame(returns[0].getClass(), BJSON.class);
    ...
    public void testBacktickXMLMapVariableAccess() {
        BValue[] returns = BLangFunctions.invoke(bFile, "backtickXMLMapVariableAccess");
        Assert.assertEquals(returns.length, 1);
        Assert.assertSame(returns[0].getClass(), BXML.class);
