...
public class BinaryExprTest {
    ...
    @BeforeClass
    public void setup() {
        bFile = BTestUtils.parseBalFile("lang/expressions/binary-expr.bal");
    }
    ...
    public void testBinaryExpr() {
        ...
        BValue[] returns = BLangFunctions.invoke(bFile, "makeChild", args);
        ...
        returns = BLangFunctions.invoke(bFile, "makeChild", args);
        Assert.assertEquals(returns.length, 1);
        Assert.assertSame(returns[0].getClass(), BBoolean.class);
    ...
    public void multiBinaryAndExpressionTest() {
        ...
        BValue[] returns = BLangFunctions.invoke(bFile, "multiBinaryANDExpression", args);
        Assert.assertEquals(returns.length, 1);
        Assert.assertSame(returns[0].getClass(), BBoolean.class);
    ...
    public void multiBinaryORExpressionTest() {
        ...
        BValue[] args = { new BBoolean(one), new BBoolean(two), new BBoolean(three) };
        BValue[] returns = BLangFunctions.invoke(bFile, "multiBinaryORExpression", args);
        Assert.assertEquals(returns.length, 1);
        Assert.assertSame(returns[0].getClass(), BBoolean.class);
        boolean actualResult = ((BBoolean) returns[0]).booleanValue();
    ...
    public void multiBinaryExpressionTest() {
        ...
        BValue[] args = { new BBoolean(one), new BBoolean(two), new BBoolean(three) };
        BValue[] returns = BLangFunctions.invoke(bFile, "multiBinaryExpression", args);
        Assert.assertEquals(returns.length, 1);
        Assert.assertSame(returns[0].getClass(), BBoolean.class);
        boolean actualResult = ((BBoolean) returns[0]).booleanValue();
