...
public class FunctionOverloadTest {
    ...
    @BeforeClass
    public void setup() {
        bFile = ParserUtils.parseBalFile("lang/functions/function-overloading.bal");
    }
    ...
    public void testFunctionOverloadingDifferentArgCount() {
        ...
        BValue[] returnsStep1 = Functions.invoke(bFile, overloadingFunctionName);
        ...
        BValue[] returnsStep2 = Functions.invoke(bFile, overloadingFunctionName, argsStep2);
        ...
        BValue[] returnsStep3 = Functions.invoke(bFile, overloadingFunctionName, argsStep3);
    ...
    public void testFunctionOverloadingSameArgCountTest() {
        ...
        BValue[] returnsStep1 = Functions.invoke(bFile, overloadingFunctionName, argsStep1);
        ...
        BValue[] returnsStep4 = Functions.invoke(bFile, overloadingFunctionName, argsStep4);
        ...
        BValue[] returnsStep5 = Functions.invoke(bFile, overloadingFunctionName, argsStep5);
    ...
    public void testInvalidFunctionOverloading() {
        ...
        try {
            ParserUtils.parseBalFile("lang/functions/invalid-function-overloading.bal");
        } catch (Exception e) {
            ex = e;
        } finally {
