...
public class IfElseStmtTest {
    ...
    @BeforeClass
    public void setup() {
        bFile = BTestUtils.parseBalFile("lang/statements/if-stmt.bal");
    }

    @Test(description = "Check a == b")
    public void testIfBlock() {
        BValue[] args = {new BInteger(10), new BInteger(10), new BInteger(20)};
        BValue[] returns = BLangFunctions.invoke(bFile, funcName, args);
...
//        Assert.assertEquals(actual, expected);
    ...
    public void testAge() {
        ...
        BValue[] returns = BLangFunctions.invoke(bFile, "testAgeGroup", args);
        ...
        returns = BLangFunctions.invoke(bFile, "testAgeGroup", args);
    ...
    public void testIfElseBlockScopes() {
        ...
        BValue[] returns = BLangFunctions.invoke(bFile, "ifElseScope", args);
        Assert.assertEquals(returns.length, 1);
        ...
        returns = BLangFunctions.invoke(bFile, "ifElseScope", args);
        Assert.assertEquals(returns.length, 1);
        Assert.assertSame(returns[0].getClass(), BInteger.class, "Class type mismatched");
    ...
    public void testNestedIfElseBlockScopes() {
        ...
        BValue[] returns = BLangFunctions.invoke(bFile, "nestedIfElseScope", args);
        Assert.assertEquals(returns.length, 1);
        Assert.assertSame(returns[0].getClass(), BInteger.class, "Class type mismatched");
        BInteger actual = (BInteger) returns[0];
        ...
        returns = BLangFunctions.invoke(bFile, "nestedIfElseScope", args);
        Assert.assertEquals(returns.length, 1);
        Assert.assertSame(returns[0].getClass(), BInteger.class, "Class type mismatched");
        actual = (BInteger) returns[0];
        Assert.assertEquals(actual.intValue(), 200, "mismatched output value");
    ...
    public void testIfConditionScope() {
        BallerinaFile balFile = BTestUtils.parseBalFile("lang/statements/if-condition-scope.bal");

        BValue[] args1 = { new BInteger(3)};
        BValue[] returns = BLangFunctions.invoke(balFile, "testConditionScope", args1);
        Assert.assertEquals(returns.length, 1);
        Assert.assertSame(returns[0].getClass(), BInteger.class, "Class type mismatched");
        BInteger actual = (BInteger) returns[0];
        ...
        returns = BLangFunctions.invoke(balFile, "testConditionScope", args2);
        Assert.assertEquals(returns.length, 1);
        Assert.assertSame(returns[0].getClass(), BInteger.class, "Class type mismatched");
        actual = (BInteger) returns[0];
