...
function testXAransactonSuccess () (int count1, int count2) {
    endpoint<sql:ClientConnector> testDB1 {
        create sql:ClientConnector(sql:DB.H2_FILE, "./target/H2_1/",
                                   0, "TestDB1", "sa", "", {maximumPoolSize:1, isXA:true});
    }
    endpoint<sql:ClientConnector> testDB2 {
        create sql:ClientConnector(sql:DB.H2_FILE, "./target/H2_2/",
                                   0, "TestDB2", "sa", "", {maximumPoolSize:1, isXA:true});
    }
    transaction {
