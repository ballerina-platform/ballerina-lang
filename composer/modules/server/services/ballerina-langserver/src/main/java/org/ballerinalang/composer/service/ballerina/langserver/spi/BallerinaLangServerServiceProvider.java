 ...
 */
package org.ballerinalang.composer.service.ballerina.langserver.spi;
...
import org.ballerinalang.composer.service.ballerina.langserver.service.BallerinaLangServerService;

/**
 * Ballerina LangServer service provider.
 */
@ComposerSPIServiceProvider
public class BallerinaLangServerServiceProvider implements ComposerServiceProvider {
    @Override
    public ComposerService createService(ServerConfig config) {
        return new BallerinaLangServerService();
    }
}
