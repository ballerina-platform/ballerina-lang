...
public class ModelGenerator {
    ...
    static final String TEMPLATE_PATH = "./modules/client/packages/plugins/ballerina/src/model/templates/";
    static final String GENERATE_PATH = "./modules/client/packages/plugins/ballerina/src/model/gen/";
