        ...
        beginVisitMatchExpressionPatternClause?(node: Ballerina.MatchExpressionPatternClause): void;
        endVisitMatchExpressionPatternClause?(node: Ballerina.MatchExpressionPatternClause): void;
        ...
        beginVisitDocumentationDescription?(node: Ballerina.DocumentationDescription): void;
        endVisitDocumentationDescription?(node: Ballerina.DocumentationDescription): void;
    

        beginVisitDocumentationParameter?(node: Ballerina.DocumentationParameter): void;
        ...
        beginVisitPatternStreamingEdgeInput?(node: Ballerina.PatternStreamingEdgeInput): void;
        endVisitPatternStreamingEdgeInput?(node: Ballerina.PatternStreamingEdgeInput): void;
        ...
        beginVisitXmlAttributeAccessExpr?(node: Ballerina.XmlAttributeAccessExpr): void;
