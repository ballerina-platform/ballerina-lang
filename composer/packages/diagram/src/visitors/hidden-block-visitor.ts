...
import { ASTKindChecker, ASTNode, ASTUtil, Block, BlockFunctionBody, Visitor } from "@ballerina/ast-model";
...
export const visitor: Visitor = {
    ...
    endVisitBlockFunctionBody(node: BlockFunctionBody) {
        endVisitBlock(node);
    },
...
function endVisitBlock(node: Block | BlockFunctionBody) {
    let hiddenSet = false;
