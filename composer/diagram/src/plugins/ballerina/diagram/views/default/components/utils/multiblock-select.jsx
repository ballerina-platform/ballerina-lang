...
class MultiBlockSelect extends React.Component {
    ...
    render() {
        ...
        const yPosition = props.model.viewState.components['statement-box'].y
            + props.model.viewState.components['statement-box'].h - 25;
        const style = {
            display: 'block',
            top: yPosition,
            left: props.model.viewState.components['statement-box'].x
            + props.model.viewState.components['statement-box'].w
...
MultiBlockSelect.contextTypes = {
    editor: PropTypes.instanceOf(Object).isRequired,
};

export default MultiBlockSelect;
