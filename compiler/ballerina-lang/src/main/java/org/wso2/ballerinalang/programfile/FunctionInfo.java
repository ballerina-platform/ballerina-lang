...
public class FunctionInfo extends CallableUnitInfo {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(pkgNameCPIndex, nameCPIndex, attachedToTypeCPIndex);
    }
    ...
    public boolean equals(Object obj) {
        ...
        FunctionInfo otherFuncInfo = (FunctionInfo) obj;
        return this.pkgNameCPIndex == otherFuncInfo.pkgNameCPIndex &&
                this.nameCPIndex == otherFuncInfo.nameCPIndex &&
                this.attachedToTypeCPIndex == otherFuncInfo.attachedToTypeCPIndex;
    }
}
