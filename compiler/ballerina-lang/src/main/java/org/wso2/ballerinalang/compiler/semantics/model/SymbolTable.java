...
public class SymbolTable {
    ...
    public static final BType noType = new BNoType(TypeTags.NONE);
    public static final BType nilType = new BNilType();
    public static final BType intType = new BType(TypeTags.INT, null);
    public static final BType floatType = new BType(TypeTags.FLOAT, null);
    public static final BType stringType = new BType(TypeTags.STRING, null);
    public static final BType booleanType = new BType(TypeTags.BOOLEAN, null);
    public static final BType blobType = new BType(TypeTags.BLOB, null);
    public static final BType typeDesc = new BType(TypeTags.TYPEDESC, null);
    public static final BType jsonType = new BJSONType(TypeTags.JSON, noType, null);
    public static final BType xmlType = new BXMLType(TypeTags.XML, null);
    public static final BType tableType = new BTableType(TypeTags.TABLE, noType, null);
    public static final BType streamType = new BStreamType(TypeTags.STREAM, noType, null);
    public static final BType anyType = new BAnyType(TypeTags.ANY, null);
    public static final BType mapType = new BMapType(TypeTags.MAP, anyType, null);
    public static final BType futureType = new BFutureType(TypeTags.FUTURE, nilType, null);
    public static final BType xmlAttributesType = new BXMLAttributesType(TypeTags.XML_ATTRIBUTES);
    public static final BType connectorType = new BConnectorType(null, null);
    public static final BType endpointType = new BType(TypeTags.CONNECTOR, null);
    public static final BType arrayType = new BArrayType(noType);
