...
import static org.wso2.ballerinalang.compiler.bir.codegen.JvmConstants.B_STRING_VALUES;
...
public class JvmInstructionGen {
    ...
    void generateStringLoadIns(BIRNonTerminator.FieldAccess stringLoadIns) {
        ...
        this.mv.visitMethodInsn(INVOKESTATIC, B_STRING_VALUES, "getStringAt",
