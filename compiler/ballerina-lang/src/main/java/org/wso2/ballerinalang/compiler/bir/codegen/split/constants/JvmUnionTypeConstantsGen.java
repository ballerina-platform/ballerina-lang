...
public class JvmUnionTypeConstantsGen {
    ...
    public JvmUnionTypeConstantsGen(PackageID packageID, BTypeHashComparator bTypeHashComparator,
        ...
        this.unionVarConstantsPkgName = JVMModuleUtils.getModuleLevelClassName(packageID,
                UNION_TYPE_CONSTANT_PACKAGE_NAME);
    }
    ...
    private void generateBUnionInits(BUnionType type, String varName, SymbolTable symbolTable) {
        ...
        jvmUnionTypeGen.createUnionType(cw, mv, unionTypeClass, varName, type, symbolTable);
        genMethodReturn(mv);
        cw.visitEnd();
    ...
    public void generateGetBUnionType(MethodVisitor mv, String varName) {
        mv.visitFieldInsn(GETSTATIC, unionVarConstantsPkgName + varName, TYPE_VAR_NAME, GET_UNION_TYPE_IMPL);
    }
}
