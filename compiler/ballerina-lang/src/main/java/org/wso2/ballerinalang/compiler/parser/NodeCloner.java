...
public class NodeCloner extends BLangNodeVisitor {
    ...
    public void visit(BLangCheckedOnFailExpr source) {
        ...
        source.cloneRef = clone;
        clone.bLangCheckedExpr = clone(source.bLangCheckedExpr);
        clone.bLangIdentifier = clone(source.bLangIdentifier);
        clone.bLangErrorConstructorExpr = clone(source.bLangErrorConstructorExpr);
//        clone.isRedundantChecking = source.isRedundantChecking;
    }
