...
public class JvmCodeGenUtil {
    ...
    public static String getMethodDescWithCallerEnv(List<BType> paramTypes, BType retType) {
        return INITIAL_MEHOD_DESC_WITH_CALLER_ENV + populateMethodDesc(paramTypes) + generateReturnType(retType);
    }
