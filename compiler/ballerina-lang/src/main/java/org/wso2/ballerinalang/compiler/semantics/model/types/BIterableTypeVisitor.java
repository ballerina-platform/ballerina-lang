...
public abstract class BIterableTypeVisitor implements BTypeVisitor<Operation, List<BType>> {
    ...
    @Override
    public List<BType> visit(BAnydataType type, Operation op) {
        return visit((BType) type, op);
    }

    @Override
    public List<BType> visit(BObjectType type, Operation op) {
        return visit((BType) type, op);
    }
    ...
    @Override
    public List<BType> visit(BTypedescType type, Operation op) {
