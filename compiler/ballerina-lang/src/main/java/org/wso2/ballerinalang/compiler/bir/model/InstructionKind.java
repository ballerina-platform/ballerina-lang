...
public enum InstructionKind {
    ...
    FP_LOAD((byte) 36),
    STRING_LOAD((byte) 37),
    NEW_XML_SEQUENCE((byte) 38),
    NEW_XML_ELEMENT((byte) 39),
    NEW_XML_TEXT((byte) 40),
    NEW_XML_COMMENT((byte) 41),
    NEW_XML_PI((byte) 42),
    NEW_XML_SEQ((byte) 43),
    NEW_XML_QNAME((byte) 44),
    NEW_STRING_XML_QNAME((byte) 45),
    XML_SEQ_STORE((byte) 46),
    XML_SEQ_LOAD((byte) 47),
    XML_LOAD((byte) 48),
    XML_LOAD_ALL((byte) 49),
    XML_ATTRIBUTE_LOAD((byte) 50),
    XML_ATTRIBUTE_STORE((byte) 51),
    NEW_TABLE((byte) 52),
    NEW_TYPEDESC((byte) 53),
    NEW_STREAM((byte) 54),
    TABLE_STORE((byte) 55),
    TABLE_LOAD((byte) 56),
