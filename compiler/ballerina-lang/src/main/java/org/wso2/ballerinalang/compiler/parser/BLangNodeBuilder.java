...
//            attachAnnotations(invocation, numAnnotations, false);
    ...
    private BLangCheckedOnFailExpr createCheckOnFailExpr(Location pos, CheckExpressionNode checkExpressionNode) {
        ...
        checkedOnFailExpr.bLangCheckedExpr = createCheckExpr(pos, expr);
        checkedOnFailExpr.bLangIdentifier = createIdentifier(onFailCheckNode.identifier());
        checkedOnFailExpr.bLangErrorConstructorExpr = createExpression(onFailCheckNode.errorConstructor());
