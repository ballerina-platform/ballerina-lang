...
public class Names {
    ...
    public static final Name ABSTRACT_ITERATOR = new Name("_StreamImplementor");
    public static final Name ABSTRACT_CLOSEABLE_ITERATOR = new Name("_CloseableStreamImplementor");
