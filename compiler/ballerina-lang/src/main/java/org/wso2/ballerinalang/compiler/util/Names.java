...
public class Names {
    ...
    public static final Name LANG_ARRAY = new Name("lang.array");
    public static final Name LANG_DECIMAL = new Name("lang.decimal");
    public static final Name LANG_ERROR = new Name("lang.error");
    public static final Name LANG_FLOAT = new Name("lang.float");
    public static final Name LANG_FUTURE = new Name("lang.future");
    public static final Name LANG_INT = new Name("lang.int");
    public static final Name LANG_MAP = new Name("lang.map");
    public static final Name LANG_STRING = new Name("lang.string");
    public static final Name LANG_VALUE = new Name("lang.value");
