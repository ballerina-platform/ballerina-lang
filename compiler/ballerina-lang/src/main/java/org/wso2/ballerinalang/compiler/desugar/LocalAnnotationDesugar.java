...
public class LocalAnnotationDesugar extends BLangNodeVisitor {
    ...
    public static LocalAnnotationDesugar getInstance(CompilerContext context) {
        LocalAnnotationDesugar parameterDesugar = context.get(LOCAL_ANNOTATION_DESUGAR_KEY);
        if (parameterDesugar == null) {
            parameterDesugar = new LocalAnnotationDesugar(context);
        }

        return parameterDesugar;
    }

    private LocalAnnotationDesugar(CompilerContext context) {
        context.put(LOCAL_ANNOTATION_DESUGAR_KEY, this);
    ...
    public  <E extends BLangNode> List<E> rewrite(List<E> nodeList, SymbolEnv env) {
    ...
    @SuppressWarnings("unchecked")
    public  <E extends BLangExpression> E rewriteExpr(E node) {
        if (node == null) {
            return null;
        }
