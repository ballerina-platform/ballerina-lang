 ...
 * @since 1.0
 */
public class BLangSequence extends BLangExpression implements ListConstructorExprNode {
     ...
     * @since 0.94
     */
    public static class BLangArrayLiteral extends BLangSequence {
     ...
     * @since 1.0
     */
    public static class BLangTupleLiteral extends BLangSequence {
