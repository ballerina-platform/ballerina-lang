...
public class SymTag {
    ...
    public static final int ERROR = 1 << 7 | TYPE | VARIABLE_NAME;
    ...
    public static final int ENDPOINT = 1 << 16 | VARIABLE;
    public static final int TYPE_DEF = 1 << 17 | TYPE | VARIABLE_NAME;
    public static final int OBJECT = 1 << 18 | TYPE_DEF | STRUCT;
    public static final int RECORD = 1 << 19 | TYPE_DEF | STRUCT;
    public static final int FINITE_TYPE = 1 << 20 | TYPE | VARIABLE_NAME;
    public static final int UNION_TYPE = 1 << 21 | TYPE | VARIABLE_NAME;
    public static final int TUPLE_TYPE = 1 << 22 | TYPE | VARIABLE_NAME;
    public static final int ARRAY_TYPE = 1 << 23 | TYPE | VARIABLE_NAME;
