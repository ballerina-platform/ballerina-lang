...
public class SymTag {
    ...
    public static final int VARIABLE = 1 << 5 | VARIABLE_NAME | MAIN;
    ...
    public static final int PACKAGE = 1 << 13 | IMPORT;
    public static final int XMLNS = 1 << 14 | IMPORT;
    public static final int SEMANTIC_ERROR = 1 << 15 | MAIN;
    public static final int ENDPOINT = 1 << 16 | VARIABLE | MAIN;
    public static final int TYPE_DEF = 1 << 17 | TYPE | VARIABLE_NAME | MAIN;
    public static final int OBJECT = 1 << 18 | TYPE_DEF | STRUCT | MAIN;
    public static final int RECORD = 1 << 19 | TYPE_DEF | STRUCT | MAIN;
    public static final int FINITE_TYPE = 1 << 20 | TYPE | VARIABLE_NAME | MAIN;
    public static final int UNION_TYPE = 1 << 21 | TYPE | VARIABLE_NAME | MAIN;
    public static final int TUPLE_TYPE = 1 << 22 | TYPE | VARIABLE_NAME | MAIN;
