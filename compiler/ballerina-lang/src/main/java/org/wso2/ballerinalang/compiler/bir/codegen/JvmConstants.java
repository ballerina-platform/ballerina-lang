...
public class JvmConstants {
    ...
    public static final String STOP_HANDLER_REGISTRY_CLASS =
            "io/ballerina/runtime/internal/scheduling/Scheduler$StopHandlerRegistry";
    ...
    public static final String STOP_HANDLER_REGISTRY_VARIABLE = "$stopHandlerRegistry";
