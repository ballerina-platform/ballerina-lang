...
/**
 * Represent mapping-binding-pattern.
 *
 * @since 2.0.0
 */
public class BLangMappingBindingPattern extends BLangBindingPattern implements MappingBindingPatternNode {
    ...
    @Override
    public List<? extends FieldBindingPatternNode> getFieldBindingPatterns() {
        return fieldBindingPatterns;
    }
    ...
    public NodeKind getKind() {
        return NodeKind.MAPPING_BINDING_PATTERN;
    }
}
