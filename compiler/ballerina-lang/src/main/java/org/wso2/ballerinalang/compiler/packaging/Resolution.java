...
public class Resolution {
    public static final Resolution NOT_FOUND = new Resolution(null);
    private RepoHierarchy resolvedBy;

    Resolution(RepoHierarchy resolvedBy) {
        this.resolvedBy = resolvedBy;
    }

    public RepoHierarchy getResolvedBy() {
        return resolvedBy;
    }
}
