...
public class ObjectGenerator {
    ...
    private void createRecordInitWrapper(ClassWriter cw, String className, BIRNode.BIRTypeDefinition typeDef) {
        ...
        for (BType typeRef : typeDef.referencedTypes) {
            if (typeRef.tag == TypeTags.RECORD) {
                String refTypeClassName = JvmValueGen.getTypeValueClassName(typeRef.tsymbol.pkgID, toNameString(typeRef));
                mv.visitInsn(DUP2);
    ...
    void createRecordGetValuesMethod(ClassWriter cw, List<BField> fields, String className) {
    ...
    void createGetSizeMethod(ClassWriter cw, List<BField> fields, String className) {
    ...
    void createRecordGetKeysMethod(ClassWriter cw, List<BField> fields, String className) {
