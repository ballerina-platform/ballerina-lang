...
public class LockFilePackage {
    ...
    private List<LockFilePackage> importPackages = new ArrayList<>();
    ...
    public void addImport(LockFilePackage lockFilePackage) {
        this.importPackages.add(lockFilePackage);
        importPackages = removeDuplicates(importPackages);
    }
     ...
     *
     * @param importPackages imported package list
     */
    void setImportPackages(List<LockFilePackage> importPackages) {
