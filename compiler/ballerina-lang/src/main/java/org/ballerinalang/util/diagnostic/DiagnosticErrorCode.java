...
public enum DiagnosticErrorCode implements DiagnosticCode {
    ...
    INVALID_RAW_TEMPLATE_TYPE("BCE3934", "invalid.raw.template.type"),
    MULTIPLE_COMPATIBLE_RAW_TEMPLATE_TYPES("BCE3935", "multiple.compatible.raw.template.types"),
    INVALID_NUM_STRINGS("BCE3936", "invalid.num.of.strings"),
    INVALID_NUM_INSERTIONS("BCE3937", "invalid.num.of.insertions"),
    INVALID_RAW_TEMPLATE_ASSIGNMENT("BCE3938", "invalid.raw.template.assignment"),
    INVALID_NUM_FIELDS("BCE3939", "invalid.number.of.fields"),
    METHODS_NOT_ALLOWED("BCE3940", "methods.not.allowed"),

    INVALID_MUTABLE_ACCESS_IN_ISOLATED_FUNCTION("BCE3941", "invalid.mutable.access.in.isolated.function"),
    INVALID_MUTABLE_ACCESS_AS_RECORD_DEFAULT("BCE3942", "invalid.mutable.access.as.record.default"),
    INVALID_MUTABLE_ACCESS_AS_OBJECT_DEFAULT("BCE3943", "invalid.mutable.access.as.object.default"),

    INVALID_NON_ISOLATED_FUNCTION_AS_ARGUMENT("BCE3944", "invalid.non.isolated.function.as.argument"),

    INVALID_NON_ISOLATED_INVOCATION_IN_ISOLATED_FUNCTION(
            "BCE3945", "invalid.non.isolated.invocation.in.isolated.function"),
    INVALID_NON_ISOLATED_INVOCATION_AS_RECORD_DEFAULT("BCE3946", "invalid.non.isolated.invocation.as.record.default"),
    INVALID_NON_ISOLATED_INVOCATION_AS_OBJECT_DEFAULT("BCE3947", "invalid.non.isolated.invocation.as.object.default"),

    INVALID_NON_ISOLATED_INIT_EXPRESSION_IN_ISOLATED_FUNCTION(
            "BCE3948", "invalid.non.isolated.init.expression.in.isolated.function"),
    INVALID_NON_ISOLATED_INIT_EXPRESSION_AS_RECORD_DEFAULT(
            "BCE3949", "invalid.non.isolated.init.expression.as.record.default"),
    INVALID_NON_ISOLATED_INIT_EXPRESSION_AS_OBJECT_DEFAULT(
            "BCE3950", "invalid.non.isolated.init.expression.as.object.default"),

    INVALID_ASYNC_INVOCATION_IN_ISOLATED_FUNCTION("BCE3951", "invalid.async.invocation.in.isolated.function"),
    INVALID_WORKER_DECLARATION_IN_ISOLATED_FUNCTION("BCE3952", "invalid.worker.declaration.in.isolated.function"),
    INVALID_FORK_STATEMENT_IN_ISOLATED_FUNCTION("BCE3953", "invalid.fork.statement.in.isolated.function"),

    INVALID_NON_PRIVATE_MUTABLE_FIELD_IN_ISOLATED_OBJECT(
            "BCE3954", "invalid.non.private.mutable.field.in.isolated.object"),
    INVALID_MUTABLE_FIELD_ACCESS_IN_ISOLATED_OBJECT_OUTSIDE_LOCK(
            "BCE3955", "invalid.mutable.field.access.in.isolated.object.outside.lock"),
    INVALID_REFERENCE_TO_SELF_IN_ISOLATED_OBJECT_OUTSIDE_LOCK(
            "BCE3956", "invalid.reference.to.self.in.isolated.object.outside.lock"),
    INVALID_NON_ISOLATED_EXPRESSION_AS_INITIAL_VALUE("BCE3957", "invalid.non.isolated.expression.as.initial.value"),
    INVALID_TRANSFER_OUT_OF_LOCK_WITH_RESTRICTED_VAR_USAGE(
            "BCE3958", "invalid.transfer.out.of.lock.with.restricted.var.usage"),
    INVALID_TRANSFER_INTO_LOCK_WITH_RESTRICTED_VAR_USAGE(
            "BCE3959", "invalid.transfer.into.lock.with.restricted.var.usage"),
    INVALID_NON_ISOLATED_INVOCATION_IN_LOCK_WITH_RESTRICTED_VAR_USAGE(
            "BCE3960", "invalid.non.isolated.invocation.in.lock.with.restricted.var.usage"),
    INVALID_ISOLATED_VARIABLE_ACCESS_OUTSIDE_LOCK("BCE3961", "invalid.isolated.variable.access.outside.lock"),
    INVALID_ASSIGNMENT_IN_LOCK_WITH_RESTRICTED_VAR_USAGE(
            "BCE3962", "invalid.assignment.in.lock.with.restricted.var.usage"),
    INVALID_USAGE_OF_MULTIPLE_RESTRICTED_VARS_IN_LOCK("BCE3963", "invalid.usage.of.multiple.restricted.vars.in.lock"),

    INVALID_ISOLATED_QUALIFIER_ON_MODULE_NO_INIT_VAR_DECL(
            "BCE3964", "invalid.isolated.qualifier.on.module.no.init.var.decl"),
    ONLY_A_SIMPLE_VARIABLE_CAN_BE_MARKED_AS_ISOLATED(
            "BCE3965", "only.a.simple.variable.can.be.marked.as.isolated"),
    BINDING_PATTERN_NOT_YET_SUPPORTED_IN_MODULE_VAR_DECL(
            "BCE3966", "binding.pattern.not.yet.supported.in.module.var.decl"),
