...
public enum DiagnosticErrorCode implements DiagnosticCode {
    ...
    OPERATION_DOES_NOT_SUPPORT_MEMBER_ACCESS("BCE2554", "operation.does.not.support.member.access"),
    OPERATION_DOES_NOT_SUPPORT_FIELD_ACCESS("BCE2555", "operation.does.not.support.field.access"),
    OPERATION_DOES_NOT_SUPPORT_FIELD_ACCESS_FOR_ASSIGNMENT(
            "BCE2556", "operation.does.not.support.field.access.for.assignment"),
    OPERATION_DOES_NOT_SUPPORT_OPTIONAL_FIELD_ACCESS("BCE2557", "operation.does.not.support.optional.field.access"),
    OPERATION_DOES_NOT_SUPPORT_FIELD_ACCESS_FOR_NON_REQUIRED_FIELD(
            "BCE2558", "operation.does.not.support.field.access.for.non.required.field"),
    OPERATION_DOES_NOT_SUPPORT_OPTIONAL_FIELD_ACCESS_FOR_FIELD(
            "BCE2559", "operation.does.not.support.optional.field.access.for.field"),
    OPERATION_DOES_NOT_SUPPORT_MEMBER_ACCESS_FOR_ASSIGNMENT(
            "BCE2560", "operation.does.not.support.member.access.for.assignment"),
    INVALID_MEMBER_ACCESS_EXPR_STRUCT_FIELD_ACCESS("BCE2561", "invalid.member.access.expr.struct.field.access"),
    INVALID_MEMBER_ACCESS_EXPR_TUPLE_FIELD_ACCESS("BCE2562", "invalid.member.access.expr.tuple.field.access"),
    INVALID_TUPLE_MEMBER_ACCESS_EXPR("BCE2563", "invalid.tuple.member.access.expr"),
    INVALID_RECORD_MEMBER_ACCESS_EXPR("BCE2564", "invalid.record.member.access.expr"),
    INVALID_ENUM_EXPR("BCE2565", "invalid.enum.expr"),
    INVALID_EXPR_IN_MATCH_STMT("BCE2566", "invalid.expr.in.match.stmt"),
    INVALID_PATTERN_CLAUSES_IN_MATCH_STMT("BCE2567", "invalid.pattern.clauses.in.match.stmt"),
    STATIC_MATCH_ONLY_SUPPORTS_ANYDATA("BCE2568", "static.value.match.only.supports.anydata"),
    USAGE_OF_UNINITIALIZED_VARIABLE("BCE2569", "usage.of.uninitialized.variable"),
    UNINITIALIZED_VARIABLE("BCE2570", "uninitialized.variable"),
    CONTAINS_UNINITIALIZED_FIELDS("BCE2571", "uninitialized.object.fields"),
    CONTAINS_UNINITIALIZED_VARIABLES("BCE2572", "uninitialized.variables"),
    INVALID_ANY_VAR_DEF("BCE2573", "invalid.any.var.def"),
    INVALID_RECORD_LITERAL("BCE2574", "invalid.record.literal"),
    INVALID_FIELD_IN_RECORD_BINDING_PATTERN("BCE2575", "invalid.field.in.record.binding.pattern"),
    INVALID_RECORD_LITERAL_BINDING_PATTERN("BCE2576", "invalid.record.literal.in.binding.pattern"),
    DUPLICATE_KEY_IN_RECORD_LITERAL("BCE2577", "duplicate.key.in.record.literal"),
    DUPLICATE_KEY_IN_TABLE_LITERAL("BCE2578", "duplicate.key.in.table.literal"),
    DUPLICATE_KEY_IN_RECORD_LITERAL_SPREAD_OP("BCE2579", "duplicate.key.in.record.literal.spread.op"),
    POSSIBLE_DUPLICATE_OF_FIELD_SPECIFIED_VIA_SPREAD_OP(
            "BCE2580", "possible.duplicate.of.field.specified.via.spread.op"),
    SPREAD_FIELD_MAY_DULPICATE_ALREADY_SPECIFIED_KEYS("BCE2581", "spread.field.may.duplicate.already.specified.keys"),
    MULTIPLE_INCLUSIVE_TYPES("BCE2582", "multiple.inclusive.types"),
    INVALID_ARRAY_LITERAL("BCE2583", "invalid.array.literal"),
    INVALID_TUPLE_LITERAL("BCE2584", "invalid.tuple.literal"),
    INVALID_LIST_CONSTRUCTOR_ELEMENT_TYPE("BCE2585", "invalid.list.constructor.type"),
    INVALID_ARRAY_ELEMENT_TYPE("BCE2586", "invalid.array.element.type"),
    INVALID_LIST_BINDING_PATTERN("BCE2587", "invalid.list.binding.pattern"),
    INVALID_LIST_BINDING_PATTERN_DECL("BCE2588", "invalid.list.binding.pattern.decl"),
    INVALID_LIST_BINDING_PATTERN_INFERENCE("BCE2589", "invalid.list.binding.pattern.inference"),
    MISMATCHING_ARRAY_LITERAL_VALUES("BCE2590", "mismatching.array.literal.values"),
    CLOSED_ARRAY_TYPE_NOT_INITIALIZED("BCE2591", "closed.array.type.not.initialized"),
    INVALID_LIST_MEMBER_ACCESS_EXPR("BCE2592", "invalid.list.member.access.expr"),
    INVALID_ARRAY_MEMBER_ACCESS_EXPR("BCE2593", "invalid.array.member.access.expr"),
    CLOSED_ARRAY_TYPE_CAN_NOT_INFER_SIZE("BCE2594", "closed.array.type.can.not.infer.size"),
    INVALID_SORT_FUNC_RETURN_TYPE("BCE2595", "invalid.key.func.return.type"),
    INVALID_SORT_ARRAY_MEMBER_TYPE("BCE2596", "invalid.sort.array.member.type"),
    // TODO Maryam remove list array tuple and use first only
    INDEX_OUT_OF_RANGE("BCE2597", "index.out.of.range"),
    LIST_INDEX_OUT_OF_RANGE("BCE2598", "list.index.out.of.range"),
    ARRAY_INDEX_OUT_OF_RANGE("BCE2599", "array.index.out.of.range"),
    TUPLE_INDEX_OUT_OF_RANGE("BCE2600", "tuple.index.out.of.range"),
    INVALID_ARRAY_SIZE_REFERENCE("BCE2601", "invalid.array.size.reference"),
    INVALID_TYPE_FOR_REST_DESCRIPTOR("BCE2602", "invalid.type.for.rest.descriptor"),
    INVALID_TYPE_NEW_LITERAL("BCE2603", "invalid.type.new.literal"),
    INVALID_USAGE_OF_KEYWORD("BCE2604", "invalid.usage.of.keyword"),
    INVALID_TYPE_OBJECT_CONSTRUCTOR("BCE2605", "invalid.type.object.constructor"),

    INVALID_RECORD_BINDING_PATTERN("BCE2606", "invalid.record.binding.pattern"),
    NO_MATCHING_RECORD_REF_PATTERN("BCE2607", "no.matching.record.ref.found"),
    MULTIPLE_RECORD_REF_PATTERN_FOUND("BCE2608", "multiple.matching.record.ref.found"),
    NOT_ENOUGH_PATTERNS_TO_MATCH_RECORD_REF("BCE2609", "not.enough.patterns.to.match.record.ref"),
    INVALID_TYPE_DEFINITION_FOR_RECORD_VAR("BCE2610", "invalid.type.definition.for.record.var"),

    INVALID_ERROR_BINDING_PATTERN("BCE2611", "invalid.error.binding.pattern"),
    INVALID_ERROR_REASON_BINDING_PATTERN("BCE2612", "invalid.error.reason.binding.pattern"),
    INVALID_ERROR_REST_BINDING_PATTERN("BCE2613", "invalid.error.rest.binding.pattern"),
    INVALID_TYPE_DEFINITION_FOR_ERROR_VAR("BCE2614", "invalid.type.definition.for.error.var"),
    INVALID_ERROR_MATCH_PATTERN("BCE2615", "invalid.error.match.pattern"),
    DUPLICATE_VARIABLE_IN_BINDING_PATTERN("BCE2616", "duplicate.variable.in.binding.pattern"),
    INVALID_VARIABLE_REFERENCE_IN_BINDING_PATTERN("BCE2617", "invalid.variable.reference.in.binding.pattern"),
    CANNOT_ASSIGN_VALUE_TO_TYPE_DEF("BCE2618", "cannot.assign.value.to.type.def"),

    INVALID_NAMESPACE_PREFIX("BCE2619", "invalid.namespace.prefix"),
    XML_TAGS_MISMATCH("BCE2620", "mismatching.xml.start.end.tags"),
    XML_ATTRIBUTE_MAP_UPDATE_NOT_ALLOWED("BCE2621", "xml.attribute.map.update.not.allowed"),
    XML_QNAME_UPDATE_NOT_ALLOWED("BCE2622", "xml.qname.update.not.allowed"),
    INVALID_NAMESPACE_DECLARATION("BCE2623", "invalid.namespace.declaration"),
    CANNOT_UPDATE_XML_SEQUENCE("BCE2624", "cannot.update.xml.sequence"),
    INVALID_XML_NS_INTERPOLATION("BCE2625", "invalid.xml.ns.interpolation"),
    CANNOT_FIND_XML_NAMESPACE("BCE2626", "cannot.find.xml.namespace.prefix"),
    UNSUPPORTED_METHOD_INVOCATION_XML_NAV("BCE2627", "method.invocation.in.xml.navigation.expressions.not.supported"),
    DEPRECATED_XML_ATTRIBUTE_ACCESS("BCE2628", "deprecated.xml.attribute.access.expression"),
    UNSUPPORTED_MEMBER_ACCESS_IN_XML_NAVIGATION("BCE2629", "member.access.within.xml.navigation.expression.not" +
            ".supported"),

    UNDEFINED_ANNOTATION("BCE2630", "undefined.annotation"),
    ANNOTATION_NOT_ALLOWED("BCE2631", "annotation.not.allowed"),
    ANNOTATION_ATTACHMENT_CANNOT_HAVE_A_VALUE("BCE2632", "annotation.attachment.cannot.have.a.value"),
    ANNOTATION_ATTACHMENT_REQUIRES_A_VALUE("BCE2633", "annotation.attachment.requires.a.value"),
    ANNOTATION_ATTACHMENT_CANNOT_SPECIFY_MULTIPLE_VALUES(
            "BCE2634", "annotation.attachment.cannot.specify.multiple.values"),
    ANNOTATION_INVALID_TYPE("BCE2635", "annotation.invalid.type"),
    ANNOTATION_INVALID_CONST_TYPE("BCE2636", "annotation.invalid.const.type"),
    ANNOTATION_REQUIRES_CONST("BCE2637", "annotation.requires.const"),
    INCOMPATIBLE_TYPES_ARRAY_FOUND("BCE2638", "incompatible.types.array.found"),
    CANNOT_GET_ALL_FIELDS("BCE2639", "cannot.get.all.fields"),

    INVALID_DOCUMENTATION_IDENTIFIER("BCE2640", "invalid.documentation.identifier"),

    OPERATOR_NOT_SUPPORTED("BCE2641", "operator.not.supported"),
    OPERATOR_NOT_ALLOWED_VARIABLE("BCE2642", "operator.not.allowed.variable"),
    NEVER_TYPE_NOT_ALLOWED_FOR_REQUIRED_DEFAULTABLE_PARAMS("BCE2643",
            "never.type.not.allowed.for.required.and.defaultable.params"),
    INVALID_CLIENT_REMOTE_METHOD_CALL("BCE2644", "invalid.client.remote.method.call"),
    NEVER_TYPED_VAR_DEF_NOT_ALLOWED("BCE2645", "never.typed.var.def.not.allowed"),
    NEVER_TYPED_OBJECT_FIELD_NOT_ALLOWED("BCE2646", "never.typed.object.field.not.allowed"),

    CANNOT_USE_TYPE_INCLUSION_WITH_MORE_THAN_ONE_OPEN_RECORD_WITH_DIFFERENT_REST_DESCRIPTOR_TYPES("BCE2647",
            "cannot.use.type.inclusion.with.more.than.one.open.record.with.different.rest.descriptor.types"),
    INVALID_METHOD_CALL_EXPR_ON_FIELD("BCE2648", "invalid.method.call.expr.on.field"),
    INCOMPATIBLE_TYPE_WAIT_FUTURE_EXPR("BCE2649", "incompatible.type.wait.future.expr"),
