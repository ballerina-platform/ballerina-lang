...
public enum DiagnosticErrorCode implements DiagnosticCode {
        ...
        CANNOT_USE_FIELD_ACCESS_TO_ACCESS_A_REMOTE_METHOD("BCE2038",
                        "cannot.use.field.access.to.access.a.remote.method"),
        ...
        USAGE_OF_WORKER_WITHIN_LOCK_IS_PROHIBITED(
                        "BCE2080",
                        "usage.of.worker.within.lock.is.prohibited"),
        ...
        INVALID_WORKER_INTERACTION(
                        "BCE2083",
                        "worker.invalid.worker.interaction"),
        ...
        UNDECLARED_AND_NILABLE_FIELDS_IN_UNION_OF_RECORDS("BCE2121",
                        "undeclared.and.nilable.fields.in.union.of.records"),
        ...
        CANNOT_SPECIFY_NAMED_ARG_FOR_FIELD_OF_INCLUDED_RECORD_WHEN_ARG_SPECIFIED_FOR_INCLUDED_RECORD(
                        "BCE2137",
                        "cannot.specify.named.argument.for.field.of."
                                        + "included.record.when.arg.specified.for.included.record"),
        CYCLIC_TYPE_REFERENCE_NOT_YET_SUPPORTED(
                        "BCE2138",
                        "cyclic.type.reference.not.yet.supported"),
        ...
        BREAK_CANNOT_BE_USED_TO_EXIT_TRANSACTION("BCE2303",
        ...
        RETURN_CANNOT_BE_USED_TO_EXIT_TRANSACTION("BCE2306",
        ...
        TRANSACTIONAL_FUNC_INVOKE_PROHIBITED("BCE2316",
                        "transactional.function.prohibited.outside.transactional.scope"),
        ...
        SPREAD_FIELD_MAY_DULPICATE_ALREADY_SPECIFIED_KEYS("BCE2582",
                        "spread.field.may.duplicate.already.specified.keys"),
        ...
        UNSUPPORTED_METHOD_INVOCATION_XML_NAV("BCE2628",
                        "method.invocation.in.xml.navigation.expressions.not.supported"),
        ...
        NEVER_TYPED_OBJECT_FIELD_NOT_ALLOWED(
                        "BCE2647",
                        "never.typed.object.field.not.allowed"),
        ...
        CANNOT_USE_TYPE_INCLUSION_WITH_MORE_THAN_ONE_OPEN_RECORD_WITH_DIFFERENT_REST_DESCRIPTOR_TYPES("BCE2650",
                        "cannot.use.type.inclusion.with.more." 
                         + "than.one.open.record.with.different.rest.descriptor.types"),
        ...
        ARROW_EXPRESSION_NOT_SUPPORTED_ITERABLE_OPERATION("BCE3602",
                        "arrow.expression.not.supported.iterable.operation"),
        ...
        INDIRECT_ERROR_CTOR_REASON_NOT_ALLOWED("BCE3704",
                        "invalid.error.reason.argument.to.indirect.error.constructor"),
        ...
        INVALID_NON_ISOLATED_INVOCATION_AS_RECORD_DEFAULT("BCE3948",
                        "invalid.non.isolated.invocation.as.record.default"),
        INVALID_NON_ISOLATED_INVOCATION_AS_OBJECT_DEFAULT("BCE3949",
                        "invalid.non.isolated.invocation.as.object.default"),
        ...
        INVALID_NON_ISOLATED_INIT_EXPRESSION_AS_OBJECT_DEFAULT(
                        "BCE3952",
                        "invalid.non.isolated.init.expression.as.object.default"),
        ...
        INVALID_ACCESS_OF_NON_ISOLATED_EXPR_IN_ARGS_OF_ASYNC_INV_OF_ISOLATED_FUNC("BCE3955",
                        "invalid.access.of.non.isolated.expression.in" 
                        + ".argument.of.async.invocation.of.isolated.function"),
        ...
        INVALID_USAGE_OF_MULTIPLE_RESTRICTED_VARS_IN_LOCK("BCE3964",
                        "invalid.usage.of.multiple.restricted.vars.in.lock"),
        ...
        SERVICE_PATH_LITERAL_IS_NOT_SUPPORTED_BY_LISTENER("BCE3976",
                        "service.path.literal.is.not.supported.by.listener"),
        SERVICE_ABSOLUTE_PATH_IS_NOT_SUPPORTED_BY_LISTENER("BCE3977",
        ...
        UNUSED_VARIABLE_WITH_INFERRED_TYPE_INCLUDING_ERROR("BCE3998",
                        "unused.variable.with.inferred.type.including.error"),
        ...
        UNIMPLEMENTED_REFERENCED_METHOD_IN_OBJECT_CTOR("BCE4007",
                        "unimplemented.referenced.method.in.object.constructor"),
        ...
        SERVICE_DOES_NOT_IMPLEMENT_REQUIRED_CONSTRUCTS("BCE4022",
                        "service.decl.does.not.implement.required.constructs"),
        INVALID_ASSIGNMENT_TO_NARROWED_VAR_IN_QUERY_ACTION("BCE4023",
                        "invalid.assignment.to.narrowed.var.in.query.action"),
        ...
        QUERY_CONSTRUCT_TYPES_CANNOT_BE_USED_WITH_COLLECT("BCE4049",
                        "query.construct.types.cannot.be.used.with.collect"),
        ...
        EXPECTED_TYPE_FOR_NATURAL_EXPR_MUST_CONTAIN_ERROR("BCE4070",
                        "expected.type.for.natural.expr.must.contain.error"),
