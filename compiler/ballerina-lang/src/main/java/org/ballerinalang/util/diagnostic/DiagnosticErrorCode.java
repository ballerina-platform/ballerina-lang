...
public enum DiagnosticErrorCode implements DiagnosticCode {
    ...
    GREATER_THAN_SIGNED_INT32_MAX_ARRAY_SIZES_NOT_YET_SUPPORTED(
            "BCE2116", "greater.than.signed.int32.max.array.sizes.not.yet.supported"),
    ...
    INCOMPATIBLE_TYPE_WAIT_FUTURE_EXPR_WAIT_FIELD("BCE2652", "incompatible.type.wait.future.expr.wait.field"),
