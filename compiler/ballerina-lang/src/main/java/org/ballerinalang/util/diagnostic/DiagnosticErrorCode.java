...
public enum DiagnosticErrorCode implements DiagnosticCode {
    ...
    SEALED_ARRAY_TYPE_NOT_INITIALIZED("BCE2592", "sealed.array.type.not.initialized"),
    INVALID_LIST_INDEX_EXPR("BCE2593", "invalid.list.index.expr"),
    INVALID_ARRAY_INDEX_EXPR("BCE2594", "invalid.array.index.expr"),
    SEALED_ARRAY_TYPE_CAN_NOT_INFER_SIZE("BCE2595", "sealed.array.type.can.not.infer.size"),
    ...
    UNSUPPORTED_INDEX_IN_XML_NAVIGATION("BCE2630", "indexing.within.xml.navigation.expression.not.supported"),
    ...
    EXPRESSION_DOES_NOT_SUPPORT_INDEX_ACCESS("BCE2647", "expression.does.not.support.index.access"),
    ...
    CANNOT_USE_TYPE_INCLUSION_WITH_MORE_THAN_ONE_OPEN_RECORD_WITH_DIFFERENT_REST_DESCRIPTOR_TYPES(
            "BCE2649", "cannot.use.type.inclusion.with.more.than.one.open.record.with.different.rest.descriptor.types"),
