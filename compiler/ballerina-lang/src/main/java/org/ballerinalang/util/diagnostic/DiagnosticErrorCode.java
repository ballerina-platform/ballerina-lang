...
public enum DiagnosticErrorCode implements DiagnosticCode {
    ...
    INVALID_USAGE_OF_CHECK_IN_RECORD_FIELD_DEFAULT_EXPRESSION("BCE4009",
            "invalid.usage.of.check.in.record.field.default.expression"),
    INVALID_USAGE_OF_CHECK_IN_OBJECT_FIELD_INITIALIZER_IN_OBJECT_WITH_NO_INIT_METHOD("BCE4010",
            "invalid.usage.of.check.in.object.field.initializer.in.object.with.no.init.method"),
    INVALID_USAGE_OF_CHECK_IN_OBJECT_FIELD_INITIALIZER_WITH_INIT_METHOD_RETURN_TYPE_MISMATCH("BCE4011",
