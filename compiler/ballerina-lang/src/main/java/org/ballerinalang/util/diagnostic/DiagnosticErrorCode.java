...
public enum DiagnosticErrorCode implements DiagnosticCode {
    ...
    UNSUPPORTED_ERROR_REASON_CONST_MATCH("BCE2017","error.match.over.const.reason.ref.not.supported"),
    ...
    OBJECT_CTOR_DOES_NOT_SUPPORT_TYPE_REFERENCE_MEMBERS("BCE2066","object.constructor.does.not.support.type.reference.members"),
    ...
    CONTINUE_CANNOT_BE_USED_TO_EXIT_TRANSACTION("BCE2304","continue.statement.cannot.be.used.to.exit.from.a.transaction"),
    CHECK_EXPRESSION_INVALID_USAGE_WITHIN_TRANSACTION_BLOCK("BCE2305","check.expression.invalid.usage.within.transaction.block"),
    ...
    TRANSACTION_CANNOT_BE_USED_WITHIN_TRANSACTIONAL_SCOPE("BCE2315","transaction.cannot.be.used.within.transactional.scope"),
    TRANSACTIONAL_FUNC_INVOKE_PROHIBITED("BCE2316","transactional.function.prohibited.outside.transactional.scope"),
    TRANSACTIONAL_WORKER_OUT_OF_TRANSACTIONAL_SCOPE("BCE2317","transactional.worker.prohibited.outside.transactional.scope"),
    ...
    CANNOT_ASSIGN_VALUE_TO_POTENTIALLY_INITIALIZED_FINAL("BCE2548","cannot.assign.value.to.potentially.initialized.final"),
    ...
    OPERATION_DOES_NOT_SUPPORT_FIELD_ACCESS_FOR_ASSIGNMENT("BCE2557","operation.does.not.support.field.access.for.assignment"),
    OPERATION_DOES_NOT_SUPPORT_OPTIONAL_FIELD_ACCESS("BCE2558","operation.does.not.support.optional.field.access"),
    OPERATION_DOES_NOT_SUPPORT_FIELD_ACCESS_FOR_NON_REQUIRED_FIELD("BCE2559","operation.does.not.support.field.access.for.non.required.field"),
    OPERATION_DOES_NOT_SUPPORT_OPTIONAL_FIELD_ACCESS_FOR_FIELD("BCE2560","operation.does.not.support.optional.field.access.for.field"),
    OPERATION_DOES_NOT_SUPPORT_INDEX_ACCESS_FOR_ASSIGNMENT("BCE2561","operation.does.not.support.index.access.for.assignment"),
    ...
    POSSIBLE_DUPLICATE_OF_FIELD_SPECIFIED_VIA_SPREAD_OP("BCE2581","possible.duplicate.of.field.specified.via.spread.op"),
    ...
    ANNOTATION_ATTACHMENT_CANNOT_SPECIFY_MULTIPLE_VALUES("BCE2637","annotation.attachment.cannot.specify.multiple.values"),
    ...
    MATCH_PATTERNS_SHOULD_CONTAIN_SAME_SET_OF_VARIABLES("BCE2906","match.patterns.should.contain.same.set.of.variables"),
    ...
    CHECKED_EXPR_NO_MATCHING_ERROR_RETURN_IN_ENCL_INVOKABLE("BCE3032","checked.expr.no.matching.error.return.in.encl.invokable"),

    FAIL_EXPR_NO_MATCHING_ERROR_RETURN_IN_ENCL_INVOKABLE("BCE3033","fail.expr.no.matching.error.return.in.encl.invokable"),
    ...
    KEY_CONSTRAINT_NOT_SUPPORTED_FOR_TABLE_WITH_MAP_CONSTRAINT("BCE3312","key.constraint.not.supported.for.table.with.map.constraint"),
    ...
    ON_CONFLICT_ONLY_WORKS_WITH_TABLES_WITH_KEY_SPECIFIER("BCE3315","on.conflict.only.works.with.tables.with.key.specifier"),
    ...
    TAINTED_VALUE_PASSED_TO_UNTAINTED_PARAMETER_ORIGINATING_AT("BCE3402","tainted.value.passed.to.untainted.param.in.obj.method"),
    ...
    UNABLE_TO_PERFORM_TAINT_CHECKING_FOR_BUILTIN_METHOD("BCE3408","unable.to.perform.taint.checking.for.builtin.method"),
    ...
    INVALID_NON_ISOLATED_INVOCATION_IN_ISOLATED_FUNCTION("BCE3942","invalid.non.isolated.invocation.in.isolated.function"),
    ...
    INVALID_NON_ISOLATED_INIT_EXPRESSION_IN_ISOLATED_FUNCTION("BCE3945","invalid.non.isolated.init.expression.in.isolated.function"),
    INVALID_NON_ISOLATED_INIT_EXPRESSION_AS_RECORD_DEFAULT("BCE3946","invalid.non.isolated.init.expression.as.record.default"),
    INVALID_NON_ISOLATED_INIT_EXPRESSION_AS_OBJECT_DEFAULT("BCE3947","invalid.non.isolated.init.expression.as.object.default"),
    ...
    INVALID_NON_PRIVATE_MUTABLE_FIELD_IN_ISOLATED_OBJECT("BCE3951","invalid.non.private.mutable.field.in.isolated.object"),
    INVALID_MUTABLE_FIELD_ACCESS_IN_ISOLATED_OBJECT_OUTSIDE_LOCK("BCE3952","invalid.mutable.field.access.in.isolated.object.outside.lock"),
    INVALID_REFERENCE_TO_SELF_IN_ISOLATED_OBJECT_OUTSIDE_LOCK("BCE3953","invalid.reference.to.self.in.isolated.object.outside.lock"),
    INVALID_NON_UNIQUE_EXPRESSION_AS_INITIAL_VALUE_IN_ISOLATED_OBJECT("BCE3954","invalid.non.unique.expression.as.initial.value.in.isolated.object"),
    INVALID_COPY_OUT_OF_MUTABLE_VALUE_FROM_ISOLATED_OBJECT("BCE3955","invalid.copy.out.of.mutable.value.from.isolated.object"),
    INVALID_COPY_IN_OF_MUTABLE_VALUE_INTO_ISOLATED_OBJECT("BCE3956","invalid.copy.in.of.mutable.value.into.isolated.object"),
    INVALID_NON_ISOLATED_INVOCATION_IN_ISOLATED_OBJECT_METHOD("BCE3957","invalid.non.isolated.invocation.in.isolated.object.method"),

    BINDING_PATTERN_NOT_YET_SUPPORTED_IN_MODULE_VAR_DECL("BCE3958", "binding.pattern.not.yet.supported.in.module.var.decl"),
    ;
