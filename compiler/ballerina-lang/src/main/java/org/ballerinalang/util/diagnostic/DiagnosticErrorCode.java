...
public enum DiagnosticErrorCode implements DiagnosticCode {
    ...
    FIELD_ACCESS_CANNOT_BE_USED_TO_ACCESS_OPTIONAL_FIELDS(
            "BCE2119", "field.access.cannot.be.used.to.access.optional.fields"),
    UNDECLARED_FIELD_IN_RECORD("BCE2120", "undeclared.field.in.record"),
    INVALID_FIELD_ACCESS_IN_RECORD_TYPE("BCE2121", "invalid.field.access.in.record.type"),
    UNDECLARED_AND_OPTIONAL_FIELDS_IN_UNION_OF_RECORDS("BCE2122", "undeclared.and.optional.fields.in.union.of.records"),
    UNDECLARED_FIELD_IN_UNION_OF_RECORDS("BCE2123", "undeclared.field.in.union.of.records"),
    OPTIONAL_FIELD_IN_UNION_OF_RECORDS("BCE2124", "optional.field.in.union.of.records"),
    ALREADY_INITIALIZED_SYMBOL("BCE2125", "already.initialized.symbol"),
    ARRAY_LENGTH_GREATER_THAT_2147483637_NOT_YET_SUPPORTED(
            "BCE2126", "array.length.greater.that.2147483637.not.yet.supported"),
    INVALID_ARRAY_LENGTH("BCE2127", "invalid.array.length"),
    CANNOT_RESOLVE_CONST("BCE2128", "cannot.resolve.const"),
