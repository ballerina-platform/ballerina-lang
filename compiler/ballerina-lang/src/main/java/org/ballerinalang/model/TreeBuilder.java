...
public class TreeBuilder {
    ...
    public static BLangAwaitExpr createWaitExpressionNode() {
    ...
    public static BLangWorkerReceiveExpr createWorkerReceiveExpressionNode() {
        return new BLangWorkerReceiveExpr();
    }
