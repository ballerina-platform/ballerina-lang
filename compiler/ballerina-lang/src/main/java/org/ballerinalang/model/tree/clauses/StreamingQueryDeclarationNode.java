 ...
 *      query q1 {
 *          from-statement insert into tempStream;
 *      }
 *
 *      query q2 {
 *          from tempStream .. insert into outS;
 *      }
 *
 * </pre>
 */
...
public interface StreamingQueryDeclarationNode extends Node {
    ...
    void addQueryStatement(QueryStatementNode queryStatement);

    List<QueryStatementNode> getQueryStatements();
