...
public class BallerinaStreamTypeBuilder implements TypeBuilder.StreamTypeBuilder {
    ...
    @Override
    public TypeBuilder.StreamTypeBuilder withValueType(TypeSymbol valueType) {
    ...
    @Override
    public TypeBuilder.StreamTypeBuilder withCompletionType(TypeSymbol completionType) {
