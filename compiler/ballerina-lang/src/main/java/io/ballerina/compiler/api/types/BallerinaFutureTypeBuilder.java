...
public class BallerinaFutureTypeBuilder implements TypeBuilder.FutureTypeBuilder {
    ...
    @Override
    public TypeBuilder.FutureTypeBuilder withTypeParam(TypeSymbol typeParam) {
