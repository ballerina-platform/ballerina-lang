...
public class BallerinaTomlProcessor {
     ...
     */
    public static BallerinaToml parse(String tomlPath) {
        try {
    ...
    public static PackageManifest parseAsPackageManifest(String tomlString) {
        try {
            toml = parseAsToml(tomlString);
     ...
     *
     * @param tomlString Ballerina.toml file path
     * @return `Toml` object
     */
    private static Toml parseAsToml(String tomlString) {
