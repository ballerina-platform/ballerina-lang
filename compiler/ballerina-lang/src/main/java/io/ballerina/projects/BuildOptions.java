...
public class BuildOptions {
    ...
    public BuildOptions acceptTheirs(BuildOptions theirOptions) {
        ...
        buildOptionsBuilder.setOptimizeMemory(compilationOptions.optimizeMemory);
    ...
    public static class BuildOptionsBuilder {
         ...
         */
        public BuildOptionsBuilder setOptimizeMemory(Boolean value) {
            compilationOptionsBuilder.setOptimizeMemory(value);
            return this;
        }
