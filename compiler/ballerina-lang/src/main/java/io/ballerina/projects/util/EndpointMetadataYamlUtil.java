...
/**
 * Serializes endpoint metadata as YAML.
 *
 * @since 2201.13.6
 */
public final class EndpointMetadataYamlUtil {
    ...
    private EndpointMetadataYamlUtil() {
    }

    public static String toYaml(List<EndpointMetaInfo> endpoints) {
