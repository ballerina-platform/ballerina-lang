 ...
 * @since 2201.10.0
 */
public class CodegenOptimizationConstants {
    public static final String BALLERINA_OBSERVE = "ballerina/observe";
    public static final String BALLERINAI_OBSERVE = "ballerinai/observe";
    public static final String BALLERINA_JBALLERINA = "ballerina/jballerina";
