...
public class TestAnnotationProcessor {
    ...
    public void processFunction(BLangFunction bLangFunction) {
        ...
        TestSuite suite = registry.getTestSuites().get(parent.packageID.name.toString());
        ...
        List<BLangAnnotationAttachment> annotations =
                bLangFunction.getAnnotationAttachments().stream().distinct().filter(bLangAnnotationAttachment ->
                        bLangAnnotationAttachment.annotationSymbol.pkgID.orgName.equals(Names.BALLERINA_ORG) &&
                                bLangAnnotationAttachment.annotationSymbol.pkgID.name.toString().equals("test"))
            ...
            if (BEFORE_SUITE_ANNOTATION_NAME.equals(annotationName)) {
                ...
                if (attachmentNode.getExpression().getKind() == NodeKind.RECORD_LITERAL_EXPR) {
                    ...
                    BLangTestablePackage bLangTestablePackage =
                            (BLangTestablePackage) bLangFunction.parent;
