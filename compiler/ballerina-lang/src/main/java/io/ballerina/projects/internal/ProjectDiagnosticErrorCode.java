...
public enum ProjectDiagnosticErrorCode implements DiagnosticCode {
    ...
    BUILT_WITH_LOWER_PATCH_VERSION("BCE5009", "built.with.lower.patch.version"),
    BUILT_WITH_LOWER_MINOR_VERSION("BCE5010", "built.with.lower.patch.version"),
    BUILT_WITH_DIFFERENT_DITRIBUTION_VERSION("BCE5011", "built.with.different.version"),
    STICKY_BUILD_WITH_NO_DEPENDENCIES_TOML("BCE5012", "sticky.build.with.no.dependencies.toml"),
    STICKY_BUILD_WITH_OLDER_SL_UPDATE("BCE5013", "sticky.build.with.older.sl.update"),
    STICKY_BUILD_WITH_DIFFERENT_UPDATES("BCE5014", "sticky.build.with.different.updates"),
