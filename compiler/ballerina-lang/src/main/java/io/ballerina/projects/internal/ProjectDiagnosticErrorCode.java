...
public enum ProjectDiagnosticErrorCode implements DiagnosticCode {
    ...
    INVALID_SOURCE_ENTRIES_IN_TOOL_PROPERTIES("BCE5011", "invalid.source.entries.in.tool.properties"),
    INVALID_SOURCE_KIND_IN_TOOL_PROPERTIES("BCE5012", "invalid.source.kind.in.tool.properties"),
