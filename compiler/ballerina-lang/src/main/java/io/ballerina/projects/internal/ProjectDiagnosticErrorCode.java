...
public enum ProjectDiagnosticErrorCode implements DiagnosticCode {
    ...
    INCOMPATIBLE_DEPENDENCY_VERSIONS("BCE5101", "incompatible.dependency.versions"),
    PACKAGE_NOT_FOUND("BCE5102", "package.not.found"),
    DEPRECATED_PACKAGE("BCE5103", "deprecated.package"),
    BUILT_WITH_OLDER_SL_UPDATE_DISTRIBUTION("BCE5104", "built.with.older.sl.update.distribution"),
    CUSTOM_REPOSITORY_NOT_FOUND("BCE5105", "custom.repository.not.found"),

    // Error codes used in the ManifestBuilder
    MISSING_PKG_INFO_IN_BALLERINA_TOML("BCE5201", "missing.package.info"),
    INVALID_PATH("BCE5202", "error.invalid.path"),
    INVALID_ICON("BCE5203", "error.invalid.icon"),

    // Error codes related to build tools.
    MISSING_TOOL_PROPERTIES_IN_BALLERINA_TOML("BCE5401", "missing.tool.properties"),
    INCOMPATIBLE_TYPE_FOR_TOOL_PROPERTY("BCE5402", "incompatible.tool.properties"),
    EMPTY_TOOL_PROPERTY("BCE5403", "empty.tool.properties"),
