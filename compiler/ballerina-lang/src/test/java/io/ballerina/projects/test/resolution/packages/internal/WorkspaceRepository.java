...
public class WorkspaceRepository extends AbstractPackageRepository {
    ...
    public static final WorkspaceRepository EMPTY_REPO = new WorkspaceRepository(
            new PackageVersionContainer<>(), new HashMap<>());

    public WorkspaceRepository(PackageVersionContainer<PackageDescWrapper> pkgContainer,
