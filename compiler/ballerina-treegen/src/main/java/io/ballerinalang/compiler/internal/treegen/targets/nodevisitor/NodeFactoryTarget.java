...
import static io.ballerinalang.compiler.internal.treegen.TreeGenConfig.EXTERNAL_NODE_FACTORY_TEMPLATE_KEY;
...
/**
 * Generates a node factory java class for the external syntax tree.
 *
 * @since 1.3.0
 */
public class NodeFactoryTarget extends AbstractNodeVisitorTarget {

    public NodeFactoryTarget(TreeGenConfig config) {
        super(config);
    }
    ...
    protected String getClassName() {
        return EXTERNAL_NODE_FACTORY_CN;
    }

    @Override
    protected String getSuperClassName() {
        return EXTERNAL_BASE_NODE_FACTORY_CN;
    }
    ...
    protected String getTemplateName() {
        return config.getOrThrow(EXTERNAL_NODE_FACTORY_TEMPLATE_KEY);
    }
}
