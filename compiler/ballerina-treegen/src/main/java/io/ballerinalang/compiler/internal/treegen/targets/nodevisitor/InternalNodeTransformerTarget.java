...
import static io.ballerinalang.compiler.internal.treegen.TreeGenConfig.INTERNAL_NODE_TRANSFORMER_TEMPLATE_KEY;

/**
 * Generates a node transformer Java class for the external syntax tree.
 *
 * @since 1.3.0
 */
public class InternalNodeTransformerTarget extends AbstractNodeVisitorTarget {

    public InternalNodeTransformerTarget(TreeGenConfig config) {
        super(config);
    }
    ...
    protected String getTemplateName() {
        return config.getOrThrow(INTERNAL_NODE_TRANSFORMER_TEMPLATE_KEY);
    }
}
