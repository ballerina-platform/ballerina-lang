...
import static io.ballerinalang.compiler.internal.treegen.TreeGenConfig.EXTERNAL_NODE_TRANSFORMER_TEMPLATE_KEY;
...
public class NodeTransformerTarget extends AbstractNodeVisitorTarget {
    ...
    public NodeTransformerTarget(TreeGenConfig config) {
        super(config);
    }
    ...
    protected String getTemplateName() {
        return config.getOrThrow(EXTERNAL_NODE_TRANSFORMER_TEMPLATE_KEY);
    }
}
