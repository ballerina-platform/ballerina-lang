...
import static io.ballerinalang.compiler.internal.treegen.TreeGenConfig.TS_NODE_VISITOR_TEMPLATE_KEY;

/**
 * Generates a node visitor TS interface for the TS syntax tree.
 *
 * @since 2.0.0
 */
public class TSNodeVisitorTarget extends AbstractNodeVisitorTarget {
    public static final String TS_EXT = "ts";
    public static final String FILE_NAME = "base-visitor";

    public TSNodeVisitorTarget(TreeGenConfig config) {
        super(config);
    }

    @Override
    protected String getTemplateName() {
        return config.getOrThrow(TS_NODE_VISITOR_TEMPLATE_KEY);
    }
