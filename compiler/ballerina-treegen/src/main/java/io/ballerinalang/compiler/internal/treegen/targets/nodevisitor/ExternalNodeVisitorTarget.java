...
import static io.ballerinalang.compiler.internal.treegen.TreeGenConfig.EXTERNAL_NODE_VISITOR_TEMPLATE_KEY;
 ...
 * @since 1.3.0
 */
public class ExternalNodeVisitorTarget extends AbstractNodeVisitorTarget {

    public ExternalNodeVisitorTarget(TreeGenConfig config) {
        super(config);
    }
    ...
    protected String getClassName() {
        return EXTERNAL_NODE_VISITOR_CN;
    }
    ...
    protected String getTemplateName() {
        return config.getOrThrow(EXTERNAL_NODE_VISITOR_TEMPLATE_KEY);
    }
}
