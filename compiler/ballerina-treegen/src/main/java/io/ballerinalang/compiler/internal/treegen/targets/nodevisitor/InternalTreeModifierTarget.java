...
import static io.ballerinalang.compiler.internal.treegen.TreeGenConfig.INTERNAL_TREE_MODIFIER_TEMPLATE_KEY;
 ...
 * @since 1.3.0
 */
public class InternalTreeModifierTarget extends AbstractNodeVisitorTarget {

    public InternalTreeModifierTarget(TreeGenConfig config) {
        super(config);
    }
    ...
    protected String getClassName() {
        return INTERNAL_TREE_MODIFIER_CN;
    }
    ...
    protected String getTemplateName() {
        return config.getOrThrow(INTERNAL_TREE_MODIFIER_TEMPLATE_KEY);
    }
}
