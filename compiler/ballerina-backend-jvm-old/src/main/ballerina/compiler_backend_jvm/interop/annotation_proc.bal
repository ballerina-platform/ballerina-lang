    ...
    if annotValue is bir:AnnotationArrayValue {
        ...
        foreach var annotArrayElement in annotArrayElements {
            ...
            if annotArrayElement is bir:AnnotationLiteralValue {
                ...
                string elementClass = <string> getLiteralValueFromAnnotValue(annotValueMap[CLASS_FIELD_NAME]);
                byte dimensions = <byte> getLiteralValueFromAnnotValue(annotValueMap[DIMENSIONS_FIELD_NAME]);
