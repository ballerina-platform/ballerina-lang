...
import org.ballerina.compiler.impl.semantic.visitors.SymbolsLookupVisitor;
...
public class SemanticModel extends AbstractSemanticModel {
    ...
    public SemanticModel(BLangCompilationUnit compilationUnit,
    ...
    public List<BCompiledSymbol> lookupSymbols(LinePosition linePosition) {
        ...
        scopeSymbols.forEach((name, scopeEntries) ->
     ...
     */
    @Override
    public Optional<BCompiledSymbol> lookupSymbol(int position) {
     ...
     */
    @Override
    public List<BCompiledSymbol> symbolByName(LinePosition linePosition, String name) {
     ...
     */
    @Override
    public List<Diagnostic> diagnostics(TextRange range, DiagnosticKind kind) {
        return null;
    }
