 ...
 * @since 2.0.0
 */
public class BallerinaServiceSymbol extends BallerinaSymbol {

    private final BServiceSymbol serviceSymbol;

    private List<BallerinaFunctionSymbol> resources;
     ...
     */
    public List<BallerinaFunctionSymbol> resources() {
        if (resources == null) {
    ...
    private List<BallerinaFunctionSymbol> getResources(BServiceSymbol serviceSymbol) {
    ...
    private List<BallerinaFunctionSymbol> getFunctions(BServiceSymbol serviceSymbol) {
