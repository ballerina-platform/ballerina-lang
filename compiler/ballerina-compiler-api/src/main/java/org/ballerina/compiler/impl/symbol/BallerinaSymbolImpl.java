 ...
 * @since 2.0.0
 */
public class BallerinaSymbolImpl implements BCompiledSymbol {
    ...
    protected BallerinaSymbolImpl(String name,
                                  PackageID moduleID,
    ...
    protected abstract static class SymbolBuilder<T extends SymbolBuilder<T>> {
         ...
         *
         * @return {@link BallerinaSymbolImpl} built
         */
        public abstract BallerinaSymbolImpl build();
    }
}
