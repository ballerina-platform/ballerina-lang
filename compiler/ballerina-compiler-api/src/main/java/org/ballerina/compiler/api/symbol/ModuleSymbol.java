...
import org.ballerina.compiler.impl.symbol.TypeDefinitionImpl;
 ...
 * @since 2.0.0
 */
public interface ModuleSymbol extends BCompiledSymbol {
     ...
     */
    List<TypeDefinitionImpl> typeDefinitions();
     ...
     * @return {@link List} of type definitions
     */
    List<BCompiledSymbol> allSymbols();
}
