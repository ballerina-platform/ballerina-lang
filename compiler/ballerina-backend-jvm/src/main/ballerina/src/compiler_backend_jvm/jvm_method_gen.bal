...
function genJMethodForBFunc(bir:Function func,
    ...
    mv.visitVarInsn(ALOAD, localVarOffset);
    mv.visitFieldInsn(GETFIELD, "io/ballerina/jvm/scheduling/Strand", "resumeIndex", "I");
    ...
    // mv.visitInsn(ICONST_1);
    // mv.visitFieldInsn(PUTFIELD, "io/ballerina/jvm/scheduling/Strand", "yield", "Z");
    ...
    mv.visitVarInsn(ALOAD, localVarOffset);
    mv.visitFieldInsn(GETFIELD, "io/ballerina/jvm/scheduling/Strand", "frames", "[Ljava/lang/Object;");
    mv.visitVarInsn(ALOAD, localVarOffset);
    mv.visitInsn(DUP);
    mv.visitFieldInsn(GETFIELD, "io/ballerina/jvm/scheduling/Strand", "resumeIndex", "I");
    mv.visitInsn(ICONST_1);
    mv.visitInsn(ISUB);
    mv.visitInsn(DUP_X1);
    mv.visitFieldInsn(PUTFIELD, "io/ballerina/jvm/scheduling/Strand", "resumeIndex", "I");
    mv.visitInsn(AALOAD);
...
function getMethodDesc(bir:BType?[] paramTypes, bir:BType? retType, bir:BType? attachedType = (),
    ...
    string desc = "(Lio/ballerina/jvm/scheduling/Strand;";
