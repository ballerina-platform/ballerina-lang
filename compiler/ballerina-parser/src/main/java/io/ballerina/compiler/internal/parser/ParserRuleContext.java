...
public enum ParserRuleContext {
    ...
    //RegExp
    REG_EXP_TERM("regexp-term"),
    REG_EXP_QUANTIFIER("regexp-quantifier"),
    REG_EXP_ASSERTION("regexp-assertion"),
    REG_EXP_ASSERTION_RHS("regexp-assertion-rhs"),
    REG_EXP_CHAR_ESCAPE("regexp-char-or-escape"),
    REG_EXP_CHAR_ESCAPE_RHS("regexp-char-or-escape-rhs"),
    REG_EXP_CHAR_CLASS("regexp-char-class"),
    REG_EXP_CHAR_CLASS_START("[^"),
    REG_EXP_CHAR_CLASS_START_RHS("regexp-char-class-start-rhs"),
    REG_EXP_CHAR_CLASS_END_RHS("regexp-char-class-end-rhs"),
    REG_EXP_CHAR_SET("regexp-char-set"),
    REG_EXP_CHAR_CLASS_END("]"),
    REG_EXP_CAPTURING_GROUP("regexp-capturing-group"),
    REG_EXP_CAPTURING_GROUP_START("("),
    REG_EXP_CAPTURING_GROUP_START_RHS("regexp-capturing-group-start-rhs"),
    REG_EXP_CAPTURING_GROUP_END(")"),
    REG_EXP_CAPTURING_GROUP_END_RHS("regexp-capturing-group-end-rhs"),
    REG_EXP_FLAG_EXPR("regexp-flag-expr"),
    REG_EXP_FLAG_EXPR_START("?"),
    REG_EXP_FLAG_EXPR_START_RHS("regexp-flag-expr-start-rhs"),
    REG_EXP_FLAG_ON_OFF("?"),
    REG_EXP_FLAG_EXPR_END(":"),
    REG_EXP_FLAG_EXPR_END_RHS("regexp-flag-expr-end-rhs"),
    REG_EXP_TEXT("regexp-text"),
