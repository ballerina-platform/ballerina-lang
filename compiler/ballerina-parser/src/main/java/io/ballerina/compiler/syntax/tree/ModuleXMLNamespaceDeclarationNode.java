 ...
 * @since 2.0.0
 */
public class ModuleXMLNamespaceDeclarationNode extends ModuleMemberDeclarationNode {
    ...
    public ModuleXMLNamespaceDeclarationNode modify(
            Token xmlnsKeyword,
        ...
        return NodeFactory.createModuleXMLNamespaceDeclarationNode(
                xmlnsKeyword,
                namespaceuri,
                asKeyword,
                namespacePrefix,
    ...
    public static class ModuleXMLNamespaceDeclarationNodeModifier {
        ...
        public ModuleXMLNamespaceDeclarationNodeModifier withXmlnsKeyword(
                Token xmlnsKeyword) {
        ...
        public ModuleXMLNamespaceDeclarationNodeModifier withNamespaceuri(
                ExpressionNode namespaceuri) {
        ...
        public ModuleXMLNamespaceDeclarationNodeModifier withSemicolonToken(
                Token semicolonToken) {
