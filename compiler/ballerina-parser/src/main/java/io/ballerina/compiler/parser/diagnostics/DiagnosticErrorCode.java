...
public enum DiagnosticErrorCode implements DiagnosticCode {
    ...
    ERROR_MISSING_XML_CDATA_START_TOKEN("BCE0062", "error.missing.xml.cdata.start.token"),
    ERROR_MISSING_XML_CDATA_END_TOKEN("BCE0063", "error.missing.xml.cdata.end.token"),
