...
public enum DiagnosticErrorCode implements DiagnosticCode {
    ...
    ERROR_MISSING_BUILTIN_TYPE("BCE0522", "error.missing.builtin.type"),
    ERROR_METADATA_NOT_ATTACHED_TO_A_TOP_LEVEL_CONSTRUCT("BCE0523",
            "error.metadata.not.attached.to.a.top.level.construct"),
    ERROR_METADATA_NOT_ATTACHED_TO_A_OBJECT_MEMBER("BCE0524", "error.metadata.not.attached.to.a.object.member"),
