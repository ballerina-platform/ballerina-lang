 ...
 * @since 2201.3.0
 */
public class STReAssertionNode extends STReTermNode {
    public final STNode reAssertion;
    ...
    STReAssertionNode(
        ...
        super(SyntaxKind.RE_ASSERTION, diagnostics);
    ...
    public STReAssertionNode modify(
            STNode reAssertion) {
