...
public enum SyntaxKind {
    ...
    RE_ASSERTION(4015),
    RE_ASSERTION_VALUE(4016),
    RE_QUANTIFIER(4017),
    RE_BASE_QUANTIFIER_VALUE(4018),
    RE_ATOM(4019),
    RE_CHARACTER_CLASS(4020),
    RE_CHAR_SET(4021),
    RE_CHAR_SET_ATOM(4022),
    RE_FLAG_EXPR(4023),
    RE_FLAGS_ON_OFF(4024),
    RE_FLAGS_VALUE(4025),
    RE_CAPTURING_GROUP(4026),
    RE_CHAR_ESCAPE(4027),
    RE_CHAR_ESCAPE_VALUE(4028),
    RE_BRACED_QUANTIFIER(4029),
    RE_QUOTE_ESCAPE(4030),
    RE_SIMPLE_CHAR_CLASS_ESCAPE(4031),
    RE_UNICODE_PROPERTY_ESCAPE(4032),
    RE_UNICODE_SCRIPT(4033),
    RE_UNICODE_GENERAL_CATEGORY(4034),
    RE_CHAR_SET_RANGE(4035),
    RE_CHAR_SET_RANGE_NO_DASH(4036),
    RE_CHAR_SET_RANGE_WITH_RE_CHAR_SET(4037),
    RE_CHAR_SET_RANGE_NO_DASH_WITH_RE_CHAR_SET(4038),
    RE_CHAR_SET_ATOM_NO_DASH_WITH_RE_CHAR_SET_NO_DASH(4039),
    RE_CHAR_SET_ATOM_WITH_RE_CHAR_SET_NO_DASH(4039),
    RE_FLAGS(4041),
    RE_CHAR_SET_ATOM_NO_DASH(4042),
    RE_CHAR_SET_RANGE_LHS_CHAR_SET_ATOM(4042),
    RE_CHAR_SET_RANGE_NO_DASH_LHS_CHAR_SET_ATOM_NO_DASH(4042),
    RE_BRACED_QUANTIFIER_DIGIT(4043),
