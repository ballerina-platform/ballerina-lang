...
public enum SyntaxKind {
    ...
    WHERE_KEYWORD(403, "where"),
    JOIN_KEYWORD(404, "join"),
    OUTER_KEYWORD(405, "outer"),
    EQUALS_KEYWORD(406, "equals"),
    ORDER_KEYWORD(407, "order"),
    BY_KEYWORD(408, "by"),
    ASCENDING_KEYWORD(409, "ascending"),
    ...
    QUERY_ACTION(2510),
    COMMIT_ACTION(2511),
    CLIENT_RESOURCE_ACCESS_ACTION(2512),
    ...
    // Reg Exp
    RE_SEQUENCE(4013),
    RE_ATOM_QUANTIFIER(4014),
    RE_ASSERTION(4015),
    RE_LITERAL_CHAR_DOT_OR_ESCAPE(4016),
    RE_QUOTE_ESCAPE(4017),
    RE_SIMPLE_CHAR_CLASS_ESCAPE(4018),
    RE_UNICODE_PROPERTY_ESCAPE(4019),
    RE_UNICODE_SCRIPT(4020),
    RE_UNICODE_GENERAL_CATEGORY(4021),
    RE_CHARACTER_CLASS(4022),
    RE_CHAR_SET_ATOM_WITH_RE_CHAR_SET_NO_DASH(4023),
    RE_CHAR_SET_ATOM_NO_DASH_WITH_RE_CHAR_SET_NO_DASH(4024),
    RE_CHAR_SET_RANGE(4025),
    RE_CHAR_SET_RANGE_NO_DASH(4026),
    RE_CHAR_SET_RANGE_WITH_RE_CHAR_SET(4027),
    RE_CHAR_SET_RANGE_NO_DASH_WITH_RE_CHAR_SET(4028),
    RE_CAPTURING_GROUP(4029),
    RE_FLAG_EXPR(4030),
    RE_FLAGS_ON_OFF(4031),
    RE_FLAGS(4032),
    RE_QUANTIFIER(4033),
    RE_BRACED_QUANTIFIER(4034),

    RE_ASSERTION_VALUE(4035),
    RE_LITERAL_CHAR(4036),
    RE_NUMERIC_ESCAPE(4037),
    RE_CONTROL_ESCAPE(4038),
    RE_SIMPLE_CHAR_CLASS_CODE(4039),
    RE_PROPERTY(4040),
    RE_UNICODE_SCRIPT_START(4041),
    RE_UNICODE_PROPERTY_VALUE(4042),
    RE_UNICODE_GENERAL_CATEGORY_START(4043),
    RE_UNICODE_GENERAL_CATEGORY_NAME(4044),
    RE_CHAR_SET_ATOM_NO_DASH(4045),
    RE_FLAGS_VALUE(4046),
    RE_BASE_QUANTIFIER_VALUE(4047),
    DIGIT(4048),
