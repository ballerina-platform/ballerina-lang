...
public enum SyntaxKind {
    ...
    NEGATED_CHAR_CLASS_START_TOKEN(593, "[^"),
    ...
    RE_DISJUNCTION(4013),
    RE_SEQUENCE(4014),
    RE_ATOM_QUANTIFIER(4015),
    RE_ASSERTION(4016),
    RE_QUANTIFIER(4017),
    RE_ATOM(4018),
    RE_SEQUENCE_PIPED(4019),
    RE_CHARACTER_CLASS(4020),
    RE_CHAR_SET(4021),
    RE_FLAG_EXPR(4050),
    RE_FLAGS_ON_OFF(4022),
    RE_CAPTURING_GROUPS(4023),
    REGEXP_ASSERTION(4025),
    REGEXP_ATOM_CHAR_ESCAPE(4027),
    REGEXP_CHARSET(4028),
    REGEXP_TEXT(4029),
    REGEXP_QUANTIFIER(4030),
