...
public enum ParserRuleContext {
    ...
    IMPLICIT_ANON_FUNC_START("implicit-anon-func-start"),
    IMPLICIT_ANON_FUNC_SINGLE_PARAM("implicit-anon-func-single-param"),
    IMPLICIT_ANON_FUNC_OPEN_PAREN("implicit-anon-func-open-paren"),
