...
public enum ParserRuleContext {
    ...
    MAPPING_BINDING_PATTERN_CONTENTS("mapping-binding-pattern-content"),
    MAPPING_BINDING_PATTERN_END_OR_CONTINUE("mapping-binding-pattern-end-or-continue"),
    FIELD_BINDING_PATTERN_END_OR_CONTINUE("field-binding-pattern-end-or-continue"),
