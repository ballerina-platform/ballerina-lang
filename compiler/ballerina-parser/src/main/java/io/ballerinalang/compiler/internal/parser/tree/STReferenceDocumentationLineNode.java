...
import io.ballerinalang.compiler.syntax.tree.ReferenceDocumentationLineNode;
...
public class STReferenceDocumentationLineNode extends STDocumentationNode {
    ...
    STReferenceDocumentationLineNode(
            STNode hashToken,
    ...
    STReferenceDocumentationLineNode(
        ...
        super(SyntaxKind.REFERENCE_DOCUMENTATION_LINE, diagnostics);
    ...
    public STReferenceDocumentationLineNode modify(
            STNode hashToken,
            STNode referenceOrDescription) {
    ...
    public Node createFacade(int position, NonTerminalNode parent) {
        return new ReferenceDocumentationLineNode(this, position, parent);
    }
