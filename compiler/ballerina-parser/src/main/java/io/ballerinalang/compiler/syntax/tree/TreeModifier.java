...
public abstract class TreeModifier extends NodeTransformer<Node> {
    ...
    public ForEachStatementNode transform(
        ...
        Node typeDescriptor =
                modifyNode(forEachStatementNode.typeDescriptor());
        Token variableName =
                modifyToken(forEachStatementNode.variableName());
        Token inKeyword =
    ...
    public XMLSimpleNameNode transform(
        ...
        XMLSimpleNameNode name =
                modifyNode(xMLSimpleNameNode.name());
    ...
    public FlushActionNode transform(
        ...
        Token peerWorker =
                modifyToken(flushActionNode.peerWorker());
