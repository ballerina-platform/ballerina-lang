 ...
 * @since 1.3.0
 */
public class STDistinctTypeDescriptorNode extends STNode {
    public final STNode distinctKeywordToken;
    public final STNode typeDescriptorNode;

    STDistinctTypeDescriptorNode(
            STNode distinctKeywordToken,
            STNode typeDescriptorNode) {
        super(SyntaxKind.DISTINCT_TYPE_DESC);
        this.distinctKeywordToken = distinctKeywordToken;
