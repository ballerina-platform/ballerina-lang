 ...
 * @since 1.3.0
 */
public class ObjectTypeDescriptor extends NonTerminalNode {

    public ObjectTypeDescriptor(STNode internalNode, int position, NonTerminalNode parent) {
    ...
    public ObjectTypeDescriptor modify(
