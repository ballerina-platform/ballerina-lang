 ...
 * @since 2.0.0
 */
public class STServiceConstructorExpressionNode extends STExpressionNode {
    public final STNode annotations;
    public final STNode serviceKeyword;
    public final STNode serviceBody;

    STServiceConstructorExpressionNode(
            STNode annotations,
            STNode serviceKeyword,
            STNode serviceBody) {
        super(SyntaxKind.SERVICE_CONSTRUCTOR_EXPRESSION);
