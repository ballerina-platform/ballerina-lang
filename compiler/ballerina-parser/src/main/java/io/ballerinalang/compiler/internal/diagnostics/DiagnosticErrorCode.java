...
public enum DiagnosticErrorCode implements DiagnosticCode {
    ...
    // Visibility is public by default for remote methods. Explicit declaration is not allowed.
    ERROR_REMOTE_METHOD_HAS_A_VISIBILITY_QUALIFIER("BCE211", "error.remote.method.has.a.visibility.qualifier"),
