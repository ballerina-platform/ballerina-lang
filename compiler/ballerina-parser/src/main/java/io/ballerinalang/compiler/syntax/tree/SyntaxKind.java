...
public enum SyntaxKind {
    ...
    //Parameter Types of BFM
    TYPE_REFERENCE_TYPE(900, "type"),
    SERVICE_REFERENCE_TYPE(901, "service"),
    VARIABLE_REFERENCE_TYPE(902, "variable"),
    VAR_REFERENCE_TYPE(903, "var"),
    ANNOTATION_REFERENCE_TYPE(904, "annotation"),
    MODULE_REFERENCE_TYPE(905, "module"),
    FUNCTION_REFERENCE_TYPE(906, "function"),
    PARAMETER_REFERENCE_TYPE(907, "parameter"),
    ...
    // Documentation
    BACKTICK_CONTENT(4500),
    DOCUMENTATION_DESCRIPTION(4501),
    PARAMETER_NAME(4502),
    PARAMETER_DOCUMENTATION_LINE(4503),
    RETURN_PARAMETER_DOCUMENTATION_LINE(4504),
    REFERENCE_DOCUMENTATION_LINE(4505),
    DOCUMENTATION_REFERENCE(4506),
    DOCUMENTATION_CODE_REFERENCE(4507),
    DEPRECATION_DOCUMENTATION_LINE(4508),
