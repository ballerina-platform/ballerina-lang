...
public class FailActionTest extends AbstractActionTest {
    ...
    public void testBasicFailAction() {
        testFile("check-action/fail_action_source_01.bal", "check-action/fail_action_assert_01.json");
    }
    ...
    public void testInvalidTokenInFailAction() {
        testFile("check-action/fail_action_source_02.bal", "check-action/fail_action_assert_02.json");
    }
}
