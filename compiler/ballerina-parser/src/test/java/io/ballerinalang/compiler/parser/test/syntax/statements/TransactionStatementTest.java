...
public class TransactionStatementTest extends AbstractStatementTest {
    ...
    public void testTransactionStatementWithOnFailClause() {
        testFile("transaction-stmt/transaction_stmt_source_03.bal",
                "transaction-stmt/transaction_stmt_assert_03.json");
    }
    ...
    public void testRetryStatementWithOnFailClauseWithoutVariable() {
        testFile("transaction-stmt/retry_stmt_source_06.bal", "transaction-stmt/retry_stmt_assert_07.json");
    }
}
