...
/**
 * Holder for source response timer.
 */
public class SourceResponseStaticsHolder implements MetricsStaticsHolder {
    ...
    public SourceResponseStaticsHolder(TimerHolder timerHolder) {
