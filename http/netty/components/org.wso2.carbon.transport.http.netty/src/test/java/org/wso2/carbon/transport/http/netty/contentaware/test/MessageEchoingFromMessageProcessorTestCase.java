 ...
 */
public class MessageEchoingFromMessageProcessorTestCase {
    protected static final Logger LOGGER = LoggerFactory.getLogger(MessageEchoingFromMessageProcessorTestCase.class);
   ...
   private URI baseURI = URI.create(String.format("http://%s:%d", "localhost", 8080));
    ...
    @Test
    public void passthroughWorkerPoolEnabledTestCase() {
    ...
    @Test
    public void passthroughDisruptorEnabledTestCase() {
