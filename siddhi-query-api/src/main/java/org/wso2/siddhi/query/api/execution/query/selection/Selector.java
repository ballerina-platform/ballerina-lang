...
public abstract class Selector {
    ...
    protected List<OutputAttribute> selectionList = new ArrayList<OutputAttribute>();
    protected List<Variable> groupByList = new ArrayList<Variable>();
    ...
    public static HavingSelector selector() {
        return new HavingSelector();
    }
