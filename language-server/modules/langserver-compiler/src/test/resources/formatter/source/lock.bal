...
function lockWithinLock() returns [int, string] {
  ...
  lockWithinLockInt1 = 50;
        ...
        lock{lockWithinLockString1 = "second sample value";
                      int ret = makeAsync();
       lockWithinLockInt1 = 99;
                  lock{lockWithinLockInt1 = 90;}}
...
function lockWithinLockInWorkers() returns [int, string] {
    ...
    worker w2 {
        runtime:sleep(20);
        lock {lockWithinLockString1 = "hello";lock {lockWithinLockInt1 = 88;}lockWithinLockInt1 = 56;}
    }
