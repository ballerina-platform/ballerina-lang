 ...
 * @since 2.0.0
 */
public abstract class AbstractTomlCompletionContext implements CompletionContext {
     ...
     */
    public abstract void setNodeAtCursor(NonTerminalNode node);
     ...
     */
    public abstract Optional<NonTerminalNode> getNodeAtCursor();
     ...
     */
    public abstract Optional<SyntaxTree> getTomlSyntaxTree();
     ...
     */
    public abstract LanguageServerContext getLanguageServerContext();
}
