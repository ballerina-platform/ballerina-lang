...
/**
 * Completion provider for {@link MethodDeclarationNode} context.
 *
 * @since 2.0.0
 */
...
public class MethodDeclarationNodeContext extends AbstractCompletionProvider<MethodDeclarationNode> {
    ...
    @Override
    public List<LSCompletionItem> getCompletions(CompletionContext context, MethodDeclarationNode node)
