...
public class BallerinaOASRequest {
    ...
    public void setBallerinaService(String ballerinaService) {
        this.ballerinaService = ballerinaService;
    }
    ...
    public void setBallerinaDocument(TextDocumentIdentifier ballerinaDocument) {
        this.ballerinaDocument = ballerinaDocument;
    }
