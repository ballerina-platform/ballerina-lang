...
public class AddMissingParameterExecutor implements LSCommandExecutor {

    public static final String COMMAND = "ADD_MISSING_PARAMETER_IN_OPENAPI";
     ...
     */
    public static String generateOpenApiDefinitions(String ballerinaSource, String serviceName) {
        try {
    ...
    public Object execute(LSContext context) throws LSCommandExecutorException {
        ...
        try {
            ...
            if (contractURI != null) {
                ...
                String openAPIDefinitions = generateOpenApiDefinitions(balSource, serviceNode.name.value);
                ...
                openAPINew.getPaths().forEach((s, path) -> {
                    // todo find the paramter and add 
