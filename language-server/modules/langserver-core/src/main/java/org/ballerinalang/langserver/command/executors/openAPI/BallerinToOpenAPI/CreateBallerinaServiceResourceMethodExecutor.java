...
public class CreateBallerinaServiceResourceMethodExecutor implements LSCommandExecutor {

    public static final String COMMAND = "CREATE_HTTP_METHOD_FOR_THE_PATH_IN_OPENAPI";
    ...
    public static String generateOpenApiDefinitions(String ballerinaSource, String serviceName, String resourcePath,
        ...
        try {
            ...
            Swagger openapi = getOpenApiDefinition(new Swagger(), openApiServiceMapper, serviceName, topCompilationUnit,
                                                   endpoints, resourcePath, resourceMethod);
    ...
    public Object execute(LSContext context) throws LSCommandExecutorException {
        ...
        try {
            ...
            if (contractURI != null) {
                ...
                if (openAPI != null && openAPINew != null) {
                    String finalResourcePath = resourcePath;
                    String finalResourceMethod = resourceMethod;
                    openAPI.getPaths().forEach((s, path) -> {
                        if (s.equals(finalResourcePath)) {
                            openAPINew.getPaths().forEach((newKey, newPath) -> {
                                if (finalResourceMethod != null) {
