 ...
 */
public class FunctionContext implements CompletionItemsContext {
    @Override
    public CompletionItemsContext resolve(LSContext context) {
        ...
        CompletionItemsContext contextResolver = CompletionItemResolver.get(parserRuleContext.getClass(), context);
