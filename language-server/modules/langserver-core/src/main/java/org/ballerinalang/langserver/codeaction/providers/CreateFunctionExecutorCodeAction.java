...
/**
 * Code Action provider for creating a function.
 *
 * @since 1.0.4
 */
@JavaSPIService("org.ballerinalang.langserver.codeaction.BallerinaCodeActionProvider")
public class CreateFunctionExecutorCodeAction implements BallerinaCodeActionProvider {
    List<CodeActionNodeType> codeActionNodeTypes = Arrays.asList(CodeActionNodeType.FUNCTION,
    ...
    public List<org.eclipse.lsp4j.CodeAction> getCodeActions(CodeActionNodeType nodeType, LSContext lsContext,
        ...
        LSDocument finalDocument = document;
