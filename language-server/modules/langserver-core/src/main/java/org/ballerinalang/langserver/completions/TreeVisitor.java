...
//        }
    ...
    private boolean isWithinEndpointContext(DiagnosticPos diagnosticPos, SymbolEnv symbolEnv, String epName) {
        if (documentServiceContext.get(DocumentServiceKeys.COMPLETION_META_CONTEXT_KEY)
        ...
        } else if (documentServiceContext.get(DocumentServiceKeys.COMPLETION_META_CONTEXT_KEY)
                .get(CompletionKeys.META_CONTEXT_IS_ENDPOINT_KEY)) {
            // Syntax errors has occurred
            boolean isWithinEndpoint = documentServiceContext.get(DocumentServiceKeys.COMPLETION_META_CONTEXT_KEY)
                    .get(CompletionKeys.META_CONTEXT_IS_ENDPOINT_KEY);
            String name = documentServiceContext.get(DocumentServiceKeys.COMPLETION_META_CONTEXT_KEY)
