...
public enum CursorPositionResolvers {
    ...
    LIST_CONSTRUCTOR_SCOPE(ListConstructorScopeResolver.class, new ListConstructorScopeResolver()),
    ...
    CursorPositionResolvers(Class context, CursorPositionResolver positionResolver) {
