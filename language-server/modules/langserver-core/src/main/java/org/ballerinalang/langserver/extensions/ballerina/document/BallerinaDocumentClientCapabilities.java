...
/**
 * Client capabilities for the ballerinaDocument service.
 *
 * @since 2.0.0
 */
public class BallerinaDocumentClientCapabilities extends BallerinaClientCapability {
    ...
    public BallerinaDocumentClientCapabilities() {
