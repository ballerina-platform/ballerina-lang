    ...
    public CompletableFuture<BallerinaSyntaxTreeResponse> syntaxTreeByName(BallerinaSyntaxTreeByNameRequest request) {
        return CompletableFuture.supplyAsync(() -> {
            ...
            try {
                ...
                Optional<Symbol> functionSymbol = semanticModel.get()
                        .symbol(srcFile.get(), LinePosition.from(lineValue, charValue));
                    ...
                    module.documentIds().forEach(id -> {
                        ...
                        if (functionPath.equals(document.name())) {
                            ...
                            functionNodes.forEach(node -> {
                                ...
                                int symbolLine = functionSymbol.get().getLocation().get().lineRange()
                                        .startLine().line();
                                ...
                                if (functionSymbol.get().nameEquals(node.functionName().text()) && withinRange) {
                                    ...
                                    PackageCompilation packageCompilation = document.module().packageInstance()
                                            .getCompilation();
