 ...
 * @since 0.94
 */
public class CompletionTreeVisitor extends LangServerNodeVisitor {
    ...
    public CompletionTreeVisitor(TextDocumentServiceContext documentServiceContext) {
    ...
    public void visit(BLangWhile whileNode) {
        this.visitForeachOrWhileNode(whileNode, whileNode.body);
    }
    ...
    public void visit(BLangForeach foreach) {
        this.visitForeachOrWhileNode(foreach, foreach.body);
    }
    ...
    private void visitForeachOrWhileNode(BLangNode bLangNode, BLangBlockStmt body) {
        if (!ScopeResolverConstants.getResolverByClass(cursorPositionResolver)
                .isCursorBeforeNode(bLangNode.getPosition(), bLangNode, this, this.documentServiceContext)) {
            this.blockOwnerStack.push(bLangNode);
            loopCount++;
            this.acceptNode(body, symbolEnv);
            loopCount--;
            this.blockOwnerStack.pop();
        }
    }
