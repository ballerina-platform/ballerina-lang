...
public type Client client object {
    ...
    remote function post(@untainted string path, RequestMessage message) returns Response|error {

    }

    remote function get(@untainted string path, RequestMessage message) returns Response|error = external;
