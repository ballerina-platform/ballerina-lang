...
public type SomeConfiguration3 record {
   ...
   public  annotation < function,service >   ConfigAnnotation4 ;annotation < function , service >ConfigAnnotation5 ;

public   annotation <  function  >     ConfigAnnotation6   ;

       annotation <  function  >   ConfigAnnotation7 ; annotation       ConfigAnnotation7 ;
