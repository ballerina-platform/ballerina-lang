...
const boolean tet = true;  const   annotation    tet    ConfigAnnotation2  on  source  object  function ,source  service  ;
...
;
     ...
     public  annotation  ConfigAnnotation6  on  type ; annotation  ConfigAnnotation7 on  object  type  ;
...
type Annot record {
    string foo;
    int bar?;
};public     annotation    Annot   v1   on  type   ;annotation  Annot [ ]  v2  on  object  type ;
...
annotation    Annot    v6    on  parameter  ;
 ...
 .@
  ...
  service serTwo = @v8 {
      ...
      foo : "v642" } int intVal) returns @ v7 int {
          return 1;
      }
  };
