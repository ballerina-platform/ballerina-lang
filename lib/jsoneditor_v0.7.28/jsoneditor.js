...
JSONEditor.defaults.editors.object = JSONEditor.AbstractEditor.extend({
  ...
  getValue: function() {
    var result = this._super();
      /**
       * Browser console error "Uncaught TypeError: Cannot read property 'remove_empty_properties' of null" occurred,
       * when this.jsoneditor.options = null and this.options.remove_empty_properties = undefined.
       * No functionality changes have been added with this fix to the json-editor library.
       */
    if((this.jsoneditor.options && this.jsoneditor.options.remove_empty_properties) || this.options.remove_empty_properties) {
      for(var i in result) {
  ...
  refreshValue: function(force) {
    ...
    if(oldi !== this.value.length || force) {
      ...
      if(!this.value.length) {
        ...
        // If there are minItems items in the array, or configured to hide the delete_last_row button, hide the delete
        // button beneath the rows
