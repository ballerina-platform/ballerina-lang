...
// Enter a parse tree produced by WUMLParser#interfaceDeclaration.
	WUMLListener.prototype.enterInterfaceDeclaration = function(ctx) {
	};

// Exit a parse tree produced by WUMLParser#interfaceDeclaration.
	WUMLListener.prototype.exitInterfaceDeclaration = function(ctx) {
	};
...
// Enter a parse tree produced by WUMLParser#localVariableInitializationStatement.
	WUMLListener.prototype.enterLocalVariableInitializationStatement = function(ctx) {
	};

// Exit a parse tree produced by WUMLParser#localVariableInitializationStatement.
	WUMLListener.prototype.exitLocalVariableInitializationStatement = function(ctx) {
	};


// Enter a parse tree produced by WUMLParser#localVariableAssignmentStatement.
	WUMLListener.prototype.enterLocalVariableAssignmentStatement = function(ctx) {
	};

// Exit a parse tree produced by WUMLParser#localVariableAssignmentStatement.
	WUMLListener.prototype.exitLocalVariableAssignmentStatement = function(ctx) {
	};


// Enter a parse tree produced by WUMLParser#mediatorCallStatement.
	WUMLListener.prototype.enterMediatorCallStatement = function(ctx) {
	};

// Exit a parse tree produced by WUMLParser#mediatorCallStatement.
	WUMLListener.prototype.exitMediatorCallStatement = function(ctx) {
	};
...
// Enter a parse tree produced by WUMLParser#keyValuePairs.
	WUMLListener.prototype.enterKeyValuePairs = function(ctx) {
	};

// Exit a parse tree produced by WUMLParser#keyValuePairs.
	WUMLListener.prototype.exitKeyValuePairs = function(ctx) {
	};


// Enter a parse tree produced by WUMLParser#keyValuePair.
	WUMLListener.prototype.enterKeyValuePair = function(ctx) {
	};

// Exit a parse tree produced by WUMLParser#keyValuePair.
	WUMLListener.prototype.exitKeyValuePair = function(ctx) {
	};
