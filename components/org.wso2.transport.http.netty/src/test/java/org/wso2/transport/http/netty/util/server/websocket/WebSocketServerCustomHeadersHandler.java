...
public class WebSocketServerCustomHeadersHandler extends ChannelDuplexHandler {
    ...
    private boolean acknowledgeCustomHeader;
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        if (msg instanceof HttpRequest) {
            ...
            acknowledgeCustomHeader = Boolean.valueOf(headers.get("x-ack-custom-header"));
        }
    ...
    public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception {
        if (msg instanceof HttpResponse && acknowledgeCustomHeader) {
            HttpResponse response = (HttpResponse) msg;
            response.headers().set("x-custom-header-return", "custom-header");
            acknowledgeCustomHeader = false;
