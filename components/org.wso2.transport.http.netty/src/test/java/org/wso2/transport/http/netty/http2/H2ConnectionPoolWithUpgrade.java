...
public class H2ConnectionPoolWithUpgrade {
    ...
    public void testH2CUpgradeWithPool() {
        ...
        HttpClientConnector client1 = getTestClient(httpWsConnectorFactory, false); //Upstream uses eventloop1 pool
        String response1 = getResponse(client1);
        HttpClientConnector client2 = getTestClient(httpWsConnectorFactory, false); //Upstream uses eventloop2 pool
        String response2 = getResponse(client2);
        HttpClientConnector client3 = getTestClient(httpWsConnectorFactory, false); //Upstream uses eventloop1 pool
        String response3 = getResponse(client3);
        HttpClientConnector client4 = getTestClient(httpWsConnectorFactory, false); //Upstream uses eventloop2 pool
