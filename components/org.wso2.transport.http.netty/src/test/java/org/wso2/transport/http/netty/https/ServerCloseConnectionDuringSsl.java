...
public class ServerCloseConnectionDuringSsl {

    private HttpClientConnector httpClientConnector;
    private HttpServer httpServer;
    private HttpWsConnectorFactory factory;
    private static final Logger LOG = LoggerFactory.getLogger(ServerCloseConnectionDuringSsl.class);
    ...
    public void setup() {
        ...
        SenderConfiguration senderConfiguration = getSenderConfigs();
        httpClientConnector = factory.createHttpClientConnector(new HashMap<>(), senderConfiguration);
    }
