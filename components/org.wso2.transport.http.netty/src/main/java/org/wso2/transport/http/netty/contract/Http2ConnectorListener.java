 ...
 */
public interface Http2ConnectorListener {
    /**
     * Each event triggered by connector ends up here.
     *
     * @param http2Response contains the state change information of the event.
     */
    void onMessage(Http2Response http2Response);
