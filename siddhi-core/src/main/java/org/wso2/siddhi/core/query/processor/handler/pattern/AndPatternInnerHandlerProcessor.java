    ...
    protected void passToNextStates(StateEvent eventBundle) {
        ...
        if (distributedProcessing) {
            if (currentState == higherState) {
                partnerStateInnerHandlerProcessor.updateToCurrentEvents(eventBundle, higherState);
            } else if (currentState == lowerState) {
                partnerStateInnerHandlerProcessor.updateToNextEvents(eventBundle, lowerState);
            }
        }
