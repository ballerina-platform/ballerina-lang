...
public class UpdateTableCallback extends OutputCallback {
    ...
    public UpdateTableCallback(Table table, CompiledCondition compiledCondition, AbstractDefinition updatingStreamDefinition,
    ...
    public synchronized void send(ComplexEventChunk updatingEventChunk) {
        ...
        if (updatingEventChunk.hasNext()) {
            ...
            table.update(updatingStateEventChunk, compiledCondition, updateAttributeMappers);
        }
    }
