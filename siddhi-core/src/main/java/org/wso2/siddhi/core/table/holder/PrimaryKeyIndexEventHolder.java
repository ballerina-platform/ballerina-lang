...
public class PrimaryKeyIndexEventHolder implements IndexedEventHolder {
    ...
    public PrimaryKeyIndexEventHolder(StreamEventPool tableStreamEventPool, StreamEventConverter eventConverter,
