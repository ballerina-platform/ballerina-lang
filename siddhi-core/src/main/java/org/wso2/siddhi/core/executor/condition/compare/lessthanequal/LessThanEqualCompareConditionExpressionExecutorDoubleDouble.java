...
/**
 * Executor class for Double-Double Less Than or Equal condition. Condition evaluation logic is implemented within
 * executor.
 */
public class LessThanEqualCompareConditionExpressionExecutorDoubleDouble extends
        LessThanEqualCompareConditionExpressionExecutor {


    public LessThanEqualCompareConditionExpressionExecutorDoubleDouble(
