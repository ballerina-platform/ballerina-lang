...
public class RightInStreamJoinProcessor extends JoinProcessor {

    public RightInStreamJoinProcessor(ConditionExecutor onConditionExecutor, boolean triggerEvent,
