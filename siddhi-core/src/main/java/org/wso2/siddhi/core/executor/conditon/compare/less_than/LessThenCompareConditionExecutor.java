...
public abstract class LessThenCompareConditionExecutor extends CompareConditionExecutor {

    public LessThenCompareConditionExecutor(ExpressionExecutor leftExpressionExecutor,
