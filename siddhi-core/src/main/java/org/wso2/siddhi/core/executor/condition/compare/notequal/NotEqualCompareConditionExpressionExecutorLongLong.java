...
/**
 * Executor class for Long-Long Not Equal condition. Condition evaluation logic is implemented within
 * executor.
 */
public class NotEqualCompareConditionExpressionExecutorLongLong extends
        NotEqualCompareConditionExpressionExecutor {


    public NotEqualCompareConditionExpressionExecutorLongLong(
    ...
    public ExpressionExecutor cloneExecutor(String key) {
        return new NotEqualCompareConditionExpressionExecutorLongLong(leftExpressionExecutor.cloneExecutor(key),
