...
public class LessThanCompareConditionExecutorIntFloat extends
                                                      LessThenCompareConditionExecutor {


    public LessThanCompareConditionExecutorIntFloat(ExpressionExecutor leftExpressionExecutor,
