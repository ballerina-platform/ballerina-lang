...
public class InsertIntoRDBMSTestCase {
    ...
    public void testQuery1() throws InterruptedException {
        ...
        siddhiManager.defineTable("define table cseEventTable (symbol string, price float, volume long) " + createFromClause("cepDataSource", "cepEventTable", "CREATE TABLE cepEventTable (symbol VARCHAR(50), price DECIMAL, volume BIGINT, vwap DECIMAL) "));
    ...
    public void testQuery1LRU() throws InterruptedException {
        log.info("InsertIntoTableTestCase testQuery1LRU");

        SiddhiManager siddhiManager = new SiddhiManager();
        siddhiManager.getSiddhiContext().addDataSource(dataSourceName, dataSource);

        siddhiManager.defineStream("define stream cseEventStream (symbol string, price float, volume long) ");
        siddhiManager.defineTable("define table cseEventTable (symbol string, price float, volume long) " + createFromClause("cepDataSource", "cepEventTable", "CREATE TABLE cepEventTable (symbol VARCHAR(50), price DECIMAL, volume BIGINT, vwap DECIMAL) ", "lru"));
    ...
    public void testQuery1LFU() throws InterruptedException {
        log.info("InsertIntoTableTestCase testQuery1LFU");

        SiddhiManager siddhiManager = new SiddhiManager();
        siddhiManager.getSiddhiContext().addDataSource(dataSourceName, dataSource);

        siddhiManager.defineStream("define stream cseEventStream (symbol string, price float, volume long) ");
        siddhiManager.defineTable("define table cseEventTable (symbol string, price float, volume long) " + createFromClause("cepDataSource", "cepEventTable", "CREATE TABLE cepEventTable (symbol VARCHAR(50), price DECIMAL, volume BIGINT, vwap DECIMAL) ", "lfu"));
    ...
    public void testQuery2() throws InterruptedException {
        ...
        siddhiManager.defineTable("define table cseEventTable2 (symbol string, price float, volume long)  " + createFromClause("cepDataSource", "cepEventTable2", null));
    ...
    public void testQuery4() throws InterruptedException {
        ...
        siddhiManager.defineTable("define table cseEventTable (symbol string, price float, volume long) " + createFromClause("cepDataSource", "cepEventTableCheck", null));
    ...
    @Test
    public void testQueryDefineCacheSize() throws InterruptedException {
        log.info("InsertIntoTableTestCase testDefineCacheSize");

        SiddhiManager siddhiManager = new SiddhiManager();
        siddhiManager.getSiddhiContext().addDataSource(dataSourceName, dataSource);

        siddhiManager.defineStream("define stream cseEventStream (symbol string, price float, volume long) ");
        String query = "define table cseEventTable10 (symbol string, price float, volume long) from ( 'datasource.name'='cepDataSource','table.name'='cseEventTable10','cache.size'='1000')";
        siddhiManager.defineTable(query);
