...
public class ExternalTimeBatchWindowEventTableTestCase {


    private static final Logger log = Logger.getLogger(ExternalTimeBatchWindowEventTableTestCase.class);
