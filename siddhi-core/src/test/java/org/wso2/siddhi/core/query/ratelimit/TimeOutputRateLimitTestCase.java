 ...
 * under the License.
 */kage org.wso2.siddhi.core.query.ratelimit;
    ...
    public void testTimeOutputRateLimitQuery5() throws InterruptedException {
        ...
        executionPlanRuntime.addCallback("query1", new QueryCallback() {
            ...
            public void receive(long timeStamp, Event[] inEvents, Event[] removeEvents) {
                ...
                if (inEvents != null) {
                    count += inEvents.length;
                    Assert.assertTrue("192.10.1.3".equals(inEvents[0].getData(0)) || "192.10.1.4".equals(inEvents[0].getData(0)) || "192.10.1.30".equals(inEvents[0].getData(0)));
                } else {
                    Assert.fail("Remove events emitted");
                }
                eventArrived = true;
