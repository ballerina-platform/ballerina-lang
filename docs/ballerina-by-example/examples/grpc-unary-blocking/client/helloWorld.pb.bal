...
public type HelloWorldStub object {
    ...
    function hello (string req, typedesc listener, grpc:Headers... headers) returns (grpc:Headers|error) {
        grpc:Headers|grpc:ConnectorError unionResp = self.serviceStub.nonBlockingExecute("HelloWorld/hello", req,
            listener, ...headers);
        match unionResp {
            grpc:ConnectorError payloadError => {
                error err = {message:payloadError.message};
