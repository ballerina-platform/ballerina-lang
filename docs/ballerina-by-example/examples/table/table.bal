...
function main (string[] args) {
    ...
    int count = testDB.updateQuery("CREATE TABLE EMPLOYEE (id INT,name
        VARCHAR(25),salary DOUBLE,status BOOLEAN,birthdate DATE,birthtime TIME,
        updated TIMESTAMP)", null);
    count = testDB.updateQuery("INSERT INTO EMPLOYEE VALUES(1, 'John', 1050.50, false,
        '1990-12-31', '11:30:45', '2007-05-23 09:15:28')", null);
    count = testDB.updateQuery("INSERT INTO EMPLOYEE VALUES(2, 'Anne', 4060.50, true,
    ...
    table dt = testDB.selectQuery("SELECT * from EMPLOYEE", null, typeof Employee);
    ...
    dt = testDB.selectQuery("SELECT id,name FROM EMPLOYEE", null, null);
    ...
    int ret = testDB.updateQuery("DROP TABLE EMPLOYEE", null);
