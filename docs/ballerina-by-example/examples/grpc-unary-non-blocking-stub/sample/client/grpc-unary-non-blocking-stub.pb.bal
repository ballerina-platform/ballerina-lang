...
public connector helloWorldBlockingStub(string host, int port){
    ...
    action hello (string req) (string, error) {
        var res, err1 = ep.blockingExecute("server.org.ballerinalang.net.grpc.helloworldstruct.helloWorld/hello", req);
        if (err1 != null) {
...
public connector helloWorldNonBlockingStub(string host, int port){
    ...
    action hello (string req, string serviceName) (error) {
        var err1 = ep.nonBlockingExecute("server.org.ballerinalang.net.grpc.helloworldstruct.helloWorld/hello", req, serviceName);
...
const string descriptorKey = "server.org.ballerinalang.net.grpc.helloworldstruct.helloWorld.proto";
map descriptorMap ={
                       "server.org.ballerinalang.net.grpc.helloworldstruct.helloWorld.proto":"",
