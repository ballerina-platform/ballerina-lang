...
ballerina: Default Ballerina WebSub Hub started up at http://localhost:9292/websub/hub
ballerina: started HTTP/WS server connector localhost:9292
...
2018-03-23 05:32:30,915 INFO  [ballerina.websub] - Subscription Request successful at Hub[http://localhost:9292/websub/hub], for Topic[http://www.websubpubtopic.com]
