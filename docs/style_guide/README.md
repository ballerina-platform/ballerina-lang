...
The Ballerina Style Guide aims at maintaining a standard coding style among the Ballerina community. Therefore, code formatting and the other features provided by the Ballerina IDE plugins and tools are based on this guide. 
