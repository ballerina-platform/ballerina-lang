...
public class ChangePackageQuickFix extends BaseIntentionAction {

    private String packageName;

    public ChangePackageQuickFix(String packageName) {
    ...
    public String getText() {
        return "Change package to '" + packageName + "'";
    }
    ...
    private void changePackageDeclaration(Project project, PsiFile psiFile) {
        new WriteCommandAction.Simple(project) {
            ...
            public void run() {
                ...
                ASTNode node = ballerinaFile.getNode().findChildByType(BallerinaTypes.PACKAGE_DECLARATION);
                if (node != null) {
                    node.getPsi().replace(packageDeclaration.getNode().getPsi());
                }
            }
        }.execute();
    }
