...
public class VariableReference extends BallerinaElementReference {
    ...
    public Object[] getVariants() {
        ...
        //
        //        // Todo - improve suggesting elements from a package in StructValueNode since it will not be
        // identified properly
        ...
        //                        results.addAll(BallerinaCompletionUtils.createGlobalVariableLookupElements
        // (globalVariables));
        //
        ...
        //        ScopeNode scope = PsiTreeUtil.getParentOfType(identifier, CodeBlockScope.class, VariableContainer
        // .class,
