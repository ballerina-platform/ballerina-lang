...
//
//public class FunctionCompletionInsertHandler implements InsertHandler<LookupElement> {
//
//    public final static InsertHandler<LookupElement> INSTANCE = new FunctionCompletionInsertHandler(false);
//    public final static InsertHandler<LookupElement> INSTANCE_WITH_AUTO_POPUP =
//            new FunctionCompletionInsertHandler(true);
//
//    private final String myIgnoreOnChars;
//    private final boolean myTriggerAutoPopup;
//
//    public FunctionCompletionInsertHandler(boolean triggerAutoPopup) {
//        this("", triggerAutoPopup);
//    }
//
//    public FunctionCompletionInsertHandler(String ignoreOnChars, boolean triggerAutoPopup) {
