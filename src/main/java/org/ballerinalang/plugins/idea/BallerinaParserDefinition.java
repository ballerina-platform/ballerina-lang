...
public class BallerinaParserDefinition implements ParserDefinition {
    ...
    public static final TokenSet KEYWORDS = PSIElementTypeFactory.createTokenSet(BallerinaLanguage.INSTANCE,
            ...
            CONTINUE, CREATE, ELSE, FINALLY, FORK, FUNCTION, IF, IMPORT, ITERATE, JOIN, LENGTHOF, NATIVE, PACKAGE,
            PARAMETER, REPLY, RESOURCE, RETURN, RETURNS, SERVICE, SOME, STRUCT, THROW, TIMEOUT, TRANSACTION,
            TRANSFORM, TRY, TYPEMAPPER, VAR, WHILE, WORKER, XMLNS, TYPEOF, TYPE_BOOL, TYPE_INT, TYPE_FLOAT, TYPE_STRING,
            TYPE_BLOB, TYPE_MESSAGE, TYPE_MAP, TYPE_XML, TYPE_JSON, TYPE_DATATABLE, TYPE_ANY, TYPE_TYPE, BooleanLiteral,
            NullLiteral);
