...
import org.ballerinalang.plugins.idea.debugger.JsonReaderEx;
...
@JsonType
public interface BallerinaResponse {

    int id();

    @Nullable
    @Optional
    org.ballerinalang.plugins.idea.debugger.JsonReaderEx result();
    ...
    final class CommandResponseImpl implements BallerinaResponse {
        @Nullable
        private BallerinaResponse.ErrorInfo _error;
        private int _id = -1;
        @Nullable
        ...
        @Nullable
        @Override
        public BallerinaResponse.ErrorInfo error() {
            return _error;
        }
        ...
        @Nullable
        @Override
        public org.ballerinalang.plugins.idea.debugger.JsonReaderEx result() {
            return _result;
        }
    }

    final class M5m implements BallerinaResponse.ErrorInfo {
