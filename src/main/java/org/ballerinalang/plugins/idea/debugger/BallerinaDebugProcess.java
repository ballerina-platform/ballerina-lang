...
import static org.ballerinalang.plugins.idea.debugger.protocol.BallerinaAPI.*;
        ...
        public void registerBreakpoint(@NotNull XLineBreakpoint<BallerinaBreakpointProperties> breakpoint) {
            ...
            send(new BallerinaRequest.CreateBreakpoint(file.getPath(), line + 1))
                    .done(b -> {
                        ...
                        getSession().updateBreakpointPresentation(breakpoint, AllIcons.Debugger.Db_verified_breakpoint,
                                null);
                    })
                    .rejected(t -> {
