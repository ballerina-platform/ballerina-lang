...
connector Twitter (string consumerKey, string consumerSecret, string accessToken, string accessTokenSecret) <fold text='{...}'>{
    ...
    action tweet (Twitter t, string msg) (message) <fold text='{...}'>{
        //comment
        message request = {};
...
function constructOAuthHeader (string consumerKey, string consumerSecret, string accessToken, string accessTokenSecret, string tweetMessage) (string) <fold text='{...}'>{
    //comment
