...
function testSimpleUnion() {
    ...
    test:assertTrue(y[0][1] is int);
    test:assertEquals(1, y[0][1]);
    test:assertEquals(2, y[1][1]);
}
...
function testUnionOfRecordTypes() {
    ...
    test:assertEquals("34", stringOrIntVar);
    test:assertTrue(stringOrIntVar is string);
}
...
function testUnionOfSimpleTupleTypes() {
    ...
    test:assertEquals(4, valueRecord["value"]);
    test:assertTrue(valueRecord["value"] is int);
}
