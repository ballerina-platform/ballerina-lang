...
public class LangLibRuntimeTest {
    ...
    public void testGetStackTrace() {
        ...
        assertEquals(returns[0].stringValue(), "{callableName:\"externGetStackTrace\"," +
                " moduleName:\"ballerina.lang$0046runtime.0_0_1.runtime\", fileName:\"runtime.bal\", lineNumber:93}");
        assertEquals(returns[1].stringValue(), "{callableName:\"getStackTrace\", " +
                "moduleName:\"ballerina.lang$0046runtime.0_0_1.runtime\", fileName:\"runtime.bal\", lineNumber:83}");
