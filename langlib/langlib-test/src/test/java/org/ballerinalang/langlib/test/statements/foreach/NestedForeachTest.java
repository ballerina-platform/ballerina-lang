...
public class NestedForeachTest {
    ...
    public void test2LevelNestedForeachWithoutType() {
        ...
        Assert.assertEquals(returns[0].toString(), "1:A 1:B 1:C 2:A 2:B 2:C 3:A 3:B 3:C ");
    }
    ...
    public void test3LevelNestedForeachWithoutType() {
        ...
        Assert.assertEquals(returns.length, 1);
        Assert.assertEquals(returns[0].toString(), "1:A:10.0 1:A:11.0 1:A:12.0 1:B:10.0 1:B:11.0 1:B:12.0 1:C:10.0" +
    ...
    public void testNestedForeachWithBreak1() {
        ...
        Assert.assertEquals(returns.length, 1);
        Assert.assertEquals(returns[0].toString(), "innerouter");
    }
    ...
    public void testNestedForeachWithBreak2() {
        ...
        Assert.assertEquals(returns.length, 1);
        Assert.assertEquals(returns[0].toString(), "level4level3level2level1");
    }
}
