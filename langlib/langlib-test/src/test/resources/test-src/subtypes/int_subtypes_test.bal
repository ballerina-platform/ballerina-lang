...
type IntType1 int:Signed8|int:Unsigned32;
type IntType2 int:Signed16|int:Unsigned32;
type IntType3 int:Signed8|int:Unsigned16;
type IntType4 int:Signed8|int:Unsigned8;
type IntType5 int:Signed16|int:Unsigned16;
type IntType6 int:Signed32|int:Unsigned32;

public function test assignmentToIntUnsignedAndSignedUnionTest() {
    ...
    IntType6 a44 = 4000967000;
    IntType6 a45 = x6;
    IntType6 a46 = -2147;
    int:Unsigned32|int:Signed32 a47 = 4000967000;
    int:Unsigned32|int:Signed32 a48 = -2,147;
