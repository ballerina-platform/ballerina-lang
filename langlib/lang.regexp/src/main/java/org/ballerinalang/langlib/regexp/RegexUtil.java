...
public class RegexUtil {
    ...
    static Matcher getMatcher(BRegexpValue regexpVal, BString inputStr) {
        try {
            ...
            throw ErrorHelper.getRuntimeException(BallerinaErrorReasons.REG_EXP_PARSING_ERROR,
    ...
    protected static void checkIndexWithinRange(BString str, long startIndex) {
        if (startIndex != (int) startIndex) {
            throw ErrorHelper.getRuntimeException(BallerinaErrorReasons.REGEXP_OPERATION_ERROR,
