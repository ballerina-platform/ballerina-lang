 ...
 */
@BallerinaFunction(
        orgName = "ballerina", packageName = "lang.stream", functionName = "filter",
...
public class Filter {
    ...
    public static StreamValue filter(Strand strand, StreamValue strm, FPValue<Object, Boolean> func) {
        return (StreamValue) strm.filter(strm, func);
    }
}
