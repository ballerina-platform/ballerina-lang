...
type StreamManager object {
    ...
    function addSubscriptionFunc(stream<PureType> strm, function (PureType) func) = external;
    ...
    function getSubscriptionFuncs(stream<PureType> strm) returns function (PureType)[] = external;
};
