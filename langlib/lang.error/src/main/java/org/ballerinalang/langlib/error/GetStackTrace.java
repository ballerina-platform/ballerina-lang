...
public class GetStackTrace {
    ...
    private static final String PACKAGE_NAME = "lang.error";
    ...
    public static final Module BALLERINA_ERROR_PKG_ID = new Module(BALLERINA_BUILTIN_PKG_PREFIX,
    ...
    public static BArray getStackTrace() {
        ...
        Type recordType = ValueCreator.createRecordValue(BALLERINA_ERROR_PKG_ID, CALL_STACK_ELEMENT).getType();
        ...
        for (int i = 0; i < filteredStack.size(); i++) {
            ...
            BMap<BString, Object> createRecordValue = ValueCreator.createRecordValue(ValueCreator.
                    createRecordValue(BALLERINA_ERROR_PKG_ID, CALL_STACK_ELEMENT), values);
