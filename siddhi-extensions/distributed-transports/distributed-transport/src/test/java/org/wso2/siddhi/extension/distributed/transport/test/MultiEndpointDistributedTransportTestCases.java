package org.wso2.siddhi.extension.distributed.transport.test;
...
public class MultiEndpointDistributedTransportTestCases {
    static final Logger log = Logger.getLogger(MultiEndpointDistributedTransportTestCases.class);
    ...
    public void testTcpOutputTransport1() throws InterruptedException {
        ...
        String inStreamDefinition = "" +
                ...
                "@sink(type='tcp', hostname='localhost', context='foo', @map(type='passThrough'), " +
                "   @distribution(strategy='broadcast', partitionKey='a', " +
