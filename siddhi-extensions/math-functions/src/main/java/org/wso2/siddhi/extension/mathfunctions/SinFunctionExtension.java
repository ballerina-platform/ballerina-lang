...
public class SinFunctionExtension extends FunctionExecutor {
    ...
    private static final Logger log = Logger.getLogger(SinFunctionExtension.class);
    ...
    protected Object execute(Object data) {
        ...
        if (data != null) {
            ...
            throw new OperationNotSupportedException("Input to the math:sin() function cannot be null");
        }
        return returnValue;
    }
