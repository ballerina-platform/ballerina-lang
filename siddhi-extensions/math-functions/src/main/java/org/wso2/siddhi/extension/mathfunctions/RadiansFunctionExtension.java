 ...
 */
public class RadiansFunctionExtension extends FunctionExecutor {
    private static final Logger log = Logger.getLogger(RadiansFunctionExtension.class);
    ...
    protected Object execute(Object[] data) {
        return null;  //Since the radians function takes in only 1 parameter, this method does not get called. Hence, not implemented.
    }
    ...
    protected Object execute(Object data) {
        ...
        if (data != null) {
            ...
            returnValue = Math.toRadians(inputValue);
            if (isDebugMode) {
                log.debug("Input Value = " + inputValue + ", Output Value =" + returnValue);
            }
        } else {
            throw new OperationNotSupportedException("Input to the math:radians() function cannot be null");
        }
        return returnValue;
    }
