...
public class CosFunctionExtension extends FunctionExecutor {
    ...
    private static final Logger log = Logger.getLogger(CosFunctionExtension.class);
    ...
    protected Object execute(Object[] data) {
        return null;  //Since the cos function takes in only 1 parameter, this method does not get called. Hence, not implemented.
    }
    ...
    protected Object execute(Object data) {
        ...
        if (data != null) {
            ...
            throw new OperationNotSupportedException("Input to the math:cos() function cannot be null");
        }
        return returnValue;
    }
