...
* 3, and the absolute value of −3 is also 3. The absolute value of a number
* may be thought of as its distance from zero.
*
...
public class AbsFunctionExtension extends FunctionExecutor {
    ...
    private static final Logger log = Logger.getLogger(AbsFunctionExtension.class);
    ...
    protected Object execute(Object data) {
        ...
        if (data != null) {
            ...
            throw new OperationNotSupportedException("Input to the math:abs() function cannot be null");
        }
        return returnValue;
    }
