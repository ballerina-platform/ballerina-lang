...
public class RadiansFunctionExtensionTestCase {
    private static Logger logger = Logger.getLogger(RadiansFunctionExtensionTestCase.class);
    protected static SiddhiManager siddhiManager;

    @Test
    public void testProcess() throws Exception {
        logger.info("RadiansFunctionExtension TestCase");
