...
public class IsInfiniteFunctionExtension extends FunctionExecutor{
    ...
    protected void init(ExpressionExecutor[] attributeExpressionExecutors, ExecutionPlanContext executionPlanContext) {
        if (attributeExpressionExecutors.length != 1) {
            throw new ExecutionPlanValidationException("Invalid no of arguments passed to math:is_infinite() function, " +
    ...
    protected Object execute(Object[] data) {
        return null;  //Since the is_infinite function takes in only 1 parameter, this method does not get called. Hence, not implemented.
    }
