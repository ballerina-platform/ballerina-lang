...
public class Log10FunctionExtension extends FunctionExecutor {
    ...
    private static final Logger log = Logger.getLogger(Log10FunctionExtension.class);
    ...
    protected Object execute(Object data) {
        ...
        if (data != null) {
            ...
            returnValue = Math.log10(inputValue);
            if (isDebugMode) {
                log.debug("Input Value = " + inputValue + ", Output Value =" + returnValue);
            }
        } else {
            throw new OperationNotSupportedException("Input to the math:log10() function cannot be null");
        }
        return returnValue;
    }
