...
public class SquareRootFunctionExtension extends FunctionExecutor {
    ...
    private static final Logger log = Logger.getLogger(SquareRootFunctionExtension.class);
    ...
    protected Object execute(Object data) {
        ...
        if (data != null) {
            ...
            throw new OperationNotSupportedException("Input to the math:sqrt() function cannot be null");
        }
        return returnValue;
    }
