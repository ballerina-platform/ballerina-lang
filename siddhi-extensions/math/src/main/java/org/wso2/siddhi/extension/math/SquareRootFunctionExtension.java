...
public class SquareRootFunctionExtension extends FunctionExecutor {
    ...
    protected void init(ExpressionExecutor[] attributeExpressionExecutors, ExecutionPlanContext executionPlanContext) {
        if (attributeExpressionExecutors.length != 1) {
            throw new ExecutionPlanValidationException("Invalid no of arguments passed to math:sqrt() function, " +
        ...
        if (!((attributeType == Attribute.Type.DOUBLE)
            ...
            throw new ExecutionPlanValidationException("Invalid parameter type found for the argument of math:sqrt() function, " +
    ...
    protected Object execute(Object[] data) {
        return null;  //Since the sqrt function takes in only 1 parameter, this method does not get called. Hence, not implemented.
    }
