...
public class TCPInputTransportTestCase {
    ...
    public void testTcpInputTransportPauseAndResume() throws InterruptedException {
        ...
        String query = ("@info(name = 'query1') " +
                        ...
                        "insert into outputStream;");
        ExecutionPlanRuntime executionPlanRuntime = siddhiManager.createExecutionPlanRuntime(inStreamDefinition + query);
        Collection<List<Source>> inputTransports = executionPlanRuntime.getSources();
        ...
        // pause
        inputTransports.forEach(e -> e.forEach(Source::pause));
        Thread.sleep(1000);
        // send few events
        arrayList.clear();
        arrayList.add(new Event(System.currentTimeMillis(), new Object[]{"test", 36, 3.0f, 380l, 23.0, true}));
        ...
        // resume
        inputTransports.forEach(e -> e.forEach(Source::resume));
