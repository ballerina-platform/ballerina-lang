...
public class SetUpdateOrInsertRDBMSTableTestCase {
    private static final Logger log = Logger.getLogger(SetUpdateOrInsertRDBMSTableTestCase.class);
    ...
    public void updateFromTableTest1() throws InterruptedException, SQLException {
        log.info("SET-RDBMS-update-or-insert test case 1: setting all columns");
    ...
    public void updateFromTableTest2() throws InterruptedException, SQLException {
        log.info("SET-RDBMS-update-or-insert test case 2: setting a subset of columns");
        SiddhiManager siddhiManager = new SiddhiManager();
        try {
            RDBMSTableTestUtils.clearDatabaseTable(TABLE_NAME);
            String streams = "" +
    ...
    public void updateFromTableTest3() throws InterruptedException, SQLException {
        log.info("SET-RDBMS-update-or-insert test case 3: using a constant value as the assigment expression.");
        SiddhiManager siddhiManager = new SiddhiManager();
        try {
            RDBMSTableTestUtils.clearDatabaseTable(TABLE_NAME);
            String streams = "" +
    ...
    public void updateFromTableTest4() throws InterruptedException, SQLException {
        log.info("SET-RDBMS-update-or-insert test case 4: using one of the output attribute values in the " +
...
//                    "select price, symbol, volume " +
    ...
    public void updateFromTableTest5() throws InterruptedException, SQLException {
        log.info("SET-RDBMS-update-or-insert test case 5: assignment expression containing an output attribute " +
    ...
    public void updateFromTableTest6() throws InterruptedException, SQLException {
        log.info("SET-RDBMS-update-or-insert test case 6: Omitting table name from the LHS of set assignment.");
        SiddhiManager siddhiManager = new SiddhiManager();
        try {
            RDBMSTableTestUtils.clearDatabaseTable(TABLE_NAME);
            String streams = "" +
    ...
    public void updateFromTableTest7() throws InterruptedException, SQLException {
        log.info("SET-RDBMS-update-or-insert test case 7: Set clause should be optional.");
        SiddhiManager siddhiManager = new SiddhiManager();
        try {
            RDBMSTableTestUtils.clearDatabaseTable(TABLE_NAME);
            String streams = "" +
