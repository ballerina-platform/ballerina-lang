...
import org.wso2.siddhi.extension.timeseries.linreg.MultipleLinearRegressionCalculatorTimeLengthWindow;
 ...
 */
public class LinearRegressionStreamProcessorTimeLengthWindow extends StreamProcessor {
    ...
    protected List<Attribute> init(AbstractDefinition inputDefinition,
        ...
        if (paramCount > SIMPLE_LINREG_INPUT_PARAM_COUNT) {
            regressionCalculator = new MultipleLinearRegressionCalculatorTimeLengthWindow(paramCount,
