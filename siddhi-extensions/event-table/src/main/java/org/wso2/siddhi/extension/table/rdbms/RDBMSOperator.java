...
public class RDBMSOperator implements Operator {
    ...
    public RDBMSOperator(ExecutionInfo executionInfo, List<ExpressionExecutor> expressionExecutorList, DBHandler dbHandler, Operator inMemoryTableOperator, int matchingEventOutputSize) {
    ...
    public CompiledCondition cloneCompiledCondition(String key) {
        return new RDBMSOperator(executionInfo, expressionExecutorList, dbHandler, inMemoryTableOperator, matchingEventOutputSize);
    }
